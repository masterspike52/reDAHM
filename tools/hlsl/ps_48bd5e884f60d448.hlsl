// ps_48bd5e884f60d448.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 102 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000198 10040800 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.y = ps;
    ps = log2(r5.x);
    r8.xyz = r5.zzz * -SpotDirection.xyz;
    r5.x = ps;
    ps = 5.0 * r5.w;
    r7.xyz = r5.yyy * r7.xyz;
    r5.y = saturate(ps);
    ps = 1.0 - r5.y;
    r5.z = dot(r8.zxy, r2.zxy);
    r5.y = ps;
    r5.yw = -r5.yy * ModShadowGroupColor.xy + 1.0;
    r0.yz = r0.xy * r5.yw + 0.125;
    ps = LightColorAndFalloffExponent.w * r5.x;
    r5.z = r5.z - SpotAngles.x;
    r5.x = ps;
    ps = SpotAngles.y * r5.z;
    r5.y = saturate(dot(r7.zxy, r1.zxy));
    r0.x = saturate(ps);
    ps = pow(2.0, r5.x);
