...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.y = tex2D(Texture2D_8, r0.xy).w;
    ps = UniformScalar_4.x - r4.w;
    r3.xz = r0.wz * 3.0;
    r3.w = ps;
    r3.z = tex2D(Texture2D_4, r3.xz).z;
    r3.x = float((UniformScalar_3.x >= 1.0));
    r3.x = r3.w * r3.x + r4.w;
    r3.x = -r3.x + r4.z;
    ...
    ps = 1.0 - r3.x;
    r3.x = ps;
    r3.z = (UniformScalar_4.x > 0.0) ? r3.x : 1.0;
    r3.x = (UniformScalar_4.x >= 0.0) ? r3.z : r3.x;
    r3.x = r3.x * r3.y - 0.5;
