// ps_be025bc3b2d8f5a0.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 78 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000138 10040500 00000506 00000000 000048A5 001F001F 00000021 00003050 0000F154 0000F256 0000F357 0000F458
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.x = ps;
    r0.xy = r0.xy * abs(r5.xy);
    r0.yz = tex2D(ModShadowAccumTexture, r0.xy).xy;
    ps = OpacityOverride.x;
    r0.x = dot(r1.zxy, r1.zxy);
    r0.w = saturate(ps);
    r3.xyz = r3.xyz * UniformVector_1.xyz + UniformVector_0.xyz;
    ps = rsqrt(abs(r0.x));
    r4.xy = r0.yz * 0.875;
    r0.x = ps;
    r0.x = r0.x * r1.z + 0.1;
    ...
    r1.xy = r4.xy * r1.xy + 0.125;
    ps = 1.0 + ps;
    r1.x = r1.x * r1.y;
    r0.z = ps;
    r0.xyz = r1.xxx * r0.xyz + ModShadowColor.xyz;
    ps = -r2.w;
