// ps_60e62d353c7ebbe9.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 93 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000174 10040700 0000060A 00000000 000058C6 000F003F 00000001 00007054 0000F155 00007256 0000F357 0000F4A0 0000F5A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.x = ps;
    ps = 1.0 - r4.y;
    r2.xyz = r4.xxx * r2.zxy;
    r4.x = ps;
    r4.xy = -r4.xx * ModShadowGroupColor.xy + 1.0;
    r2.yz = -r2.yz;
    r2.x = r2.x * 2.0 - r2.x;
    r4.w = saturate(dot(r6.yzx, r2.yzx));
    ps = log2(r4.w);
    r1.xyz = r1.xyz * LightColor.xyz;
    r5.z = ps;
    r5.xyz = r5.xyz * float3(0.875, 0.875, 15.0);
    ps = pow(2.0, r5.z);
    r7.x = saturate(r4.z * r0.z);
    r4.z = ps;
    r4.xy = r5.xy * r4.xy + 0.125;
    ps = r4.x * r4.y;
    r5.xy = r4.zz * float2(0.3, 0.6);
    r4.x = ps;
    r4.xyz = r4.xxx * r3.xyz + ModShadowColor.xyz;
    r5.xyz = r7.xyz * r7.wxx + r5.xyx;
