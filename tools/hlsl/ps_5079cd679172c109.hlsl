// ps_5079cd679172c109.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 96 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000180 10040700 0000060A 00000000 000060C6 000F003F 00000001 0000F054 0000F156 0000F257 0000F358 0000F4A0 0000F5A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.xyz = AmbientColorAndSkyFactor.xyz * 0.25;
    r4.y = ps;
    ps = 1.0 / ModShadowAccumResolution.y;
    r4.x = dot(r0.zxy, r0.zxy);
    r4.z = ps;
    r4.yz = r4.yz * abs(r6.xy);
    r4.zw = tex2D(ModShadowAccumTexture, r4.yz).xy;
    ...
    r4.y = ps;
    r5.xyz = r5.xyz * r2.xyz + UniformVector_0.xyz;
    ps = rsqrt(abs(r4.x));
    r6.xyw = r2.xyz * 0.25;
    r4.x = ps;
    r7.xyz = r6.xwy * ConstantLighting.xzy + r5.xzy;
    ps = r4.x;
    r2 = r4.yyzw * float4(0.5, -0.5, 0.875, 0.875);
    ps = r0.z * ps;
    r4.yz = r2.xy * r3.zz;
    r4.x = ps;
    ps = -ModShadowColor.x;
    r4.xyz = r4.xyz + float3(0.1, 0.5, 0.5);
    ps = 1.0 + ps;
    r5.xw = abs(r4.yz) * abs(r4.yz);
    r0.x = ps;
    ps = 5.0 * r4.x;
    r5.xyz = r6.xwy * r5.xxx;
    r4.x = saturate(ps);
    ps = 1.0 - r4.x;
    r4.yzw = r6.xwy * r5.www;
    r4.x = ps;
    ps = -ModShadowColor.y;
    r6.xy = r4.xx * ModShadowGroupColor.xy;
    r4.xyz = r4.ywz * LowerSkyColor.xyz + r7.xzy;
