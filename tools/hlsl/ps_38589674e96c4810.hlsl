...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4 = tex2D(Texture2D_0, r0.xy).xywz;
    r5.y = dot(r1.zxy, r1.zxy);
    r5.x = dot(r2.zxy, r2.zxy);
    ps = rsqrt(abs(r5.y));
    r0.zw = r5.zw * 0.875;
    r6.w = ps;
    r2.x = saturate(r6.w * r1.z);
    ps = r1.z;
    ...
    r5.z = ps;
    ps = 1.0 - r5.x;
    r0.xy = r4.zz * UniformVector_1.xy;
    r5.w = saturate(ps);
    ps = r4.z;
    r4.xyw = r2.yzw * r4.xyw;
    r5.x = ps;
    ps = rsqrt(abs(r5.y));
    r2.yzw = r6.www * r1.zxy;
    r5.y = ps;
    ps = 5.0 * r5.z;
    r1.xyz = r5.yyy * r3.zxy;
    r5.y = saturate(ps);
    ps = 1.0 - r5.y;
    r1.yz = -r1.yz;
    r5.y = ps;
    ...
    r9.yz = r0.zw * r5.yz + 0.125;
    ps = log2(r5.w);
    r5.y = saturate(dot(r2.zwy, r1.yzx));
    r5.z = ps;
    ps = log2(r5.y);
