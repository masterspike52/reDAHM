// ps_2fc824662e14f998.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 171 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000002AC 10040C00 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9.yzw = tex2D(Texture2D_3, r0.xy).xyz;
    ...
    r7.x = max(UniformScalar_7.x, 0.0001);
    ps = -UniformVector_0.x;
    r5.y = float((UniformScalar_0.x > UniformScalar_1.x));
    ps = 1.0 + ps;
    ...
    r6.w = ps;
    r5.yzw = (-abs(r5.yyy) >= 0.0) ? r9.yzw : r2.xyz;
    ps = log2(r0.w);
    r2.xyz = r11.xyz - r10.xyz;
    r5.x = ps;
    r2.xyz = r2.xyz * UniformScalar_0.xxx + r10.xyz;
    r5.yzw = (-abs(r1.www) >= 0.0) ? r9.yzw : r5.yzw;
    ...
    r7.w = ps;
    r2.xy = r7.xy * r7.wz;
    r5.xyz = r2.yyy * r8.xyz + ModShadowColor.xyz;
    ps = pow(2.0, r2.x);
