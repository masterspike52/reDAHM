// ps_134c08540ea4dce2.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 171 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000002AC 10040D00 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.xyz = r13.xyz * 2.0 - 1.0;
    ps = rsqrt(abs(r5.w));
    r8.yz = r8.yz * 0.875;
    r5.w = ps;
    ps = 5.0 * r5.z;
    r0.xyz = r11.xyz * r4.xyz;
    r5.x = saturate(ps);
    ps = rsqrt(abs(r5.y));
    ...
    r6.w = ps;
    r0.xyz = (-abs(r3.www) >= 0.0) ? r11.xyz : r0.xyz;
    ps = log2(r0.w);
    r1.xyz = r12.xyz - r2.xyz;
    r5.x = ps;
    r0.xyz = (-abs(r1.www) >= 0.0) ? r11.xyz : r0.xyz;
    ...
    r6.w = ps;
    r1.xyz = r0.xyz * UniformScalar_0.xxx + r10.xyz;
    r0.yzw = r1.xyz * UniformScalar_2.xxx + UniformScalar_3.xxx;
    r3.xyz = r2.xyz * r6.www;
    r6.w = dot(r3.zxy, r5.wyz);
    r2.xyz = r3.xzy * r6.www;
    r5.yzw = r2.xyz * 2.0 - r5.ywz;
