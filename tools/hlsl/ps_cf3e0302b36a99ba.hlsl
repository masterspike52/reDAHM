...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0 = tex2D(Texture2D_1, r1.xy).wyxz;
    ps = r2.z;
    ...
    r9.yz = r1.zw * r1.xy + 0.125;
    r3.xyz = r7.xyz * r6.www;
    r2.x = saturate(dot(r3.zxy, r2.wyz));
    ps = rsqrt(abs(r6.y));
    r0.z = r5.w * r2.x;
    r7.w = ps;
    ps = r0.x;
    ...
    r6.z = saturate(dot(r2.wyz, r1.yxz));
    r9.y = saturate(ps);
    ps = log2(r6.z);
    r1.xyz = r7.www * r8.xyz;
    r9.z = ps;
    ps = pow(2.0, r6.w);
    r6.xz = r9.xy * r9.zy;
    r6.w = ps;
    ...
    r2.y = ps;
    ps = UniformVector_1.z * r6.y;
    r0.xy = r0.xy * r2.yy;
    r5.z = ps;
    r0.xyz = r5.xyz * r2.xxy + r0.xyz;
    r0.xyz = r1.xyz * r0.xyz;
    r0.xyz = r0.xyz * LightColorAndFalloffExponent.xyz;
    r6.xyz = r0.xyz * r6.zzz;
