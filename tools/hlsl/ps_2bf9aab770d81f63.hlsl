// ps_2bf9aab770d81f63.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 18 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000048 10000500 00000008 00000000 00005CC6 0007003F 00000021 0000F050 0000F156 00007257 0000F3A0 0000F4A1 0000F5A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.y = tex2D(Texture2D_1, r0.xy).w;
    r3.x = (-0.5) + r3.y;
