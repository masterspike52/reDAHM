...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r10.xy = tex2D(ModShadowAccumTexture, r6.xz).xy;
    r6.x = r2.z + 0.1;
    r6.z = dot(r2.zxy, r2.zxy);
    r7.y = saturate(-r6.y + 1.0);
    r6.z = rsqrt(abs(r6.z));
    r7.w = saturate(r6.z * r2.z);
    r7.z = rsqrt(abs(r6.y));
    ...
    ps = -r6.y;
    r4.xyz = r7.zzz * -SpotDirection.xyz;
    r2.y = ps;
    r2.x = r6.w * 2.0 - r6.w;
    ps = -r6.z;
    ...
    r6.z = saturate(dot(r8.yzx, r2.yzx));
    r6.y = ps;
    ps = log2(r6.z);
    r8.x = saturate(r6.y * SpotAngles.y);
    r10.z = ps;
    r6.yzw = r10.xyz * float3(0.875, 0.875, 15.0);
    r8.yz = r6.yz * r7.xy + 0.125;
    ps = pow(2.0, r6.w);
    r7.xyz = r8.wxy * r8.wxz;
    r0.w = ps;
    ps = LightColorAndFalloffExponent.w * r6.x;
    r0 = r0 * r1;
    r6.w = ps;
    r6.xyz = r7.zzz * r9.xyz + ModShadowColor.xyz;
    r0.xy = r0.xy * r7.ww + r0.ww;
    r0.z = r0.z * r7.w + r0.w;
    ps = pow(2.0, r6.w);
