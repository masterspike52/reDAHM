// vs_aab99308214e3dce.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 1128 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000080 000011A0 0081000E 00000000 00000000 00008929 00000001 00000008 00000009 00000290 0010002C 0000602D 0000702E 0000302F 00005030 00015031 00025032 00201033 0000F050 0001F151 00027254 0003F355 00047456 0005F557 0006F6A0 0007F7A1 0008F8A2 00001173 00001174 0000116F 00001175 00001170 00001176 00001171 0000116E 00001172
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r8.xyz = -r0.zyx + LightPositionAndInvRadius.xyz;
    r9.xyz = r8.zzz * WorldToLocal[2].xzy;
    ...
    r0.xyz = r8.yyy * WorldToLocal[1].xzy + r9.xyz;
    r0.xyz = r8.xxx * WorldToLocal[0].xyz + r0.xzy;
    r9.xyz = r5.www * WorldToLocal[0].xzy + r5.xzy;
    r5.x = dot(r1.xzy, r9.yxz);
    r5.y = dot(r6.yxz, r9.yxz);
    r5.z = dot(r3.zyx, r9.yxz);
    r9.x = dot(r1.xzy, r0.zxy);
    r9.y = dot(r6.yxz, r0.zxy);
    r9.z = dot(r3.zyx, r0.zxy);
    p0 = (-SP_DemolitionSpread.x >= 0.0);
    ps = p0 ? 0.0 : 1.0;
    // UNHANDLED control flow: cjmp
    r0 = r12.wwww * LocalToWorld[3].xwzy;
    ...
    oPos = r0;
    r8.xyz = r8.xyz * LightPositionAndInvRadius.www;
    o7.xyz = r14.xyz;
    o7.w = 0.0;
    o2.xyz = r9.xyz;
    o4.xyz = r5.xyz;
