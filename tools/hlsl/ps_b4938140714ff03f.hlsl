// ps_b4938140714ff03f.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 153 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000264 10040C00 0000070A 00000000 000070E7 001F007F 00000001 0000F050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.w = ps;
    r4.xyz = r7.xyz * UniformVector_1.xyz + UniformVector_0.xyz;
    r7.xyz = r3.xyz * AmbientColorAndSkyFactor.xyz + r4.xyz;
    ps = rsqrt(abs(r5.w));
    r6.xyz = r0.www * r1.xzy;
    r5.w = ps;
    r1.xyz = r9.xyz * r5.www;
    ps = 0.1 - -r6.y;
    r10.x = dot(r5.zxy, r1.xyz);
    r5.x = ps;
    ps = 5.0 * r5.x;
    ...
    r5.x = ps;
    ps = 0.5 + r5.x;
    r1.w = saturate(dot(r6.yxz, r9.zxy));
    r4.x = ps;
    ps = 0.5 + r0.x;
    r5.xyw = -r4.yzw + 1.0;
    r4.y = ps;
    ...
    r0.x = ps;
    ps = r5.y * r5.z;
    r4.xyz = r3.xzy * r6.xxx;
    r5.x = ps;
    r5.xyz = r5.xxx * r8.xyz + ModShadowColor.xyz;
    ps = pow(2.0, r0.x);
    r0.yzw = r3.xzy * r6.yyy;
    r0.x = ps;
    r0.yzw = r0.ywz * UpperSkyColor.xyz + r7.xyz;
    r6.xyz = r4.xyz * LowerSkyColor.xzy + r0.ywz;
    r0.xyz = r0.xxx * ConstantLighting.xzy;
    r6.xyz = r0.xzy * r6.www + r6.xzy;
    r6.xyz = r1.xzy * r3.xzy + r6.xzy;
    ps = -r2.w;
