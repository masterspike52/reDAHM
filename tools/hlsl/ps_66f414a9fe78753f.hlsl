// ps_66f414a9fe78753f.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 126 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001F8 10040900 00000506 00000000 000040A5 001F001F 00000001 00003050 00007154 0000F255 00007356 0000F457
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.x = saturate(dot(r1.wyz, r3.yxz));
    ps = log2(r1.x);
    r0.z = saturate(dot(r2.zxy, r1.wyz));
    r8.z = ps;
    r2.xyz = r8.xyz * float3(0.875, 0.875, 15.0);
    ps = pow(2.0, r2.z);
    r1.xyw = r7.xyz * r0.zzz;
    r0.z = ps;
