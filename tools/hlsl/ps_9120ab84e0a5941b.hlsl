// ps_9120ab84e0a5941b.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 120 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001E0 10040800 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.z = saturate(ps);
    r6.zw = -r6.zw + 1.0;
    r2.y = float((abs(r6.w) > 0.0345));
    ps = -SpotAngles.x - -r5.y;
    r2.z = float((abs(r6.w) >= 0.0345));
    r5.x = ps;
