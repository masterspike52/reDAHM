// ps_1e63de4ab6a05ea7.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 132 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000210 10040900 00000806 00000000 00006908 00FF00FF 00000001 00003050 00003151 0000F252 0000F353 00007454 0000F555 00007656 0000F757
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.xyz = tex2D(LightAttenuationTexture, r1.xy).xyz;
    ...
    r1.w = ps;
    ps = rsqrt(abs(r2.w));
    r5 = r7.xyxz * float4(5.0, 5.0, 5e+01, 5.0);
    r1.x = ps;
    ps = rsqrt(abs(r0.w));
    ...
    r0.y = ps;
    ps = 1.0 - r0.x;
    r6.xyz = r0.yyy * r8.xyz;
    r0.x = ps;
    r0.xy = -r0.xx * ModShadowGroupColor.xy + 1.0;
    r1.xy = r1.zw * r0.xy + 0.125;
    ps = r5.z;
    ...
    r1.w = ps;
    ps = max(r1.z, r1.w);
    r0.xyw = r6.xzy * r0.xxx;
    r1.z = ps;
    r0.xyw = r0.xyw * 2.0 - r7.xzy;
    ps = log2(r0.z);
    r0.x = saturate(dot(r4.zxy, r0.yxw));
    r0.y = ps;
    ps = log2(r0.x);
    r0.w = r0.y * LightColorAndFalloffExponent.w;
    r1.w = ps;
    r1.xw = r1.zx * r1.wy;
    r0.xyz = r1.www * r9.xyz + ModShadowColor.xyz;
    ps = pow(2.0, r1.x);
    r1.w = saturate(dot(r6.zxy, r4.zxy));
    r1.x = ps;
    ps = pow(2.0, r0.w);
    r1.xyz = r5.xyw * r1.xxx;
    r0.w = ps;
