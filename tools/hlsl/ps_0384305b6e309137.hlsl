// ps_0384305b6e309137.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 276 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000450 10040E00 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.zw = r8.xy * 2.0 - 1.0;
    ps = rsqrt(abs(r5.x));
    r2.y = saturate(r5.z * 0.00022222222);
    r5.x = ps;
    ps = -r0.z;
    r8.xyz = r5.xxx * r3.xyz;
    ps = 1.0 + ps;
    r3.xyw = r2.yzw * float3(-0.025, 0.5, 0.5);
    r5.x = ps;
    ps = UniformVector_2.y * r5.x;
    r2.zw = r8.xy * r3.xx;
    r2.y = ps;
    r5.xz = r2.xy - 0.5;
    r10.xz = float2((r2.xy >= 0.5));
    ps = r5.y;
    r5.xz = r5.xz - r2.xy;
    ps = abs(r7.x) * ps;
    r6.zw = r5.xz * r10.xz;
    ...
    r5.xy = r9.zw + r9.zw;
    r5.w = ps;
    r7.zw = tex2D(ModShadowAccumTexture, r5.zw).xy;
    ...
    r10.y = ps;
    ps = r2.y + r2.y;
    r10.x = dot(r10.xzz, float3(1.0, 1.0, 1.0));
    r10.z = ps;
    r5.z = (r10.x == 0.0) ? r14.x : r14.y;
    r10 = r10.xzxy + float4(-3.0, -1.0, -2.0, -1.0);
    ps = r10.w;
    r6.xyw = r6.xyz * UniformVector_4.xyz;
    r5.z = (r10.z == 0.0) ? r14.z : r5.z;
    r10.x = (r10.x == 0.0) ? r14.w : r5.z;
    ps = r3.y + ps;
    r5.z = max(r10.x, 0.0);
    r7.x = ps;
    ps = r10.y;
    r7.y = min(r5.z, 0.3);
    ps = r3.w + ps;
    r3.xyz = r7.zyw * float3(0.875, 3.3333333, 0.875);
    r7.y = ps;
    r7.xy = r3.yy * r7.xy + r6.xy;
    ps = 1.0 / r4.w;
    r13.xy = r7.xy - r12.xy;
    r5.z = ps;
    r7.xy = r13.zw * r5.zz + ScreenPositionScaleBias.wz;
    r9.xyz = tex2D(Texture2D_4, r9.xy).xyz;
    r10.yzw = tex2D(LightAttenuationTexture, r7.xy).xyz;
    ...
    r5.x = ps;
    r2.xyz = r0.xyz * UniformScalar_1.xxx + UniformScalar_2.xxx;
    r4.x = r8.w * r2.w - 1.0;
    ps = 5.0 * r5.x;
    r0.xyz = r10.yzw * LightColor.xyz;
    r10.y = saturate(ps);
    ps = -r12.z;
    ...
    r11.w = ps;
    ps = 2.5 * r5.x;
    r4.zw = r5.yy * ModShadowGroupColor.xy;
    r14.w = ps;
    ps = rsqrt(abs(r5.z));
    r4.yzw = -r4.wzy + 1.0;
    r5.z = ps;
    r10.yzw = r3.yxz * r4.xzy + float3(1.0, 0.125, 0.125);
    ps = abs(r10.y) * abs(r10.y);
    r3.xyz = r5.zzz * r1.xyz;
    r10.x = ps;
    r11.xyz = r14.xyz * r10.yyy - r9.xyz;
    r6.w = saturate(r14.w * r10.y - 0.5);
    r5.xy = r13.xy * r6.ww + r12.xy;
    r5.z = r11.w * r6.w - 2.0;
    r9.xyz = r11.xyz * r6.www + r9.xyz;
    r1.xw = r10.zx * r10.wx;
    r6.xyz = r1.xxx * r6.xyz + ModShadowColor.xyz;
    r5.z = r5.w * 2.0 + r5.z;
    r5.xyz = r5.zxy * r4.www;
    ps = 1.0 + r5.x;
    r1.xyz = r9.xyz * r7.xyz;
    r5.w = ps;
    r5.xyz = (r4.www > 0.0) ? r5.yzw : float3(0.0, 0.0, 1.0);
    r5.yzw = (r4.www >= 0.0) ? r5.xyz : float3(0.0, 0.0, 1.0);
    ps = r1.w * r1.w;
