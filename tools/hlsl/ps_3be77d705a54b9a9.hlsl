...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.x = ps;
    r7.zw = -r6.yy * ModShadowGroupColor.xy + 1.0;
    ps = rsqrt(abs(r6.w));
    r6.z = dot(r4.zxy, r3.zxy);
    r6.y = ps;
    r3.xyz = r6.yyy * r8.xyz;
    r0.z = saturate(dot(r3.zxy, r2.zxy));
    r6.y = dot(r3.zxy, r1.zxy);
    r3.xyz = r3.xzy * r6.yyy;
    r1.xyz = r3.xyz * 2.0 - r1.xzy;
    r6.y = saturate(dot(r2.zxy, r1.yxz));
    ps = log2(r6.y);
    r7.x = r6.z - SpotAngles.x;
    r10.x = ps;
