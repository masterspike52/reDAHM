...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9.xyw = tex2D(LightAttenuationTexture, r6.zw).xyz;
    ...
    r8.x = ps;
    ps = 0.875 * r6.y;
    r7.xy = r5.ww * UniformVector_1.xy;
    r8.y = ps;
    r1.xzw = r10.xyz * 2.0 - 1.0;
    ps = rsqrt(abs(r6.z));
    r6.x = saturate(r6.w * 5.0);
    r6.y = ps;
    ps = 1.0 - r6.x;
    r3.xyw = r3.xyz * r5.xyz;
    r7.w = ps;
    ps = rsqrt(abs(r7.z));
    r6.yzw = r6.yyy * r2.xyz;
    r0.y = ps;
    ps = log2(r0.z);
    r7.z = dot(r1.wxz, r1.wxz);
    r6.x = ps;
    ps = rsqrt(abs(r7.z));
    r4.xyz = r0.yyy * r4.xyz;
    r7.z = ps;
    ps = LightColorAndFalloffExponent.w * r6.x;
    r0.xyz = r0.xxx * r9.xyw;
    r6.x = ps;
    r2.xy = -r7.ww * ModShadowGroupColor.xy + 1.0;
    r9.xy = r8.xy * r2.xy + 0.125;
    ps = pow(2.0, r6.x);
    r2.xyz = r1.xzw * r7.zzz;
    r6.x = ps;
    ps = -ModShadowColor.y;
    ...
    ps = 1.0 + ps;
    r6.x = saturate(dot(r6.wyz, r4.yxz));
    r1.w = ps;
    ps = log2(r6.x);
    r1.x = saturate(dot(r2.zxy, r6.wyz));
    r9.w = ps;
    ps = r5.w;
    r7.zw = r9.xz * r9.yw;
    r6.x = ps;
    r6.yzw = r7.zzz * r1.yzw + ModShadowColor.xyz;
    ps = pow(2.0, r7.w);
    r7.z = r3.w * r1.x;
    r1.y = ps;
