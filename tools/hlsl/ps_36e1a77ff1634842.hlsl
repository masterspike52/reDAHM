// ps_36e1a77ff1634842.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 117 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001D4 10040800 00000506 00000000 000040A5 001F001F 00000001 00003050 00007154 0000F255 00007356 0000F457
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.yz = r0.zz * ScreenPositionScaleBias.xy;
    r0.w = ps;
    ps = 1.0 / ModShadowAccumResolution.x;
    r6.xyz = -ModShadowColor.xyz + 1.0;
    r0.z = ps;
    r0.zw = r0.zw * abs(r5.xy);
    r4.xy = r7.yz * r4.xy + ScreenPositionScaleBias.wz;
    ...
    r0.z = ps;
    ps = 1.0 - r0.x;
    r2.zw = r5.zz * UniformVector_1.xy;
    r0.w = saturate(ps);
    ps = r5.z;
    ...
    ps = log2(r0.w);
    r0.y = saturate(dot(r8.yzx, r1.yzx));
    r0.z = ps;
    ps = log2(r0.y);
