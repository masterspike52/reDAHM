// ps_ae2334480da6ae04.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 150 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000258 10040C00 00000506 00000000 000040A5 001F001F 00000001 00003050 00007154 0000F255 00007356 0000F457
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.yzw = tex2D(Texture2D_2, r0.xy).xyz;
    r0.xy = tex2D(ModShadowAccumTexture, r5.xy).xy;
    ...
    r4.xyz = r4.xzy * LightColor.xzy;
    r7.x = ps;
    r10.yzw = r7.yzw * 2.0 - 1.0;
    ps = UniformScalar_0.x * r2.z;
    r0.x = saturate(r0.x * 5.0);
    r7.y = ps;
    ps = 1.0 - r0.x;
    r0.y = dot(r8.xzy, float3(1.0, 1.0, 1.0));
    r0.z = ps;
    ps = rsqrt(abs(r1.w));
    r12.xyz = r10.wyz * float3(0.7, 1.0, 1.0);
    r0.x = ps;
    ps = rsqrt(abs(r0.w));
    ...
    r1.z = ps;
    ps = log2(abs(r0.y));
    r1.x = dot(r8.zxy, r10.wyz);
    r10.x = ps;
    ps = rsqrt(abs(r1.w));
    r0 = r10 * float4(0.1, 1.0, 1.0, 0.7);
    r1.w = ps;
    ps = r1.x;
    r3.xyz = r0.yzw * r1.www;
    r7.z = ps;
    ps = 0.0;
    r0.w = saturate(dot(r3.zxy, r9.zxy));
    r7.w = ps;
    ps = max(r7.z, r7.w);
    r1.w = dot(r3.zxy, r8.zxy);
    r1.x = ps;
    ps = pow(2.0, r0.x);
    r10.xyz = r3.xzy * r1.www;
    r1.w = ps;
    ps = UniformScalar_0.x * r2.w;
    r1 = -r1.wxyz + float4(1.0, 0.45, 1.0, 1.0);
    r7.z = ps;
    r3.yz = r11.xy * r1.zw + 0.125;
    ps = r1.y;
    r2.xyz = r1.xxx * r2.yzw;
    r0.x = ps;
    r8.xyz = r10.xyz * 2.0 - r8.xzy;
    ps = 4.0 * r0.x;
    r3.w = saturate(dot(r9.zxy, r8.yxz));
    r2.w = saturate(ps);
    ps = r3.w * r3.w;
    r0.xyz = r2.xyz * UniformVector_3.www;
    r3.x = ps;
    r0.xyz = r0.xyz * UniformVector_3.xyz - r2.xyz;
