// ps_6ce1724bceb8fe79.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 276 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000450 10040E00 00000606 00000000 000048C6 003F003F 00000021 00003050 00003151 00007254 0000F355 00007456 0000F557
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.yz = r7.xy * 2.0 - 1.0;
    ps = rsqrt(abs(r0.z));
    r8.x = saturate(r0.w * 0.00022222222);
    r0.z = ps;
    ps = -r1.y;
    r7.xyz = r0.zzz * r4.xyz;
    ps = 1.0 + ps;
    r8.xyz = r8.xyz * float3(-0.025, 0.5, 0.5);
    r0.z = ps;
    ps = UniformVector_2.y * r0.z;
    r12.zw = r7.xy * r8.xx;
    r12.y = ps;
    r0.zw = r12.xy - 0.5;
    r9.xw = float2((r12.xy >= 0.5));
    ps = r3.x;
    r0.zw = r0.zw - r12.xy;
    ps = abs(r6.x) * ps;
    r10.zw = r0.zw * r9.xw;
    ...
    r0.xyw = tex2D(Texture2D_0, r4.zw).xyz;
    ...
    r6.y = ps;
    ps = r3.y + r3.y;
    r6.x = dot(r9.xww, float3(1.0, 1.0, 1.0));
    r6.z = ps;
    r0.z = (r6.x == 0.0) ? r10.x : r10.y;
    r6 = r6.xxzy + float4(-3.0, -2.0, -1.0, -1.0);
    ps = r6.w;
    r1.xyw = r1.xyz * UniformVector_4.xyz;
    r0.z = (r6.y == 0.0) ? r10.z : r0.z;
    r6.y = (r6.x == 0.0) ? r10.w : r0.z;
    ps = r8.y + ps;
    r0.z = max(r6.y, 0.0);
    r6.x = ps;
    ps = r6.z;
    r9.x = min(r0.z, 0.3);
    ps = r8.z + ps;
    r10.xyz = r9.yxz * float3(0.875, 3.3333333, 0.875);
    r6.z = ps;
    r6.xz = r10.yy * r6.xz + r1.xy;
    ps = 1.0 / r5.w;
    r13.xy = r6.xz - r12.xy;
    r0.z = ps;
    r4.xy = r13.zw * r0.zz + ScreenPositionScaleBias.wz;
    r9.xyz = tex2D(Texture2D_4, r4.zw).xyz;
