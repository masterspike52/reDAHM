// ps_6196d66b32707f83.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 114 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001C8 10040900 0000070A 00000000 000060E7 001F007F 00000001 00003050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.x = ps;
    ps = 1.0 - r5.z;
    r2.xyz = r5.xxx * r3.zxy;
    r5.x = ps;
    r0.xy = -r5.xx * ModShadowGroupColor.xy + 1.0;
    r2.yz = -r2.yz;
    r2.x = r2.x * 2.0 - r2.x;
    ps = 1.0 - r5.y;
    r5.x = saturate(dot(r9.yzx, r2.yzx));
    r5.z = saturate(ps);
    ps = log2(r5.x);
    r6.x = saturate(r5.w * r1.z);
    r7.z = ps;
    ps = log2(r5.z);
    r5.xyw = r7.zyx * float3(15.0, 0.875, 0.875);
    r5.z = ps;
    r0.xy = r5.wy * r0.xy + 0.125;
    ps = pow(2.0, r5.x);
    r5.w = r5.z * LightColorAndFalloffExponent.w;
    r5.x = ps;
    r5.xy = r5.xx * float2(0.3, 0.6);
    r6.xyz = r6.xyz * r6.wxx + r5.xyx;
    r0.xy = r0.xz * r0.yz;
