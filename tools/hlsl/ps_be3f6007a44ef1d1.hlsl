...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.yz = r0.yz * r7.xy + ScreenPositionScaleBias.wz;
    ...
    r5.xyz = r1.zzz * r4.zxy;
    r1.w = rsqrt(abs(r1.w));
    r2.xyz = r1.www * r6.zxy;
    r0.x = 1.0 - r0.x;
    r3.xy = -r0.xx * ModShadowGroupColor.xy + 1.0;
    r2.yz = -r2.yz;
    r2.x = r2.x * 2.0 - r2.x;
    r0.x = saturate(dot(r5.yzx, r2.yzx));
    r2.zw = r0.yz * LightColor.xy;
    r0.x = log2(r0.x);
    r0.x = 15.0 * r0.x;
    r4.w = saturate(r1.z * r4.z);
    r1.z = pow(2.0, r0.x);
    r4.xyz = r1.xyz * float3(0.875, 0.875, 0.21952);
    r0.x = r4.z * r0.w;
