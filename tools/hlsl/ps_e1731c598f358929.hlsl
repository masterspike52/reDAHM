...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9.x = ps;
    ps = rsqrt(abs(r6.x));
    r6.yzw = r0.wxy * AmbientColorAndSkyFactor.xyz;
    r6.x = ps;
    r6.yzw = r6.yzw * r7.xyz + UniformVector_0.xyz;
    ps = rsqrt(abs(r5.w));
    r10.xyz = r6.xxx * r1.xyz;
    r5.w = ps;
    ps = 0.875 * r5.y;
    ...
    r5.x = ps;
    ps = rsqrt(abs(r5.y));
    r5.w = saturate(dot(r10.xyz, r1.yzx));
    r1.y = ps;
    ps = log2(r5.w);
    r5.xy = r5.xx * ModShadowGroupColor.xy;
    r1.x = ps;
    ps = 1.0 - r5.x;
    r0.xyz = r7.xyz * r0.wxy;
    r7.x = ps;
    ps = 1.0 - r5.y;
