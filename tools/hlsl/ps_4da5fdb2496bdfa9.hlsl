// ps_4da5fdb2496bdfa9.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 318 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004F8 10041100 0000080A 00000000 00007908 003F00FF 00000021 00003050 0000F151 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9.xzw = tex2D(Texture2D_6, r7.zw).xyz;
    r4.xyz = tex2D(Texture2D_0, r4.xy).xyz;
    r10.xyz = tex2D(Texture2D_3, r1.xy).xyz;
    r14.xyz = tex2D(Texture2D_2, r7.xy).xyw;
    ...
    r0.x = ps;
    r16.x = r14.z * r1.z - 1.0;
    r12.xw = r1.xy * 2.0 - 1.0;
    r16.zw = r14.xy * 2.0 - 1.0;
    ps = rsqrt(abs(r6.z));
    r0.yzw = r0.yzw * r13.xyz;
    r6.z = ps;
    ...
    ps = 1.0 + ps;
    r15.yzw = r0.yzw * r9.xzw;
    r0.y = ps;
    r14.yzw = r15.yzw * UniformScalar_3.xxx + UniformScalar_4.xxx;
