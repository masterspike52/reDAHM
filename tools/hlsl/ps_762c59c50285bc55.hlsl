// ps_762c59c50285bc55.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 117 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001D4 10040900 0000080A 00000000 00008108 003F00FF 00000001 0000F050 0000F153 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.x = ps;
    r7.yzw = r0.xyz * r7.yzw + UniformVector_0.xyz;
    ps = rsqrt(abs(r6.y));
    r5.xyz = r7.xxx * r5.xyz;
    r6.y = ps;
    r7.x = r6.z * r2.z + 0.1;
    ps = OpacityOverride.x;
    r0.xyw = r6.yyy * r9.xyz;
    r0.z = saturate(ps);
    ps = 5.0 * r7.x;
