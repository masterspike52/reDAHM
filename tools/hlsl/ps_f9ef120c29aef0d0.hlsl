// ps_f9ef120c29aef0d0.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 120 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001E0 10040800 00000806 00000000 00006908 00FF00FF 00000001 00003050 00003151 0000F252 0000F353 00007454 0000F555 00007656 0000F757
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.z = ps;
    ps = 1.0 - r0.x;
    r2.z = saturate(r0.z * r4.z);
    r2.w = saturate(ps);
    ps = rsqrt(abs(r0.y));
    r8.xyz = r0.zzz * r4.zxy;
    r0.y = ps;
    ps = rsqrt(abs(r0.x));
    ...
    r0.z = saturate(dot(r8.yzx, r2.ywx));
    r0.y = ps;
    ps = log2(r0.z);
    ...
    r7.x = ps;
    ps = pow(2.0, r0.x);
    r0.yzw = r7.xyz * float3(0.21952, 0.875, 0.875);
    r4.z = ps;
    r0.x = r2.z * r1.w + r0.y;
    r0 = r0.zwxy * r4.xyzz;
    r0.xy = r0.xy + 0.125;
    r1.xyz = r0.zww * r1.xyz;
    ps = r0.x * r0.y;
