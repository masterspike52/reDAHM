// vs_896789fee2b17efd.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 1116 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000080 00001170 0071000E 00000000 00000000 00007908 00000001 00000007 00000008 00000290 0010002C 0000602D 0000702E 0000302F 00005030 00015031 00201032 0000F050 00017154 0002F255 00037356 0004F457 0005F5A0 0006F6A1 0007F7A2 00001170 0000116C 00001171 0000116D 00001172 0000116E 0000116B 0000116F
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r7 = r12.wwww * LocalToWorld[3].xzyw;
    ps = 0.003921569 * r1.w;
    r3.xyz = r10.yxz * 0.003921569;
    r8.x = ps;
    ...
    r11.x = dot(r1.xzy, r0.zxy);
    r11.y = dot(r7.yxz, r0.zxy);
    r11.z = dot(r6.zyx, r0.zxy);
    p0 = (-SP_DemolitionSpread.x >= 0.0);
    ps = p0 ? 0.0 : 1.0;
    // UNHANDLED control flow: cjmp
    r0 = r12.wwww * LocalToWorld[3].xwzy;
    ...
    oPos = r0;
    r10.xyz = r13.xyz * LightPositionAndInvRadius.www;
    o6.xyz = r8.xyz;
    o6.w = 0.0;
    o1.xyz = r11.xyz;
    o3.xyz = r5.yzw;
