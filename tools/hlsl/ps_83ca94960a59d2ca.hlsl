// ps_83ca94960a59d2ca.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 123 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001EC 10040900 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.w = ps;
    ps = 1.0 - r6.y;
    r4.xyz = r7.www * r0.xyw;
    r6.y = ps;
    r0.xy = -r6.yy * ModShadowGroupColor.xy + 1.0;
    r0.xy = r5.xy * r0.xy + 0.125;
    r6.y = dot(r4.zxy, r6.wxz);
    r5.xyz = r4.xzy * r6.yyy;
    r5.xyz = r5.xyz * 2.0 - r6.xwz;
    r0.xy = r0.xz * r0.yz;
    r6.xyz = r0.xxx * r8.xyz + ModShadowColor.xyz;
    r7.w = saturate(dot(r2.zxy, r5.yxz));
    ps = log2(r7.w);
    r6.w = saturate(dot(r4.zxy, r2.zxy));
    r7.w = ps;
    r7 = r7.wxyz * float4(15.0, 4.0, 4.0, 4.0);
    ps = pow(2.0, r7.x);
