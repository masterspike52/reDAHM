// ps_de49e3f51ab165ca.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 294 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000498 10040B00 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.y = ps;
    r4.xyz = r4.zyx * r5.yyy;
    r7.w = float((r10.z >= UniformScalar_2.x));
    r0.y = float((UniformScalar_2.x >= r10.z));
    r5.y = dot(r4.zxy, r5.xzw);
    r3.xy = (r7.zw > 0.0) ? r0.xy : 1.0;
    r0.xyz = r4.zyx * r5.yyy;
    r0.xyz = r0.zyx * 2.0 - r5.zwx;
    p0 = (-r0.w > 0.0);
    ps = p0 ? 0.0 : 1.0;
    r5.x = r3.x * r3.y;
    r5.yzw = r6.www * r9.xyz + ModShadowColor.xyz;
    if (!p0)
    {
        ps = r0.w;
        r6.w = ps;
    ...
    r7.x = r6.w + r1.w;
    r3.xyz = tex2D(Texture2D_1, r7.xy).xyz;
    ...
    r6.w = saturate(dot(r4.zxy, r6.zxy));
