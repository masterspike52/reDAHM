// ps_adfa9431e79a3cfa.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 447 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000006FC 10041600 0000080A 00000000 00007108 003F00FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r14 = tex2D(Texture2D_7, r1.xy);
    r4 = tex2D(Texture2D_6, r1.xy).xzyw;
    ...
    ps = 5.0 * r6.z;
    r15.xzw = UniformVector_4.xzy * 2e+01;
    r6.z = saturate(ps);
    ps = 1.0 - r6.x;
    ...
    r4.z = ps;
    ps = log2(r6.x);
    r15.xzw = r15.xzw * r4.xyz;
    r6.x = ps;
    r4.yzw = (-abs(r6.www) >= 0.0) ? r14.yxz : r15.zxw;
    r14.xyz = (abs(r6.www) > 0.0) ? r15.xwz : r14.xzy;
    ps = -r7.w;
    ...
    r7.xw = -r0.xy + 1.0;
    r1.x = ps;
    r6.z = (UniformScalar_12.x > 0.0) ? r7.w : 1.0;
    r6.z = (UniformScalar_12.x >= 0.0) ? r6.z : r7.w;
    ps = r12.z + r12.z;
    r1.z = r6.z * r9.w;
    r1.y = ps;
    ps = r11.x + r11.x;
