// ps_48848da82c50e0b1.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 282 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000468 10040E00 0000080A 00000000 00007108 003F00FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.w = ps;
    r10.zw = r9.xy * 2.0 - 1.0;
    ps = rsqrt(abs(r6.x));
    r10.y = saturate(r6.z * 0.00022222222);
    r6.x = ps;
    ps = -r1.z;
    r4.xyz = r6.xxx * r4.xyz;
    ps = 1.0 + ps;
    r9.xyz = r10.yzw * float3(-0.025, 0.5, 0.5);
    r6.x = ps;
    ...
    r1.z = ps;
    r0.z = (r1.x == 0.0) ? r13.x : r13.y;
    r1 = r1.xzxy + float4(-3.0, -1.0, -2.0, -1.0);
    ps = r1.w;
    r6.xyz = r14.xyz * UniformVector_4.xyz;
    r0.z = (r1.z == 0.0) ? r13.z : r0.z;
    r0.z = (r1.x == 0.0) ? r13.w : r0.z;
    ps = r9.y + ps;
    r0.w = max(r0.z, 0.0);
    r1.x = ps;
    ps = r1.y;
    r10.x = min(r0.w, 0.3);
    ps = r9.z + ps;
    r10.xyz = r10.yxz * float3(0.875, 3.3333333, 0.875);
    r1.y = ps;
    r1.xy = r10.yy * r1.xy + r6.xy;
    ps = 1.0 / r5.w;
    r12.xy = r1.xy - r11.xy;
    r0.w = ps;
    r1.xy = r12.zw * r0.ww + ScreenPositionScaleBias.wz;
    r9.xyz = tex2D(LightAttenuationTexture, r1.xy).xyz;
    r0.y = tex2D(ShadowTexture, r0.xy).x;
    r8.xyz = tex2D(Texture2D_4, r7.xy).xyz;
    ...
    r5.x = r9.w * r8.w - 1.0;
    ps = rsqrt(abs(r7.w));
    r13.xyz = r5.yzw * r3.xyz;
    r7.w = ps;
    ps = 5.0 * r6.x;
    r3.xyz = r7.www * r2.xyz;
    r0.w = saturate(ps);
    r2.xyz = r13.xyz * UniformScalar_1.xxx + UniformScalar_2.xxx;
    ps = -r11.z;
    r6.xy = -r0.zw + 1.0;
    ps = r6.z + ps;
    ...
    r5.yzw = -r0.wzx + 1.0;
    r13.w = ps;
    r6.xyz = r10.yzx * r5.xyz + float3(1.0, 0.125, 0.125);
    r10.xyz = r13.xyz * r6.xxx - r8.xyz;
    r7.w = saturate(r13.w * r6.x - 0.5);
