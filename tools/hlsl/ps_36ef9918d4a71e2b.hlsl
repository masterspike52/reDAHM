// ps_36ef9918d4a71e2b.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 198 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000318 10040D00 0000080A 00000000 00007908 001F00FF 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A1 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.w = ps;
    ps = 1.0 / r4.w;
    r7.zw = r6.zw * abs(r8.xy);
    r6.z = ps;
    r12.xy = r5.xy * UniformVector_2.xy - r9.xw;
    r7.xy = r12.zw * r6.zz + ScreenPositionScaleBias.wz;
    ...
    r8.xyz = UniformVector_4.xyz * UniformVector_4.www;
    ps = r4.w;
    r7.xyz = r7.xyz * r2.www;
    ps = 0.0001 * ps;
    r13.yzw = r8.zxy * r11.zxy;
    r8.x = saturate(ps);
    ps = rsqrt(abs(r7.w));
    r5.x = saturate(-r5.w + 1.0);
    r7.w = ps;
    ps = rsqrt(abs(r6.w));
    r4.xyz = r7.www * r1.xyz;
    r6.w = ps;
    ps = rsqrt(abs(r5.w));
    r11.xyz = r6.www * r3.xyz;
    r5.y = ps;
    r13.x = r5.z * UniformVector_2.z - 1.0;
    ps = log2(r5.x);
    ...
    r1 = r13.zwxy * r6.yyyy;
    r8.z = ps;
    r2.xyz = r5.xxx * UniformVector_3.xyz + r6.www;
    r2.xyz = r1.xyw * UniformScalar_2.xxx + r2.xyz;
    r5.xz = r12.xy * r6.yy + r9.xw;
    r8.xyz = -r8.xyz + 1.0;
    ps = LightColorAndFalloffExponent.w * r5.y;
    r6.xy = r5.xz * r8.xx;
    r5.y = ps;
    r6.z = r1.z * r8.x + 1.0;
    r6.xyz = (r8.xxx > 0.0) ? r6.xyz : float3(0.0, 0.0, 1.0);
    r6.xyz = (r8.xxx >= 0.0) ? r6.xyz : float3(0.0, 0.0, 1.0);
    ps = pow(2.0, r5.y);
    r5.x = dot(r6.zxy, r6.zxy);
    r5.y = ps;
    ps = rsqrt(abs(r5.x));
    r7.xyz = r7.xzy * r5.yyy;
    r5.x = ps;
    r3.xyz = r6.xyz * r5.xxx;
    r5.x = dot(r3.zxy, r11.zxy);
    r5.xyz = r3.xzy * r5.xxx;
    r5.xyz = r5.xyz * 2.0 - r11.xzy;
    r5.x = saturate(dot(r4.zxy, r5.yxz));
    ps = log2(r5.x);
    r1.xyz = r1.xyw * r10.xyz;
    r9.x = ps;
    ps = -SpotAngles.x - -r5.w;
    r6.xyw = r9.xzy * float3(15.0, 0.875, 0.875);
    r5.x = ps;
    r5.yz = r6.wy * r8.yz + 0.125;
    ps = pow(2.0, r6.x);
