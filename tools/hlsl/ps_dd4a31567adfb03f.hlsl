...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.yzw = tex2D(Texture2D_3, r0.xy).xyz;
    ...
    r8.zw = r5.yw * 0.875;
    r5.y = ps;
    r7.xyz = r6.xyw * 2.0 - 1.0;
    ps = rsqrt(abs(r5.z));
    r6.xy = r4.yz * float2(0.5, 3.0);
    r5.w = ps;
    ps = rsqrt(abs(r5.x));
    ...
    ps = r1.y * ps;
    r5.w = dot(r7.zxy, r9.zxy);
    r3.y = ps;
    ps = r5.z;
    r5.x = r5.x * r5.y;
    r5.xyz = r5.xxx * r10.xyz + ModShadowColor.xyz;
    ps = r1.z * ps;
    r10.xyz = r7.xzy * r5.www;
    r3.z = ps;
    r1.xyz = r10.xyz * 2.0 - r9.xzy;
    r5.w = saturate(dot(r3.zxy, r1.yxz));
    ps = log2(r5.w);
    r1.y = saturate(dot(r7.zxy, r3.zxy));
    r4.x = ps;
    r8.zw = r4.wx * float2(4.0, 3e+01);
    ps = pow(2.0, r8.w);
