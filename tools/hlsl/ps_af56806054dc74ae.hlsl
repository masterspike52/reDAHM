// ps_af56806054dc74ae.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 120 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001E0 10040700 00000406 00000000 00003884 000F000F 00000001 00007054 0000F155 00007256 0000F357
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.yw = tex2D(ModShadowAccumTexture, r4.xy).xy;
    ...
    r4.z = -r4.z + 1.0;
    r3.x = ps;
    r7.yz = -r4.zz * ModShadowGroupColor.xy + 1.0;
    ps = LightColorAndFalloffExponent.w * r3.x;
    r2.yzw = r2.www * r2.zxy;
    r2.x = ps;
    ps = -r2.z;
    r5.xyz = r0.www * -SpotDirection.xyz;
    r2.z = ps;
    r2.y = r2.y * 2.0 - r2.y;
    ps = -r2.w;
    r0.w = dot(r5.zxy, r1.zxy);
    r2.w = ps;
    ps = -SpotAngles.x - -r0.w;
    r1.xyz = r4.xxx * r0.zxy;
    r0.x = ps;
    ps = pow(2.0, r2.x);
    r0.y = saturate(dot(r1.yzx, r2.zwy));
    r7.x = ps;
    ps = log2(r0.y);
    r4.z = r6.x * r7.x;
    r0.y = ps;
    ...
    r2.y = r2.x * r2.x;
    r4.x = ps;
    r5.xyz = r4.xyw * float3(0.21952, 0.875, 0.875);
    r0 = r5 * r7;
    ps = r0.w;
    r4.xy = r0.yz + 0.125;
    ps = r5.x + ps;
    ...
    r4.w = ps;
    r1.xw = r4.zx * r4.wy;
    r0.xyz = r1.www * r3.yzw + ModShadowColor.xyz;
