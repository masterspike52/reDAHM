...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.xy = tex2D(ModShadowAccumTexture, r6.yw).xy;
    ...
    r6.y = ps;
    r4.xyz = r9.xyz * r6.yyy;
    r6.y = dot(r4.zxy, r8.zxy);
    ps = 1.0 - r6.x;
    r9.xyz = r4.xzy * r6.yyy;
    r6.y = saturate(ps);
    r6.xzw = r9.xyz * 2.0 - r8.xzy;
    ps = log2(r6.y);
    ...
    r0.xy = r6.xy * r0.xy + 0.125;
    ps = pow(2.0, r6.z);
    r7.z = saturate(dot(r4.zxy, r2.zxy));
    r6.x = ps;
    r6.xyz = r6.xxx * UniformVector_1.xyz;
