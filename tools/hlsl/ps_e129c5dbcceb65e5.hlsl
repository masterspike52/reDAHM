// ps_e129c5dbcceb65e5.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 444 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000006F0 10000400 00000004 00000000 00002863 00070007 00000021 00003050 0000F151 0000F256
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.xy = r0.yx + UniformVector_1.yx;
    r4 = r0.xyxy * float4(3.0, 3.0, 4.0, 4.0);
    r0.zw = r4.zw + UniformVector_2.xy;
    r3.yz = r3.yx + r0.xy;
    r3.x = tex2D(Texture2D_1, r0.zw).w;
