...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9 = tex2D(Texture2D_1, r1.zw);
    r6.xyw = tex2D(Texture2D_2, r1.xy).xyw;
    r1.xyw = tex2D(Texture2D_0, r8.xz).xyz;
    ...
    r11.z = ps;
    r0.z = (r11.x == 0.0) ? r9.x : r9.y;
    r11 = r11.xxyz + float4(-3.0, -2.0, -1.0, -1.0);
    r9.xy = r11.zw + r10.xw;
    r0.z = (r11.y == 0.0) ? r9.z : r0.z;
    r8.y = (r11.x == 0.0) ? r9.w : r0.z;
    r0.z = max(r8.y, 0.0);
    r10.x = min(r0.z, 0.3);
    ps = 1.0 / r5.w;
    r6.xyz = r10.yxz * float3(0.875, 3.3333333, 0.875);
    r0.z = ps;
    r9.xy = r6.yy * r9.xy - r1.xy;
    r13.xy = r4.xy * UniformVector_4.xy + r9.xy;
    ...
    r8.xzw = tex2D(Texture2D_6, r0.xy).xyz;
    ...
    r0.y = ps;
    r3.xyz = r8.xzw * UniformScalar_1.xxx + UniformScalar_2.xxx;
    r8.x = r7.w * r6.w - 1.0;
    ps = 1.0 - r0.x;
    r14.xyz = r5.yzw * r12.xyz;
    r0.x = saturate(ps);
    r12.w = r4.w * UniformVector_4.z - r1.z;
    ps = log2(r0.x);
    r8.z = saturate(r0.y * 5.0);
    r0.x = ps;
    r0.yz = -r8.yz + 1.0;
    ps = 2.5 * r0.y;
