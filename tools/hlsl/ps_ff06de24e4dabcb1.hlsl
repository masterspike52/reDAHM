...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.x = ps;
    ps = r8.x;
    r2.xyz = r6.www * r3.zxy;
    ps = abs(r7.x) * ps;
    r6.w = saturate(dot(r2.xyz, r6.zxy));
    r6.x = ps;
    ps = r8.y;
    r6.yz = r5.zz * ModShadowGroupColor.xy;
    ps = abs(r7.y) * ps;
    r3.xyz = -r6.yzw + 1.0;
    r6.y = ps;
    r4.xy = tex2D(ModShadowAccumTexture, r6.xy).xy;
    r8.xyz = tex2D(Texture2D_2, r3.zz).xyz;
    ...
    r2.z = ps;
    r6.xyz = r6.xyz * r5.www + r1.zzz;
    r5.xy = r1.xy * r3.xy + 0.125;
    ps = r5.x * r5.y;
