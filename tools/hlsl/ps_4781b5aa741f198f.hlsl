// ps_4781b5aa741f198f.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 141 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000234 10040A00 0000090A 00000000 00008129 003F01FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A1 0000F8A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.xy = r6.xx * ScreenPositionScaleBias.xy;
    r7.y = ps;
    ps = 1.0 / ModShadowAccumResolution.x;
    r7.z = dot(r4.zxy, r4.zxy);
    r7.x = ps;
    r7.yw = r7.xy * abs(r9.xy);
    ...
    r5.xyz = tex2D(Texture2D_5, r1.xy).xyz;
    r7.x = tex2D(ShadowTexture, r0.xy).x;
    r0.xyz = tex2D(Texture2D_0, r1.xy).xyz;
    r1.xy = tex2D(ModShadowAccumTexture, r7.yw).xy;
    ...
    r7.y = ps;
    ps = 1.0 - r6.x;
    r1.yzw = r7.yyy * r2.xyz;
    r7.y = ps;
    ps = rsqrt(abs(r7.z));
    r6.x = dot(r0.zxy, r0.zxy);
    r7.z = ps;
    ps = rsqrt(abs(r6.x));
    r2.xyz = r7.zzz * r4.xyz;
    r6.x = ps;
    r7.yz = -r7.yy * ModShadowGroupColor.xy + 1.0;
    r7.yz = r3.xy * r7.yz + 0.125;
    r3.xyz = r0.xyz * r6.xxx;
    ...
    r7.z = ps;
    r6.xyz = r0.xxx * r6.yzw + ModShadowColor.xyz;
    r2.xyz = r4.xyz * 2.0 - r2.xzy;
    ps = log2(abs(r5.y));
    r6.w = saturate(dot(r1.wyz, r2.yxz));
    r7.w = ps;
    ps = log2(r6.w);
    r2.xyz = r10.xyz * 0.4;
    r7.x = ps;
