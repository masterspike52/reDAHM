// ps_fb8a86357845aa2a.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 306 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004C8 10040B00 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.x = ps;
    ps = 1.0 / r4.w;
    r1.w = float((abs(r5.y) > abs(r5.z)));
    r5.w = ps;
    r0.z = dot(r5.zy, r5.zy) + 0.0;
    ps = max(abs(r5.y), abs(r5.z));
    r0.x = float((-r5.z > r5.z));
    r0.w = ps;
    ps = min(r5.y, r5.z);
    ...
    r0.y = -r0.y + 1.0;
    r5.y = ps;
    r0.yz = -r0.yy * ModShadowGroupColor.yx + 1.0;
    ...
    r5.z = r6.w * r5.x;
    r5.x = ps;
    r0.zw = r5.xz + float2(0.8, 0.999866);
    r0.y = r10.y * r0.w;
    r5.xzw = r0.zyx * float3(0.24999972, -2.0, -3.1415927);
    ...
    r0.w = dot(r11.xzy, r11.xzy);
    ps = rsqrt(abs(r0.w));
    r3.x = float((UniformScalar_0.x >= r5.y));
    r5.y = ps;
    r1.xyz = r11.zyx * r5.yyy;
    r7.w = float((r10.z >= UniformScalar_2.x));
    r3.y = float((UniformScalar_2.x >= r10.z));
    r5.y = dot(r1.zxy, r5.xzw);
    r0.xw = (r7.zw > 0.0) ? r3.xy : 1.0;
    r3.xyz = r1.zyx * r5.yyy;
    r5.xzw = r3.zyx * 2.0 - r5.zwx;
    p0 = (-r0.y > 0.0);
    ps = p0 ? 0.0 : 1.0;
    r5.y = r0.x * r0.w;
    r3.xyz = r0.zzz * r9.xyz + ModShadowColor.xyz;
    if (!p0)
    {
        ps = r0.y;
        r0.x = ps;
    ...
    r7.x = r0.x + r6.w;
    r0.xzw = tex2D(Texture2D_1, r7.xy).xyz;
    r0.xzw = r5.yyy * r0.xzw;
    p0 = (-r0.y > 0.0);
    ps = p0 ? 0.0 : 1.0;
    r0.xzw = r0.xzw * r8.xyz;
    if (p0)
    {
        r0.y = -abs(r0.y) + 1.0;
    }
    ...
    r6.w = saturate(dot(r1.zxy, r4.zxy));
    r5.w = saturate(dot(r4.zxy, r5.wxz));
    r1.xyz = r7.xyz * UniformScalar_7.xxx + UniformScalar_8.xxx;
    ...
    r5.z = saturate(ps);
    ps = log2(r5.w);
    r2.x = saturate(r5.y * SpotAngles.y);
    r2.z = ps;
    ps = log2(r5.z);
    r5.xy = r2.xy * r2.xz;
    r5.z = ps;
    ...
    r5.z = ps;
    r1.xy = r0.xz * r6.ww + r1.xy;
    r1.z = r0.w * r6.w + r1.z;
    r0.xyz = r1.xyz * r5.zzz;
