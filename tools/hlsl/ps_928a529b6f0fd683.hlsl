// ps_928a529b6f0fd683.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 24 ucode dwords, 0 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000000 00000060 10000600 00000004 00000000 00005CE7 007F007F 00000001 00003050 00003151 0000F252 0000F353 0000F455 00007556 0000F657
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.x = SCENE_COLOR_BIAS_FACTOR.x * r6.w;
    r1.yzw = tex2D(Texture2D_0, r0.zw).xyz;
    r0.y = tex2D(Texture2D_1, r0.xy).x;
    r0.xzw = r1.yzw + r1.yzw;
    r0.xzw = r0.xzw * UniformVector_1.xyz + UniformVector_0.xyz;
