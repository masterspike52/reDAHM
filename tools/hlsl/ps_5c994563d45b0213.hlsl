...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0 = tex2D(Texture2D_0, r0.xy).wxyz;
    r1.xyz = abs(r0.yzw) * abs(r0.yzw);
    r0.x = r0.x;
    r1.xyz = r1.xyz * abs(r0.yzw);
    r0.y = UniformVector_1.w * r0.x;
    r0.xzw = r1.xyz * UniformVector_1.xyz + UniformVector_0.xyz;
