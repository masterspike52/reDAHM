// ps_eb88bef22e4c297d.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 312 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004E0 10041300 00000606 00000000 000050C6 003F003F 00000021 00003050 00003151 0000F254 0000F356 0000F457 0000F558
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 + ps;
    r4.xyw = r11.yxz * float3(0.5, -0.025, 0.5);
    r0.z = ps;
    ...
    r16.xyz = tex2D(Texture2D_4, r9.xy).xyz;
    ...
    r1.yzw = UniformVector_5.xyz * UniformVector_5.www;
    ps = 1.0 + ps;
    r1.x = dot(r2.zxy, r2.zxy);
    r12.y = ps;
    r18.x = r7.w * r9.z - 1.0;
    r18.yz = r9.xy * 2.0 - 1.0;
    ps = rsqrt(abs(r1.x));
    r17.yzw = r1.yzw * r8.xyz;
    r1.x = ps;
    r6.xyz = r6.zxy * 2.0 - 1.0;
    r13.xyz = r11.wxy * 2.0 - 1.0;
    r14.x = r6.x * UniformVector_4.z - r13.x;
    r14.yzw = r17.yzw * UniformScalar_1.xxx + UniformScalar_2.xxx;
    ps = -UniformVector_0.z;
    r9.xyz = r1.xxx * r2.xyz;
    ps = 1.0 + ps;
    r9.w = dot(r0.zww, float3(1.0, 1.0, 1.0));
    r12.z = ps;
    r0.w = (r9.w == 0.0) ? r19.x : r19.y;
    ps = rsqrt(abs(r0.x));
    r1.xyz = r9.zww + float3(0.1, -3.0, -2.0);
    r0.x = ps;
    ps = 5.0 * r1.x;
    r15.xyz = r12.xyz * AmbientColorAndSkyFactor.xyz;
    r0.z = saturate(ps);
    r0.w = (r1.z == 0.0) ? r19.z : r0.w;
    r8.z = (r1.y == 0.0) ? r19.w : r0.w;
    ps = 1.0 - r0.z;
    ...
    r6.yz = r1.yz - r13.yz;
    r6.x = ps;
    r0.xyz = r17.yzw * r0.www - r16.xyz;
    r6.w = saturate(r17.x * r0.w - 0.5);
    r2.xyz = r0.xyz * r6.www + r16.xyz;
    r5.xyz = r15.xyz * r2.xyz + UniformVector_0.xyz;
    r0.xyz = r6.xyz * r6.xww;
    ps = r13.y;
    r1.y = float((r8.x >= 0.004));
    ps = r0.y + ps;
    r14.yzw = r0.xxx * r14.yzw;
    r0.y = ps;
    ps = r13.z;
    r6 = r14.xywz * r6.wwww;
    ps = r0.z + ps;
    ...
    r1.xzw = r0.xyw * r0.zzz;
    r4 = r4.xxyz * float4(-0.5, 0.5, 0.875, 0.875);
    r1.xzw = r1.xzw * 2.0 - r10.xyz;
    r1.x = saturate(dot(r9.zxy, r1.wxz));
    r1.zw = r4.zw * r8.yz + 0.125;
    ...
    r0.z = r1.z * r1.w;
    r0.x = ps;
    r1.xzw = r0.zzz * r7.xyz + ModShadowColor.xyz;
    ps = 15.0 * r0.x;
