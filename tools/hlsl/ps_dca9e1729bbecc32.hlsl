// ps_dca9e1729bbecc32.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 168 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000002A0 10040900 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.x = dot(r8.zxy, r6.wxy);
    r5.xyz = r8.zxy * r5.xxx;
    r9.xyz = r5.xyz * 2.0 - r6.wxy;
    r5 = xe_cube(r9.yzx);
    ps = 1.0 / abs(r5.z);
    r6.w = r5.w;
    r6.x = ps;
    r6.xy = r5.yx * r6.xx + 1.5;
    r4.xyz = tex2D(Texture2D_1, r0.zw).xyz;
    r0.xyz = tex2D(LightAttenuationTexture, r0.xy).xyz;
    r7.yzw = texCUBE(TextureCube_0, xe_cube_dir(r6.xyw)).xyz;
    ps = -ModShadowColor.x;
    ...
    r5.w = saturate(dot(r1.zxy, r9.xyz));
    ps = log2(r5.w);
