// ps_aeada75064848579.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 294 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000498 10041100 0000080A 00000000 00007108 003F00FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.y = ps;
    r2.xyz = r12.xyz * UniformScalar_3.xxx + UniformScalar_4.xxx;
    ps = r8.z + r8.z;
    r13.xyz = r6.www * r13.xyz;
    r5.y = ps;
    ps = r8.w + r8.w;
    r5.x = dot(r16.xyy, float3(1.0, 1.0, 1.0));
    r5.z = ps;
    r6.x = (r5.x == 0.0) ? r14.x : r14.y;
    r5 = r5.xyxz + float4(-3.0, -1.0, -2.0, -1.0);
    ps = 5.0 * r6.z;
    r14.xy = r5.yw + r15.xw;
    r5.y = saturate(ps);
    r6.x = (r5.z == 0.0) ? r14.z : r6.x;
    r5.x = (r5.x == 0.0) ? r14.w : r6.x;
    ...
    r5.xyz = r15.yxz * float3(0.875, 3.3333333, 0.875);
    r8.w = ps;
    ps = pow(2.0, r6.y);
    r8.yzw = -r8.wzy + 1.0;
    r6.z = ps;
    r6.xy = r5.yy * r14.xy - r11.xy;
    r6.xy = r10.xy * UniformVector_4.xy + r6.xy;
    r5.xyz = r5.yxz * r8.xzy + float3(1.0, 0.125, 0.125);
    r10.xyz = r12.xyz * r5.xxx - r9.xyz;
    ...
    r6.z = r0.w * 2.0 + r6.z;
    r5.xy = r5.yw * r5.zw;
    r7.xyz = r5.xxx * r7.xyz + ModShadowColor.xyz;
