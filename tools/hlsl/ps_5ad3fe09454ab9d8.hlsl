...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.w = r0.x * 5.0 + UniformScalar_1.x;
    r1.y = r3.w * OpacityOverride.x;
    r0.z = 1.0 / r4.w;
    r0.zw = r0.zz * ScreenPositionScaleBias.xy;
    r1.xz = r0.zw * r4.xy + ScreenPositionScaleBias.wz;
    r1.xzw = r1.wxz * float3(1.0000007, 1e+01, 1e+01) + float3(0.5, 1e+01, 1e+01);
    ...
    r0.xyz = tex2D(Texture2D_0, r1.zw).xyz;
    r0.xyz = r0.xyz * r3.xyz + UniformVector_0.xyz;
    r1.x = saturate(r1.x * 7e+01 - 2e+01);
    oC0.w = r1.y * r1.x;
