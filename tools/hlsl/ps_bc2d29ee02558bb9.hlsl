// ps_bc2d29ee02558bb9.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 432 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000006C0 10000200 00000004 00000000 00001842 00030003 00000021 00003050 0000F156
...
// NOTE: unhandled fetch opcode 18 at 50
...
// NOTE: unhandled fetch opcode 18 at 68
...
// NOTE: unhandled fetch opcode 18 at 92
...
// NOTE: unhandled fetch opcode 18 at 116
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.x = saturate(r0.z - UniformScalar_5.x);
    r2.y = 0.5;
    r2.z = tex2D(Texture2D_3, r2.xy).x;
    r0.z = tex2D(Texture2D_0, r0.xy).x;
    r0.w = 5e+01 * r0.z;
    r0.z = r2.z * UniformVector_1.x - 0.5;
    r0.z = r0.w * r2.x + r0.z;
    ...
    r0.yw = r2.xy * r1.yz;
    r0.z = ps;
    oC0.y = (r1.x == 0.0) ? r0.z : r0.y;
    oC0.xz = 0.0;
    oC0.w = 1.0;
    oC0.x = (r1.x == 0.0) ? 0.0 : r0.x;
    oC0.z = (r1.x == 0.0) ? r0.w : 0.0;
