// ps_4a34fe77865b270b.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 357 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000594 10041300 0000080A 00000000 00008108 003F00FF 00000001 0000F050 0000F153 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r11.xyz = UniformVector_4.xyz - UniformVector_5.xyz;
    r9.x = ps;
    ps = UniformVector_2.z * UniformVector_2.z;
    r7.z = dot(r2.zxy, r2.zxy);
    r9.z = ps;
    ps = UniformScalar_22.x;
    r13.yzw = r0.yzw * UniformVector_8.xyz;
    ps = -UniformScalar_21.x + ps;
    r16.xyz = r0.yzw * UniformScalar_17.xxx;
    r12.w = ps;
    ps = r6.w + r6.w;
    r6.z = dot(r0.zwy, float3(0.59, 0.11, 0.3));
    r0.x = ps;
    ps = 4.0 * r6.x;
    r0.y = dot(r0.zyw, float3(0.59, 0.3, 0.11));
    r18.z = ps;
    ps = 4.0 * r6.y;
    ...
    ps = rsqrt(abs(r7.z));
    r6.x = UniformScalar_19.x + r0.y;
    r6.y = ps;
    ps = 5.0 * r6.z;
    r6.w = dot(r10.zxy, float3(1.0, 1.0, 1.0));
    r9.y = ps;
    ps = 1.0 * r6.z;
    r0.yzw = r6.yyy * r2.xyz;
    r9.w = ps;
    ps = frac(r6.x);
    r18.xy = r9.wy * UniformScalar_15.xx;
    r11.w = ps;
    r2.xyz = r18.yyy * r11.xyz + UniformVector_5.xyz;
    ps = r0.w;
    r11.xyz = r7.xyw + r7.xyw;
    r6.x = ps;
    ps = 0.1 + r6.x;
    r6.z = float((r18.x >= 0.2));
    r6.x = ps;
    ps = (-1.0) + r0.x;
    r2.w = float((r18.x > 0.2));
    r6.y = ps;
    ps = 5.0 * r6.x;
    r7.xyz = r18.xzw + float3(-0.2, -2.0, -2.0);
    r6.x = saturate(ps);
    ps = 1.25 * r7.x;
    r11 = r11 + float4(-1.0, -1.0, -1.0, -0.5);
    r9.y = ps;
    ...
    r19.xy = -r11.xy - 2.0;
    ps = -r11.x + ps;
    r18.xy = r19.xy + r18.zw;
    r18.z = ps;
    r15.xyz = r15.xyz * r6.yyy + UniformVector_6.xyz;
    r17.xyz = r9.yyy * r17.xyz + UniformVector_4.xyz;
    r17.xyz = (r2.www > 0.0) ? r17.xyz : UniformVector_4.xyz;
    ps = r7.z;
    r15.xyz = r15.xyz * UniformScalar_20.xxx;
    ps = -r11.y + ps;
    r15.xyz = r15.xzy * r10.zzz;
    r18.w = ps;
    r2.xyz = (r6.zzz > 0.0) ? r17.xyz : r2.xyz;
    r11 = r18.zxyw * UniformScalar_0.xxxx + r11.xxyy;
    ps = 1.0 - r6.w;
    ...
    r7.z = ps;
    r6.xyz = r16.xyz * r10.yyy + r15.xzy;
    r10.xyz = r2.xzy * r10.xxx + r6.xzy;
    ...
    r7.w = r6.x + 1.0;
    r7.x = ps;
    r12.xyz = r6.yzw * r12.xyz - r6.yzw;
    r2.xyz = r12.xyz * UniformScalar_0.xxx + r6.yzw;
    r2.w = r12.w * UniformScalar_0.x + UniformScalar_21.x;
    ...
    r15.xyz = r6.yww * r11.yzw;
    r11.y = ps;
    ps = r15.z * r15.z;
    r12.yzw = r2.xyz * r2.www;
    r9.z = ps;
    r2.w = dot(r13.yz, r7.wx) + r9.z;
    r12.x = r13.z * r7.x + r9.z;
    ps = rsqrt(abs(r2.w));
    r9 = r12.xywz + r9.xyyy;
    r11.z = ps;
    ps = rsqrt(abs(r9.x));
    ...
    r6.x = ps;
    r4.xyz = r16.ywz * r6.xxx;
    r6.x = dot(r4.zxy, r14.zxy);
    ...
    r13.z = r6.w;
    r2.w = ps;
    r13.xy = r6.yx * r2.ww + 1.5;
    r12.yz = tex2D(ModShadowAccumTexture, r11.xy).xy;
    r13.xyz = texCUBE(TextureCube_0, xe_cube_dir(r13.xyz)).xyz;
    ...
    ps = 1.0 + ps;
    r18.xyz = r2.www - r13.xyz;
    r11.y = ps;
    r13.xyz = r18.xyz * 0.8 + r13.xyz;
    ...
    r6.z = saturate(dot(r0.wyz, r8.zxy));
    r6.x = ps;
    ps = log2(r6.z);
    r5.xyz = r2.xzy * r5.xxx;
    r12.w = ps;
    ps = r12.x * r12.w;
    r8.xyz = r2.xzy * r5.www;
    r0.x = ps;
    ps = r12.y * r12.z;
