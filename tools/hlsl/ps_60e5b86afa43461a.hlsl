// ps_60e5b86afa43461a.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 117 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001D4 10040800 0000080A 00000000 00007108 003F00FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.w = 0.1 - -r2.z;
    r3.zw = tex2D(ModShadowAccumTexture, r6.yz).xy;
    r7.xyz = tex2D(Texture2D_0, r1.xy).xyz;
    r6.w = dot(r7.zxy, r7.zxy);
    r6.y = 1.0 / r5.w;
    r6.yz = r6.yy * ScreenPositionScaleBias.xy;
    r6.yz = r6.yz * r5.xy + ScreenPositionScaleBias.wz;
    r0.z = saturate(r7.w * 5.0);
    r6.w = rsqrt(abs(r6.w));
    r3.xy = r6.ww * r7.xz;
    r1 = r3 * float4(0.70710677, 0.70710677, 0.875, 0.875);
    r7.yzw = r4.xyz * r7.xyz;
    r0.y = r1.x + r1.y;
    r0.zw = -r0.yz + 1.0;
    r0.y = float((abs(r0.z) > 0.0345));
    r0.z = float((abs(r0.z) >= 0.0345));
