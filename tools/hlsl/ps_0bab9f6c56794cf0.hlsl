...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r13.xyz = r7.wyz * 2.0 - 1.0;
    ps = rsqrt(abs(r6.y));
    r8.xyz = r9.xyz * r10.yzw;
    r6.y = ps;
    ps = rsqrt(abs(r6.x));
    ...
    r7.x = ps;
    ps = r6.y * r6.z;
    r0.xyz = r8.xzy * r7.zzz;
    r6.x = ps;
    r6.xyz = r6.xxx * r11.xyz + ModShadowColor.xyz;
    ps = pow(2.0, r7.x);
    r2.xyz = r8.xzy * r7.yyy;
    r7.x = ps;
