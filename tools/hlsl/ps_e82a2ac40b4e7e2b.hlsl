// ps_e82a2ac40b4e7e2b.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 147 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000024C 10040B00 00000606 00000000 000048C6 003F003F 00000001 00003050 00003151 00007254 0000F355 00007456 0000F557
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r10.xyz = r1.xyz * 2.0 - 1.0;
    ps = 0.1 + ps;
    r1.xyz = r7.xyz * UniformVector_1.xyz;
    r0.y = ps;
    ps = rsqrt(abs(r0.w));
    ...
    r0.y = -r0.y + 1.0;
    r0.x = ps;
    r4.xy = -r0.yy * ModShadowGroupColor.xy + 1.0;
    ps = rsqrt(abs(r0.z));
    r0.y = dot(r11.zxy, r3.zxy);
    r0.z = ps;
    r3.xyz = r10.xyz * r0.zzz;
    r0.z = dot(r3.zxy, r8.zxy);
    r10.xyz = r3.xzy * r0.zzz;
    r8.xyz = r10.xyz * 2.0 - r8.xzy;
    ps = -SpotAngles.x - -r0.y;
    r0.z = saturate(dot(r2.zxy, r8.yxz));
    r0.y = ps;
    ps = log2(r0.z);
    r8.z = saturate(r0.y * SpotAngles.y);
    r9.x = ps;
    r0.yzw = r9.xyz * float3(15.0, 0.875, 0.875);
    r8.xy = r0.zw * r4.xy + 0.125;
    ps = pow(2.0, r0.y);
    ...
    ps = r7.w * ps;
    r1.xyz = r8.wxz * r8.wyz;
    r2.w = ps;
    r0.yzw = r1.yyy * r6.xyz + ModShadowColor.xyz;
    ps = LightColorAndFalloffExponent.w * r0.x;
    r2.xyz = r2.xyw + r2.wwz;
    r0.x = ps;
    ps = pow(2.0, r0.x);
    r3.xyz = r1.xxx * r5.xyz;
    r0.x = ps;
    r3.xyz = r3.xzy * r0.xxx;
    r2.xyz = r3.xzy * r2.xyz;
    r2.xyz = r2.xyz * LightColorAndFalloffExponent.xyz;
    r1.xyz = r2.xzy * r1.zzz;
