// ps_ac58198e4fbea767.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 87 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000015C 10000600 00000008 00000000 00005CC6 000F003F 00000001 0000F050 0000F155 00007256 0000F357 0000F4A0 0000F5A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.x = tex2D(Texture2D_2, r6.xy).x;
    r5.w = tex2D(SceneDepthTexture, r5.wz).x;
    r5.xyz = tex2D(Texture2D_1, r5.xy).xyz;
    r0.yz = r5.yz * r4.yz + UniformVector_0.yz;
    ...
    r4.x = ps;
    r4.y = r4.x - r1.w;
    ps = UniformVector_0.x + r4.z;
    r5.x = float((r4.x != 1.0));
    r0.x = ps;
    r5.yzw = r0.xyz * r3.www + r3.xyz;
    ps = 0.002 * r4.y;
    r4.x = saturate(ps);
    r4.x = r4.w * r4.x;
    oC0.xyz = r5.yzw * SCENE_COLOR_BIAS_FACTOR.xxx;
    r4.x = (r5.x == 0.0) ? r4.w : r4.x;
    r4.y = min(r4.x, 1.0);
