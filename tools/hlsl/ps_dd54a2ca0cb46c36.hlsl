// ps_dd54a2ca0cb46c36.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 99 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000018C 10040700 0000070A 00000000 000070E7 001F007F 00000001 0000F050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.z = saturate(ps);
    ps = rsqrt(abs(r5.y));
    r0.xyz = r3.xyw * AmbientColorAndSkyFactor.xyz;
    r5.y = ps;
    ps = rsqrt(abs(r5.x));
    r3.xyw = r6.xyz * r3.xyw;
    r5.x = ps;
    r6.xyz = r0.xyz * r6.xyz + UniformVector_0.xyz;
    r7.xyz = r3.xwy * ConstantLighting.xzy + r6.xzy;
    ps = r5.x;
