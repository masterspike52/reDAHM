// vs_40dbc1e3034bebcc.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 1074 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000080 000010C8 0071000D 00000000 00000000 00007908 00000001 00000008 00000008 00000290 0010002A 0000602B 0000702C 0000302D 0001A02E 0000502F 00015030 0020A031 00003050 0001F151 0002F254 0003F356 0004F457 0005F558 0006F6A0 0007F7A2 0000115D 00001164 0000115F 0000115E 00001160 00001161 00001162 00001163
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r9.zw = r9.zw * ShadowCoordinateScaleBias.xy + ShadowCoordinateScaleBias.wz;
    ...
    r9.xy = r0.xx * ViewProjectionMatrix[2].zw + r2.xy;
    r11.xyz = -r0.xyz * CameraPosition.www + CameraPosition.zyx;
    ...
    r3.y = dot(r4.yxz, WorldToLocal[2].zxy);
    r3.z = dot(r2.zyx, WorldToLocal[2].zxy);
    r8.xyz = r13.xxx * WorldToLocal[2].xyz;
    r6.xyz = r11.xxx * WorldToLocal[2].xyz;
    r9.xy = r0.yy * ViewProjectionMatrix[1].zw + r9.xy;
    r9.xy = r0.zz * ViewProjectionMatrix[0].zw + r9.xy;
    r6.xyz = r11.yyy * WorldToLocal[1].xyz + r6.xyz;
    r0.xyz = r13.yyy * WorldToLocal[1].xyz + r8.xyz;
    r0.xyz = r13.zzz * WorldToLocal[0].xzy + r0.xzy;
    r6.xyz = r11.zzz * WorldToLocal[0].xzy + r6.xzy;
    r8.x = dot(r5.xzy, r6.yxz);
    r8.y = dot(r4.yxz, r6.yxz);
    r8.z = dot(r2.zyx, r6.yxz);
    r5.x = dot(r5.xzy, r0.yxz);
    r5.y = dot(r4.yxz, r0.yxz);
    r5.z = dot(r2.zyx, r0.yxz);
    p0 = (-SP_DemolitionSpread.x >= 0.0);
    ps = p0 ? 0.0 : 1.0;
    // UNHANDLED control flow: cjmp
    r0 = r10.wwww * LocalToWorld[3].xwzy;
    ...
    ps = -r4.x * -r4.x;
    r6.xy = -r4.yx + BBox_Size.xy;
    r11.x = ps;
    r11.yz = r0.zx * BBox_Size.yx - r4.xy;
    r4.x = dot(r11.zy, r11.zy) + 0.0;
    ps = -r4.y * -r4.y;
    r11.zw = r6.xy * r6.xy;
    r11.y = ps;
    ps = 1.0 / r0.y;
    ...
    r2.x = ps;
    ps = 1.0;
    r11.x = saturate(floor(r2.y));
    r2.y = ps;
    p0 = (r6.z != 0.0);
    ps = p0 ? 0.0 : 1.0;
    r11.z = saturate(r0.y * r0.w);
    if (p0)
    {
        if (p0)
        {
            ...
            r2.y = r2.x + r2.z;
            ps = BBox_Size.z * r2.x;
            r0.y = float((r4.w >= r2.x));
            r2.w = ps;
            ps = SP_DemolitionSpread.x * r0.y;
            r4.y = r2.y * BBox_Size.z;
            r2.y = ps;
        }
    }
    if (!p0)
    ...
    r6.xy = r2.xy + r2.zy;
    // UNHANDLED control flow: cjmp
    r2.y = float((r4.w > r6.x));
    r6.x = saturate(r6.y * r11.y);
    ps = sqrt(abs(r4.w));
    r0.y = float((Collapse_Endcaps.x >= 2.0));
    r4.x = ps;
    p0 = (r0.y != 0.0);
    ...
    if (p0)
    {
        r6.xy = r0.xx * float2(8e+02, -1e+03);
        r10.y = r6.x + r10.y;
        ps = 3.3333333 * r0.z;
        r4.x = r6.y + r10.z;
        r3.w = ps;
    ...
    if (p0)
    {
        r6.xy = r0.yy * float2(8e+02, -1e+03);
        r10.x = r6.x + r10.x;
        ps = 3.3333333 * r0.x;
        r4.x = r6.y + r10.z;
        r3.w = ps;
    ...
    ps = r10.z;
    r4.x = ps;
    r0.z = float((r10.z >= r4.y));
    r2.y = -r5.w * r11.y + r4.x;
    ps = (-abs(r0.x) > 0.0) ? 1.0 : 0.0;
    r0.xy = -r4.xy + r2.ww;
    r11.y = ps;
    p0 = (r6.z != 0.0);
    ps = p0 ? 0.0 : 1.0;
    r6.xy = float2((r4.yx >= r2.yw));
    r0.xy = r4.ww * r8.ww + r0.xy;
    r0.xy = r0.xy * SP_DemolitionSpread.xx + r4.xy;
    r0.x = (r6.y == 0.0) ? r4.x : r0.x;
