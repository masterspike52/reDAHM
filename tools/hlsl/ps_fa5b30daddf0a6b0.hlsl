// ps_fa5b30daddf0a6b0.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 54 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000000D8 10000200 00000004 00000000 00001842 00030003 00000021 00003050 0000F156
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.z = r0.y * r0.x;
    r0.w = ps;
    r2.xz = r0.zw * IndividualVelocityScale.xy;
    r2.y = r2.z * r1.y;
    r0.x = dot(r2.xy, r2.xy) + 0.0;
    r0.y = max(r0.x, 1.0);
    ps = rsqrt(abs(r0.y));
    r0.x = r0.w - 0.003921569;
    r0.y = ps;
    r0.yz = r2.yx * r0.yy;
    ps = abs(r0.z);
