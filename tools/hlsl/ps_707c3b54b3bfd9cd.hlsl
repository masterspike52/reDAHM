...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 / r1.w;
    r2.x = r4.x * UniformVector_1.x;
    r4.x = ps;
    r4.xw = r4.xx * ScreenPositionScaleBias.xy;
    r4.xw = r4.wx * r1.yx + ScreenPositionScaleBias.zw;
    r4.x = tex2D(SceneDepthTexture, r4.wx).x;
    ...
    r4.w = ps;
    ps = 1.0 / r4.x;
    r5.xy = r5.yz * UniformVector_1.yz;
    r4.x = ps;
    ps = r4.x;
    r0.zw = r5.xy * r4.yz;
    ps = -r1.w + ps;
    ...
    r4.x = ps;
    ps = 0.001 * r4.x;
    r5.xyz = r0.yzw + UniformVector_0.xyz;
    r4.x = saturate(ps);
    ps = SCENE_COLOR_BIAS_FACTOR.x * r3.w;
    r4.x = r4.w * r4.x;
    r0.x = ps;
    oC0.xyz = r0.xxx * r5.xyz;
    r4.y = (r4.y == 0.0) ? r4.w : r4.x;
