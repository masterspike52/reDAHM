// ps_9f8c9d4e07a9ae8c.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 444 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000006F0 10000400 00000008 00000000 00004084 0003000F 00000021 0000F050 0000F156 0000F2A0 0000F3A2
...
// NOTE: unhandled fetch opcode 18 at 132

#include "xenos_common.hlsli"

float4 SCENE_COLOR_BIAS_FACTOR : register(c0); // float4
float4 TextureDensityParameters : register(c6); // float4
float4 TextureLookupInfo[16] : register(c7); // float4[16]
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.y = 0.5;
    r2.xz = tex2D(Texture2D_1, r0.xy).xw;
    r2.w = tex2D(Texture2D_0, r0.xy).x;
    r2.y = tex2D(Texture2D_3, r3.xy).x;
    r2.y = UniformVector_1.x * r2.y;
    r3.z = dot(r2.wx, float2(5.0, 3e+01)) + 0.0;
    r2.y = r3.z * r3.x + r2.y;
    r2.y = UniformScalar_9.x * r2.y;
    r2.x = r2.y * r2.z - 0.333;
