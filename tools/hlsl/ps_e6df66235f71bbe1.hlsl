// ps_e6df66235f71bbe1.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 324 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000510 10041000 0000080A 00000000 00007108 003F00FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r13.x = ps;
    ps = r6.y * r6.y;
    r13.z = dot(r9.zww, float3(1.0, 1.0, 1.0));
    r13.y = ps;
    r7.z = (r13.z == 0.0) ? r16.x : r16.y;
    r7.xyw = r13.zzx + float3(-3.0, -2.0, 1.0);
    r7.z = (r7.y == 0.0) ? r16.z : r7.z;
    r7.x = (r7.x == 0.0) ? r16.w : r7.z;
    r7.z = max(r7.x, 0.0);
    r15.x = min(r7.z, 0.3);
    ...
    r12 = r15.xxww * r12;
    r6.xy = r1.xy + r12.zw;
    r6.xy = r6.xy * UniformVector_4.xy + r12.xy;
    ps = 1.0 / r5.w;
    r9.zw = r6.xy - r8.xy;
    r6.x = ps;
    ...
    r6.x = saturate(ps);
    r13.w = r1.z * UniformVector_4.z - r8.z;
    ps = log2(r6.x);
    r5.xyz = r5.xyz * r14.xyz;
    r6.x = ps;
    ps = LightColorAndFalloffExponent.w * r6.x;
    r14.xyz = r0.www * -SpotDirection.xyz;
    r0.w = ps;
    ps = rsqrt(abs(r7.z));
    ...
    r14.w = ps;
    r5.yzw = r15.xyz * r7.ywz + float3(1.0, 0.125, 0.125);
    ps = abs(r5.y) * abs(r5.y);
    r0.xyz = r0.xzy * r6.xxx;
    r5.x = ps;
    r0.w = saturate(r14.w * r5.y - 0.5);
    r13.xyz = r14.xyz * r5.yyy - r11.xyz;
    r7.w = r13.w * r0.w - 2.0;
    r11.xyz = r13.xyz * r0.www + r11.xyz;
    ps = -SpotAngles.x - -r6.y;
    r5.yz = r5.xz * r5.xw;
    r6.x = ps;
    r7.xyz = r5.zzz * r12.xyz + ModShadowColor.xyz;
