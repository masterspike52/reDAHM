// ps_37c108c237135744.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 75 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000012C 18000300 00000004 00000000 00002863 00070007 00000011 00003050 0000F151 0000F257
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.xy = r0.yx - 0.5;
    r0.w = dot(r3.xy, UniformVector_2.yx) + 0.5;
    r0.z = dot(r3.xy, UniformVector_1.yx) + 0.5;
