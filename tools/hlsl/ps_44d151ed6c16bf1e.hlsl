...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4 = r5 + r4.zwxy;
    r5.xz = r4.zw + 0.5;
    r5.y = tex2D(Texture2D_0, r5.xz).x;
    r0.xy = tex2D(Texture2D_1, r4.xy).xy;
    r0.z = tex2D(Texture2D_1, r5.xz).x;
    r4.xyz = tex2D(Texture2D_0, r4.xy).zxy;
    r5.x = SCENE_COLOR_BIAS_FACTOR.x * r3.w;
    r5.zw = r4.yz + UniformVector_0.xy;
    r4.w = UniformVector_0.z + r4.x;
    r4.xz = r0.xy * float2(0.8, 0.4) + r5.zw;
    r4.y = r0.z * 0.8 + r5.y;
