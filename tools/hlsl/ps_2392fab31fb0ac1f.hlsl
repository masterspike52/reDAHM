...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r12.yw = tex2D(ModShadowAccumTexture, r5.yz).xy;
    ...
    r8.z = ps;
    ps = 0.1 - -r0.x;
    r12.x = dot(r4.zxy, r5.wyz);
    r5.x = ps;
    ps = 5.0 * r5.x;
    r6.w = dot(r5.wyz, r3.zxy);
    r5.x = saturate(ps);
    ps = ConstantLighting.x * r5.w;
    r4.yzw = r5.ywz * r6.www;
    r4.x = ps;
    ps = 1.0 - r5.x;
    r1 = r12.xxyw * float4(0.5, -0.5, 0.875, 0.875);
    r5.z = ps;
    r3.xyz = r4.yzw * 2.0 - r3.xzy;
    ps = ModShadowGroupColor.x * r5.z;
    r0.x = saturate(dot(r0.xyz, r3.yxz));
    r12.x = ps;
    ...
    r0.y = ps;
    r0.zw = r1.zw * r0.zw + 0.125;
    ps = r0.z * r0.w;
    r1.xyz = r9.xzy * r5.xxx;
    r5.x = ps;
    ps = log2(r0.x);
    r3.xyz = r9.xzy * r0.yyy;
    r10.w = ps;
    r0.xyz = r5.xxx * r11.xyz + ModShadowColor.xyz;
    ps = ConstantLighting.y * r5.w;
    r10 = r10 * float4(0.5, 3.0, 4.0, 1e+01);
    r4.y = ps;
    ps = pow(2.0, r10.w);
    r10.xyz = r10.xyz * r6.yzx;
    r5.x = ps;
    ps = ConstantLighting.z * r5.w;
    r11.xyz = r5.xxx * ConstantLighting.xzy;
    r4.z = ps;
    r5.xyz = r11.xzy * r10.xyz + UniformVector_0.xyz;
    r5.xyz = r4.xyz * r9.xyz + r5.xyz;
    r5.xyz = r3.xyz * LowerSkyColor.xzy + r5.xzy;
    r5.xyz = r1.xzy * UpperSkyColor.xyz + r5.xzy;
    r5.xyz = r8.xzy * r7.xzy + r5.xzy;
    r5.xyz = r6.yzx * 2.0 + r5.xzy;
    ps = -r2.w;
