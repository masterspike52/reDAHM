// ps_3770f72be77e50a7.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 330 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000528 10041300 00000606 00000000 000048C6 003F003F 00000021 00003050 00003151 00007254 0000F355 00007456 0000F557
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.w = ps;
    r5.xy = r7.zw * r1.ww + ScreenPositionScaleBias.wz;
    ps = rsqrt(abs(r2.w));
    r1.w = r14.w - 0.5;
    r2.w = ps;
    ...
    r18.xyz = tex2D(Texture2D_2, r1.xy).xyw;
    r1.xyw = tex2D(Texture2D_8, r0.xy).xyz;
    ...
    r9.xyz = r1.xyw * UniformScalar_5.xxx + UniformScalar_6.xxx;
    r2.w = r17.z * r18.z - 1.0;
    ps = r17.x + r17.x;
    ...
    r17.zw = r5.yz + r5.yz;
    r17.y = ps;
    r0.xyw = r19.xzy * 2.0 - 1.0;
    r1.xyw = r7.wxy * 2.0 - 1.0;
    ps = rsqrt(abs(r4.z));
    r0.z = saturate(-r1.z + 1.0);
    r4.z = ps;
    ps = rsqrt(abs(r1.z));
    r7.xyz = r4.zzz * r2.xyz;
    r1.z = ps;
    r12.w = r0.y * UniformVector_4.z - r1.x;
    ps = log2(r0.z);
    r2.xyz = r1.zzz * -SpotDirection.xyz;
    r0.y = ps;
    ps = r5.w;
    r17 = r17 - 1.0;
    ps = 0.0001 * ps;
    ...
    r1.xz = -r4.zy + 1.0;
    ps = r18.x + r18.x;
    r2.x = r1.x * UniformScalar_1.x;
    r3.y = ps;
    r0.xw = r2.xx * r17.zw + r0.xw;
    r0.xw = r0.xw * UniformVector_4.xy - r1.yw;
    ps = r18.y + r18.y;
    r3.x = dot(r15.xww, float3(1.0, 1.0, 1.0));
    r3.z = ps;
    r2.x = (r3.x == 0.0) ? r16.x : r16.y;
    r3 = r3.xxyz + float4(-3.0, -2.0, -1.0, -1.0);
    r4.xy = r17.xy * 0.5 + r3.zw;
    r2.x = (r3.y == 0.0) ? r16.z : r2.x;
    r2.z = (r3.x == 0.0) ? r16.w : r2.x;
    ...
    r3.w = ps;
    ps = r3.w;
    r3.xyz = r15.xyz * float3(3.3333333, 0.875, 0.875);
    r5.yz = r3.xx * r4.xy + r0.xw;
    ps = r1.x * ps;
    ...
    r0.x = ps;
    r2.xyz = r0.xxx * r12.xyz + ModShadowColor.xyz;
