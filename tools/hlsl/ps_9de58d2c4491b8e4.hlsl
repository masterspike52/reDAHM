// ps_9de58d2c4491b8e4.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 69 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000114 10000400 00000004 00000000 00002863 00070007 00000021 00003050 0000F151 0000F256
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3 = r0.xyyx * float4(3.0, 3.0, 4.0, 4.0);
    r0.xy = r3.wz + UniformVector_2.xy;
    r3.w = tex2D(Texture2D_1, r0.xy).w;
    r4.x = tex2D(Texture2D_2, r3.xy).x;
    r0.x = tex2D(Texture2D_0, r0.zw).w;
    ps = 4.0 - r0.x;
    r3.yz = r2.xy * IndividualVelocityScale.xy;
    r3.x = ps;
    ps = r4.x;
    r0.yzw = r3.xyz * r3.wyz;
    ps = r1.w * ps;
    r0.xy = r0.yz + r0.xw;
    r0.z = ps;
    r0.x = r0.z * r0.x - 0.5;
