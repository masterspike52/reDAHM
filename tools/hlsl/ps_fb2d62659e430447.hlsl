// ps_fb2d62659e430447.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 156 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000270 10040E00 0000080A 00000000 00008108 003F00FF 00000001 0000F050 0000F153 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.yw = r0.xy * 0.2 + UniformVector_1.xy;
    ...
    r8.w = tex2D(Texture2D_1, r6.yw).w;
    ...
    r12.x = ps;
    r6.z = dot(r13.yy, r8.ww) + r6.z;
    r6.x = dot(r13.zz, r8.ww) + r6.x;
