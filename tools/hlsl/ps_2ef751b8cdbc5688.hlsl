// ps_2ef751b8cdbc5688.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 87 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000015C 10040700 0000070A 00000000 000060E7 001F007F 00000001 00003050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A1
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.x = ps;
    ps = r2.x * r2.x;
    r5.xyz = r3.xyz * r0.xzw;
    r5.w = ps;
    ps = r2.y * r2.z;
    r0.xyz = r5.xyz * r0.yxx;
    r5.x = ps;
