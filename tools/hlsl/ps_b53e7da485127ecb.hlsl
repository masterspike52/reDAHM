// ps_b53e7da485127ecb.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 171 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000002AC 10040D00 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.yzw = tex2D(Texture2D_1, r1.xy).xyz;
    ...
    r9.y = ps;
    ps = 5.0 * r7.x;
    r0.yzw = r0.yyy * r13.xyz;
    r6.x = saturate(ps);
    r1.yzw = (-abs(r0.xxx) >= 0.0) ? r10.xyz : r1.yzw;
    ps = log2(r6.y);
    r2.xyz = r12.yzx + r11.xyz;
    r6.y = ps;
    r1.yzw = (-abs(r6.www) >= 0.0) ? r10.xyz : r1.yzw;
    ps = 1.0 - r6.x;
    r2.xyz = r2.xyz + float3(-1.0, -1.0, 0.0);
    r6.x = ps;
    r6.xz = -r6.xx * ModShadowGroupColor.xy + 1.0;
    r9.xy = r9.xy * r6.xz + 0.125;
    ps = LightColorAndFalloffExponent.w * r6.y;
    r6.xzw = r2.zxy * UniformScalar_0.xxx;
    r0.x = ps;
    ps = 1.0 + r6.x;
    r1.yzw = r1.yzw - r7.yzw;
    r6.y = ps;
    r2.xyz = r1.yzw * UniformScalar_0.xxx + r7.yzw;
    r7.yzw = r2.xyz * UniformScalar_2.xxx + UniformScalar_3.xxx;
    ps = pow(2.0, r0.x);
