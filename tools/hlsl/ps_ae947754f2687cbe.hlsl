// ps_ae947754f2687cbe.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 129 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000204 10040A00 00000806 00000000 00006908 00FF00FF 00000001 00003050 00003151 0000F252 0000F353 00007454 0000F555 00007656 0000F757
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 0.1 + ps;
    r5.xyz = r2.xyw * UniformVector_1.xyz;
    r0.x = ps;
    ps = rsqrt(abs(r0.w));
    ...
    r0.z = ps;
    r6.xyz = r9.xyz * r0.zzz;
    r0.z = dot(r6.zxy, r8.zxy);
    r9.xyz = r6.xzy * r0.zzz;
    r8.xyz = r9.xyz * 2.0 - r8.xzy;
    r1.w = saturate(dot(r4.zxy, r8.yxz));
    ps = log2(r1.w);
    r0.z = saturate(dot(r6.zxy, r4.zxy));
    r7.z = ps;
    r4.xyz = r7.xyz * float3(0.875, 0.875, 15.0);
    ps = pow(2.0, r4.z);
    r2.xyw = r5.xyz * r0.zzz;
    r0.z = ps;
