// ps_413e10572bd5ecda.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 126 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001F8 10040800 00000506 00000000 000048A5 001F001F 00000001 00003050 0000F154 0000F256 0000F357 0000F458
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.z = saturate(ps);
    r7.xyz = r7.xyz * r6.yzw + UniformVector_0.xyz;
    ps = rsqrt(abs(r0.z));
    ...
    r3.x = r3.x * 2.0 - r3.x;
    ps = -r3.z;
    r1 = r8.xyww * float4(0.875, 0.875, -0.5, 0.5);
    r3.z = ps;
    ps = 0.1 - -r0.w;
    r1.zw = r1.zw * r4.zz;
    r0.x = ps;
    ps = 5.0 * r0.x;
    r3.x = saturate(dot(r0.yzw, r3.yzx));
    r0.x = saturate(ps);
    ps = -ModShadowColor.x;
    r0.x = -r0.x + 1.0;
    ps = 1.0 + ps;
    ...
    r6.x = ps;
    ps = -ModShadowColor.y;
    r3 = r6 * float4(15.0, 0.21952, 0.21952, 0.21952);
    ps = 1.0 + ps;
    r1.xy = r1.xy * r0.yw;
    r0.y = ps;
    ps = pow(2.0, r3.x);
    ...
    r1.z = ps;
    r0.xyz = r1.zzz * r0.xyz + ModShadowColor.xyz;
    r6.xyz = r3.ywz * r1.xxx;
    r1.xyz = r3.ywz * r1.yyy;
    r1.xyz = r1.xzy * UpperSkyColor.xyz + r7.xyz;
    r1.xyz = r6.xyz * LowerSkyColor.xzy + r1.xzy;
    r1.xyz = r4.xyz * 0.21952 + r1.xyz;
    r1.xyz = r5.xyz * r3.yzw + r1.xzy;
    ps = -r2.w;
