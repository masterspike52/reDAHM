...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.zw = r0.xy * 0.08 + UniformVector_2.xy;
    r1.x = tex2D(Texture2D_1, r0.zw).x;
    r0.zw = r0.xy * 3.0 + UniformVector_1.xy;
    ...
    ps = r6.w;
    r0.xyw = r0.www * r0.yzx;
    r0.xyz = r0.wxy * r3.xyz + UniformVector_0.xyz;
    ps = SCENE_COLOR_BIAS_FACTOR.x * ps;
    r1.x = r0.w * OpacityOverride.x;
    r0.w = ps;
    oC0.w = r1.x * r3.x;
