// ps_5898f0a499c37012.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 282 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000468 10040B00 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.z = float((r5.y >= UniformScalar_0.x));
    r7.x = ps;
    r6.xw = r7.xy * r7.zy;
    r5.xzw = r6.yzw * float3(0.875, 0.875, 0.0208351);
    r10.xw = r5.zx * r4.xy + 0.125;
    ...
    r5.y = ps;
    r3.xyz = r10.zyx * r5.yyy;
    r4.w = float((r7.z >= UniformScalar_2.x));
    r0.y = float((UniformScalar_2.x >= r7.z));
    r5.y = dot(r3.zxy, r5.xzw);
    r6.xz = (r4.zw > 0.0) ? r0.xy : 1.0;
    r0.xyz = r3.zyx * r5.yyy;
    r0.xyz = r0.zyx * 2.0 - r5.zwx;
    p0 = (-r6.w > 0.0);
    ps = p0 ? 0.0 : 1.0;
    r5.x = r6.x * r6.z;
    r5.yzw = r6.yyy * r9.xyz + ModShadowColor.xyz;
    if (!p0)
    {
        ps = r6.w;
        r6.x = ps;
    ...
    r4.x = r6.x + r0.w;
    r6.xyz = tex2D(Texture2D_1, r4.xy).xyz;
    ...
    r0.w = max(UniformScalar_9.x, 0.0001);
    r4.xyz = r4.xyz * UniformScalar_7.xxx + UniformScalar_8.xxx;
    r0.x = saturate(dot(r1.zxy, r0.zxy));
    ps = log2(r0.x);
