...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.xyz = AmbientColorAndSkyFactor.xyz * float3(32.0, 2e+01, 0.5);
    r6.xyz = r0.xyz * r8.yzw + r6.xyz;
    ps = rsqrt(abs(r5.y));
    ...
    r6.w = ps;
    ps = rsqrt(abs(r5.x));
    r0.xyz = r6.www * r3.zxy;
    r9.z = ps;
    r0.x = r0.x * 2.0 - r0.x;
    r3 = r9.zzxy * float4(-0.5, 0.5, 0.875, 0.875);
    ps = -r0.y;
    r3.xy = r3.xy * r4.zz;
    r0.y = ps;
    ps = -r0.z;
    ...
    r0.z = ps;
    ps = 0.1 - -r5.y;
    r1.xyz = r7.xzy * LightMapScale.xzy;
    r5.x = ps;
    ps = 5.0 * r5.x;
    r5.w = saturate(dot(r5.zwy, r0.yzx));
    r5.x = saturate(ps);
    ps = 1.0 - r5.x;
    r5.x = ps;
    ...
    r5.xyz = -r5.xyz + 1.0;
    r8.x = ps;
    r0 = r8 * float4(15.0, 32.0, 2e+01, 0.5);
    r3.zw = r3.zw * r5.xy;
    ...
    r3.xyz = r0.ywz * r3.xxx;
    ps = pow(2.0, r0.x);
    r4.xyz = r0.ywz * r3.www;
    r6.w = ps;
    r6.xyz = r4.xyz * UpperSkyColor.xzy + r6.xzy;
    r6.xyz = r3.xzy * LowerSkyColor.xyz + r6.xzy;
    r6.xyz = r1.xyz * r6.www + r6.xzy;
    r6.xyz = r1.xzy * r0.yzw + r6.xzy;
    ps = -r2.w;
