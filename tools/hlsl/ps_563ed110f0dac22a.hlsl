...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.x = ps;
    r4.yz = r6.xy * abs(r5.xy);
    r4.yz = tex2D(ModShadowAccumTexture, r4.yz).xy;
    ...
    r0.x = saturate(ps);
    ps = rsqrt(abs(r4.x));
    r7.xyz = r4.www * r1.zxy;
    r1.x = ps;
    ps = 1.0 - r0.x;
    r1.xyz = r1.xxx * r3.zxy;
    r0.x = ps;
    ...
    r1.x = ps;
    ps = pow(2.0, r0.x);
    r3.xyz = r6.xyz * r1.xxx;
    r4.x = ps;
    r4.xyz = r4.xyz * float3(0.21952, 0.875, 0.875);
    r1.xyz = r5.xyz * r1.www + r4.xxx;
    r2.xy = r4.yz * r2.xy + 0.125;
    ps = r2.x * r2.y;
