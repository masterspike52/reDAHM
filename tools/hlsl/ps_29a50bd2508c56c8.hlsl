// ps_29a50bd2508c56c8.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 57 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000000E4 10000400 00000008 00000000 000050A5 0007001F 00000021 0000F050 0000F151 0000F256 0000F3A0 0000F4A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.w = tex2D(Texture2D_0, r0.xy).w;
    r4.x = tex2D(Texture2D_0, r0.wz).w;
    ps = r3.w;
    r4.yz = r2.xy * IndividualVelocityScale.xy;
    ps = 5.0 * ps;
    r3.x = -r4.w + r4.x;
    r4.x = ps;
    r4.w = r3.x * r1.x + r4.w;
    r3.xyz = r4.xyz * r4.wyz;
    ps = r3.y + r3.z;
    r3.x = min(r3.x, 1.0);
    r3.y = ps;
    r3.y = max(r3.y, 1.0);
