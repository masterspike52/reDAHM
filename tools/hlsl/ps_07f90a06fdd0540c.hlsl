// ps_07f90a06fdd0540c.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 123 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001EC 10040900 0000070A 00000000 000060E7 001F007F 00000001 00003050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.yz = tex2D(ModShadowAccumTexture, r5.xz).xy;
    ...
    r6.w = saturate(dot(r1.yzx, r0.yzx));
    r5.y = ps;
    ps = log2(r6.w);
    r0.x = saturate(r5.y * SpotAngles.y);
    r9.x = ps;
    r2 = r9 * float4(15.0, 0.21952, 0.21952, 0.21952);
    ps = pow(2.0, r2.x);
    r0.y = r0.x * r0.x;
    r6.w = ps;
    r1.xyz = r6.yzw * float3(0.875, 0.875, 0.21952);
    r6.xyz = r2.yzw * r6.xxx + r1.zzz;
    r7.xy = r1.xy * r5.zw + 0.125;
    ps = LightColorAndFalloffExponent.w * r5.x;
    r0.zw = r7.xz * r7.yz;
    r5.w = ps;
    r5.xyz = r0.zzz * r8.xyz + ModShadowColor.xyz;
    ps = pow(2.0, r5.w);
