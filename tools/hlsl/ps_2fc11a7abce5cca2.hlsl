// ps_2fc11a7abce5cca2.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 126 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001F8 10040900 0000080A 00000000 00007108 003F00FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.y = ps;
    ps = 5.0 * r6.x;
    r7.xyw = r7.xyz * r9.xyz;
    r6.x = saturate(ps);
    ps = rsqrt(abs(r6.w));
    r5.yzw = r6.yyy * r2.zxy;
    r6.w = ps;
    ps = 1.0 - r6.x;
    r3.xyz = r6.www * r4.zxy;
    r6.x = ps;
    ...
    r3.x = r3.x * 2.0 - r3.x;
    ps = 1.0 + ps;
    r6.x = saturate(dot(r5.zwy, r3.yzx));
    r5.y = ps;
    ps = log2(r6.x);
    r7.z = saturate(r6.y * r2.z);
    r8.x = ps;
    ps = log2(r6.z);
    r6.xyw = r8.xzy * float3(15.0, 0.875, 0.875);
    r6.z = ps;
