...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.z = ps;
    r5.z = (r0.x == 0.0) ? r15.x : r15.y;
    r0 = r0.xzxy + float4(-3.0, -1.0, -2.0, -1.0);
    ps = r0.w;
    r6.xyw = r6.xyz * UniformVector_4.xyz;
    r5.z = (r0.z == 0.0) ? r15.z : r5.z;
    r7.z = (r0.x == 0.0) ? r15.w : r5.z;
    ps = r10.y + ps;
    r5.z = max(r7.z, 0.0);
    r0.x = ps;
    ps = r0.y;
    ...
    r7.yzw = -r7.wzy + 1.0;
    r5.z = ps;
    r2.xyz = r3.yxz * r7.xzy + float3(1.0, 0.125, 0.125);
    r11.xyz = r14.xyz * r2.xxx - r10.xyz;
    ps = abs(r2.x) * abs(r2.x);
    r3.xyz = r5.zzz * r1.xyz;
    r0.w = ps;
    r6.w = saturate(r14.w * r2.x - 0.5);
