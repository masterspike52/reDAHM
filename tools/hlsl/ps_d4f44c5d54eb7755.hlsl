// ps_d4f44c5d54eb7755.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 45 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000000B4 10000400 00000008 00000000 00004CA5 0007001F 00000001 0000F050 0000F155 00007256 0000F3A0 0000F4A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.zw = r0.xy * 0.5 + UniformVector_2.xy;
    r3.xy = tex2D(Texture2D_4, r0.xy).xy;
    r3.zw = tex2D(Texture2D_3, r3.zw).xy;
    r3.zw = r3.zw * 5.0;
    r3.xy = r3.zw * r3.xy;
    r3.xy = r3.xy * 4.0;
