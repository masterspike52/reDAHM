// ps_07a772202245f3ed.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 147 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000024C 10040A00 0000070A 00000000 000060E7 001F007F 00000001 00003050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A1
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.yz = r7.xy * r5.yz + 0.125;
    r7.xyz = r2.xyz * r5.www;
    ps = 1.0 - r5.x;
    ...
    r5.x = r5.y * r5.z;
    r0.y = ps;
    r5.xyz = r5.xxx * r0.xzw + ModShadowColor.xyz;
    ps = log2(abs(r8.x));
    r2.xyz = r7.xzy * r6.www;
    r0.z = ps;
    ...
    r0.x = ps;
    ps = log2(r5.w);
    r0 = r0 * float4(2e+01, 0.3, 0.3, 0.3);
    r5.w = ps;
    ps = pow(2.0, r0.z);
