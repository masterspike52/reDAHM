...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = rsqrt(abs(r5.z));
    r4.zw = r6.xy * abs(r8.xy);
    r6.w = ps;
    r5.z = dot(r3.zxy, r3.zxy);
    ps = rsqrt(abs(r5.z));
    r6.xyz = r6.www * r1.zxy;
    r5.z = ps;
    ...
    r11.xy = tex2D(ModShadowAccumTexture, r4.zw).xy;
    ...
    r0.x = ps;
    r4.xyz = r0.xxx * UniformVector_1.xyz + r5.www;
    r8.x = r7.w * 2.0 - r7.w;
    ps = 0.1 - -r1.z;
    r7.w = dot(r11.zww, float3(1.0, 1.0, 1.0));
    r5.y = ps;
    r5.w = (r7.w == 0.0) ? r12.x : r12.y;
    ps = 5.0 * r5.y;
    r6.yz = r7.ww + float2(-3.0, -2.0);
    r5.x = saturate(ps);
    r5.w = (r6.z == 0.0) ? r12.z : r5.w;
    r5.y = (r6.y == 0.0) ? r12.w : r5.w;
    r5.w = saturate(r6.x * r8.x + r5.z);
    r11.zw = -r5.xy + 1.0;
    r6.xy = -r11.zz * ModShadowGroupColor.xy + 1.0;
    ps = log2(r5.w);
    r5.xyz = r11.wxy * float3(2.5, 0.875, 0.875);
    r10.w = ps;
    r0 = r10 * float4(0.5, 0.5, 0.5, 15.0);
    r6.xy = r5.yz * r6.xy + 0.125;
    r2.xyz = r0.xyz * r9.www;
    r4.xyz = r2.xyz * UniformScalar_1.xxx + r4.xyz;
    r2.xyz = r9.xyz * 2e+01 + r2.xyz;
    ps = r6.x * r6.y;
    r0.xyz = -UniformVector_0.xyz + 1.0;
    r5.w = ps;
    r6.xyz = r5.www * r8.yzw + ModShadowColor.xyz;
    ps = (-0.5) + r5.x;
