// ps_e99e486117deb310.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 129 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000204 10040900 0000070A 00000000 000060E7 001F007F 00000001 00003050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.y = saturate(ps);
    ps = rsqrt(abs(r5.z));
    r0.x = saturate(r5.w * 5.0);
    r6.w = ps;
    ps = rsqrt(abs(r5.y));
    r7.xyw = r6.www * r1.xyz;
    r5.y = ps;
    ps = rsqrt(abs(r5.x));
    ...
    r0.x = -r0.x + 1.0;
    r5.x = ps;
    r8.yz = -r0.xx * ModShadowGroupColor.xy + 1.0;
    ps = -r5.y;
    r3.xyz = r6.xxx * -SpotDirection.xyz;
    r0.y = ps;
    r0.x = r5.w * 2.0 - r5.w;
    ps = -r5.z;
    ...
    r5.z = saturate(dot(r7.xyw, r0.yzx));
    r5.y = ps;
    ps = log2(r5.z);
    r0.x = saturate(r5.y * SpotAngles.y);
    r5.y = ps;
    ...
    r6.x = ps;
    ps = pow(2.0, r5.z);
    r5.xyw = r6.yzx * float3(0.875, 0.875, 0.21952);
    r8.x = ps;
    r6.xyz = r5.wxy * r8.xyz;
    r7.xy = r6.yz + 0.125;
    r6.yz = r7.xz * r7.yz;
    r5.xyz = r6.yyy * r9.xyz + ModShadowColor.xyz;
    ps = r6.w;
    r2.xyz = r6.zzz * r4.xyz;
    ps = r1.z * ps;
    r6.xy = r2.xz * r6.xx;
    r2.w = saturate(ps);
    r6.zw = r2.yw * r8.xw;
