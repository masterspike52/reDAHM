// ps_9046b4ba3628eb7d.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 114 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001C8 10040900 0000080A 00000000 00007908 003F00FF 00000001 0000F050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.x = tex2D(Texture2D_0, r1.zw).w;
    ...
    r5.y = ps;
    r6.xyz = r5.zyw * float3(0.875, 15.0, 0.875);
    r6.xz = r6.xz * r3.xy + 0.125;
    ps = pow(2.0, r6.y);
    r6.x = r6.x * r6.z;
    r5.y = ps;
