...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 + ps;
    r0.x = dot(r6.zxy, r1.zxy);
    r7.y = ps;
    ps = -UniformVector_0.z;
    r3.xyz = r6.xzy * r0.xxx;
    r1.xyz = r3.xyz * 2.0 - r1.xzy;
    ps = 1.0 + ps;
    r0.x = saturate(dot(r5.zxy, r1.yxz));
    r7.z = ps;
    ps = log2(r0.x);
    r3.xyz = r8.xyz * LightColor.xyz;
    r7.w = ps;
    r1 = r7 * float4(0.21952, 0.21952, 0.21952, 15.0);
    ps = pow(2.0, r1.w);
    r0.x = saturate(dot(r6.zxy, r5.zxy));
    r4.x = ps;
    r4.xyz = r4.xyz * float3(0.21952, 0.875, 0.875);
    r1.xyz = r1.xyz * r0.xxx + r4.xxx;
