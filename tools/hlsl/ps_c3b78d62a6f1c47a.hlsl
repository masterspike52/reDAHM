// ps_c3b78d62a6f1c47a.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 114 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001C8 10040900 00000506 00000000 000040A5 001F001F 00000001 00003050 00007154 0000F255 00007356 0000F457
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.yz = tex2D(ModShadowAccumTexture, r2.xy).xy;
    ...
    r6.xyz = r6.xyz * r2.xyw;
    r3.w = rsqrt(abs(r3.w));
    r7.xyz = r3.www * r1.xyz;
    r0.w = 0.1 - -r1.z;
    r1.z = dot(r9.zxy, r9.zxy);
    ...
    r0.w = ps;
    r3.yzw = r9.xyz * r0.www;
    r0.w = dot(r3.wyz, r8.zxy);
    r9.xyz = r3.ywz * r0.www;
    r8.xyz = r9.xyz * 2.0 - r8.xzy;
    ps = LightColor.x * r0.y;
    r1.z = saturate(dot(r7.zxy, r8.yxz));
    r3.x = ps;
    ps = log2(r1.z);
    r0.w = saturate(dot(r3.wyz, r7.zxy));
    r5.x = ps;
    ps = LightColor.y * r0.z;
    r5.xyz = r5.xyz * float3(15.0, 0.875, 0.875);
    r3.y = ps;
    ps = pow(2.0, r5.x);
    r2.xyw = r6.xyz * r0.www;
    r0.w = ps;
    r1.xy = r5.yz * r1.xy + 0.125;
    ps = r1.x * r1.y;
    r2.z = r0.w * r2.z;
    r0.w = ps;
    r1.xyz = r0.www * r4.xyz + ModShadowColor.xyz;
