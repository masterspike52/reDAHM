// ps_d8ba4c27ad7b68be.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 165 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000294 10000800 00000008 00000000 000044A5 0007001F 00000021 00003050 0000F155 00007256 0000F3A0 0000F4A1
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.x = tex2D(Texture2D_0, r0.zw).w;
    r7 = r3 * 2.0 - 1.0;
    ...
    r6.w = ps;
    ps = rsqrt(abs(r3.x));
    r4.y = r0.x * UniformScalar_4.x;
    r3.x = ps;
    ps = rsqrt(abs(r3.y));
    r4.z = dot(r6.zxy, r6.zxy);
    r3.w = ps;
    ps = UniformVector_2.x * r3.w;
    r3.y = dot(r7.zxy, r7.zxy);
    r1.x = ps;
    ps = UniformVector_2.y * r3.w;
    r5.xyz = r3.xxx * r2.zxy;
    r1.y = ps;
    ps = rsqrt(abs(r3.y));
    r3.x = max(r5.x, 0.0);
    r3.y = ps;
    ps = UniformVector_2.z * r3.w;
    r8.xyz = r7.xyz * r3.yyy;
    r1.z = ps;
    ps = 1.0 - r3.x;
    r3.yzw = r8.zzz * LocalToWorldMatrix[2].xyz;
    r3.x = ps;
    r2.xyz = r8.yyy * LocalToWorldMatrix[1].xyz + r3.yzw;
    ps = abs(r3.x) * abs(r3.x);
    r0.xyw = r8.xyz * r5.xxx;
    r3.y = ps;
    r2.xyz = r8.xxx * LocalToWorldMatrix[0].xzy + r2.xzy;
    ps = r3.y * r3.y;
    r4.x = dot(r1.zxy, r2.yxz);
    r3.z = ps;
    ps = rsqrt(abs(r4.z));
    r3.yz = r3.yz * abs(r3.xx);
    r3.x = ps;
    r0.z = r3.z * UniformScalar_12.x + UniformScalar_11.x;
    r6 = r6.xzyw * r3.xxxy;
    r3.x = max(r6.w, (-255.0));
    r3.yzw = r8.zxy * r6.zyx;
    r3.x = min(r3.x, 255.0);
    r3.yzw = r8.yxz * r6.yzx - r3.ywz;
    ps = log2(abs(r1.w));
    r7.xyz = r3.ywz * r7.www;
    r3.y = ps;
    ...
    r4.z = ps;
    r0.xyw = r7.xzy * r5.zzz + r0.xyw;
    r3.yzw = r6.xyz * r5.yyy + r0.xwy;
    r4.xy = r4.xy + r4.xz;
    r0.xyw = r3.zzz * LocalToWorldMatrix[2].xzy;
    r1.xyz = r4.xxx * r2.xzy - r1.xyz;
    r0.xyw = r3.www * LocalToWorldMatrix[1].xzy + r0.xyw;
    r0.xyw = r3.yyy * LocalToWorldMatrix[0].xyz + r0.xwy;
    r3.w = saturate(dot(r1.zxy, r0.wxy));
    ps = log2(r3.w);
    r3.z = min(r3.x, 0.0);
    r3.y = ps;
