...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.xy = tex2D(ModShadowAccumTexture, r6.yz).xy;
    ...
    r2.xyz = r5.yzw * r6.www;
    ps = 1.0 + ps;
    r6.w = dot(r2.zxy, r4.zxy);
    r5.y = ps;
    ps = -UniformVector_0.z;
    r8.xyz = r2.xzy * r6.www;
    r4.xyz = r8.xyz * 2.0 - r4.xzy;
    ps = 1.0 + ps;
    r6.w = saturate(dot(r1.zxy, r4.yxz));
    r5.z = ps;
    ps = log2(r6.w);
    r0.xyz = r5.xyz * r0.xyz;
    r7.z = ps;
    r7.xyz = r7.xyz * float3(0.875, 0.875, 15.0);
    r6.yz = r7.xy * r6.yz + 0.125;
    ps = pow(2.0, r7.z);
    r6.w = saturate(dot(r2.zxy, r1.zxy));
    r7.x = ps;
    r7.xyz = r7.xxx * UniformVector_1.xyz;
