...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.x = ps;
    ps = rsqrt(abs(r4.z));
    r7.yz = r7.xy * float2(0.5, 0.1);
    r5.w = ps;
    ps = 5.0 * r4.x;
    r4.w = dot(r2.zxy, r2.zxy);
    r4.z = saturate(ps);
    ps = rsqrt(abs(r4.w));
    r6.xyz = r5.www * r0.zxy;
    r4.x = ps;
    ps = 1.0 - r4.z;
    r1.xyz = r4.xxx * r2.zxy;
    r4.x = ps;
    r4.xz = -r4.xx * ModShadowGroupColor.xy + 1.0;
    r1.yz = -r1.yz;
    r1.x = r1.x * 2.0 - r1.x;
    ps = 1.0 - r4.y;
    r4.w = saturate(dot(r6.yzx, r1.yzx));
    r4.y = saturate(ps);
    ps = log2(r4.w);
    r7.x = saturate(r5.w * r0.z);
    r3.z = ps;
    ps = log2(r4.y);
    r0.xyz = r3.zxy * float3(15.0, 0.875, 0.875);
    r4.y = ps;
    ps = pow(2.0, r0.x);
    r4.w = r4.y * LightColorAndFalloffExponent.w;
    r0.x = ps;
    r0.yz = r0.yz * r4.xz + 0.125;
    ps = r0.y * r0.z;
    r4.xyz = -ModShadowColor.xyz + 1.0;
    r5.w = ps;
    ps = pow(2.0, r4.w);
    r0.xy = r0.xx * float2(0.3, 0.6);
    r4.w = ps;
    r4.xyz = r5.www * r4.xyz + ModShadowColor.xyz;
    r0.xyz = r7.xyz * r7.wxx + r0.xyx;
