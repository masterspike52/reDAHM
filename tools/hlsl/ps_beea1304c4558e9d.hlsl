...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.x = r3.w * SCENE_COLOR_BIAS_FACTOR.x;
    r5.x = 1.0 / r1.w;
    r5.xy = r5.xx * ScreenPositionScaleBias.xy;
    r2.yz = r5.yx * r1.yx + ScreenPositionScaleBias.zw;
    r5.yzw = tex2D(Texture2D_0, r0.xy).xyz;
    r5.x = tex2D(SceneDepthTexture, r2.zy).x;
    r5.x = r5.x * MinZ_MaxZRatio.z - MinZ_MaxZRatio.w;
    r5.yzw = r5.yzw * r4.xyz + UniformVector_0.xyz;
    oC0.xyz = r2.xxx * r5.yzw;
    r4.y = 1.0 / r5.x;
    r4.x = r4.y - r1.w;
    r5.x = float((r4.y != 1.0));
    r5.y = saturate(0.004 * r4.x);
    r4.x = r5.y * r4.w;
    r4.y = (r5.x == 0.0) ? r4.w : r4.x;
