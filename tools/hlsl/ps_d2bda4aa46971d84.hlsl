// ps_d2bda4aa46971d84.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 99 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000018C 10040900 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.xyz = r6.yyy * r5.xyz;
    r6.x = ps;
    ps = pow(2.0, r6.x);
    r6.y = saturate(dot(r2.zxy, r1.zxy));
    r6.x = ps;
    r0.yz = r0.yz * r6.zw + 0.125;
    ps = r0.x * r0.x;
