...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.x = ps;
    ps = r6.x;
    r9.xyz = r7.xzy * r5.yyy;
    r5.y = ps;
    r8.xyz = r9.xyz * 2.0 - r8.xzy;
    ps = UniformVector_1.x * r5.y;
    r5.z = saturate(dot(r1.wxy, r8.yxz));
    r1.z = ps;
    ps = log2(r5.z);
    r1.x = saturate(dot(r7.zxy, r1.wxy));
    r3.w = ps;
    ps = UniformVector_1.y * r6.x;
    r3.xy = r3.xy * r3.wz;
    r1.w = ps;
    r5.yzw = r3.yyy * r4.xyz + ModShadowColor.xyz;
    ps = pow(2.0, r3.x);
    r6.z = r2.w * r1.x;
    r1.y = ps;
