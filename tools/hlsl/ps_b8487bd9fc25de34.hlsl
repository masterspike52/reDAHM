// ps_b8487bd9fc25de34.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 63 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000000FC 10000300 00000004 00000000 00002863 00070007 00000021 00003050 0000F151 0000F256
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.xy = r0.yx - 0.5;
    r0.w = dot(r3.xy, UniformVector_3.yx) + 0.5;
    r0.z = dot(r3.xy, UniformVector_2.yx) + 0.5;
    r3.w = tex2D(Texture2D_1, r0.xy).x;
    r0.x = tex2D(Texture2D_1, r0.zw).x;
    r3.yz = r2.xy * IndividualVelocityScale.xy;
    r3.x = r0.x * r1.x;
    r0.xyz = r3.xyz * r3.wyz;
    ps = r0.y + r0.z;
    r0.x = min(r0.x, 1.0);
    r0.y = ps;
    r0.y = max(r0.y, 1.0);
