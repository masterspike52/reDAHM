// ps_93c79dc3019f4928.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 246 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000003D8 10040D00 0000080A 00000000 00007908 001F00FF 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A1 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.x = ps;
    r7.zw = r6.xz * r5.xx + ScreenPositionScaleBias.wz;
    ps = r11.w;
    ...
    r8.xyz = tex2D(LightAttenuationTexture, r7.zw).xyz;
    ...
    r13.xyz = tex2D(Texture2D_0, r5.yz).xyw;
    ...
    r0.yzw = (-abs(r0.yyy) >= 0.0) ? r12.xyz : 1.0;
    r4.xyz = (-abs(r5.zzz) >= 0.0) ? 1.0 : r0.yzw;
    ps = UniformVector_2.z * r7.x;
    r0.yzw = UniformVector_4.xyz * UniformVector_4.www;
    r13.w = ps;
    ps = 1.0 - r5.x;
    r11.xyz = r0.yzw * r11.xyz;
    r5.z = ps;
    ps = rsqrt(abs(r6.y));
    r12.xyz = r7.www * r1.xyz;
    r5.x = ps;
    ps = rsqrt(abs(r5.w));
    r3.xyz = r5.xxx * r3.xyz;
    r5.x = ps;
    ps = log2(r5.y);
    r0.yzw = r5.xxx * -SpotDirection.xyz;
    r5.x = ps;
    ...
    r0.z = ps;
    r0.yzw = -r0.xyz + 1.0;
    r2.zw = r1.yx * r0.yy + 1.0;
    ps = UniformScalar_1.x * r0.y;
    r1.xyz = -UniformVector_0.xyz + 1.0;
    r0.x = ps;
    r5.yz = r0.xx * r9.yz + r7.yz;
    r5.yz = r5.yz * UniformVector_2.xy;
    r2.xy = r5.yz * r0.yy;
    r7 = (r0.xyyy > 0.0) ? r2.wxyz : float4(1.0, 0.0, 0.0, 1.0);
    r9.z = (r0.x >= 0.0) ? r7.x : 1.0;
    r7.xyz = (r0.yyy >= 0.0) ? r7.yzw : float3(0.0, 0.0, 1.0);
    r5.y = dot(r7.zxy, r7.zxy);
    ps = rsqrt(abs(r5.y));
    r5.z = r5.w - SpotAngles.x;
    r5.y = ps;
    r2.xyz = r7.xyz * r5.yyy;
    r5.y = dot(r2.zxy, r3.zxy);
    r7.xyz = r2.xyz * r5.yyy;
    r7.xyz = r7.xyz * 2.0 - r3.xyz;
    r5.y = saturate(dot(r12.zxy, r7.zxy));
    ps = log2(r5.y);
    r9.y = saturate(r5.z * SpotAngles.y);
    r6.y = ps;
    ps = UniformScalar_9.x * r6.y;
    r7.xyw = -ModShadowColor.xyz + 1.0;
    r5.y = ps;
    ps = pow(2.0, r5.y);
    r7.z = saturate(dot(r2.zxy, r12.zxy));
    r5.y = ps;
    ps = UniformScalar_10.x * r5.y;
    r6.xyz = r6.xzy * float3(0.875, 0.875, 15.0);
    r5.w = ps;
    r5.yz = r6.xy * r0.zw + 0.125;
    ps = r5.y * r5.z;
    r11.w = r5.w * r9.z;
    r5.y = ps;
    r5.yzw = r5.yyy * r7.xyw + ModShadowColor.xyz;
    r0 = r11 * r4.xyzx;
    r0 = r0 * r9.zzzw;
    r7.xyw = r0.xyz * r1.xyz;
    r9.z = (r6.w > 0.0) ? 0.0 : r0.w;
    ...
    r6.z = ps;
    ps = pow(2.0, r5.x);
    r6.xzw = r0.xyz * r6.zzz;
    r5.x = ps;
    r7.xy = r7.xy * r7.zz + r6.xz;
    r7.z = r7.w * r7.z + r6.w;
