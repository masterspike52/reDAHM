// ps_aae171a8279f05a0.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 123 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001EC 10040A00 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.w = tex2D(Texture2D_1, r5.zw).w;
    ...
    r5.x = saturate(ps);
    ps = rsqrt(abs(r6.w));
    r8.xyz = r5.www * r1.zxy;
    r5.y = ps;
    ps = 1.0 - r5.x;
    r3.xyz = r5.yyy * r3.zxy;
    r5.x = ps;
    r2.xyz = r2.xyz * r10.zzz + r10.xyz;
    ps = r5.w;
