// ps_3845a635c9f2972f.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 138 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000228 10040B00 00000606 00000000 000050C6 003F003F 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 0.1 + ps;
    r8.xyz = r6.xyz * UniformVector_1.xyz;
    r0.y = ps;
    ps = rsqrt(abs(r0.w));
    ...
    r0.z = dot(r3.zxy, r2.zxy);
    r10.xyz = r3.xzy * r0.zzz;
    r2.xyz = r10.xyz * 2.0 - r2.xzy;
    ps = -SpotAngles.x - -r0.y;
    r0.z = saturate(dot(r8.zxy, r2.yxz));
    r0.y = ps;
    ps = log2(r0.z);
