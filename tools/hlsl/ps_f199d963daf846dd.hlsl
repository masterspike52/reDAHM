// ps_f199d963daf846dd.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 192 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000300 10040C00 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.yzw = r2.xyz * r6.xxx + r11.xzy;
    r1.yzw = r6.www * r1.xyz;
    r10.xy = r8.xx * r10.xy + r9.zw;
    r11.xyz = r10.xyz * UniformVector_2.xyz;
    ps = rsqrt(abs(r0.w));
    r6.w = dot(r11.zxy, r11.zxy);
    r0.w = ps;
    ps = rsqrt(abs(r6.w));
    r10.xyz = r0.www * r3.xyz;
    r6.w = ps;
    r3.xyz = r11.xyz * r6.www;
    r6.w = dot(r3.zxy, r10.zxy);
    ps = -UniformVector_0.x;
    r11.xyz = r3.xzy * r6.www;
    r10.xyz = r11.xyz * 2.0 - r10.xzy;
    ps = 1.0 + ps;
    r0.w = saturate(dot(r1.wyz, r10.yxz));
    r1.x = ps;
    ps = log2(r0.w);
    ...
    r3.w = ps;
    r5.xyw = r3.xyw * r5.xzy + float3(0.125, 0.125, 1.0);
