// ps_85c7e9c3037f729d.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 126 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001F8 10040A00 00000506 00000000 000040A5 001F001F 00000001 00003050 00007154 0000F255 00007356 0000F457
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6 = tex2D(Texture2D_0, r0.xy).wyxz;
    ps = r1.z;
    ...
    r0.z = ps;
    ps = rsqrt(abs(r0.x));
    r7.xyw = r7.xyz * r6.zyw;
    r1.w = ps;
    ps = rsqrt(abs(r3.w));
    r0.x = saturate(-r0.x + 1.0);
    r0.y = ps;
    ps = log2(r0.x);
    r4.z = saturate(r0.y * r1.z);
    r0.x = ps;
    ps = rsqrt(abs(r0.w));
    r6.z = r7.w * r4.z;
    r3.w = ps;
    ...
    r9.x = ps;
    ps = 0.875 * r4.y;
    r6.xy = r6.xx * UniformVector_1.xy;
    r9.y = ps;
    ps = 5.0 * r0.z;
    r4.xyw = r0.yyy * r1.zxy;
    r0.y = saturate(ps);
    ps = 1.0 - r0.y;
    ...
    r0.z = saturate(dot(r4.ywx, r3.yzx));
    r0.y = ps;
    ps = log2(r0.z);
    r1.z = saturate(r0.y * SpotAngles.y);
    r1.w = ps;
