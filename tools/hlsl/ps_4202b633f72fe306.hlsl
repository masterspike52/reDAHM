// ps_4202b633f72fe306.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 33 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000084 10000500 00000008 00000000 00004CC6 000F003F 00000021 00003050 00003151 0000F256 00007357 0000F4A0 0000F5A1
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.y = UniformScalar_4.x - UniformScalar_3.x;
    r4.w = -UniformScalar_3.x + 1.0;
    r4.z = saturate(r1.y);
    ps = 1.0 / r4.y;
    r4.z = r4.w - r4.z;
    r4.y = ps;
    r4.y = saturate(r4.z * r4.y);
    r4.x = r4.y * r4.x - 0.5;
