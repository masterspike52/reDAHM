...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.xyz = texCUBE(TextureCube_0, xe_cube_dir(r3.xyz)).xyz;
    ...
    r8.xyz = r6.www * r5.yzw;
    r5.y = dot(r8.zxy, r9.zxy);
    r5.yzw = r8.xzy * r5.yyy;
    r5.yzw = r5.yzw * 2.0 - r9.xzy;
    ps = LightColorAndFalloffExponent.w * r5.x;
    r5.y = saturate(dot(r2.zxy, r5.zyw));
    r6.w = ps;
    ps = log2(r5.y);
    r5.w = saturate(dot(r8.zxy, r2.zxy));
    r7.z = ps;
    ps = pow(2.0, r6.w);
    r5.xyz = r7.xyz * float3(0.875, 0.875, 15.0);
    r6.w = ps;
    ps = pow(2.0, r5.z);
