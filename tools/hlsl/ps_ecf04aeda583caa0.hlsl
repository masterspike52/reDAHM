// ps_ecf04aeda583caa0.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 147 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000024C 10040B00 0000080A 00000000 00007908 001F00FF 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A1 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.xyw = tex2D(Texture2D_5, r0.xy).xzy;
    ...
    ps = rsqrt(abs(r6.z));
    r5.y = saturate(r7.w * 5.0);
    r6.z = ps;
    ps = 1.0 - r5.y;
    r8.xyz = r6.zzz * r1.xyz;
    r7.w = ps;
    ps = rsqrt(abs(r1.w));
    ...
    r1.xz = r4.zw * r1.xy + 0.125;
    ps = 1.0 - r5.x;
    r3.xyz = r11.xyz * r6.zzz;
    r5.x = saturate(ps);
    ps = log2(abs(r6.y));
    ...
    ps = log2(abs(r6.w));
    r10.xyz = r3.xzy * r7.www;
    r1.w = ps;
    r9.xyz = r10.xyz * 2.0 - r9.xzy;
    ps = log2(r5.x);
    r6.w = saturate(dot(r8.zxy, r9.yxz));
    r5.x = ps;
    ps = log2(r6.w);
