// vs_cd48ea44cc47e7ef.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 447 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000040 000006FC 0011000E 00000000 00000000 00001842 00000001 00000007 00000002 00000290 00100013 00003014 00002015 00001016 00005017 00065018 00275019 00003050 0001F156 00001093 00001092
...
//   vertex element: instruction 25 -> TEXCOORD7
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r4.z = dot(r9.zxyw, r11);
    r0.x = dot(r10.zxyw, r13);
    r5.xyz = r0.yzw * 0.007843138 - 1.0;
    r4.w = dot(r5.xzy, r5.xzy);
    r0 = r0.xxxx * PreviousLocalToWorld[2].xzyw + PreviousLocalToWorld[3].xzyw;
    r0 = r4.zzzz * PreviousLocalToWorld[1].xzyw + r0;
    ps = rsqrt(abs(r4.w));
    r4.z = dot(r12.zxyw, r11);
    r4.w = ps;
    p0 = (r2.w != 0.0);
    ps = p0 ? 0.0 : 1.0;
    r9.xyz = r5.zyx * r4.www;
    r5 = r4.zzzz * PreviousLocalToWorld[0] + r0.xzyw;
    // UNHANDLED control flow: cjmp
    ps = 3.0 * r1.x;
    r0.y = ps;
    a0 = xe_mova(r0.y);
