// vs_2ed43f4993bda9ac.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 1116 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000080 00001170 0081000D 00000000 00000000 00008129 00000001 00000007 00000009 00000290 0010002C 0000602D 0000702E 0000302F 00005030 00015031 0020A032 00003050 0001F151 00027254 0003F355 00047456 0005F557 0006F6A0 0007F7A1 0008F8A2 0000116B 00001171 0000116D 0000116A 0000116E 00001172 0000116F 0000116C 00001170
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r5 = r11.wwww * LocalToWorld[3].xwzy;
    ps = 0.003921569 * r1.w;
    ...
    r4 = r11.zzzz * LocalToWorld[2].xwzy + r5;
    r8.yzw = r6.zyw * 0.007843138 - 1.0;
    r7.xyz = r10.xzy * 0.007843138 - 1.0;
    ps = 0.003921569 * r1.y;
    r5.xyz = r8.yyw * r7.xzz;
    r8.y = ps;
    r4 = r11.yyyy * LocalToWorld[1].xzyw + r4.xzwy;
    r4 = r11.xxxx * LocalToWorld[0] + r4.xzyw;
    r5.xyz = r8.wzz * r7.yyx - r5.xyz;
    ps = 0.003921569 * r1.x;
    ...
    r4 = r0.xxxx * LocalToWorld[2].xzyw + r7;
    r13.xyz = r6.zyw * 0.007843138 - 1.0;
    r8.yzw = r10.yxz * 0.007843138 - 1.0;
    ps = 0.003921569 * r1.y;
    r7.xyz = r13.xxz * r8.zyy;
    r8.y = ps;
    r4 = r5.wwww * LocalToWorld[1].xzyw + r4;
    r4 = r5.zzzz * LocalToWorld[0] + r4.xzyw;
    r5.xyz = r13.zyy * r8.wwz - r7.xyz;
    ps = 0.003921569 * r1.x;
    r0.x = dot(r0.yzw, r5.xyz);
    r8.z = ps;
    r3.w = r0.x * 0.5 + 0.5;
    r0.xyz = WorldToLocal[2].xzy * LightDirection.zzz;
    r13 = r4.wwww * ViewProjectionMatrix[3].xwzy;
    r7.xyz = r10.xyz * 0.007843138 - 1.0;
    r5.xzw = r6.yzw * 0.007843138 - 1.0;
    r1.xyz = r1.xyw * 0.007843138 - 1.0;
    r6 = r4.zzzz * ViewProjectionMatrix[2].xwzy + r13;
    r10.xyz = WorldToLocal[1].xzy * LightDirection.yyy + r0.xyz;
    r0.xyw = -r4.yxz * CameraPosition.www + CameraPosition.yxz;
    r13.xyz = WorldToLocal[0].xyz * LightDirection.xxx + r10.xzy;
    r6 = r4.yyyy * ViewProjectionMatrix[1].xzyw + r6.xzwy;
    r4 = r4.xxxx * ViewProjectionMatrix[0] + r6.xzyw;
    ps = WorldToLocal[2].x * r0.w;
    r10.x = dot(r1.xzy, r13.zxy);
    r6.x = ps;
    ps = WorldToLocal[2].z * r0.w;
    r10.y = dot(r5.zxw, r13.zxy);
    r6.y = ps;
    ps = WorldToLocal[2].y * r0.w;
    r10.z = dot(r7.zyx, r13.zxy);
    r6.z = ps;
    r6.xyz = r0.xxx * WorldToLocal[1].xzy + r6.xyz;
    r0.xyz = r0.yyy * WorldToLocal[0].xyz + r6.xzy;
    r5.y = dot(r1.xzy, r0.zxy);
    r5.z = dot(r5.zxw, r0.zxy);
    r5.w = dot(r7.zyx, r0.zxy);
    p0 = (-SP_DemolitionSpread.x >= 0.0);
    ps = p0 ? 0.0 : 1.0;
    // UNHANDLED control flow: cjmp
    ...
    ps = -r6.x * -r6.x;
    r7.xy = -r6.yx + BBox_Size.xy;
    r13.x = ps;
    r12.zw = r0.zx * BBox_Size.yx - r6.xy;
    r6.x = dot(r12.wz, r12.wz) + 0.0;
    ps = -r6.y * -r6.y;
    r13.zw = r7.xy * r7.xy;
    r13.y = ps;
    ps = 1.0 / r0.y;
    ...
    ps = BBox_Size.z * r1.w;
    r6.z = float((Collapse_Endcaps.x > 0.5));
    r6.x = ps;
    ps = r10.w;
    ...
    r7.xy = r1.yw + r1.zw;
    // UNHANDLED control flow: cjmp
    r1.w = float((r6.w > r7.x));
    r7.y = saturate(r7.y * r10.w);
    ps = sqrt(abs(r6.w));
    r0.y = float((Collapse_Endcaps.x >= 2.0));
    r7.x = ps;
    p0 = (r0.y != 0.0);
    ...
    r0.x = r7.x * r0.x;
    p0 = (0.0 == 0.0 && r7.y != 0.0);
    r7.x = (0.0 == 0.0 && r7.y != 0.0) ? 0.0 : 0.0 + 1.0;
    if (p0)
    {
    ...
    p0 = (r7.x == 0.0 && r0.y != 0.0);
    r7.x = (r7.x == 0.0 && r0.y != 0.0) ? 0.0 : r7.x + 1.0;
    if (p0)
    {
        r0.xy = r0.xx * float2(-8e+02, -1e+03);
        ps = 1.0 - r0.z;
    ...
    if (p0)
    {
        r7.xy = r0.yy * float2(8e+02, -1e+03);
        r11.x = r7.x + r11.x;
        ps = 3.3333333 * r0.x;
        r0.y = r7.y + r11.z;
        r5.x = ps;
    ...
    r6.x = -r6.x * r10.w + r0.y;
    ps = (-abs(r0.x) > 0.0) ? 1.0 : 0.0;
    r0.xz = -r0.yw + r6.yy;
    r12.w = ps;
    p0 = (r7.z != 0.0);
    ps = p0 ? 0.0 : 1.0;
    r7.xy = float2((r0.wy >= r6.xy));
    r0.xz = r6.ww * r8.ww + r0.xz;
    r0.xz = r0.xz * SP_DemolitionSpread.xx + r0.yw;
    r0.x = (r7.y == 0.0) ? r0.y : r0.x;
    r0.x = (r1.w == 0.0) ? r0.x : r0.z;
    r0.y = (r7.x == 0.0) ? r6.x : r0.x;
    if (p0)
    {
        if (p0)
        {
