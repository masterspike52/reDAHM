// ps_6586d5ec7d6f4f22.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 207 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000033C 10040E00 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 / r4.w;
    r9.yz = UniformVector_2.xz * UniformVector_2.xz;
    r5.x = ps;
    ...
    r13.xyw = r13.xzy + float3(-2.0, -1.0, -2.0);
    r5.w = ps;
    ps = r13.w;
    r5.x = dot(r14.zxy, float3(1.0, 1.0, 1.0));
    ps = -r7.z + ps;
    r5.xyz = -r5.ywx + 1.0;
    r13.w = ps;
    ...
    r10.yzw = r10.yzw + r10.yzw;
    r5.w = ps;
    ps = r7.x;
    r8.xyz = r5.zzz * r8.xyz;
    r13.xyz = r8.xyz * r10.yzw - r8.xyz;
    ps = r6.x + ps;
    r4.w = r6.z - 2.0;
    r11.w = ps;
    r11.x = r7.w * 2.0 + r4.w;
    r8.xyz = r13.xyz * UniformScalar_0.xxx + r8.xyz;
    r9.x = r13.w * UniformScalar_0.x + r7.z;
    ps = rsqrt(abs(r1.w));
    r9.w = r3.w * r9.x;
    r6.x = ps;
    r14.xy = r11.xw * r5.zz + float2(1.0, 0.0);
    r13.yzw = r11.xyz * r5.zxy + float3(1.0, 0.125, 0.125);
    ps = r9.z;
    ...
    ps = r11.w * ps;
    r9.xyz = r14.yxz * UniformVector_2.xzy;
    r5.w = ps;
    ps = r5.w;
    r10.yz = r13.xz * r13.yw;
    r6.xyz = r10.zzz * r12.xyz + ModShadowColor.xyz;
    ps = r5.z * ps;
    r5.w = r9.w * r9.z;
    r5.x = ps;
    r1.w = r5.x * r11.w + r5.w;
    ps = rsqrt(abs(r6.w));
    r1 = r1 + r10.xxxy;
    r5.x = ps;
    ps = rsqrt(abs(r1.w));
