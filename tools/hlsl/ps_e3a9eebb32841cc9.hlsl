...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.xw = r1.xy + UniformVector_1.xy;
    r7.z = ps;
    ...
    r0.yw = tex2D(ModShadowAccumTexture, r7.xy).xy;
    r8.xyz = tex2D(Texture2D_0, r6.xw).xyz;
