...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.x = ps;
    r2.yzw = r7.yzw * 2.0 - 1.0;
    ps = UniformScalar_0.x * r6.z;
    r5.x = saturate(r5.x * 5.0);
    r7.y = ps;
    ps = 1.0 - r5.x;
    r5.y = dot(r9.xzy, float3(1.0, 1.0, 1.0));
    r5.z = ps;
    ps = rsqrt(abs(r6.x));
    r10.xyz = r2.wyz * float3(0.7, 1.0, 1.0);
    r5.x = ps;
    ps = rsqrt(abs(r5.w));
    ...
    r1.z = ps;
    ps = log2(abs(r5.y));
    r6.x = dot(r3.zxy, r2.wyz);
    r2.x = ps;
    ps = rsqrt(abs(r0.w));
    r5 = r2 * float4(0.1, 1.0, 1.0, 0.7);
    r0.w = ps;
    ps = r6.x;
    r2.xyz = r5.yzw * r0.www;
    r1.x = ps;
    ps = 0.0;
    r5.w = saturate(dot(r2.zxy, r9.zxy));
    r1.w = ps;
    ps = max(r1.x, r1.w);
    r6.x = dot(r2.zxy, r3.zxy);
    r1.x = ps;
    ps = pow(2.0, r5.x);
    r10.xyz = r2.xzy * r6.xxx;
    r1.w = ps;
    ps = UniformScalar_0.x * r6.w;
    r1 = -r1 + float4(0.45, 1.0, 1.0, 1.0);
    r7.z = ps;
    r2.xy = r11.xy * r1.yz + 0.125;
    ps = r1.x;
    r6.xyz = r1.www * r6.yzw;
    r5.x = ps;
