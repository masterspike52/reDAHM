...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.x = ps;
    r2.xz = -r0.xx * ModShadowGroupColor.xy + 1.0;
    r3.yz = -r3.yz;
    r3.x = r3.x * 2.0 - r3.x;
    ps = log2(r0.z);
    r0.x = saturate(dot(r5.xyz, r3.yzx));
    r0.z = ps;
    ps = log2(r0.x);
    r2.y = r0.z * LightColorAndFalloffExponent.w;
    r4.x = ps;
    ps = pow(2.0, r2.y);
    r0.xzw = r4.xyz * float3(15.0, 0.875, 0.875);
    r2.y = ps;
    r0.zw = r0.zw * r2.xz + 0.125;
    ps = pow(2.0, r0.x);
