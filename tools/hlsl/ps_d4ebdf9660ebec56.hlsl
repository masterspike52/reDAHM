...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.xy = r4.xy * r1.xy + ScreenPositionScaleBias.wz;
    r5.xzw = tex2D(SceneColorTexture, r4.xy).xyz;
    r4.xy = tex2D(Texture2D_0, r0.xy).yx;
    r5.zw = r5.zw + UniformVector_0.yz;
    r4.w = UniformVector_0.x + r4.y;
    r5.x = r4.w + r5.x;
    r5.y = r4.x * 0.5 + r5.z;
    oC0.xyz = r4.zzz * r5.xyw;
