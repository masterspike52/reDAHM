// ps_26fa995220889847.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 135 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000021C 10040B00 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.z = -r5.z + 1.0;
    r5.y = ps;
    r7.xy = -r5.zz * ModShadowGroupColor.xy + 1.0;
    ps = rsqrt(abs(r6.w));
    ...
    r0.y = ps;
    ps = r0.z;
    r6.w = dot(r2.zxy, r5.wyz);
    ps = r1.z * ps;
    r3.xyz = r2.xzy * r6.www;
    r0.z = ps;
    r5.yzw = r3.xyz * 2.0 - r5.ywz;
    ps = 1.0 - r5.x;
    r5.z = saturate(dot(r0.zxy, r5.zyw));
    r5.y = saturate(ps);
    ps = log2(r5.z);
    r1.xyz = r11.xyz * r10.xyz;
    r9.z = ps;
    ps = log2(r5.y);
    r5.xzw = r9.xzy * float3(0.875, 15.0, 0.875);
    r5.y = ps;
    ps = pow(2.0, r5.z);
    r5.y = r5.y * LightColorAndFalloffExponent.w;
    r5.z = ps;
    r5.xw = r5.xw * r7.xy + 0.125;
    ps = r5.x * r5.w;
    r6.w = saturate(dot(r2.zxy, r0.zxy));
    r5.x = ps;
    ps = pow(2.0, r5.y);
