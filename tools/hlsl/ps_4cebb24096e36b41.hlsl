...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9.x = ps;
    ps = 4.0 * r4.z;
    r5.x = dot(r15.zxy, float3(1.0, 1.0, 1.0));
    r9.y = ps;
    ps = 1.0 - r5.x;
    r6.w = dot(r1.zxy, r1.zxy);
    r0.y = ps;
    ps = 1.0 - r5.w;
    r4.xyz = r11.xyz + r11.xyz;
    r5.x = ps;
    r11.zw = -r5.xx * ModShadowGroupColor.xy + 1.0;
    ps = UniformScalar_23.x * r0.y;
    r9.xyz = r9.yxz + float3(-2.0, -2.0, -1.0);
    r13.x = ps;
    ps = r9.x;
    r5.xyw = r0.yyy * r14.xyz;
    ps = -r0.w + ps;
    r12.yz = r9.yz - r0.xz;
    r4.w = ps;
    r4.xyz = r5.xyw * r4.xyz - r5.xyw;
    r11.y = r4.w * UniformScalar_0.x + r0.w;
    r9.xyz = r4.xyz * UniformScalar_0.xxx + r5.xyw;
    ps = rsqrt(abs(r6.w));
    r5.xyw = r12.yzw * UniformScalar_0.xxx;
    r1.w = ps;
    ...
    r0.z = r5.x * r0.y + 1.0;
    ps = 0.875 * r6.y;
    r1 = r0.xzyw * UniformVector_2.xzyy;
    r12.w = ps;
    ps = r1.z;
    r5.yw = r12.xy * r0.yz;
    ps = r11.y * ps;
    ...
    r1.zw = r6.xy * r6.wz;
    r6.x = saturate(ps);
    r5.xyz = r1.www * r10.xyz + ModShadowColor.xyz;
    ps = log2(r6.x);
