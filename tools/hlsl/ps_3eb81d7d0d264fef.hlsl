// ps_3eb81d7d0d264fef.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 96 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000180 10040800 00000806 00000000 00006908 00FF00FF 00000001 00003050 00003151 0000F252 0000F353 00007454 0000F555 00007656 0000F757
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.xyw = tex2D(LightAttenuationTexture, r1.xy).xyz;
    r1.xyz = -UniformVector_0.xyz + 1.0;
    r1.w = dot(r6.zxy, r6.zxy);
    r0.x = r4.z + 0.1;
    r2.z = rsqrt(abs(r2.z));
    r3.xyz = r2.xyw * LightColor.xyz;
    r0.x = saturate(5.0 * r0.x);
    r7.xyz = r2.zzz * r4.zxy;
    r1.w = rsqrt(abs(r1.w));
    r6.xyz = r1.www * r6.zxy;
    r0.x = 1.0 - r0.x;
