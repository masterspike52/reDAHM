...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.yz = tex2D(ModShadowAccumTexture, r2.zw).xy;
    r2.xyz = tex2D(LightAttenuationTexture, r2.xy).xyz;
    r0.x = tex2D(ShadowTexture, r0.xy).x;
    r4.w = -UniformVector_0.y + 1.0;
    ps = rsqrt(abs(r0.w));
    r0.y = r0.x * r0.x;
    r1.w = ps;
    r4.x = saturate(r1.w * r1.z);
    ps = 5.0 * r0.z;
    ...
    r0.zw = -r3.xy;
    r0.x = r3.z * 2.0 - r3.z;
    r0.x = saturate(dot(r6.xyz, r0.zwx));
    ps = log2(r0.x);
    r2.yzw = r0.yyy * r2.yzx;
    r5.x = ps;
    r0.xyz = r5.xyz * float3(15.0, 0.875, 0.875);
    r4.yz = r0.yz * r1.xy + 0.125;
    ps = pow(2.0, r0.x);
    r2.x = r2.w * 0.21952;
    r0.x = ps;
    ps = 0.21952 * r0.x;
    ...
    r0.yw = r4.yx * r4.zw;
    r1.y = ps;
    r0.xyz = r0.yyy * r3.xyz + ModShadowColor.xyz;
    r1.z = r0.w + r1.x;
    r1.xyz = r2.xzy * r1.yxz;
    r1.xyz = r1.xzy * LightColor.xyz;
