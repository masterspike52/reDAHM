// ps_31caaa7393553606.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 330 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000528 10041000 00000606 00000000 000050C6 003F003F 00000021 00003050 00003151 0000F254 0000F356 0000F457 0000F558
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.y = ps;
    r13.yz = r7.xy * 2.0 - 1.0;
    ps = rsqrt(abs(r0.z));
    r13.x = saturate(r0.w * 0.00022222222);
    r0.z = ps;
    ps = -r1.y;
    r10.xyz = r0.zzz * r4.xyz;
    ps = 1.0 + ps;
    r4.xyw = r13.yxz * float3(0.5, -0.025, 0.5);
    r0.z = ps;
    ps = UniformVector_2.y * r0.z;
    r14.zw = r10.xy * r4.yy;
    r14.y = ps;
    r0.zw = r14.xy - 0.5;
    r13.xy = float2((r14.xy >= 0.5));
    ps = r8.x;
    r0.zw = r0.zw - r14.xy;
    ps = abs(r6.x) * ps;
    r12.zw = r0.zw * r13.xy;
    ...
    r0.zw = r15.zw + r15.zw;
    r1.w = ps;
    r4.yz = tex2D(ModShadowAccumTexture, r1.zw).xy;
    r12.xyz = tex2D(Texture2D_5, r15.xy).xyz;
    r8.xyw = tex2D(Texture2D_4, r0.xy).xyz;
    r14 = tex2D(Texture2D_1, r0.zw);
    ...
    r13.zw = r15.yz * 2.0 - 1.0;
    r7.xyz = r0.wxy * 2.0 - 1.0;
    r1.yz = r1.yz * 2.0 - 1.0;
    ps = rsqrt(abs(r0.z));
    r15.x = r7.w * r1.x;
    r0.z = ps;
    ...
    ps = r3.w;
    r9.w = dot(r13.xyy, float3(1.0, 1.0, 1.0));
    r2.z = (r9.w == 0.0) ? r14.x : r14.y;
    ps = 0.0001 * ps;
    ...
    r1.xw = r15.xw - 1.0;
    r2.x = saturate(ps);
    r2.z = (r0.z == 0.0) ? r14.z : r2.z;
    r8.z = (r0.y == 0.0) ? r14.w : r2.z;
    r0.yz = -r2.yx + 1.0;
    ps = rsqrt(abs(r6.x));
    r14.x = r1.w * r0.y;
    r2.x = ps;
    r6.xyz = UniformVector_5.xyz * UniformVector_5.www;
    r2.yzw = -UniformVector_0.xyz + 1.0;
    r15.xyz = r2.yzw * AmbientColorAndSkyFactor.xyz;
    r6.yzw = r6.xyz * r11.xyz;
    r14.yzw = r8.wxy + r8.wxy;
    r11.xyz = r2.xxx * r5.xyz;
    ...
    r1.w = ps;
    ps = r8.w;
    r16.yzw = r6.yzw * r14.xxx;
    r0.x = ps;
    r6.yzw = r16.yzw * UniformScalar_3.xxx + UniformScalar_4.xxx;
    ps = 2.5 * r0.x;
    ...
    r13.x = ps;
    r5.xyz = r16.yzw * r1.www - r12.xyz;
    r1.w = saturate(r16.x * r1.w - 0.5);
    r12.xyz = r5.xyz * r1.www + r12.xyz;
    r5.xyz = r15.xyz * r12.xyz + UniformVector_0.xyz;
    r13.xyz = r13.xyy * r13.xzw;
    r4.xw = r14.zw + r13.yz;
    r6.yzw = r13.xxx * r6.yzw;
    r1.xy = r4.xw * UniformVector_4.xy + r1.xz;
    r6 = r6.xywz * r1.wwww;
    ps = (-2.0) + r6.x;
    r1.xy = r1.xy - r7.yz;
    r0.x = ps;
    r1.yz = r1.xy * r1.ww + r7.yz;
    r1.x = r0.w * 2.0 + r0.x;
