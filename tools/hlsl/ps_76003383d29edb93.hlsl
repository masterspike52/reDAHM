// ps_76003383d29edb93.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 291 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 0000048C 10041100 0000080A 00000000 00007108 003F00FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.z = ps;
    ps = r10.y * r10.w;
    r15.xyw = r12.yxz * float3(0.5, -0.025, 0.5);
    r6.y = ps;
    ps = r10.z * r10.w;
    r0.zw = r4.xy * r15.yy;
    r6.x = ps;
    ...
    r0.zw = r7.zw + r7.zw;
    r0.y = ps;
    r9.xyz = tex2D(Texture2D_4, r7.xy).xyz;
    r15.yz = tex2D(ModShadowAccumTexture, r10.xy).xy;
    r14 = tex2D(Texture2D_1, r0.zw);
    r13.xyz = tex2D(LightAttenuationTexture, r0.xy).xyz;
    r0.xyw = tex2D(Texture2D_0, r7.xy).xyz;
    r10.xyz = tex2D(Texture2D_3, r1.xy).xyz;
    r8.xzw = tex2D(Texture2D_2, r1.wz).wxy;
    r17.xyz = tex2D(Texture2D_6, r1.xy).xyz;
    ...
    r12.z = ps;
    r5.xyz = r17.xyz * UniformScalar_1.xxx + UniformScalar_2.xxx;
    r8.x = r6.w * r8.x - 1.0;
    ps = rsqrt(abs(r6.y));
    r16.yz = r8.zw + r8.zw;
    r6.y = ps;
    ...
    ps = r2.z;
    r16.x = dot(r16.xww, float3(1.0, 1.0, 1.0));
    r6.z = (r16.x == 0.0) ? r14.x : r14.y;
    ps = 0.1 + ps;
    r2 = r16.xyxz + float4(-3.0, -1.0, -2.0, -1.0);
    r6.x = ps;
    ps = 5.0 * r6.x;
    r14.xy = r2.yw + r15.xw;
    r2.y = saturate(ps);
    r6.x = (r2.z == 0.0) ? r14.z : r6.z;
