// ps_b1afc809b26f158c.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 348 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000570 10041300 0000080A 00000000 00008108 003F00FF 00000021 0000F050 0000F153 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r14.xy = r0.wz * UniformVector_1.xy;
    r9.z = ps;
    ...
    ps = rsqrt(abs(r6.x));
    r10.x = saturate(r6.y * 0.00022222222);
    r6.x = ps;
    ps = -r0.z;
    r11.xyz = r6.xxx * r4.xyz;
    ps = 1.0 + ps;
    r12.xyw = r10.yxz * float3(0.5, -0.025, 0.5);
    r6.x = ps;
    ps = UniformVector_2.y * r6.x;
    r15.zw = r11.xy * r12.yy;
    r15.y = ps;
    ps = r0.z;
    r4.xy = r15.xy - 0.5;
    ps = UniformVector_6.y * ps;
    r6.xy = float2((r15.xy >= 0.5));
    r9.w = ps;
    ps = r9.x;
    r4.xy = r4.xy - r15.xy;
    ps = abs(r8.x) * ps;
    ...
    r9.xy = r4.zw + r4.zw;
    r10.y = ps;
    r12.yz = tex2D(ModShadowAccumTexture, r10.xy).xy;
    r16.xyz = tex2D(Texture2D_5, r4.xy).xyz;
    r19.xyz = tex2D(Texture2D_7, r9.zw).xyz;
    r15.yzw = tex2D(Texture2D_4, r0.xy).xyz;
    r8 = tex2D(Texture2D_1, r9.xy);
    r10.xyz = tex2D(Texture2D_2, r0.wz).xyw;
    r7.xyw = tex2D(Texture2D_0, r4.xy).xyz;
    r18.yzw = tex2D(Texture2D_3, r6.zw).xyw;
    r0.xyz = tex2D(Texture2D_8, r0.xy).xyz;
    r6.w = dot(r5.zxy, r5.zxy);
    r6.z = dot(r2.zxy, r2.zxy);
    r4.yzw = r0.xyz * UniformScalar_5.xxx + UniformScalar_6.xxx;
    r14.zw = r18.yz * 2.0 - 1.0;
    r9.xyz = r7.wxy * 2.0 - 1.0;
    r17.xy = r10.xy * 2.0 - 1.0;
    ps = rsqrt(abs(r6.z));
    r18.x = r7.z * r10.z;
    r6.z = ps;
    ...
    r18.xw = r18.xw - 1.0;
    r0.x = saturate(ps);
    r7.z = (r6.z == 0.0) ? r8.z : r7.z;
    r17.z = (r6.y == 0.0) ? r8.w : r7.z;
    r6.yz = -r0.yx + 1.0;
    ps = rsqrt(abs(r6.w));
    r15.x = r18.w * r6.y;
    r6.x = ps;
    ...
    r15.yzw = r15.wyz + r15.wyz;
    r2.xyz = r2.xyz * r13.xyz;
    r13.xyz = r6.xxx * r5.xyz;
    r2.yzw = r2.xyz * r19.xyz;
    ...
    r14.y = ps;
    ps = 3.3333333 * r6.x;
    r18.yz = r17.xy + r12.xw;
    r6.x = ps;
    ps = ModShadowGroupColor.x * r6.z;
    r7.xyz = r6.xxx * r18.yxz;
    r17.x = ps;
    ps = ModShadowGroupColor.y * r6.z;
    r15 = r15 + float4(1.0, -1.0, -1.0, -1.0);
    r17.y = ps;
    r4.x = r15.y * UniformVector_4.z - r9.x;
    ps = 1.0 + r7.y;
    r5 = -r17.wxyz + 1.0;
    r0.w = ps;
    ps = r5.w;
    ...
    r6.x = ps;
    ps = 2.5 * r6.x;
    r2.x = abs(r0.w) * abs(r0.w);
    r17.x = ps;
    ps = r2.x * r2.x;
    r17.yzw = r2.yzw * r15.xxx;
    r14.x = ps;
    r2.xyz = r17.yzw * r0.www - r16.xyz;
    r6.x = saturate(r17.x * r0.w - 0.5);
    r2.xyz = r2.xyz * r6.xxx + r16.xyz;
    r8.xyz = r8.xyz * r2.xyz + UniformVector_0.xyz;
    r14.xyz = r14.xyy * r14.xzw;
    r12.xw = r15.zw + r14.yz;
    r4.yzw = r14.xxx * r4.yzw;
