// vs_45ec0e8ba873210a.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 444 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000040 000006F0 0021000D 00000000 00000000 00002463 00000001 00000007 00000003 00000290 00100012 00006013 00007014 00003015 00002016 00001017 00205018 00003050 0001F156 00027257 00001092 00001091 00001090
...
//   vertex element: instruction 24 -> TEXCOORD0
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r3.w = dot(r4.zxyw, r13);
    r4.x = dot(r11.zxyw, r13);
    p0 = (r2.w != 0.0);
    r0.x = dot(r9.zxyw, r0);
