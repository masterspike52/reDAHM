// ps_6aeae7bec0fbdd96.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 78 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000138 10040800 00000806 00000000 00007108 00FF00FF 00000021 00003050 00003151 0000F252 0000F353 0000F454 0000F556 0000F657 0000F758
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.w = tex2D(Texture2D_0, r0.xy).w;
    r1.xyz = r3.xyz * 0.003 + UniformVector_0.xyz;
    ps = rsqrt(abs(r0.z));
    r6.xy = r6.xy * 0.875;
    r0.x = ps;
    r0.x = r0.x * r4.z + 0.1;
    ...
    r0.yz = r0.xx * ModShadowGroupColor.xy;
    r0.x = saturate(ps);
    r0.xyz = -r0.yzx + 1.0;
    ps = r0.w;
    r0.xy = r6.xy * r0.xy;
