...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.z = ps;
    ps = -SpotAngles.x - -r4.z;
    r0.xyz = r4.www * r0.zxy;
    r4.x = ps;
    ps = SpotAngles.y * r4.x;
    r4.z = saturate(dot(r0.yzx, r8.yzx));
    r0.x = saturate(ps);
    ps = log2(r4.z);
    r0.y = r0.x * r0.x;
    r7.x = ps;
    ps = LightColorAndFalloffExponent.w * r4.y;
    r1.xyz = r7.xyz * float3(15.0, 0.875, 0.875);
    r4.w = ps;
    r4.xy = r1.yz * r2.xy + 0.125;
    ps = pow(2.0, r1.x);
    r4.x = r4.x * r4.y;
    r3.w = ps;
    r4.xyz = r4.xxx * r6.xyz + ModShadowColor.xyz;
    ps = r5.w;
    r1 = r3.yzww * float4(0.5, 0.1, 0.3, 0.6);
    ps = r3.x * ps;
    r2.yz = r1.xy * r5.ww;
    r2.x = ps;
    ps = pow(2.0, r4.w);
    r1.xyz = r2.xyz + r1.zwz;
    r4.w = ps;
