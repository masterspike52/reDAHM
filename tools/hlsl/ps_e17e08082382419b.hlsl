// ps_e17e08082382419b.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 150 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000258 10040B00 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = r1.y * ps;
    r2.xyz = r0.yzw * TwoSidedSign.xxx;
    r0.y = ps;
    ps = r5.w;
    r5.z = dot(r2.zxy, r10.zxy);
    ps = r1.z * ps;
    r11.xyz = r2.xzy * r5.zzz;
    r0.z = ps;
    r1.xyz = r11.xyz * 2.0 - r10.xzy;
