// ps_06a48ea0805c61e8.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 90 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000168 10040700 0000060A 00000000 000058C6 000F003F 00000001 00007054 0000F155 00007256 0000F357 0000F4A0 0000F5A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.z = log2(r4.x);
    r3.xyz = r3.xyz * float3(0.875, 0.875, 15.0);
    r5.x = saturate(r5.x * r0.z);
    r4.x = pow(2.0, r3.z);
    r0.xy = r3.xy * r2.xy + 0.125;
