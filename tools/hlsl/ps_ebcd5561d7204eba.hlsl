// ps_ebcd5561d7204eba.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 345 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000564 10041200 0000080A 00000000 00008108 003F00FF 00000021 0000F050 0000F153 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9.y = ps;
    r12.yz = r7.xy * 2.0 - 1.0;
    ps = rsqrt(abs(r6.x));
    r12.x = saturate(r6.y * 0.00022222222);
    r6.x = ps;
    ps = -r0.z;
    r11.xyz = r6.xxx * r4.xyz;
    ps = 1.0 + ps;
    r12.xyw = r12.yxz * float3(0.5, -0.025, 0.5);
    r6.x = ps;
    ps = UniformVector_2.y * r6.x;
    r13.zw = r11.xy * r12.yy;
    r13.y = ps;
    r4.xy = r13.xy - 0.5;
    ...
    r4.yzw = r0.xyz * UniformScalar_3.xxx + UniformScalar_4.xxx;
    ...
    r2.yzw = r2.xyz * r15.yzw;
    r15.yzw = r13.zxy + r13.zxy;
