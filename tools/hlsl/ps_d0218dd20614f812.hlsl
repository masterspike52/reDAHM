...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.x = max(UniformScalar_0.x, 0.0001);
    r5.x = ps;
    ...
    r1.z = ps;
    r6.yw = r6.yz * r5.xw + 0.125;
    ps = 1.0 - r5.y;
    r6.z = saturate(dot(r9.yzx, r1.yzx));
    r5.w = saturate(ps);
    ...
    ps = log2(r6.z);
    r6.y = saturate(r6.y * SpotAngles.y);
    r6.z = ps;
    ps = log2(r5.w);
    r6.xy = r6.xy * r6.zy;
    r5.w = ps;
