// ps_88b4a1e716d28d34.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 84 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000150 10000600 00000004 00000000 00005CE7 007F007F 00000001 00003050 00003151 0000F252 0000F353 0000F455 00007556 0000F657
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.zw = r0.ww * r5.yx;
    r0.zw = r1.wz * r0.zz + r0.xy;
    r1.w = tex2D(Texture2D_3, r0.zw).x;
    r2.xyz = tex2D(Texture2D_2, r0.zw).xyz;
    r0.yzw = tex2D(Texture2D_0, r0.xy).xyz;
    r0.x = tex2D(SceneDepthTexture, r1.yx).x;
    r1.xyz = r3.xyz * 1e+01;
    r0.x = r0.x * MinZ_MaxZRatio.z - MinZ_MaxZRatio.w;
    r0.yzw = r2.xyz + r0.yzw;
    r1.xyz = r1.xyz * r0.yzw + UniformVector_0.xyz;
    ps = 1.0 / r0.x;
    r0.z = r1.w * r3.w;
    r0.x = ps;
    r0.y = r0.x - r4.w;
    ps = 0.02 * r0.y;
    r1.w = r6.w * SCENE_COLOR_BIAS_FACTOR.x;
    r0.w = saturate(ps);
