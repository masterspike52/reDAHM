// ps_c1aa42ff7a1e7271.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 198 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000318 10040D00 00000606 00000000 000048C6 003F003F 00000001 00003050 00003151 00007254 0000F355 00007456 0000F557
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r10.z = ps;
    r5.xy = r10.xy * r12.xx + ScreenPositionScaleBias.wz;
    ...
    r11.z = ps;
    r12.z = r13.z * 2.0 - 1.0;
    r6.xw = r13.xy * 2.0 - 1.0;
    ps = rsqrt(abs(r2.w));
    r0.w = saturate(-r0.w + 1.0);
    r2.w = ps;
    r3.xyz = r11.xzy * UniformVector_5.xzy - r11.xzy;
    r3.yzw = r3.xyz * r9.xxx + r11.xzy;
    ps = rsqrt(abs(r1.w));
    r11.xyz = r2.www * r2.xyz;
    r1.w = ps;
    r2.xyz = r1.www * r4.xyz;
    r12.xy = r10.zz * r12.yw + r6.xw;
    r4.xyz = r12.xyz * UniformVector_2.xyz;
    ps = log2(r0.w);
    r1.w = dot(r4.zxy, r4.zxy);
    r0.w = ps;
    ps = rsqrt(abs(r1.w));
    ...
    r1.w = dot(r4.zxy, r2.zxy);
    ps = -UniformVector_0.x;
    r12.xyz = r4.xzy * r1.www;
    r2.xyz = r12.xyz * 2.0 - r2.xzy;
    ps = 1.0 + ps;
    r2.y = saturate(dot(r11.zxy, r2.yxz));
    r2.x = ps;
    ps = log2(r2.y);
    r1.w = saturate(dot(r4.zxy, r11.zxy));
    r6.x = ps;
    ps = (-1.0) + r7.x;
    r6.yzw = r6.xyz * float3(15.0, 0.875, 0.875);
    r6.x = ps;
    r1.xyz = r6.xzw * r1.yxz + float3(1.0, 0.125, 0.125);
    r1.x = (r10.z > 0.0) ? r1.x : 1.0;
    ps = -UniformVector_0.y;
    r1.y = r1.y * r1.z;
    r0.xyz = r1.yyy * r0.xyz + ModShadowColor.xyz;
    r3.x = (r10.z >= 0.0) ? r1.x : 1.0;
    ps = 1.0 + ps;
    r1.xyz = r3.xwz * r9.xyz;
    r2.y = ps;
    ps = -UniformVector_0.z;
    r1.xyz = r1.xyz * r3.yxx;
    ps = 1.0 + ps;
    r3.xyz = r1.xyz * UniformScalar_5.xxx;
    r2.z = ps;
