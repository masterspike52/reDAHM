// ps_08b46cb7165c8ff6.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 309 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004D4 10041100 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r13.y = ps;
    ps = r5.w + r5.w;
    r13.x = dot(r11.xww, float3(1.0, 1.0, 1.0));
    r13.z = ps;
    r6.w = (r13.x == 0.0) ? r14.x : r14.y;
    r13 = r13.xxyz + float4(-3.0, -2.0, -1.0, -1.0);
    ps = r13.z;
    r7.xyw = r7.xyz * UniformVector_4.xyz;
    r6.w = (r13.y == 0.0) ? r14.z : r6.w;
    r9.z = (r13.x == 0.0) ? r14.w : r6.w;
    ps = r9.x + ps;
    r6.w = max(r9.z, 0.0);
    r9.x = ps;
    ps = r13.w;
    ...
    r9.y = ps;
    r9.xy = r14.yy * r9.xy + r7.xy;
    ps = 1.0 / r4.w;
    r12.zw = r9.xy - r6.xz;
    r6.w = ps;
    r9.xy = r12.xy * r6.ww + ScreenPositionScaleBias.wz;
    r11.xyz = tex2D(Texture2D_4, r10.zw).xyz;
    r13.xyz = tex2D(Texture2D_6, r10.xy).xyz;
    r17.xyz = tex2D(LightAttenuationTexture, r9.xy).xyz;
    ...
    r5.y = r1.z + 0.1;
    r16.z = ps;
    r7.xyz = r0.xyz * UniformScalar_3.xxx + UniformScalar_4.xxx;
    r9.x = r5.z * r5.x - 1.0;
    ps = 5.0 * r5.y;
