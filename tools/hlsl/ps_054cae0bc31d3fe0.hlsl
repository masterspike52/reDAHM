...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.xyz = UniformVector_0.xyz + float3(0.2, 0.5, 1e+01);
    r5.x = ps;
    ps = 1.0 / ModShadowAccumResolution.y;
    r8.xyw = AmbientColorAndSkyFactor.xyz * 0.21952;
    r5.y = ps;
    ...
    r5.x = ps;
    ps = 5.0 * r5.x;
    r6.w = saturate(dot(r5.zwy, r8.ywx));
    r5.x = saturate(ps);
    ps = -ModShadowColor.x;
    r5.x = -r5.x + 1.0;
    ps = 1.0 + ps;
