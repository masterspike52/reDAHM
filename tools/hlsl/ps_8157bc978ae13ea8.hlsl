...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = log2(r3.w);
    r0.xyw = r0.xxx * r3.xzy;
    r5.x = ps;
    ps = -r0.x;
    r3.xyz = r12.xyz * r2.www;
    r2.y = ps;
    r2.x = r0.y * 2.0 - r0.y;
    ...
    r7.xy = r7.xy * r5.xy + 0.125;
    ps = pow(2.0, r0.z);
    r5.xyw = -r6.xyz + r10.xyz;
    r0.z = ps;
    ps = -r0.w;
    r0.xyz = r3.xzy * r0.zzz;
    r2.z = ps;
    ps = 1.0 - r5.z;
    r0.w = saturate(dot(r1.yzx, r2.yzx));
    r9.w = ps;
    r1.xyz = r5.xyw * UniformScalar_1.xxx + r6.xyz;
    r6.xyz = r1.xyz * UniformScalar_2.xxx + UniformScalar_3.xxx;
    ps = log2(r0.w);
    r5 = r9.xzwy * r1.xzzy;
    r7.w = ps;
    r1.xy = r9.ww * r1.xy + r5.xw;
    ps = r5.y + r5.z;
    r5.xw = r7.xz * r7.yw;
    r1.z = ps;
