...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.z = ps;
    ps = rsqrt(abs(r0.w));
    r1.xyz = r7.xyz * AmbientColorAndSkyFactor.xyz;
    r0.w = ps;
    r8.xyz = r1.xyz * r0.xyz + UniformVector_0.xyz;
    ps = rsqrt(abs(r6.w));
    r10.xyw = r0.www * r2.xyz;
    r6.w = ps;
    ps = 0.875 * r6.y;
    ...
    r6.x = ps;
    ps = log2(r6.y);
    r10.xy = r0.ww * ModShadowGroupColor.xy;
    r6.y = ps;
    ps = 15.0 * r6.y;
