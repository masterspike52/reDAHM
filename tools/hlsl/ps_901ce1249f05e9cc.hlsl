// ps_901ce1249f05e9cc.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 93 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000174 10040600 00000606 00000000 000050C6 003F003F 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.yz = r0.yz * r5.xy + ScreenPositionScaleBias.wz;
    ...
    r6.xyz = r1.zzz * r2.zxy;
    r1.w = rsqrt(abs(r1.w));
    r3.xyz = r1.www * r4.zxy;
    r0.x = 1.0 - r0.x;
    r5.xy = -r0.xx * ModShadowGroupColor.xy + 1.0;
    r3.yz = -r3.yz;
    r3.x = r3.x * 2.0 - r3.x;
    r0.x = saturate(dot(r6.yzx, r3.yzx));
    r3.xy = r0.yz * LightColor.xy;
    r0.x = log2(r0.x);
    r0.x = 15.0 * r0.x;
    r2.w = saturate(r1.z * r2.z);
    r1.z = pow(2.0, r0.x);
    r2.xyz = r1.xyz * float3(0.875, 0.875, 0.21952);
    r0.x = r2.z * r0.w;
    ps = LightColor.z * r0.x;
    r0.yzw = -ModShadowColor.xyz + 1.0;
    r1.z = ps;
    r1.xy = r2.ww * r5.zw + r2.zz;
    r2.xy = r2.xy * r5.xy + 0.125;
    ps = r2.x * r2.y;
    r1.xy = r3.xy * r1.xy;
    r0.x = ps;
