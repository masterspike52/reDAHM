// vs_2893610815e2015f.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 1134 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000080 000011B8 0091000F 00000000 00000000 0000914A 00000001 00000008 0000000A 00000290 0010002C 0000602D 0000702E 0000302F 00005030 00015031 00025032 0020A033 00003050 0001F151 0002F252 00037354 0004F455 00057556 0006F657 0007F7A0 0008F8A1 0009F9A2 0000116F 00001176 00001177 00001171 00001172 00001173 00001178 00001174 00001170 00001175
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r0 = r13.wwww * LocalToWorld[3].xwzy;
    ps = 0.003921569 * r1.w;
    r14.xyz = r6.yxz * 0.003921569;
    r15.x = ps;
    ...
    r0 = r13.zzzz * LocalToWorld[2].xwzy + r0;
    r8.xyz = r11.yxz * 0.007843138 - 1.0;
    r5.xyz = r6.xzy * 0.007843138 - 1.0;
    ps = 0.003921569 * r1.y;
    r3.xyz = r8.xxz * r5.xzz;
    r15.y = ps;
    r0 = r13.yyyy * LocalToWorld[1].xzyw + r0.xzwy;
    r0 = r13.xxxx * LocalToWorld[0].zyxw + r0.yzxw;
    ...
    r4 = r13.wwww * LocalToWorld[3].xzyw;
    ps = 0.003921569 * r1.w;
    r14.xyz = r6.yxz * 0.003921569;
    r15.x = ps;
    r10.xy = r8.zw * ShadowCoordinateScaleBias.xy + ShadowCoordinateScaleBias.wz;
    ...
    r12.xyz = r11.yxz * 0.007843138 - 1.0;
    r5.xyz = r6.xzy * 0.007843138 - 1.0;
    ps = 0.003921569 * r1.y;
    r4.xyz = r12.xxz * r5.xzz;
    r15.y = ps;
    r0 = r8.yyyy * LocalToWorld[1].xzyw + r0;
    r0 = r8.xxxx * LocalToWorld[0].zyxw + r0.yzxw;
    r4.xyz = r12.zyy * r5.yyx - r4.xyz;
    ps = 0.003921569 * r1.x;
    ...
    r11.xyz = -r0.zyx + LightPositionAndInvRadius.xyz;
    r8.xyz = r11.zzz * WorldToLocal[2].xzy;
    ...
    r0.xyz = r11.yyy * WorldToLocal[1].xzy + r8.xyz;
    r0.xyz = r11.xxx * WorldToLocal[0].xyz + r0.xzy;
    ...
    r0 = r13.zzzz * LocalToWorld[2].xwzy + r0;
    r0 = r13.yyyy * LocalToWorld[1].xzyw + r0.xzwy;
    r0 = r13.xxxx * LocalToWorld[0].xywz + r0.xzwy;
    // UNHANDLED control flow: cjmp
    ps = 1.0 / BBox_Size.x;
    ...
    r12.x = ps;
    r6.xy = r0.zx * BBox_Size.yx - r3.zx;
    r3.z = dot(r6.yx, r6.yx) + 0.0;
    ps = -r3.x * -r3.x;
    r12.zw = r3.yw * r3.yw;
    r12.y = ps;
    ps = 1.0 / r0.y;
    ...
    r1.yw = r3.yx + r3.wx;
    // UNHANDLED control flow: cjmp
    r3.x = saturate(r1.w * r7.w);
    r1.w = float((r5.w > r1.y));
    ps = sqrt(abs(r5.w));
    r0.y = float((Collapse_Endcaps.x >= 2.0));
    r1.y = ps;
    p0 = (r0.y != 0.0);
    ...
    r1 = r13.wwww * LocalToWorld[3].xwzy;
    ...
    o8.w = 0.0;
    o3.xyz = r8.xyz;
    o4.xyz = r11.xyz * LightPositionAndInvRadius.www;
    o4.w = 0.0;
    o5.xyz = r5.xyz;
    o7 = r14;
    o9 = r2.xzyw;
