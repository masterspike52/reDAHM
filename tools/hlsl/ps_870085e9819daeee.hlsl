...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.y = saturate(ps);
    r10.xyz = (-abs(r2.www) >= 0.0) ? r11.xyz : r9.xyz;
    ps = 1.0 - r5.y;
    ...
    r3.y = ps;
    r3.x = r3.x * 2.0 - r3.x;
    r1.xyz = (-abs(r6.xxx) >= 0.0) ? r11.xyz : r10.xyz;
    r5.yz = -r5.yy * ModShadowGroupColor.xy + 1.0;
    r7.xy = r7.xy * r5.yz + 0.125;
    ps = -r3.z;
    r1.xyz = -r6.yzw + r1.xyz;
    r3.z = ps;
    ps = 1.0 - r5.x;
    r6.x = saturate(dot(r9.yzx, r3.yzx));
    r8.w = ps;
    r5.xyz = r1.xyz * UniformScalar_1.xxx + r6.yzw;
    r6.yzw = r5.xyz * UniformScalar_2.xxx + UniformScalar_3.xxx;
    ps = log2(r6.x);
    r1 = r8.xzwy * r5.xzzy;
    r7.w = ps;
    r3.xy = r8.ww * r5.xy + r1.xw;
    ps = r1.y + r1.z;
    r1.xw = r7.xz * r7.yw;
    r3.z = ps;
