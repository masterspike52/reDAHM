...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = r3.w;
    r6.xy = r1.wz * UniformVector_1.xy;
    ps = (-4e+02) + ps;
    ...
    r22.w = (-abs(r0.z) >= 0.0) ? (-1.0) : r7.x;
    r17.xyz = r6.xxx * r2.xyz;
    ps = 1.0 / UniformVector_1.y;
    r6.x = r17.z + 0.1;
    r7.x = ps;
    ps = 5.0 * r6.x;
    r4.xyz = r6.zyw + r6.zyw;
    r2.x = saturate(ps);
    ...
    r14 = tex2D(Texture2D_1, r4.xy);
    r6.xyw = tex2D(Texture2D_2, r1.wz).wxy;
    ps = r1.y;
    ...
    r12.x = ps;
    r2.z = r12.w * 2.0 + r22.y;
    ps = r2.x;
    r2.y = dot(r12.yzz, float3(1.0, 1.0, 1.0));
    r2.x = (r2.y == 0.0) ? r14.x : r14.y;
    ps = r9.y + ps;
    r12.yz = r7.xw * r22.wx;
    r7.x = ps;
    ps = r2.w;
    r21 = r2.yyzz + float4(-3.0, -2.0, -2.0, -3.0);
    r7.y = (r21.y == 0.0) ? r14.z : r2.x;
    ...
    r18.z = ps;
    ps = floor(r12.y);
    r19.xyz = r13.xzw * float3(3.3333333, 0.875, 0.875);
    r18.w = ps;
    r7.xy = r19.xx * r7.xy + r8.xy;
    ps = 1.0 / UniformScalar_1.x;
    r18.xy = r7.xy - r15.yz;
    r7.x = ps;
    r13.xz = r18.zw * r7.xx + r1.xx;
    r8.xyz = tex2D(Texture2D_6, r11.xy).xyz;
    r20 = tex2D(Texture2D_1, r4.zw);
    r4.xyz = tex2D(LightMapTexture, r0.xy).xyz;
    r11.xyz = tex2D(Texture2D_7, r0.zw).xyz;
    r1 = tex2D(Texture2D_5, r13.xy);
    ...
    r6.y = ps;
    r1.xyz = r1.xyz * r13.xyz + UniformScalar_13.xxx;
    ps = (-1.0) - -r6.y;
    r7.yw = r23.ww * ModShadowGroupColor.yx;
    r2.x = ps;
    r0.w = (r2.z == 0.0) ? r20.x : r20.y;
    ps = 1.0 - r7.x;
    r6.xw = -r22.xz + 1.0;
    r2.w = ps;
    ps = 1.0 - r7.y;
    ...
    r6.x = ps;
    r7.yzw = r19.xyz * r2.xzy + float3(1.0, 0.125, 0.125);
    r0.w = saturate(r6.x * r7.y - 0.5);
    ps = -r15.x;
    r7.xy = r7.yz * r7.xw;
