// ps_947dc40e86794015.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 69 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000114 10000400 00000004 00000000 000040A5 001F001F 00000021 00003050 00003151 0000F252 0000F353 0000F456
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1 = r0.xyyx * float4(3.0, 3.0, 4.0, 4.0);
    r0.xy = r1.wz + UniformVector_2.xy;
    r1.w = tex2D(Texture2D_1, r0.xy).w;
    r2.x = tex2D(Texture2D_2, r1.xy).x;
    r0.x = tex2D(Texture2D_0, r0.zw).w;
    ps = 4.0 - r0.x;
    r1.yz = r4.xy * IndividualVelocityScale.xy;
    r1.x = ps;
    ps = r2.x;
    r0.yzw = r1.xyz * r1.wyz;
    ps = r3.w * ps;
    r0.xy = r0.yz + r0.xw;
    r0.z = ps;
    r0.x = r0.z * r0.x - 0.5;
