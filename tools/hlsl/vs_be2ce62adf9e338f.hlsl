// vs_be2ce62adf9e338f.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 597 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000040 00000954 00410010 00000000 00000000 000044A5 00000001 00000008 00000005 00000290 00100017 00006018 00003019 0020201A 0010101C 0000501D 0006501E 0027501F 00003050 0001F155 00027256 0003F3A0 0004F4A1 000010C1 000010C5 000010C3 000010C4 000010C2
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r2.x = ps;
    ps = r1.w;
    r15.xyz = r4.zyx * r2.xxx;
    r1.w = ps;
    p0 = (r1.y != 0.0);
    ps = p0 ? 0.0 : 1.0;
    r2.xyz = r13.zxy * r15.yzx;
    r4.xyz = r13.yzx * r15.zxy - r2.xyz;
    ...
    r12.x = dot(r15.zxy, r0.wxy);
    r12.z = dot(r15.zxy, r3.zxy);
    ps = r9.x;
    r16.x = dot(r4.zxy, r3.zxy);
    ps = r7.x + ps;
    r16.y = dot(r4.zxy, r5.zxy);
    r11.x = ps;
    ps = r9.y;
    r16.z = dot(r4.zxy, r0.wxy);
    ps = r7.y + ps;
    ...
    r11.w = r10.y * BoneMatrices[a0 + 2].w + r11.w;
    // UNHANDLED control flow: cjmp
    ps = 3.0 * r0.z;
    r2.y = ps;
    a0 = xe_mova(r2.y);
    ...
    r11.w = r10.z * BoneMatrices[a0 + 2].w + r11.w;
    if (p0)
    {
        if (p0)
        {
            ...
            r11.w = r10.w * BoneMatrices[a0 + 2].w + r11.w;
        }
    }
    ...
    r0.y = dot(r14.zxyw, r16);
    r3 = r0.wwww * LocalToWorld[2] + LocalToWorld[3];
    r3 = r0.yyyy * LocalToWorld[1].xzyw + r3.xzyw;
    r14 = r0.xxxx * LocalToWorld[0].xywz + r3.xzwy;
    r0.xyw = -r14.yxw * CameraPosition.www + CameraPosition.yxz;
    p0 = (r1.y != 0.0);
    ps = p0 ? 0.0 : 1.0;
    r3 = r14.zzzz * ViewProjectionMatrix[3].xwzy;
    r3 = r14.wwww * ViewProjectionMatrix[2].xwzy + r3;
    r3 = r14.yyyy * ViewProjectionMatrix[1].xzyw + r3.xzwy;
    r3 = r14.xxxx * ViewProjectionMatrix[0] + r3.xzyw;
    // UNHANDLED control flow: cjmp
    ps = 3.0 * r1.x;
    r2.w = ps;
    a0 = xe_mova(r2.w);
    ...
    r8.z = dot(r13.zxy, r2.zxy);
    r8.w = dot(r13.zxy, r12.zxy);
    r14.x = dot(r4.zxy, r2.zxy);
    r14.y = dot(r4.zxy, r11.zxy);
    r14.z = dot(r4.zxy, r12.zxy);
    ...
    r4.xyz = r0.yyy * WorldToLocal[0].xyz + r2.xzy;
    r2.xy = r14.zw * r4.yz;
    r2.w = dot(r14.yx, r4.zx) + 0.0;
    r0.xy = r8.zw * r4.xy;
    ps = r0.x + r0.y;
    r4.x = dot(r13.zxy, r4.zxy);
    r2.z = ps;
    r4.yz = r2.xz + r2.wy;
    ps = 3.0 * r1.z;
    r1.y = float((MaxBoneInfluences.x > 1.0));
    ...
    r7 = r10.yyyy * BoneMatrices[a0 + 1] + r7;
    r0.xyw = r10.yyy * BoneMatrices[a0 + 2].xyz + r0.xyw;
    ...
    r7 = r10.zzzz * BoneMatrices[a0 + 1] + r7;
    r0.xyw = r10.zzz * BoneMatrices[a0 + 2].xyz + r0.xyw;
    ...
    r7 = r10.wwww * BoneMatrices[a0 + 1] + r7;
    r0.xyw = r10.www * BoneMatrices[a0 + 2].xyz + r0.xyw;
