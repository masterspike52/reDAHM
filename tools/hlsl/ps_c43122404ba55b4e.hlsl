// ps_c43122404ba55b4e.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 18 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000048 10000200 00000004 00000000 00002463 00070007 00000021 00003050 0000F156 00007257
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.y = tex2D(Texture2D_1, r0.xy).w;
    r0.x = (-0.5) + r0.y;
