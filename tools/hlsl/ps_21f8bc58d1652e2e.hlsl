// ps_21f8bc58d1652e2e.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 132 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000210 10040A00 00000506 00000000 000040A5 001F001F 00000001 00003050 00007154 0000F255 00007356 0000F457
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.y = -r0.y + 1.0;
    r0.x = ps;
    r3.xy = -r0.yy * ModShadowGroupColor.xy + 1.0;
    ps = rsqrt(abs(r0.z));
    r0.y = dot(r10.zxy, r2.zxy);
    r0.z = ps;
    r2.xyz = r9.xyz * r0.zzz;
    r0.z = dot(r2.zxy, r8.zxy);
    r9.xyz = r2.xzy * r0.zzz;
    r8.xyz = r9.xyz * 2.0 - r8.xzy;
    ps = -SpotAngles.x - -r0.y;
    r0.z = saturate(dot(r1.zxy, r8.yxz));
    r0.y = ps;
    ps = log2(r0.z);
    ...
    r0.x = ps;
    ps = pow(2.0, r0.z);
    r0.y = saturate(dot(r2.zxy, r1.zxy));
    r7.z = ps;
    ps = pow(2.0, r0.x);
    r2.xyz = r7.xyz * float3(0.875, 0.875, 0.21952);
    r0.x = ps;
    r1.xyz = r6.xyz * r0.yyy + r2.zzz;
    r0.yz = r2.xy * r3.xy + 0.125;
    ps = r0.y * r0.z;
