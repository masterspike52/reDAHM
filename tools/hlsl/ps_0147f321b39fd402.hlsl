// ps_0147f321b39fd402.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 54 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000000D8 10000500 00000004 00000000 00004CC6 003F003F 00000001 00003050 00003151 0000F252 0000F353 0000F455 00007556
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.zw = UniformVector_2.yx - 0.5;
    r0.xz = r0.zw + r0.yx;
    r0.y = dot(r0.xz, UniformVector_4.yx) + 0.5;
    r0.x = dot(r0.xz, UniformVector_3.yx) + 0.5;
    r0.zw = tex2D(Texture2D_1, r0.xy).xy;
    r0.xy = tex2D(Texture2D_1, r1.xy).xy;
    r0.xy = r0.zw + r0.xy;
    r0.xy = r0.xy * 4.0;
