...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.xy = tex2D(ModShadowAccumTexture, r6.xz).xy;
    ...
    r10.xy = r1.xy * 0.875;
    r6.w = saturate(ps);
    r3.yzw = r0.xyw * 2.0 - 1.0;
    ps = rsqrt(abs(r6.z));
    r1.xyz = r11.xyz * r7.xyz;
    r6.z = ps;
    ps = rsqrt(abs(r6.y));
    r6.x = saturate(r7.w * 5.0);
    r6.y = ps;
    ps = 1.0 - r6.x;
    r7 = r7.xxyz * float4(2e+01, 5.0, 5.0, 5.0);
    r6.x = ps;
    ps = r6.y;
    r0.x = max(r7.x, 0.0001);
    ps = r2.x * ps;
    ...
    r6.w = ps;
    ps = rsqrt(abs(r6.z));
    r0.y = r6.w * LightColorAndFalloffExponent.w;
    r6.w = ps;
