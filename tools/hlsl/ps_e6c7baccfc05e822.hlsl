...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.xy = tex2D(ModShadowAccumTexture, r0.xy).xy;
    ...
    r0.x = ps;
    ps = rsqrt(abs(r1.w));
    r3.z = saturate(-r3.x + 1.0);
    r1.w = ps;
    ps = 5.0 * r0.x;
    r2.xyz = r2.xyz * UniformVector_1.xyz;
    r0.x = saturate(ps);
    ps = rsqrt(abs(r2.w));
    r8.xyz = r1.www * r4.zxy;
    r2.w = ps;
    ps = 1.0 - r0.x;
    r5.xyz = r2.www * r6.zxy;
    r0.x = ps;
