...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.xy = tex2D(ModShadowAccumTexture, r3.xy).xy;
    ...
    ps = 5.0 * r6.x;
    r0.x = dot(r7.wyz, float3(0.5, 0.5, 0.5));
    r6.x = saturate(ps);
    ps = rsqrt(abs(r7.x));
    r1.yzw = r0.xxx - r7.yzw;
    r7.x = ps;
    ps = 1.0 - r6.x;
    r0.yzw = r7.xxx * r4.xyz;
    r7.x = ps;
    ps = rsqrt(abs(r2.w));
    ...
    r8.yz = r8.yz * r4.xy + 0.125;
    r4.xyz = r9.xyz * r6.xxx;
    r7.x = saturate(dot(r4.zxy, r2.zxy));
    ps = r8.x * r8.x;
    r6.x = dot(r4.zxy, r0.wyz);
    r0.x = ps;
    ps = r8.y * r8.z;
    r4.xyz = r4.xzy * r6.xxx;
    r6.x = ps;
    r6.xyz = r6.xxx * r6.yzw + ModShadowColor.xyz;
    r0.yzw = r4.xyz * 2.0 - r0.ywz;
    r6.w = saturate(dot(r2.zxy, r0.zyw));
    ps = log2(r6.w);
    r0.xyz = r0.xxx * r5.xyz;
    r1.x = ps;
    r1 = r1.yzwx * float4(0.5, 0.5, 0.5, 15.0);
    r2.xyz = r1.xyz + r7.yzw;
    ps = pow(2.0, r1.w);
