...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r10.xyz = tex2D(Texture2D_0, r5.zw).xyz;
    ...
    r6.w = dot(r1.zxy, r9.zxy);
    ps = LightColorAndFalloffExponent.w * r5.x;
    r1.xyz = r1.xzy * r6.www;
    r6.w = ps;
    r1.xyz = r1.xyz * 2.0 - r9.xzy;
    ps = pow(2.0, r6.w);
    r5.x = saturate(dot(r3.zxy, r1.yxz));
    r6.w = ps;
    ps = log2(r5.x);
    ...
    r6.xyz = r6.xyz * r5.www + r2.xxx;
    r5.xy = r2.yz * r5.yz + 0.125;
    ps = r5.x * r5.y;
