// ps_e734e766f9702180.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 114 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001C8 10040900 00000806 00000000 00006908 00FF00FF 00000001 00003050 00003151 0000F252 0000F353 00007454 0000F555 00007656 0000F757
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.xzw = -UniformVector_0.xyz + 1.0;
    r0.z = 1.0 / r7.w;
    ...
    r9.xyz = r5.xyz * 2.0 - 1.0;
    r5.xyz = r3.xzw * r2.xyw;
    r1.w = rsqrt(abs(r1.w));
    ps = 0.1 - -r4.z;
    ...
    r3.x = -r0.x + 1.0;
    r0.x = ps;
    r3.zw = -r3.xx * ModShadowGroupColor.xy + 1.0;
    ps = rsqrt(abs(r1.w));
    r8.xyz = r0.xxx * r6.xyz;
    r0.x = ps;
    r6.xyz = r9.xyz * r0.xxx;
