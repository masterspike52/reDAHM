...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.zw = r7.yz * r5.xy + ScreenPositionScaleBias.wz;
    ...
    r7.x = saturate(-r7.x + 1.0);
    r0.w = rsqrt(abs(r6.w));
    r1.xyz = -UniformVector_0.xyz + 1.0;
    r0.y = 0.875 * r6.y;
    r5.xyz = -ModShadowColor.xyz + 1.0;
    r0.z = 0.875 * r6.z;
    r6.w = saturate(r0.w * r2.z);
    r6.x = 0.1 - -r2.z;
    ps = 5.0 * r6.x;
