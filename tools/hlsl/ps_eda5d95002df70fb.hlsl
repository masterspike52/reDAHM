...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.w = ps;
    ps = rsqrt(abs(r2.w));
    r4.w = saturate(r3.w * 5.0);
    r5.w = ps;
    ps = 1.0 - r0.w;
    r3.w = saturate(r5.w * r0.z);
    r2.w = saturate(ps);
    ps = rsqrt(abs(r5.z));
    r8.xyz = r5.www * r0.zxy;
    r0.x = ps;
    ps = rsqrt(abs(r0.w));
    r7.xyz = r0.xxx * r2.zxy;
    r0.y = ps;
    ps = log2(r2.w);
    r0.z = -r4.w + 1.0;
    r0.x = ps;
    r2.zw = -r0.zz * ModShadowGroupColor.xy + 1.0;
    ps = -r7.y;
    r0.yzw = r0.yyy * -SpotDirection.xyz;
    r7.y = ps;
    r7.x = r7.x * 2.0 - r7.x;
    ps = -r7.z;
    r0.y = dot(r0.wyz, r1.zxy);
    r7.z = ps;
    ...
    r1 = r6 * float4(15.0, 0.21952, 0.21952, 0.21952);
    r0.z = ps;
    ps = pow(2.0, r1.x);
    r2.y = r2.x * r2.x;
    r5.z = ps;
