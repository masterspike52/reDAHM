// ps_3d45d989b53ed8d7.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 216 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000360 10040E00 0000080A 00000000 00007908 001F00FF 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A1 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r10.yz = r0.xy * UniformVector_1.xy;
    r6.x = ps;
    ...
    r10.xw = tex2D(Texture2D_5, r0.xy).xy;
    r6.xyz = tex2D(Texture2D_1, r0.xy).zxy;
    r4.xyz = tex2D(Texture2D_0, r10.yz).xyz;
    ...
    ps = r6.x + r6.x;
    r11.xyz = UniformVector_3.xyz * UniformVector_3.www;
    r6.x = ps;
    ps = r10.x + r10.w;
    ...
    r6.yz = r6.yz * 4.0;
    r0.w = ps;
    r0.xyz = (-abs(r2.www) >= 0.0) ? UniformVector_4.xyz : r11.xyz;
    r12.xyz = (-abs(r2.www) >= 0.0) ? UniformVector_6.xyz : r14.xyz;
    r12.xyz = (-abs(r1.www) >= 0.0) ? r14.xyz : r12.xyz;
    r11.yzw = (-abs(r1.www) >= 0.0) ? r11.xyz : r0.xyz;
    ps = 1.0 - r5.x;
    ...
    r5.y = ps;
    ps = 0.875 * r5.z;
    r6.xyz = r5.yyy * r8.xyz;
    r13.y = ps;
    r5.xy = -r5.ww * ModShadowGroupColor.xy + 1.0;
    r5.zw = r13.xy * r5.xy + 0.125;
    r6.xyz = r12.xyz * r8.xyz + r6.xyz;
    r4.xyz = r11.xyz * UniformScalar_2.xxx + r4.xyz;
    ps = rsqrt(abs(r6.w));
    ...
    r0.w = ps;
    r5.y = r0.w * UniformScalar_2.x + UniformScalar_14.x;
