...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.z = 1.0 / r4.w;
    r0.z = r0.z * 0.25 - 0.005;
    r1.zw = r1.zz * ScreenPositionScaleBias.xy;
    r0.w = rsqrt(abs(r0.w));
    r1.zw = r1.wz * r4.yx + ScreenPositionScaleBias.zw;
    r2.xy = r0.ww * r5.yx;
    r0.xy = r2.yx * r0.zz + r0.xy;
    r0.xyz = tex2D(Texture2D_1, r0.xy).xyz;
    r0.w = tex2D(SceneDepthTexture, r1.wz).x;
    r1.x = tex2D(Texture2D_2, r1.xy).x;
    r1.w = r1.x * r3.x;
