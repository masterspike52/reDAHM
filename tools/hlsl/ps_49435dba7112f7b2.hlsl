// ps_49435dba7112f7b2.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 63 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000000FC 18000300 00000008 00000000 00004084 0003000F 00000011 0000F050 0000F157 0000F2A0 0000F3A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    // unhandled fetch opcode 18
    r2.x = max(r3.y, r3.w);
    r3.y = InvMaxSubjectDepth.x * r1.z;
    r3.w = r2.x * SlopeScaleDepthBias.x + DepthBias.x;
    r3.xy = r3.zw + r3.xy;
    r2.x = r3.x * r2.w - 0.2;
    r2.x = saturate((r2.x > 0.0) ? r3.y : 1e+02);
