// ps_0fd59c78e10810de.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 108 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001B0 10040900 0000080A 00000000 00008108 003F00FF 00000001 0000F050 0000F153 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = rsqrt(abs(r6.y));
    r9.xyz = r4.xyz * AmbientColorAndSkyFactor.xyz;
    r6.y = ps;
    r7.xyz = r4.xyz * 0.1 + UniformVector_0.xyz;
    ps = rsqrt(abs(r6.x));
    r4.xyz = r0.xyz * r4.xyz;
    r6.x = ps;
    r6.x = r6.x * r2.z + 0.1;
    r7.xyz = r9.xyz * r0.xyz + r7.xyz;
