// ps_01c533e40bd99bfe.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 333 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000534 10041100 0000070A 00000000 000070E7 001F007F 00000021 0000F050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.yzw = tex2D(Texture2D_7, r0.xy).xyz;
    r0.x = dot(r4.zxy, r4.zxy);
    r5.z = dot(r1.zxy, r1.zxy);
    r13.xyz = r0.yzw * UniformScalar_3.xxx + UniformScalar_4.xxx;
    r15.zw = r17.yz * 2.0 - 1.0;
