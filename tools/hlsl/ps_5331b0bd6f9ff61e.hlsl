// ps_5331b0bd6f9ff61e.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 336 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000540 10041100 0000070A 00000000 000070E7 001F007F 00000021 0000F050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r15.xyz = tex2D(Texture2D_7, r9.xy).xyz;
    ...
    r17.yzw = tex2D(Texture2D_3, r8.xy).xyw;
    r0.x = dot(r4.zxy, r4.zxy);
    r5.z = dot(r1.zxy, r1.zxy);
    r13.zw = r17.yz * 2.0 - 1.0;
    ...
    r16.xyz = r1.xyz * r16.xyz;
    r1.xyz = r0.xxx * r4.xyz;
    r4.yzw = r16.xyz * r15.xyz;
    ...
    r5.x = ps;
    r4.yzw = r16.yzw * UniformScalar_5.xxx + UniformScalar_6.xxx;
    ps = 2.5 * r5.x;
    ...
    r13.x = ps;
    r15.xyz = r16.yzw * r6.www - r12.xyz;
    r6.w = saturate(r16.x * r6.w - 0.5);
    r12.xyz = r15.xyz * r6.www + r12.xyz;
    r3.xyz = r3.xyz * r12.xyz + UniformVector_0.xyz;
    r13.xyz = r13.xyy * r13.xzw;
    r11.xw = r14.zw + r13.yz;
    r4.yzw = r13.xxx * r4.yzw;
