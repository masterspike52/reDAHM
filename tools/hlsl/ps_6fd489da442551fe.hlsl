// ps_6fd489da442551fe.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 78 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000138 10040500 00000506 00000000 000048A5 001F001F 00000001 00003050 0000F154 0000F256 0000F357 0000F458
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.w = saturate(ps);
    r3.xyz = r3.xyz * UniformScalar_12.xxx + UniformVector_0.xyz;
    ps = rsqrt(abs(r0.x));
    r4.xy = r4.xy * 0.875;
    r0.x = ps;
    r0.x = r0.x * r1.z + 0.1;
