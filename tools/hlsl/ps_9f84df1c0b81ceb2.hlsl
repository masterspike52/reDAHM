...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.x = r5.x * 2.0 - r5.x;
    ps = 1.0 + ps;
    r0.x = saturate(dot(r8.xyz, r5.yzx));
    r2.w = ps;
    ps = log2(r0.x);
    r2.z = saturate(r0.y * r4.z);
    r7.x = ps;
    ps = log2(r0.z);
    r0.xyw = r7.xzy * float3(15.0, 0.875, 0.875);
    r0.z = ps;
    r2.xy = r0.wy * r2.xy + 0.125;
    ps = pow(2.0, r0.x);
    ...
    r2.yz = r2.xz * r2.yw;
    r2.x = ps;
    r0.xyz = r2.yyy * r3.xyz + ModShadowColor.xyz;
    ps = pow(2.0, r0.w);
    r2.y = r2.z + r2.x;
    r0.w = ps;
    r2.xy = r2.xy * r0.ww;
