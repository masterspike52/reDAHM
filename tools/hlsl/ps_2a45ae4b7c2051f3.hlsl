// ps_2a45ae4b7c2051f3.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 315 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004EC 10041100 0000070A 00000000 000070E7 001F007F 00000021 0000F050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.z = saturate(ps);
    r0.w = (r6.z == 0.0) ? r17.z : r0.w;
    r7.z = (r6.y == 0.0) ? r17.w : r0.w;
    ps = 1.0 - r5.z;
    ...
    r7.x = ps;
    ps = 3.3333333 * r5.x;
    r16.yz = r16.yz + r11.xw;
    r6.y = ps;
    ps = ModShadowGroupColor.y * r5.z;
    r6.yzw = r6.yyy * r16.xyz;
    r7.y = ps;
    r7 = -r7.wxyz + 1.0;
    r6.zw = r15.yz * UniformVector_4.xy + r6.zw;
    ps = r7.w;
    r5.z = r6.y + 1.0;
    r5.x = ps;
    ps = 2.5 * r5.x;
    r6.y = abs(r5.z) * abs(r5.z);
    r14.x = ps;
    ps = r6.y * r6.y;
    r4.yz = r6.zw - r12.yz;
    r4.x = ps;
    r6.yzw = r14.yzw * r5.zzz - r10.xyz;
    r4.w = saturate(r14.x * r5.z - 0.5);
    r10.xyz = r6.yzw * r4.www + r10.xyz;
    r3.xyz = r3.xyz * r10.xyz + UniformVector_0.xyz;
    r5.xyz = r4.xyz * r4.xww;
    ps = r12.y;
    r6.y = float((r7.x >= 0.004));
    ps = r5.y + ps;
    r13.yzw = r5.xxx * r13.yzw;
    r5.y = ps;
    ps = r12.z;
    r4 = r13.xywz * r4.wwww;
    ps = r5.z + ps;
    ...
    r5.z = r7.x * r7.y;
    r5.x = ps;
    r6.xzw = r5.zzz * r6.xzw + ModShadowColor.xyz;
    ps = 15.0 * r5.x;
