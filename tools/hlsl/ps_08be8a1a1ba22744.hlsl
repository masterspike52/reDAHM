// ps_08be8a1a1ba22744.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 147 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000024C 10040A00 0000080A 00000000 00007908 003F00FF 00000001 0000F050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5 = tex2D(Texture2D_2, r0.xy);
    r8.x = tex2D(Texture2D_1, r1.xy).w;
    ...
    ps = rsqrt(abs(r7.w));
    r6.w = dot(r2.zxy, r3.zxy);
    r7.w = ps;
    r2.xyz = r10.xyz * r7.www;
    r7.w = dot(r2.zxy, r4.zxy);
    r3.xyz = r2.xzy * r7.www;
    r3.xyz = r3.xyz * 2.0 - r4.xzy;
    r7.w = saturate(dot(r0.zxy, r3.yxz));
    ps = log2(r7.w);
    r6.w = r6.w - SpotAngles.x;
    r8.y = ps;
    ps = LightColorAndFalloffExponent.w * r6.x;
    r3.xyz = r8.yzw * float3(15.0, 0.875, 0.875);
    r7.w = ps;
    ps = pow(2.0, r3.x);
    r6.x = saturate(r6.w * SpotAngles.y);
    r8.y = ps;
    r6.yz = r3.yz * r6.yz + 0.125;
    ps = r6.x * r6.x;
    r1.x = saturate(dot(r2.zxy, r0.zxy));
    r6.w = ps;
    ps = r6.y * r6.z;
    r0 = r8.xxyx * r5.xywz;
    r6.x = ps;
    r6.xyz = r6.xxx * r1.yzw + ModShadowColor.xyz;
    ps = pow(2.0, r7.w);
    r1.yzw = r0.xyw * r9.xyz;
    r7.w = ps;
