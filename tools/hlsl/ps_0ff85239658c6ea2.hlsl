// ps_0ff85239658c6ea2.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 126 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001F8 10040B00 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.x = ps;
    r4.zw = r6.xy * abs(r7.xy);
    r6.xyz = tex2D(Texture2D_2, r0.xy).xyz;
    r8.yz = tex2D(ModShadowAccumTexture, r4.zw).xy;
    ...
    r6.w = ps;
    r4.yzw = r0.xyz * 2.0 - 1.0;
    ps = rsqrt(abs(r5.w));
    r1.w = saturate(r6.w * 5.0);
    r6.w = ps;
    ps = r6.w;
