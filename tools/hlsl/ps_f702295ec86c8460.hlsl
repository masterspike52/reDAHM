...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.yz = r0.zw * r4.xy + ScreenPositionScaleBias.wz;
    r1.yzw = r1.yzw * float3(1e+01, 1e+01, 1.0000007) + float3(1e+01, 1e+01, 0.5);
    r0.z = frac(r1.w);
    r0.z = r0.z * 6.2831855 - 3.1415927;
    r0.z = sin(r0.z);
    r0.xy = r0.zz * 0.008 + r0.xy;
    r0.y = tex2D(Texture2D_1, r0.xy).x;
    r0.xzw = tex2D(Texture2D_0, r1.yz).xyz;
