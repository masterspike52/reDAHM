// ps_7c83d5ead9b9dc4e.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 288 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000480 10041000 0000080A 00000000 00008108 001F00FF 00000001 0000F050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A1 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.zw = r0.xy * 1e+01 + UniformVector_1.xy;
    ...
    r12.w = tex2D(Texture2D_2, r7.zw).y;
    ...
    r6.w = dot(r8.zyx, r8.zyx);
    r5.xyz = r0.xyz * 2.0 - 1.0;
    ps = rsqrt(abs(r7.w));
    r6.xyz = r5.xyz - r5.xyz;
    r7.w = ps;
    ps = rsqrt(abs(r7.y));
    r15.xyz = r7.www * r3.xyz;
    r7.y = ps;
    ps = rsqrt(abs(r6.w));
    r0.xyz = r7.yyy * r1.xzy;
    r6.w = ps;
    ps = rsqrt(abs(r5.w));
    r13.xyz = r8.xzy * r6.www;
    r5.w = ps;
    r8.xyz = r10.xzy * r5.www;
    ...
    r6.x = saturate(ps);
    ps = r6.y;
    r1.xyz = r13.yzx * r8.zyx;
    r6.y = ps;
    r1.xyz = r13.xyz * r8.yxz - r1.xyz;
    ps = rsqrt(abs(r6.z));
    r14.xyz = r1.xyz * r8.www;
    r5.x = ps;
    ps = 0.0;
    r1.xyw = r5.wyz * r5.xxx;
    r6.z = ps;
    ps = max(r6.y, r6.z);
    r6.w = dot(r1.wxy, r15.zxy);
    r6.y = ps;
    ps = 0.875 * r7.x;
    r6.xz = -r6.yx + 1.0;
    r6.y = ps;
    ...
    r3.y = ps;
    ps = rsqrt(abs(r5.x));
    r16.xyz = r1.xyw * r6.www;
    r5.x = ps;
    r1.xyz = r16.xyz * 2.0 - r15.xyz;
    ...
    r3.xyw = -r3.yzx + 1.0;
    r6.w = ps;
    r12.yz = r6.yw * r3.xy + 0.125;
    r5.xyz = r8.xzy * r5.www + r5.xyz;
    ps = LocalToWorldMatrix[0].z * r5.x;
    r5.w = saturate(dot(r0.yxz, r1.zxy));
    r10.x = ps;
    ps = LocalToWorldMatrix[1].z * r5.y;
    r10.yz = r12.xy * r12.wz;
    r10.w = ps;
    r7.xz = r10.xy + r10.wy;
    r5.x = r5.z * LocalToWorldMatrix[2].z + r7.x;
    ps = 0.5 * r5.x;
    r12.yzw = r1.www * ConstantLighting.yzx;
    r11.x = ps;
    r0 = r11.yzwx + float4(-1.0, -1.0, -1.0, 0.5);
    r6.yzw = r0.xyz * UniformScalar_0.xxx + 1.0;
    ps = 5e+01 * r6.y;
    r5.x = ps;
    ps = log2(r5.w);
    ...
    r1.w = ps;
    r8 = r8.xzyw * r1.xxxw;
    r5.xyz = r14.xyz * r1.yyy + r8.xzy;
    r5.xyw = r13.xyz * r1.zzz + r5.zyx;
    ...
    r6.x = ps;
    r3.xyz = r8.xyz * r6.xxx - 0.025;
    r7.yw = r1.yz * LowerSkyColor.yz + r0.yz;
    ps = sqrt(abs(r5.w));
    r0.x = r0.x + r7.x;
    r6.x = ps;
    ps = r0.x;
    r5.w = float((r3.w >= 0.004));
    r0.yz = r1.yz * UpperSkyColor.yz + r7.yw;
    r3.xyz = r3.xyz * r6.xxx + 0.025;
    ps = r1.w + ps;
    r7.xyw = r3.xyz * r6.ywz;
    r0.x = ps;
    r6.xyz = r1.xyz * AmbientColorAndSkyFactor.xyz + r0.xyz;
    r7.z = r7.z + r7.w;
