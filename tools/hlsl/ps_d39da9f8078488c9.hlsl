// ps_d39da9f8078488c9.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 153 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000264 10040A00 0000080A 00000000 00007908 001F00FF 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A1 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 5.0 * r5.w;
    r7.xyz = r4.yyy * UniformVector_3.xyz;
    r5.w = saturate(ps);
    ps = rsqrt(abs(r7.w));
    ...
    r7.w = ps;
    r7.xyz = r4.xxx * UniformVector_2.xyz + r7.xyz;
    ps = rsqrt(abs(r0.w));
