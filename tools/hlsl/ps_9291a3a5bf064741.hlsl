// ps_9291a3a5bf064741.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 129 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000204 10040800 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.xy = r0.xy * 0.5 + UniformVector_2.xy;
    ps = 1.0 / r4.w;
    ...
    r8.xyz = tex2D(Texture2D_0, r8.xy).xyz;
    ...
    ps = 1.0 - r5.y;
    r8.xyz = r3.xzy * r6.www;
    r5.y = saturate(ps);
    r5.xzw = r8.xyz * 2.0 - r5.xwz;
    ps = log2(r5.y);
    r5.x = saturate(dot(r7.zxy, r5.zxw));
    r5.y = ps;
    ps = log2(r5.x);
    r5.z = r5.y * LightColorAndFalloffExponent.w;
    r5.x = ps;
    ps = 15.0 * r5.x;
    r5.x = ps;
    ps = pow(2.0, r5.x);
    r6.w = saturate(dot(r3.zxy, r7.zxy));
    r4.z = ps;
    ps = pow(2.0, r5.z);
    r5.xyw = r4.xyz * float3(0.875, 0.875, 0.21952);
    r5.z = ps;
    r0.xyz = r0.xyz * r6.www + r5.www;
