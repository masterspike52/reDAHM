// ps_25c246349cccc54b.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 330 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000528 10041000 0000070A 00000000 000070E7 001F007F 00000021 0000F050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.w = ps;
    ps = r8.w;
    r16.yzw = r15.xyz * r14.xxx;
    r5.x = ps;
    r4.yzw = r16.yzw * UniformScalar_3.xxx + UniformScalar_4.xxx;
    ps = 2.5 * r5.x;
