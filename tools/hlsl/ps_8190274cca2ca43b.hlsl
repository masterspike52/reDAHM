// ps_8190274cca2ca43b.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 120 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001E0 10040900 00000806 00000000 00006908 00FF00FF 00000001 00003050 00003151 0000F252 0000F353 00007454 0000F555 00007656 0000F757
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.x = ps;
    ps = pow(2.0, r0.z);
    r0.xyw = r8.xyz * float3(0.21952, 0.875, 0.875);
    r0.z = ps;
    r3.xyz = r3.xyz * r1.www + r0.xxx;
    r0.xy = r0.yw * r2.zw + 0.125;
    ps = r0.x * r0.y;
