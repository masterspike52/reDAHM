// vs_26d87ca2c059215a.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 1062 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000080 00001098 0071000D 00000000 00000000 00007108 00000001 00000008 00000008 00000290 0010002A 0000602B 0000702C 0000302D 0001A02E 0000502F 00015030 0020A031 00003050 0001F151 00027254 0003F355 00047456 0005F557 0006F6A0 0007F7A2 00001159 0000115F 0000115A 0000115B 0000115C 00001160 0000115D 0000115E
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r9.xy = r9.zw * ShadowCoordinateScaleBias.xy + ShadowCoordinateScaleBias.wz;
    ...
    r0.xyz = r12.yyy * WorldToLocal[1].xzy + r7.xyz;
    r0.xyz = r12.xxx * WorldToLocal[0].xyz + r0.xzy;
    r7.xyz = r5.www * WorldToLocal[0].xzy + r5.xzy;
    r5.x = dot(r6.xzy, r7.yxz);
    r5.y = dot(r4.yxz, r7.yxz);
    r5.z = dot(r2.zyx, r7.yxz);
    r7.y = dot(r6.xzy, r0.zxy);
    r7.z = dot(r4.yxz, r0.zxy);
    r7.w = dot(r2.zyx, r0.zxy);
    p0 = (-SP_DemolitionSpread.x >= 0.0);
    ps = p0 ? 0.0 : 1.0;
    // UNHANDLED control flow: cjmp
    r0 = r10.wwww * LocalToWorld[3].xwzy;
    ...
    o0.xy = r9.xy;
    o2.xyz = r7.yzw;
    o3.xyz = r12.xyz * LightPositionAndInvRadius.www;
    o3.w = 0.0;
    o4.xyz = r5.xyz;
    o6 = r13;
    o7 = r1.xzyw;
