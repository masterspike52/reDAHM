// ps_4290d0b90169e150.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 126 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001F8 10040900 0000070A 00000000 000068E7 001F007F 00000001 00003050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.x = ps;
    ps = 5.0 * r5.x;
    r6.w = saturate(dot(r5.yzw, r8.ywx));
    r5.x = saturate(ps);
    ps = -ModShadowColor.x;
    r5.x = -r5.x + 1.0;
    ps = 1.0 + ps;
