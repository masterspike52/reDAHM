...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.xw = r0.xy * float2(3.0, 1.0) + UniformVector_1.xy;
    r4.yz = r0.xy + UniformVector_2.xy;
    ps = UniformScalar_9.x * r4.y;
    r5.yz = r0.xy + UniformVector_3.xy;
    r5.x = ps;
    ps = UniformScalar_9.x * r4.z;
    r5.zw = r5.yz * UniformScalar_14.xx;
    r5.y = ps;
    r4.xyz = tex2D(Texture2D_0, r4.xw).xyz;
    r0.xyz = tex2D(Texture2D_1, r5.zw).xyz;
    ...
    r4.xyz = r4.xyz * UniformVector_4.xyz + UniformVector_0.xyz;
