...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r10.x = 0.875 * r6.y;
    r1.w = saturate(-r7.y + 1.0);
    r7.x = rsqrt(abs(r6.w));
    r6.w = saturate(r7.x * r2.z);
    r0.w = rsqrt(abs(r7.y));
    ...
    r7.xy = r10.xy * r7.xy + 0.125;
    ps = -SpotAngles.x - -r6.y;
    r0.w = saturate(dot(r9.yzx, r2.yzx));
    r6.z = ps;
    ...
    r7.w = ps;
    r6.xyz = r7.yyy * r8.xyz + ModShadowColor.xyz;
    ps = log2(r0.w);
    r1.xyz = r7.xxx * r1.xyz;
    r5.w = ps;
    ps = pow(2.0, r7.w);
    r2 = r5 * float4(3.0, 3.0, 3.0, 15.0);
    r7.w = ps;
