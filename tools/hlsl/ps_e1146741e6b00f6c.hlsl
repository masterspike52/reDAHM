// ps_e1146741e6b00f6c.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 84 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000150 10040600 00000606 00000000 000058C6 003F003F 00000001 00003050 0000F151 0000F254 0000F356 0000F457 0000F558
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.z = saturate(ps);
    r5.xyw = r0.xxx * UniformScalar_2.xxx + UniformVector_0.xyz;
    ps = rsqrt(abs(r1.w));
    r4.xy = r4.xy * 0.875;
    r1.w = ps;
    r0.x = r1.w * r2.z + 0.1;
    ps = 5.0 * r0.x;
    r2.xyw = r5.xyw + r0.yzw;
    r0.w = saturate(ps);
    ps = r2.x;
