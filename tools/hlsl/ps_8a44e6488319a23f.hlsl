// ps_8a44e6488319a23f.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 114 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001C8 10040900 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.z = ps;
    ps = log2(r5.y);
    r1.xyz = r4.xyz * float3(0.875, 0.875, 15.0);
    r5.y = ps;
    ps = pow(2.0, r1.z);
    r5.y = r5.y * LightColorAndFalloffExponent.w;
    r5.z = ps;
    r5.xw = r1.xy * r5.xw + 0.125;
    ps = r5.x * r5.w;
