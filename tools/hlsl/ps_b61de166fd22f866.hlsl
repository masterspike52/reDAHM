...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.y = tex2D(Texture2D_0, r0.xy).w;
    ps = (-0.6) + r2.y;
    r2.z = max(r2.x, r2.z);
    r2.x = ps;
    r2.y = r2.z * SlopeScaleDepthBias.x + DepthBias.x;
    r2.z = r1.z * InvMaxSubjectDepth.x + r2.y;
    // unhandled fetch opcode 18
    r2.y = tex2D(Texture2D_0, r0.xy).w;
    ps = (-0.6) + r2.y;
    r3.x = max(r3.x, r3.y);
    r2.w = ps;
    r2.y = r3.x * SlopeScaleDepthBias.x + DepthBias.x;
