// ps_88c2d2528962ebeb.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 156 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000270 10040E00 0000080A 00000000 00007908 003F00FF 00000001 00003050 0000F151 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.xyz = r8.xyz + UniformVector_0.xyz;
    r8.x = ps;
    ps = rsqrt(abs(r7.y));
    r10.xyz = r9.xyz * r13.xyz;
    r7.y = ps;
    r11.xyz = r10.xyz * AmbientColorAndSkyFactor.xyz + r0.xyz;
    ps = rsqrt(abs(r6.w));
    ...
    r2.y = ps;
    ps = r0.y;
    r1.xyz = r1.xzy * r13.xzy;
    r6.x = ps;
    ps = 0.5 + r6.x;
    r7.x = saturate(dot(r7.yxz, r4.zxy));
    r7.y = ps;
    ps = 0.5 + r0.x;
    r6.xyw = -r2.xyz + 1.0;
    r7.z = ps;
    ...
    r7.xyz = r7.xzy * UpperSkyColor.xyz + r11.xyz;
    ps = pow(2.0, r7.w);
    r2.xyz = r10.xzy * r0.xxx;
    r7.w = ps;
    r0.xyz = r8.xzy * r7.www;
    r7.xyz = r2.xyz * LowerSkyColor.xzy + r7.xzy;
    r7.xyz = r0.xyz * 0.21952 + r7.xyz;
