// ps_112f7dfc397c6612.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 135 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000021C 10040A00 0000090A 00000000 00008929 007F01FF 00000001 00003050 0000F151 0000F252 0000F354 0000F456 0000F557 0000F658 0000F7A0 0000F8A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.yz = tex2D(ModShadowAccumTexture, r7.zw).xy;
    r0.z = tex2D(Texture2D_0, r7.xy).w;
    ...
    r7.x = saturate(ps);
    ps = 1.0 - r7.x;
    r7.y = saturate(dot(r8.yzx, r7.zwy));
    r7.x = ps;
    ps = log2(r7.y);
    ...
    r8.xyz = r2.xyz * r8.www + r8.xyz;
    r8.xyz = r1.xyz * r0.xyz + r8.xzy;
    ps = -r4.w;
