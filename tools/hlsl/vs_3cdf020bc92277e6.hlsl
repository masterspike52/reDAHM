// vs_3cdf020bc92277e6.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 429 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000040 000006B4 0011000C 00000000 00000000 00001842 00000001 00000005 00000002 00000290 00100012 00003013 00002014 00001015 00205016 00003050 0001F156 0000108D 0000108C
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    a0 = xe_mova(r3.w);
    ps = r3.w;
    r3.z = float((MaxBoneInfluences.x > 2.0));
    p0 = (r3.z != 0.0);
    ps = p0 ? 0.0 : 1.0;
    ...
    a0 = xe_mova(r3.w);
    ps = r3.w;
    r3.z = float((MaxBoneInfluences.x > 3.0));
    p0 = (r3.z != 0.0);
    ps = p0 ? 0.0 : 1.0;
    ...
    r3.z = dot(r0.zxyw, r12);
    r3.w = dot(r7.zxyw, r12);
    p0 = (r1.y != 0.0);
    ps = p0 ? 0.0 : 1.0;
    r0.x = dot(r4.zxyw, r11);
    r0 = r0.xxxx * LocalToWorld[2].xwzy + LocalToWorld[3].xwzy;
    r0 = r3.wwww * LocalToWorld[1].xzyw + r0.xzwy;
    r0 = r3.zzzz * LocalToWorld[0].wzyx + r0.wyzx;
    // UNHANDLED control flow: cjmp
    ps = 3.0 * r1.x;
    r3.w = ps;
    a0 = xe_mova(r3.w);
    ...
    r2.w = dot(r10.zxyw, r12);
    r3.z = dot(r8.zxyw, r12);
    p0 = (r1.y != 0.0);
    ps = p0 ? 0.0 : 1.0;
    r3.w = dot(r9.zxyw, r11);
    r8 = r3.wwww * PreviousLocalToWorld[2].xzyw + PreviousLocalToWorld[3].xzyw;
    r8 = r3.zzzz * PreviousLocalToWorld[1].xzyw + r8;
    r8 = r2.wwww * PreviousLocalToWorld[0] + r8.xzyw;
    // UNHANDLED control flow: cjmp
    ps = 3.0 * r1.x;
    r3.z = ps;
    a0 = xe_mova(r3.z);
