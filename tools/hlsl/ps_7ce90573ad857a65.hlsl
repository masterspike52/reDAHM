...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = pow(2.0, r6.x);
    r5.x = saturate(dot(r4.zxy, r7.yxz));
    r6.x = ps;
    ps = log2(r5.x);
    ...
    r1.xy = r1.xz * r1.yw;
    r6.w = ps;
    r5.xyz = r1.xxx * r8.xyz + ModShadowColor.xyz;
    ps = pow(2.0, r1.y);
