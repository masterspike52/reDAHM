// ps_77602b2729075b1c.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 195 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000030C 10040C00 00000606 00000000 000048C6 003F003F 00000021 00003050 00003151 00007254 0000F355 00007456 0000F557
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.z = ps;
    r7.zw = r7.xz * r0.zz + ScreenPositionScaleBias.wz;
    ps = r11.w;
    ...
    r9.zw = r1.yz * 2.0 - 1.0;
    ps = (-1.0) + r1.x;
    r3.x = float((UniformScalar_4.x > 1.0));
    r1.z = ps;
    ps = 5.0 * r0.x;
    r1.xyw = r12.zxy + float3(-2.0, 0.0, 0.0);
    r0.y = saturate(ps);
    r3.xyz = (-abs(r3.xxx) >= 0.0) ? r10.xyz : 1.0;
    r10.xyz = (-abs(r0.zzz) >= 0.0) ? 1.0 : r3.xyz;
    ps = 1.0 - r0.y;
    r11.xyz = r5.xyw * r11.xyz;
    r0.z = ps;
    ps = rsqrt(abs(r4.w));
    r1.xyw = r1.ywx + r12.xyz;
    r0.x = ps;
    ...
    r5.yzw = -r5.zxy + 1.0;
    r0.x = ps;
    r10.zw = r1.wz * r5.yy + 1.0;
    ps = (-1.0) + r1.y;
    r5.x = r5.y * UniformScalar_1.x;
    r0.y = ps;
    r0.xy = r5.xx * r9.zw + r0.xy;
    r10.xy = r0.xy * r5.yy;
    r1 = (r5.xyyy > 0.0) ? r10.wxyz : float4(1.0, 0.0, 0.0, 1.0);
    r11 = (r5.xyyy >= 0.0) ? r1 : float4(1.0, 0.0, 0.0, 1.0);
    r0.x = dot(r11.wyz, r11.wyz);
    ps = rsqrt(abs(r2.w));
    ...
    r0.x = ps;
    r4.xyz = r11.yzw * r0.xxx;
    r0.x = dot(r4.zxy, r10.zxy);
    ps = 1.0 - r0.w;
    r11.xyz = r4.xyz * r0.xxx;
    r0.y = saturate(ps);
    r0.xzw = r11.xyz * 2.0 - r10.xyz;
    ps = log2(r0.y);
