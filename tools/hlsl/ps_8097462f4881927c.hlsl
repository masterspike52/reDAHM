// ps_8097462f4881927c.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 93 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000174 10000400 00000004 00000000 000040A5 001F001F 00000021 00003050 00003151 0000F252 0000F353 0000F456
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.xy = r0.xy * float2(1e+01, 1.0) + UniformVector_3.xy;
    r0.zw = r0.xy * float2(15.0, 1.875) + UniformVector_4.xy;
    r1.zw = r0.yx - 0.5;
    ...
    r0.x = tex2D(Texture2D_1, r1.xy).w;
    ps = 2.0 - r0.x;
    r0.y = r0.y * r3.w;
    r0.w = ps;
    r0.x = r0.w * r0.z + r0.x;
