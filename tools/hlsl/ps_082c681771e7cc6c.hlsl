...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.xyw = r10.xyz * r7.www;
    r2.x = ps;
    ps = AmbientColorAndSkyFactor.y * r6.x;
    r10.xyz = r4.xxx * r1.xyz;
    r2.y = ps;
    ps = 0.1 - -r7.x;
    r12.x = dot(r5.zxy, r4.xyw);
    r6.x = ps;
    ps = 5.0 * r6.x;
