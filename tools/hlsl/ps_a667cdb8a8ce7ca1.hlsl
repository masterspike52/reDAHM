// ps_a667cdb8a8ce7ca1.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 114 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001C8 10040800 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.yw = r6.yy * ScreenPositionScaleBias.xy;
    r6.z = ps;
    r6.xz = r6.xz * abs(r8.xy);
    r6.yw = r6.yw * r5.xy + ScreenPositionScaleBias.wz;
    r3.xyz = tex2D(LightAttenuationTexture, r6.yw).xyz;
    r6.y = tex2D(ShadowTexture, r0.xy).x;
    r5.yz = tex2D(ModShadowAccumTexture, r6.xz).xy;
    ...
    r4.yz = -r4.yz;
    r4.x = r4.x * 2.0 - r4.x;
    r6.w = saturate(dot(r8.yzx, r4.yzx));
    ps = log2(r6.w);
    r1.xyz = r1.xyz * r7.xyz;
    r5.x = ps;
    r4.xyz = r5.xyz * float3(15.0, 0.875, 0.875);
    r6.zw = r4.yz * r6.xz + 0.125;
    ps = pow(2.0, r4.x);
    r6.x = saturate(r7.w * r2.z);
    r7.w = ps;
