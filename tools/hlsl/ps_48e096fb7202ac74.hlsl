...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.w = ps;
    ps = rsqrt(abs(r6.z));
    r7.z = saturate(r6.w * 5.0);
    r6.z = ps;
    ps = rsqrt(abs(r6.y));
    r1.xyz = r6.zzz * r2.xyz;
    r6.y = ps;
    r0.xyw = r12.xyz * r0.xyz;
    ps = 1.0 - r6.x;
    ...
    r6.x = ps;
    ps = rsqrt(abs(r7.x));
    r6.yzw = r6.xxx * -SpotDirection.xyz;
    r7.x = ps;
    ps = log2(r7.w);
    r7.z = -r7.z + 1.0;
    r6.x = ps;
    r7.zw = -r7.zz * ModShadowGroupColor.xy + 1.0;
    r2.xyz = r7.xxx * r11.xyz;
    r6.y = dot(r6.wyz, r3.zxy);
    r2.xyz = r2.xyz * TwoSidedSign.xxx;
    r6.z = dot(r2.zxy, r4.zxy);
    r3.xyz = r2.xzy * r6.zzz;
