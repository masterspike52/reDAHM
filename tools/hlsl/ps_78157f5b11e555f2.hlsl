...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9.yzw = tex2D(LightAttenuationTexture, r6.xy).xyz;
    ...
    r5.z = ps;
    ps = rsqrt(abs(r5.x));
    r6.w = r5.z * LightColorAndFalloffExponent.w;
    r5.x = ps;
