// ps_e45fada8cf2989a7.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 147 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000024C 18000400 00000008 00000000 00004084 0003000F 00000011 0000F050 0000F157 0000F2A0 0000F3A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.yz = r0.wz * 3.0;
    r2.xw = r0.xy * UniformVector_2.xy;
    r2.x = tex2D(Texture2D_9, r2.xw).w;
    ...
    r3.xy = r0.wz * 3.0;
    r2.xw = r0.xy * UniformVector_2.xy;
    r2.w = tex2D(Texture2D_9, r2.xw).w;
