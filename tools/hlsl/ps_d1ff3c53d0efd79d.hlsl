// ps_d1ff3c53d0efd79d.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 96 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000180 10040700 00000606 00000000 000050C6 003F003F 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.xyz = tex2D(LightAttenuationTexture, r1.xy).xyz;
    ...
    r7.xyz = r2.www * r2.zxy;
    r1.w = rsqrt(abs(r1.w));
    r6.xyz = r1.www * r4.zxy;
    r0.x = 1.0 - r0.x;
