// ps_b27934b0ec065f4a.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 108 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001B0 10040800 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.x = saturate(ps);
    ps = rsqrt(abs(r5.y));
    r8.xyz = r5.zzz * r1.zxy;
    r5.y = ps;
    ps = 1.0 - r5.x;
    r3.xyz = r5.yyy * r3.zxy;
    r5.x = ps;
    r5.xy = -r5.xx * ModShadowGroupColor.xy + 1.0;
    r3.yz = -r3.yz;
    r3.x = r3.x * 2.0 - r3.x;
    r5.w = saturate(dot(r8.yzx, r3.yzx));
    ps = log2(r5.w);
