...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.y = max(r2.y, UniformScalar_5.x);
    ...
    ps = 1.0 - r2.y;
    r2.y = ps;
    r2.w = (UniformScalar_4.x > 0.0) ? r2.y : 1.0;
    r2.y = (UniformScalar_4.x >= 0.0) ? r2.w : r2.y;
    r2.y = r2.y * r2.x - 0.5;
    r3.xy = r0.wz * 3.0;
    r2.w = tex2D(Texture2D_8, r0.xy).w;
    ...
    r3.x = max(r3.x, UniformScalar_5.x);
    ps = 1.0 / UniformScalar_6.x;
    r3.x = min(r3.x, 1.0);
    r3.z = ps;
    ps = r3.y;
    ...
    r3.x = -r3.x + 1.0;
    r3.y = (UniformScalar_4.x > 0.0) ? r3.x : 1.0;
    r3.x = (UniformScalar_4.x >= 0.0) ? r3.y : r3.x;
    r2.w = r3.x * r2.w - 0.5;
