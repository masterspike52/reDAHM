...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.y = ps;
    ps = pow(2.0, r5.z);
    r0.xyz = r10.xzy * r6.zzz;
    r12.w = ps;
    ps = ConstantLighting.z * r5.w;
    r5.z = r12.w * 0.21952;
    r4.z = ps;
    ps = ConstantLighting.x * r5.z;
    r1.xyz = r10.xzy * r6.yyy;
    r3.x = ps;
    ps = ConstantLighting.y * r5.z;
    r3.zw = r12.xy * r12.wz;
    r3.y = ps;
    r5.xyz = r3.www * r11.xyz + ModShadowColor.xyz;
    r6.yzw = r4.xyz * r10.xyz + r3.xyz;
