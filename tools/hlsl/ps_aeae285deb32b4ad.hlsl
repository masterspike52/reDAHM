// ps_aeae285deb32b4ad.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 42 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000000A8 10000500 00000004 00000000 00004CC6 003F003F 00000021 00003050 00003151 0000F252 0000F353 0000F456 00007557
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.xy = r0.xy * 2.0 + UniformVector_1.xy;
    r0 = r0.xyxy * float4(3.0, 3.0, 4.0, 4.0);
    r1.zw = r0.zw + UniformVector_2.xy;
    r0.z = tex2D(Texture2D_1, r1.zw).w;
    r0.y = tex2D(Texture2D_2, r0.xy).x;
    r0.x = tex2D(Texture2D_0, r1.xy).w;
    ps = 4.0 - r0.x;
    r0.y = r0.y * r3.w;
    r0.w = ps;
    r0.x = r0.w * r0.z + r0.x;
