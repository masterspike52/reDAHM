...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.z = ps;
    ps = rsqrt(abs(r6.x));
    r0.x = r6.z * LightColorAndFalloffExponent.w;
    r6.x = ps;
    r6.yz = -r6.yy * ModShadowGroupColor.xy + 1.0;
    r0.zw = r0.zw * r6.yz + 0.125;
    ...
    r0.yzw = r6.www * r8.xyz;
    r2.xyz = r2.xyz * 2.0 - r4.xzy;
    ps = pow(2.0, r0.x);
