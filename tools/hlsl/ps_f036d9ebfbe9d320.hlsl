...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = rsqrt(abs(r5.z));
    r8.xyz = r0.yzw * AmbientColorAndSkyFactor.xyz;
    r10.x = ps;
    ps = rsqrt(abs(r5.y));
    r9.xyz = r7.xyz * r0.yzw;
    r5.y = ps;
    ps = rsqrt(abs(r5.x));
    ...
    r5.x = ps;
    ps = 5.0 * r5.x;
    r5.y = saturate(dot(r5.ywz, r3.yzx));
    r5.x = saturate(ps);
    ps = 1.0 - r5.x;
    r6.w = ConstantLighting.z * 0.21952;
    r5.x = ps;
