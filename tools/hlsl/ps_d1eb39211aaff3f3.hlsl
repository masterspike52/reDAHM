// ps_d1eb39211aaff3f3.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 150 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000258 10040D00 0000080A 00000000 00008108 003F00FF 00000001 0000F050 0000F153 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.y = ps;
    r10.xyz = r0.xyz * r7.yzw + UniformVector_0.xyz;
    ps = rsqrt(abs(r6.x));
    ...
    r7.xyz = r7.xyz * UpperSkyColor.xzy + r10.xzy;
    ps = pow(2.0, r7.w);
