// ps_2da88c2d40cc2aef.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 96 ucode dwords, 0 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000000 00000180 10000E00 00000004 00000000 000070E7 007F007F 00000001 0000F050 0000F151 0000F252 0000F353 0000F454 0000F555 0000F656
...
float4 SampleWeights[14] : register(c3); // float4[14]
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r14 = tex2D(FilterTexture, r6.xy);
    r0 = tex2D(FilterTexture, r6.wz);
    r0 = r0 * SampleWeights[13];
    r0 = r14.xywz * SampleWeights[12].xywz + r0.xywz;
