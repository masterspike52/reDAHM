// ps_585bc45ea0623471.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 282 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000468 10040F00 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.y = ps;
    ps = r3.y + r3.y;
    r7.x = dot(r13.xyy, float3(1.0, 1.0, 1.0));
    r7.z = ps;
    r5.z = (r7.x == 0.0) ? r15.x : r15.y;
    r7 = r7.xzxy + float4(-3.0, -1.0, -2.0, -1.0);
    ps = r7.w;
    r6.xyw = r6.xyz * UniformVector_4.xyz;
    r5.z = (r7.z == 0.0) ? r15.z : r5.z;
    r7.z = (r7.x == 0.0) ? r15.w : r5.z;
    ps = r10.y + ps;
    r5.z = max(r7.z, 0.0);
    r7.x = ps;
    ps = r7.y;
    r14.x = min(r5.z, 0.3);
    ps = r10.z + ps;
    r3.xyz = r14.yxz * float3(0.875, 3.3333333, 0.875);
    r7.y = ps;
    ...
    r15.xyz = tex2D(LightAttenuationTexture, r7.xy).xyz;
    ...
    r5.x = ps;
    r4.xyz = r0.xyz * UniformScalar_1.xxx + UniformScalar_2.xxx;
    r7.x = r8.w * r3.w - 1.0;
    ps = 5.0 * r5.x;
    ...
    r7.yzw = -r7.wzy + 1.0;
    r5.z = ps;
    r2.yzw = r3.yxz * r7.xzy + float3(1.0, 0.125, 0.125);
    r11.xyz = r14.xyz * r2.yyy - r10.xyz;
