...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.xw = r5.xy * r4.xy + ScreenPositionScaleBias.wz;
    ...
    r5.zw = -r3.xy;
    r5.x = r3.z * 2.0 - r3.z;
    r5.x = saturate(dot(r9.yzx, r5.zwx));
    ps = log2(r5.x);
    r5.w = saturate(r5.y * r1.z);
    r8.z = ps;
    r5.xyz = r8.xzy * float3(0.875, 15.0, 0.875);
    r5.xz = r5.xz * r2.xy + 0.125;
    ps = pow(2.0, r5.y);
    r5.x = r5.x * r5.z;
    r4.w = ps;
    r5.xyz = r5.xxx * r7.xyz + ModShadowColor.xyz;
    r6 = r4 * r6;
    r6.xy = r6.xy * r5.ww + r6.ww;
    r6.z = r6.z * r5.w + r6.w;
