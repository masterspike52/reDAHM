...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.xy = r0.xy * 0.08 + UniformVector_1.xy;
    r5.xy = r0.xy + r0.xy;
    r5.xyz = tex2D(Texture2D_0, r5.xy).xyz;
    r5.w = tex2D(Texture2D_1, r1.xy).x;
    r1.y = dot(r2.zxy, r2.zxy);
    ps = rsqrt(abs(r1.y));
    r1.x = OpacityOverride.x * 0.5;
    r1.y = ps;
    r1.zw = r1.yy * r2.xy;
    r5 = r5 * float4(0.1, 0.1, 0.1, 0.2);
    r1.y = r5.w - 0.005;
    r0.xy = r1.zw * r1.yy + r0.xy;
