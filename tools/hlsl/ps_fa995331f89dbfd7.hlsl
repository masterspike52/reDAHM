// ps_fa995331f89dbfd7.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 57 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000000E4 10000600 00000004 00000000 00005CE7 007F007F 00000001 00003050 00003151 0000F252 0000F353 0000F455 00007556 0000F657
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.xw = r0.yx - 0.5;
    r0.z = 1.0 / r4.w;
    r0.y = dot(r0.xw, float2(0.020794827, 0.99978375)) + 0.5;
    r0.x = dot(r0.xw, float2(-0.99978375, 0.020794827)) + 0.5;
    r0.zw = r0.zz * ScreenPositionScaleBias.xy;
    r1.w = SCENE_COLOR_BIAS_FACTOR.x * r6.w;
    r1.xy = r0.wz * r4.yx + ScreenPositionScaleBias.zw;
    r0.xyz = tex2D(Texture2D_0, r0.xy).xyz;
    r0.w = tex2D(SceneDepthTexture, r1.yx).x;
    r0.w = r0.w * MinZ_MaxZRatio.z - MinZ_MaxZRatio.w;
    r1.xyz = r0.xyz * r3.xyz + UniformVector_0.xyz;
    oC0.xyz = r1.www * r1.xyz;
    ps = 1.0 / r0.w;
    r0.z = r0.x * r3.w;
    r0.y = ps;
    r0.x = r0.y - r4.w;
