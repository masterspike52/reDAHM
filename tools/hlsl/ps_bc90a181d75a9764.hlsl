// ps_bc90a181d75a9764.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 72 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000120 10040700 0000070A 00000000 000070E7 001F007F 00000001 0000F050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = rsqrt(abs(r5.x));
    r0.xyz = r5.yzw + UniformVector_0.xyz;
    r5.x = ps;
    r5.x = r5.x * r1.z + 0.1;
    ps = 5.0 * r5.x;
    r5.y = saturate(ps);
