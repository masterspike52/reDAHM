// ps_b756621aa638b6a7.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 117 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001D4 10040900 00000406 00000000 00003884 000F000F 00000001 00007054 0000F155 00007256 0000F357
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.xz = r0.ww * ScreenPositionScaleBias.xy;
    r6.y = ps;
    r3.xy = r6.xz * r3.xy + ScreenPositionScaleBias.wz;
    ps = 1.0 / ModShadowAccumResolution.x;
    r7.yzw = -UniformVector_0.xyz + 1.0;
    r6.x = ps;
    r3.zw = r6.xy * abs(r4.xy);
    r6.yz = tex2D(ModShadowAccumTexture, r3.zw).xy;
    ...
    ps = LightColorAndFalloffExponent.w * r3.x;
    r8.xyz = r5.www * r2.zxy;
    r2.x = ps;
    ps = -r8.y;
    r9.xyz = r4.www * -SpotDirection.xyz;
    r8.y = ps;
    r8.x = r8.x * 2.0 - r8.x;
    ps = -r8.z;
    r0.w = dot(r9.zxy, r1.zxy);
    r8.z = ps;
    ps = -SpotAngles.x - -r0.w;
    r1.xyz = r4.zzz * r0.zxy;
    r0.x = ps;
    ps = pow(2.0, r2.x);
    r0.y = saturate(dot(r1.yzx, r8.yzx));
    r0.z = ps;
    ps = log2(r0.y);
    ...
    r2.y = r2.x * r2.x;
    r6.x = ps;
    r0.xyz = r6.xyz * float3(0.21952, 0.875, 0.875);
    r1.xyz = r1.yzw * r2.www + r0.xxx;
    r0.xy = r0.yz * r4.xy + 0.125;
    ps = r0.x * r0.y;
