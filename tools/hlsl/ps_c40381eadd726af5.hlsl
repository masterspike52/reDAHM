// ps_c40381eadd726af5.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 210 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000348 10040E00 0000080A 00000000 00008108 003F00FF 00000001 0000F050 0000F153 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.xyw = tex2D(Texture2D_1, r0.xy).zxy;
    ...
    r4.y = ps;
    ps = rsqrt(abs(r6.y));
    r2.xyz = r6.xxx * r13.xyz;
    r6.y = ps;
    ps = ModShadowGroupColor.y * r6.z;
    r0.xyz = r0.xyz * r6.yyy;
    r4.z = ps;
    r6.xyz = r14.xyz * r13.xzy + r2.xzy;
    r2.xyz = r6.xyz * r10.ywz - r6.xyz;
    r10.yzw = -r4.xyz + 1.0;
    r7.w = dot(r0.xyz, r0.xyz);
    ps = rsqrt(abs(r7.w));
    r6.w = float((r10.y >= 0.004));
    r7.w = ps;
    r6.xyz = r2.xzy * UniformScalar_2.xxx + r6.xzy;
    r4.xyz = r6.xzy * UniformScalar_3.xxx + UniformScalar_4.xxx;
    r2.xyz = r0.xyz * r7.www;
    r0.xyz = r6.xyz * r12.xyz;
    r6.xyz = r0.xyz * AmbientColorAndSkyFactor.xyz + UniformVector_0.xyz;
    r11.x = dot(r8.zxy, r2.xyz);
    r7.w = dot(r2.xyz, r5.zxy);
    r8.xyz = r2.yzx * r7.www;
    r8.xyz = r8.xyz * 2.0 - r5.xyz;
    r5 = r11.xxyz * float4(-0.5, 0.5, 0.875, 0.875);
    r10.yz = r5.zw * r10.zw + 0.125;
    ...
    r10.w = ps;
    r5.xyz = r7.xyz * UpperSkyColor.xzy + r6.xzy;
    r7.xw = r10.yx * r10.zw;
    r6.xyz = r7.xxx * r9.xyz + ModShadowColor.xyz;
    r7.xyz = r8.xzy * LowerSkyColor.xyz + r5.xzy;
    ps = pow(2.0, r7.w);
