...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.xyz = r4.xyz * UniformVector_1.xyz;
    ...
    r1.x = saturate(dot(r1.wyz, r8.yxz));
    ps = log2(r1.x);
    r0.x = saturate(dot(r3.zxy, r1.wyz));
    r7.z = ps;
    r3.xyz = r7.xyz * float3(0.875, 0.875, 15.0);
    ps = pow(2.0, r3.z);
    r1.xyw = r6.xyz * r0.xxx;
    r0.x = ps;
    r3.xy = r3.xy * r5.xy + 0.125;
    ps = r3.x * r3.y;
    r1.z = r0.x * r4.w;
    r0.x = ps;
