// ps_c6708158bf020d4c.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 18 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000048 10000400 00000008 00000000 00004CA5 0007001F 00000001 0000F055 00007156 0000F257 0000F3A0 0000F4A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = r2.w;
    r3.xy = UniformVector_0.xz + float2(2.0, 1.0);
    ps = UniformVector_0.y * ps;
    r3.xy = r3.xy * r2.ww;
    r3.z = ps;
