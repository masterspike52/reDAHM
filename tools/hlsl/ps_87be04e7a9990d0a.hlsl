// ps_87be04e7a9990d0a.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 45 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000000B4 10000200 00000004 00000000 00002463 00070007 00000021 00003050 0000F156 00007257
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.x = UniformVector_1.x * r0.y;
    r0.y = dot(r2.zx, float2(5.0, 3e+01)) + 0.0;
    r0.y = r0.y * r0.z + r0.x;
    r0.x = UniformScalar_9.x * r0.y;
    r0.x = r0.x * r2.y - 0.333;
