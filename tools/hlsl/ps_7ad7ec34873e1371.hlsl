...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.y = ps;
    ps = 5.0 * r5.w;
    r7 = r6.xyxz * float4(5.0, 5.0, 2e+01, 5.0);
    r5.x = saturate(ps);
    ps = rsqrt(abs(r0.x));
    r6.xyz = r5.yyy * r1.xyz;
    r5.y = ps;
    ps = rsqrt(abs(r5.z));
    ...
    r2.xy = r11.xy * r1.xy + 0.125;
    r1.xyz = r10.xyz * r5.xxx;
    ps = -SpotAngles.x - -r5.z;
    r5.w = dot(r1.zxy, r0.zxy);
    r5.x = ps;
    ps = SpotAngles.y * r5.x;
    r3.xyz = r1.xzy * r5.www;
    r2.z = saturate(ps);
    r0.yzw = r3.xyz * 2.0 - r0.xzy;
    ps = LightColorAndFalloffExponent.w * r5.y;
    r5.xw = r2.xz * r2.yz;
    r0.x = ps;
    r5.xyz = r5.xxx * r9.xyz + ModShadowColor.xyz;
    ps = pow(2.0, r0.x);
    r6.w = saturate(dot(r6.zxy, r0.zyw));
    r0.x = ps;
    ps = log2(r6.w);
    r8.w = max(r7.z, 0.0001);
    r0.y = ps;
    r0 = r8.xzyw * r0.xxxy;
    ps = pow(2.0, r0.w);
    r6.w = saturate(dot(r1.zxy, r6.zxy));
    r6.x = ps;
