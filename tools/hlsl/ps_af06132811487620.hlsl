// ps_af06132811487620.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 537 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000864 10000400 00000008 00000000 00004084 0003000F 00000021 0000F050 0000F156 0000F2A0 0000F3A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.x = tex2D(Texture2D_8, r2.xy).w;
    r2.x = (-0.5) + r2.x;
