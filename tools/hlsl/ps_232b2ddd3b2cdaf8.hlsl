...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r11.w = ps;
    r4.yz = tex2D(ModShadowAccumTexture, r11.zw).xy;
    r15.xyz = tex2D(Texture2D_4, r10.xy).xyz;
    r17 = tex2D(Texture2D_1, r11.xy);
    r7.xyz = tex2D(Texture2D_6, r1.zw).xyz;
    ...
    r16.x = r7.w * r12.z - 1.0;
    r16.yz = r12.xy * 2.0 - 1.0;
    ps = rsqrt(abs(r0.y));
    ...
    r7.w = saturate(ps);
    ps = r3.w;
    r2.yzw = r1.xyz * r7.xyz;
    r13.yzw = r2.yzw * UniformScalar_3.xxx + UniformScalar_4.xxx;
    ps = 0.0001 * ps;
