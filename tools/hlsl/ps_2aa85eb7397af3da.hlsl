...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.yzw = tex2D(Texture2D_3, r0.xy).xyz;
    ...
    r0.x = saturate(dot(r6.zxy, r4.yxz));
    r2.x = ps;
    ps = log2(r0.x);
    r4.xyz = r8.xyz * r2.yzw;
    r1.w = ps;
    ps = LightColor.y * r0.z;
    r2.zw = r1.xy * r1.wz;
    r2.y = ps;
    r1.xyz = r2.www * r7.xyz + ModShadowColor.xyz;
    ps = pow(2.0, r2.z);
