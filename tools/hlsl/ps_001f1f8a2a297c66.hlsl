...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.xz = tex2D(ModShadowAccumTexture, r6.xz).xy;
    r6.z = dot(r2.zxy, r2.zxy);
    r6.x = dot(r3.zxy, r3.zxy);
    ps = rsqrt(abs(r6.z));
    r0.zw = r0.xz * 0.875;
    r7.w = ps;
    r6.w = saturate(r7.w * r2.z);
    r0.x = max(UniformScalar_0.x, 0.0001);
    ps = r2.z;
    ...
    r2.xy = r0.zw * r6.yz + 0.125;
    ps = 1.0 - r6.x;
    r0.z = saturate(dot(r8.yzx, r3.yzx));
    r6.y = saturate(ps);
    ps = log2(r6.y);
    r6.x = r2.x * r2.y;
    r7.w = ps;
