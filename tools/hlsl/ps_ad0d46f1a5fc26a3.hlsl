...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = r2.w;
    r4.xyz = UniformVector_2.xyz - UniformVector_1.xyz;
    ps = SCENE_COLOR_BIAS_FACTOR.x * ps;
    r3.xyz = UniformVector_0.xyz + UniformVector_1.xyz;
    r3.w = ps;
    r3.xyz = r4.xyz * UniformScalar_10.xxx + r3.xyz;
