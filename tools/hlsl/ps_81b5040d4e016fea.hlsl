...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.w = ps;
    ps = log2(r5.z);
    r0.x = saturate(r5.w * r1.z);
    r5.x = ps;
    ps = LightColorAndFalloffExponent.w * r5.x;
    r1.xzw = r8.xyz * float3(0.21952, 0.875, 0.875);
    r5.x = ps;
    ps = r1.x;
    ...
    r5.yzw = r1.xyz * r0.xyz;
    r0.x = saturate(ps);
    ps = r0.x * r0.x;
    r5.xyz = r5.yzw * LightColorAndFalloffExponent.xyz;
    r0.y = ps;
