...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = r4.x * ps;
    r5.x = r4.y * LightColorAndFalloffExponent.w;
    r5.y = ps;
    ps = pow(2.0, r5.x);
    ...
    r4.y = ps;
    r4.yzw = r4.yyy * r3.xyz + ModShadowColor.xyz;
