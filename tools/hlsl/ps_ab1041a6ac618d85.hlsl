// ps_ab1041a6ac618d85.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 255 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000003FC 10041200 0000080A 00000000 00007908 003F00FF 00000021 00003050 0000F151 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r18.z = ps;
    r10.xyz = (-abs(r0.zzz) >= 0.0) ? r10.xyz : 1.0;
    ps = rsqrt(abs(r0.x));
    r16.xyz = r16.xzy * r16.www;
    r0.z = ps;
    r6.xyz = r6.zxy * 2.0 - 1.0;
    ps = UniformVector_2.z * r6.x;
    r12.yzw = r11.xzy * r11.www;
    r0.x = ps;
    ps = UniformVector_2.x * r6.y;
    r11.xyz = r0.zzz * r2.xyz;
    r0.z = ps;
    ps = UniformVector_2.y * r6.z;
    r12.yzw = r18.xyz * r12.yzw;
    r0.w = ps;
    ps = rsqrt(abs(r9.w));
    r2.xyz = r17.xyz * r16.xyz;
    r6.y = ps;
    r16.xyz = (-abs(r8.www) >= 0.0) ? 1.0 : r10.xyz;
    r8.xyz = r8.xzy * r16.xzy + UniformScalar_10.xxx;
    r2.xyz = (-abs(r1.www) >= 0.0) ? r12.yzw : r2.xyz;
    ps = rsqrt(abs(r7.w));
    r6.x = r11.z + 0.1;
    r6.z = ps;
    ps = 5.0 * r6.x;
    ...
    r6.y = ps;
    r12.yzw = (-abs(r6.www) >= 0.0) ? r12.yzw : r2.xyz;
    ps = 1.0 - r6.y;
