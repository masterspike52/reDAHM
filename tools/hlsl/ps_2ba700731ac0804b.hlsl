// ps_2ba700731ac0804b.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 426 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000006A8 10041500 0000090A 00000000 00009129 003F01FF 00000021 0000F050 0000F153 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A1 0000F8A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r16.xyz = r16.xyz * 2.0 - 1.0;
    ps = rsqrt(abs(r7.y));
    r18.xyz = r16.xyz * UniformVector_4.xyz;
    r7.z = ps;
    ps = rsqrt(abs(r7.x));
    r18.z = -r19.z + r18.z;
    r7.y = ps;
    r16.xyz = UniformVector_6.xyz * UniformVector_6.www;
    r7.x = dot(r15.zxy, r15.zxy);
    r4.xyz = r16.xyz * r12.xyz;
    r17.yzw = r4.xyz * r8.wxy;
    ...
    r7.x = ps;
    ps = r3.w;
    r15.xyz = r15.xzy * r7.xxx;
    ps = 0.0001 * ps;
    r2.xyz = r16.yzx * r15.zyx;
    r7.x = saturate(ps);
    r2.xyz = r16.xyz * r15.yxz - r2.xyz;
    ps = r11.z;
    ...
    r18.xy = r6.yz - r19.xy;
    r17.x = ps;
    r7.w = saturate(r17.x * r2.w - 0.5);
    r6.xy = r18.xy * r7.ww + r19.xy;
    r6.z = r18.z * r7.w - 2.0;
    r6.z = r4.w * 2.0 + r6.z;
    r6.xyz = r6.zxy * r7.yyy;
    ps = 1.0 + r6.x;
    r14.xy = r14.xy * abs(r9.xy);
    r6.w = ps;
    ...
    r6.xyz = r9.xzy * r11.zzz + r6.xyz;
    r6.xyw = r15.yzx * r11.xxx + r6.zyx;
    r9.xyz = r6.xxx * LocalToWorldMatrix[2].xyz;
    r6.xyz = r6.yyy * LocalToWorldMatrix[1].xyz + r9.xyz;
    r6.xyz = r6.www * LocalToWorldMatrix[0].xzy + r6.xzy;
    r6 = xe_cube(r6.xzy);
    ps = 1.0 / abs(r6.z);
    r9.z = r6.w;
    r8.z = ps;
    r9.xy = r6.yx * r8.zz + 1.5;
    r13.yz = tex2D(ModShadowAccumTexture, r14.xy).xy;
    r6.x = tex2D(Texture2D_4, r0.xy).x;
    r0.xyz = tex2D(Texture2D_7, r13.xw).xyz;
    r16.xyz = texCUBE(TextureCube_0, xe_cube_dir(r9.xyz)).xyz;
    ...
    r18.y = ps;
    r15.xyz = r4.xyz * UniformScalar_5.xxx + UniformScalar_6.xxx;
    ps = UniformVector_5.z * UniformVector_5.w;
    r19.xyz = r6.zzz - r16.xyz;
    r18.z = ps;
    r4.xyz = r17.yzw * UniformScalar_11.xxx + UniformScalar_12.xxx;
    r16.xyz = r19.xyz * UniformScalar_4.xxx + r16.xyz;
    ps = log2(abs(r10.w));
