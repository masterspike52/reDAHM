...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.xyz = r7.yzw * r0.xyz;
    r12.xyz = r9.zxy * 2.0 - 1.0;
    ps = rsqrt(abs(r6.y));
    r0.xyz = r0.xyz * AmbientColorAndSkyFactor.xyz;
    r6.y = ps;
    r9.xyz = r0.xyz * r7.yzw + UniformVector_0.xyz;
    ps = rsqrt(abs(r6.x));
    ...
    r7.xyz = r0.xzy * LowerSkyColor.xyz + r7.xzy;
    r0.xyz = r7.www * UniformVector_1.xyz;
