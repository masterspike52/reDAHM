...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.xyz = tex2D(Texture2D_3, r8.xy).xyz;
    r4.xy = tex2D(ModShadowAccumTexture, r5.xz).xy;
    r9.xyz = tex2D(Texture2D_1, r0.xy).xyz;
    r7.xyz = tex2D(Texture2D_0, r0.xy).xyz;
    r5.x = tex2D(Texture2D_2, r0.xy).x;
    r5.z = dot(r1.zxy, r1.zxy);
    r11.xyz = r7.xyz * r9.xyz - r7.xyz;
    ps = rsqrt(abs(r5.z));
    r9.xy = r4.xy * 0.875;
    r1.w = ps;
    r0.w = saturate(r1.w * r1.z);
    ps = r1.z;
    r7.w = max(UniformScalar_8.x, 0.0001);
    ps = 0.1 + ps;
    ...
    r5.y = ps;
    ps = rsqrt(abs(r5.w));
    r1.yzw = r5.yyy * -SpotDirection.xyz;
    r5.y = ps;
    ps = 1.0 - r5.x;
    r5.yzw = r5.yyy * r3.zxy;
    r1.x = ps;
    r7.xyz = r11.xyz * UniformScalar_0.xxx + r7.xyz;
    r3.xyz = r7.xyz * UniformScalar_1.xxx + UniformScalar_2.xxx;
    r5.x = r5.y * 2.0 - r5.y;
    ps = -r5.z;
    ...
    r2 = r10 * r7.xyzz;
    r5.w = ps;
    r7.xy = r10.ww * r7.xy + r2.xy;
    r1.yz = r9.xy * r1.xy + 0.125;
    ps = -SpotAngles.x - -r5.y;
    r5.z = saturate(dot(r8.yzx, r5.zwx));
    r5.x = ps;
    ps = r2.z + r2.w;
    r1.x = saturate(r5.x * SpotAngles.y);
    r7.z = ps;
    ps = log2(r5.z);
    r5.xw = r1.yx * r1.zx;
    r4.w = ps;
