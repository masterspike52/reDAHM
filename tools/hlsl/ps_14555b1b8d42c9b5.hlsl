// ps_14555b1b8d42c9b5.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 582 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000918 10000400 00000008 00000000 00004084 0003000F 00000021 0000F050 0000F156 0000F2A0 0000F3A2
...
float4 TextureDensityParameters : register(c8); // float4
float4 TextureLookupInfo[16] : register(c9); // float4[16]
float4 UniformScalar_11 : register(c4); // float
float4 UniformScalar_12 : register(c5); // float
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.yw = r0.xy * UniformVector_2.xy;
    r2.y = tex2D(Texture2D_9, r2.yw).w;
    ...
    ps = 1.0 - r2.x;
    r2.x = ps;
    r2.z = (UniformScalar_12.x > 0.0) ? r2.x : 1.0;
    r2.x = (UniformScalar_12.x >= 0.0) ? r2.z : r2.x;
    r2.x = r2.x * r2.y - 0.5;
