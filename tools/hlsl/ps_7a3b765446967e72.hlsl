// ps_7a3b765446967e72.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 87 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000015C 10040700 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.zw = tex2D(ModShadowAccumTexture, r2.xy).xy;
    ps = rsqrt(abs(r5.x));
    r2.xy = r5.zw * 0.875;
    r5.x = ps;
    ps = r1.z;
    r5.z = saturate(r5.x * r1.z);
    ps = 0.1 + ps;
