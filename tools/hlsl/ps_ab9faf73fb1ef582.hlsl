// ps_ab9faf73fb1ef582.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 114 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001C8 18000400 00000004 00000000 00002863 00070007 00000011 00003050 0000F151 0000F257
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4 = r0.zwzw * float4(3.0, 3.0, 4.0, 4.0);
    r3.y = ps;
    ps = UniformVector_1.x + r0.z;
    r3.xw = r4.zw + UniformVector_2.xy;
    r3.z = ps;
    r3.yz = r3.zy + r0.zw;
    r3.x = tex2D(Texture2D_1, r3.xw).w;
    r0.w = tex2D(Texture2D_2, r4.xy).x;
    r0.z = tex2D(Texture2D_0, r3.yz).w;
    ...
    r1.x = r2.z * InvMaxSubjectDepth.x + r1.x;
    r0.w = r0.w * r0.z - 0.5;
    r0.z = r0.x;
    r0.x = r0.y;
    ps = UniformVector_1.y + r0.x;
    r3 = r0.zxzx * float4(3.0, 3.0, 4.0, 4.0);
    r2.x = ps;
    ps = UniformVector_1.x + r0.z;
    r1.yz = r3.zw + UniformVector_2.xy;
    r2.y = ps;
    r0.xy = r2.yx + r0.zx;
    r2.x = tex2D(Texture2D_1, r1.yz).w;
    r1.y = tex2D(Texture2D_2, r3.xy).x;
    r0.y = tex2D(Texture2D_0, r0.xy).w;
    // unhandled fetch opcode 18
    r0.x = r2.z * InvMaxSubjectDepth.x;
    ps = max(r2.y, r2.w);
    r1.z = -r0.y + 4.0;
    r0.z = ps;
    ps = r1.y;
