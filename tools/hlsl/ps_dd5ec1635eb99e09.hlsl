...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.xy = r0.wz * 4.0;
    r3.z = ps;
    r3.y = tex2D(Texture2D_3, r3.xy).z;
    r3.x = float((UniformScalar_7.x >= 1.0));
    r3.x = r3.z * r3.x + r4.w;
    r3.x = -r3.x + r4.z;
    ...
    ps = 1.0 - r3.x;
    r3.x = ps;
    r3.y = (UniformScalar_8.x > 0.0) ? r3.x : 1.0;
    r3.x = (UniformScalar_8.x >= 0.0) ? r3.y : r3.x;
    ps = (-0.5) - -r3.x;
    r3.x = ps;
