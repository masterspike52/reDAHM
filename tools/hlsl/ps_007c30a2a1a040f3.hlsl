...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.x = saturate(ps);
    ps = 1.0 - r6.x;
    r0.xyw = r6.yzw * r0.xyw;
    r6.z = ps;
    ps = rsqrt(abs(r1.w));
    r10.xyz = r2.www * r2.zxy;
    r6.x = ps;
    ps = log2(r7.w);
    ...
    r7.xy = r7.xy * r6.zw + 0.125;
    ps = -SpotAngles.x - -r6.y;
    r6.w = saturate(dot(r10.yzx, r2.yzx));
    r6.z = ps;
    ...
    r6.x = ps;
    ps = pow(2.0, r6.x);
    r1.xyz = r7.zzz * r8.xyz;
    r6.x = ps;
    ps = pow(2.0, r7.x);
    r1.xyz = r1.xyz * r6.xxx;
    r6.x = ps;
    r7.xzw = r6.xxx * r5.xyz;
