// ps_7569230bb7d5e2f6.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 114 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001C8 10040900 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.w = tex2D(Texture2D_1, r6.xy).w;
    r0.yzw = tex2D(Texture2D_0, r0.xy).xyz;
    r5.yzw = tex2D(LightAttenuationTexture, r5.yz).xyz;
    ...
    r8.xyz = -r0.yzw + r1.www;
    r6.w = rsqrt(abs(r6.w));
    r8.xyz = r8.xyz * r0.www + r0.yzw;
    r9.xyz = r6.www * r1.zxy;
    r0.x = rsqrt(abs(r0.x));
    r0.xyz = r0.xxx * r3.xzy;
    r5.x = 1.0 - r5.x;
    r3.xy = -r5.xx * ModShadowGroupColor.xy + 1.0;
    r0.zw = -r0.xz;
    r0.x = LightColor.x * r5.y;
    r0.y = r0.y * 2.0 - r0.y;
    ps = LightColor.z * r5.w;
    r5.x = saturate(dot(r9.yzx, r0.zwy));
    r0.y = ps;
    ps = log2(r5.x);
    r6.w = saturate(r6.w * r1.z);
    r4.z = ps;
    ps = LightColor.y * r5.z;
    r4.xyz = r4.xyz * float3(0.875, 0.875, 15.0);
    r0.z = ps;
    ps = pow(2.0, r4.z);
    r1.xyz = r8.xyz * r7.xyz;
    r5.z = ps;
    r5.xy = r4.xy * r3.xy + 0.125;
    ps = r5.x * r5.y;
