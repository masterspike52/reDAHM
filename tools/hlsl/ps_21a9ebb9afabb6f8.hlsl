...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 - r6.x;
    r6.w = saturate(dot(r9.zxy, r6.wyz));
    r6.x = ps;
    r6.yz = r6.xx * ModShadowGroupColor.xy;
    r6.xzw = -r6.wyz + 1.0;
    r4.xyz = tex2D(LightAttenuationTexture, r7.yw).xyz;
    r7.y = tex2D(ShadowTexture, r0.xy).x;
    r5.xy = tex2D(ModShadowAccumTexture, r7.xz).xy;
    r10.xyz = tex2D(Texture2D_2, r6.xx).xyz;
    r8.xyz = tex2D(Texture2D_0, r1.xy).xyz;
    r7.z = dot(r2.zxy, r2.zxy);
    r7.x = dot(r3.zxy, r3.zxy);
    ps = rsqrt(abs(r7.z));
    r6.y = saturate(-r7.x + 1.0);
    r7.z = ps;
