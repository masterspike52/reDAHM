// ps_37ae06b210d9163a.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 120 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001E0 10000500 00000004 00000000 00004CC6 003F003F 00000021 00003050 00003151 0000F252 0000F353 0000F455 00007556
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.yz = r0.xy * 4.0 + UniformVector_4.xy;
    ps = 1.0 / r4.w;
    ...
    r0.y = ps;
    r3.xy = r0.zx * r4.yx + ScreenPositionScaleBias.zw;
    ...
    ps = (-0.002) + r0.x;
    r2.x = UniformVector_6.x * 3e+01;
    r0.x = ps;
    r2.yz = r3.wz * r0.xx + r2.yz;
    r0.w = tex2D(SceneDepthTexture, r3.yx).x;
    r0.x = tex2D(Texture2D_1, r2.yz).x;
    r1.x = r2.x * r1.z;
