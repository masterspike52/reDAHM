// ps_23667f225093922b.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 72 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000120 10040800 0000080A 00000000 00007908 001F00FF 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A1 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.w = ps;
    r6.xy = r5.zw * abs(r8.xy);
    r5.xy = r5.xy * r4.xy + ScreenPositionScaleBias.wz;
    r3.xyz = tex2D(Texture2D_2, r0.xy).xyz;
