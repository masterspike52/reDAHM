// ps_d1669f39167e9126.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 303 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004BC 10040F00 0000090A 00000000 00009129 003F01FF 00000021 0000F050 0000F153 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A1 0000F8A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.y = ps;
    ps = rsqrt(abs(r7.w));
    r2.xyz = r12.xzy * r6.yyy;
    r6.y = ps;
    ps = 0.1 - -r7.x;
    r4.xyz = r15.xzy * r6.yyy;
    r6.y = ps;
    ps = 5.0 * r6.y;
    r15.xyz = r2.yzx * r4.zyx;
    r6.z = saturate(ps);
    r15.xyz = r2.xyz * r4.yxz - r15.xyz;
    ps = 1.0 - r6.z;
    r12.xyz = r15.xyz * r12.www;
    r7.w = ps;
    ps = 1.0 - r6.w;
    r4.w = dot(r12.zxy, r12.zxy);
    r2.w = ps;
    ...
    r8.w = tex2D(Texture2D_1, r0.xy).x;
    ...
    r2.xyz = r0.xyz * UniformScalar_10.xxx + UniformScalar_11.xxx;
    r0.xyz = r0.xyz * UniformScalar_5.xxx + UniformScalar_6.xxx;
    r5.xyz = r6.yyy - r14.xyz;
