...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.y = ps;
    ps = 5.0 * r6.x;
    r7.xyw = r7.xyz * r8.xyz;
    r6.x = saturate(ps);
    ps = rsqrt(abs(r6.w));
    r3.xyz = r6.yyy * r2.zxy;
    r6.w = ps;
    ps = 1.0 - r6.x;
    r1.yzw = r6.www * r4.zxy;
    r6.x = ps;
    ...
    r1.y = r1.y * 2.0 - r1.y;
    ps = 1.0 + ps;
    r6.x = saturate(dot(r3.yzx, r1.zwy));
    r1.y = ps;
    ps = log2(r6.x);
    r7.z = saturate(r6.y * r2.z);
    r9.x = ps;
    ps = log2(r6.z);
    r6.xyw = r9.xzy * float3(15.0, 0.875, 0.875);
    r6.z = ps;
    r0.yz = r6.wy * r0.yz + 0.125;
    ps = pow(2.0, r6.x);
