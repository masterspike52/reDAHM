// ps_492fc1932fa5aca2.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 51 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000000CC 10000300 00000004 00000000 00002863 00070007 00000021 00003050 0000F151 0000F256
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.w = tex2D(Texture2D_0, r0.xy).w;
    r3.x = r1.w * 5.0;
