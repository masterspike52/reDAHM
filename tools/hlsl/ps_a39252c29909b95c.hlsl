...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5 = tex2D(Texture2D_4, r0.xy).xwyz;
    ...
    r5.x = ps;
    ps = 5.0 * r5.y;
    r1 = r10 * float4(0.875, 0.875, 1.8, 1.5);
    r5.z = ps;
    ...
    r5.w = ps;
    ps = r5.z;
    r2.xyz = r8.xyz * r5.www;
    r5.z = ps;
    ps = 0.0001;
    r6.x = dot(r2.zxy, r7.wxz);
    r5.w = ps;
    ps = max(r5.z, r5.w);
    ...
    r5.z = saturate(dot(r4.zxy, r7.zxw));
    r5.y = ps;
    ps = log2(r5.z);
    r7.x = saturate(r5.y * SpotAngles.y);
    r7.z = ps;
    r5.yw = r7.yx * r7.zx;
    ps = pow(2.0, r5.y);
    r0.w = saturate(dot(r2.zxy, r4.zxy));
    r0.x = ps;
    r2 = r1.zxyw * r0.xyzx;
