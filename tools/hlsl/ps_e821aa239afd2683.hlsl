// ps_e821aa239afd2683.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 285 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000474 10040E00 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 + ps;
    r9.xyw = r5.yxz * float3(0.5, -0.025, 0.5);
    r5.x = ps;
    ps = UniformVector_2.y * r5.x;
    r13.zw = r8.xy * r9.yy;
    r13.y = ps;
    r5.xy = r13.xy - 0.5;
    r10.xz = float2((r13.xy >= 0.5));
    ps = r6.x;
    r5.xy = r5.xy - r13.xy;
    ps = abs(r7.x) * ps;
    r12.zw = r5.xy * r10.xz;
    ...
    r10.z = ps;
    r0.z = (r10.x == 0.0) ? r7.x : r7.y;
    r10 = r10.xxyz + float4(-3.0, -2.0, -1.0, -1.0);
    r7.xy = r10.zw + r9.xw;
    r0.z = (r10.y == 0.0) ? r7.z : r0.z;
    r5.y = (r10.x == 0.0) ? r7.w : r0.z;
    r0.z = max(r5.y, 0.0);
    r9.x = min(r0.z, 0.3);
    ps = 1.0 / r4.w;
    r3.xyz = r9.yxz * float3(0.875, 3.3333333, 0.875);
    r0.z = ps;
    r7.xy = r3.yy * r7.xy - r6.xy;
    r13.xy = r0.xy * UniformVector_4.xy + r7.xy;
    r7.xy = r13.zw * r0.zz + ScreenPositionScaleBias.wz;
    ...
    r4.x = r8.w * r3.w - 1.0;
    ps = 1.0 - r5.x;
    r14.xyz = r12.xyz * r11.xyz;
    r5.x = saturate(ps);
    r2.xyz = r14.xyz * UniformScalar_1.xxx + UniformScalar_2.xxx;
    r12.w = r0.w * UniformVector_4.z - r6.z;
    ps = log2(r5.x);
