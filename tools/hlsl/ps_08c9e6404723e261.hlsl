...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.y = -r3.w + 1.0;
    r4.x = ps;
    r2.xy = -r0.yy * ModShadowGroupColor.xy + 1.0;
    ps = -r4.y;
    r8.xyz = r0.xxx * -SpotDirection.xyz;
    r0.y = ps;
    r0.x = r4.w * 2.0 - r4.w;
    ps = -r4.z;
    ...
    r4.z = saturate(dot(r7.yzx, r0.yzx));
    r4.y = ps;
    ps = log2(r4.z);
    ...
    r6.x = ps;
    ps = pow(2.0, r4.x);
    r4.yzw = r6.xyz * float3(0.21952, 0.875, 0.875);
    r2.z = ps;
    r4.x = r0.w * r5.w + r4.y;
    r4 = r4.zwxy * r2.xyzz;
    r4.xy = r4.xy + 0.125;
    r5.xyz = r4.zww * r5.xyz;
    ps = r4.x * r4.y;
