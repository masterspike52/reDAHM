// ps_fc27dc94781c9caa.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 159 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000027C 10040F00 0000080A 00000000 00008108 003F00FF 00000001 0000F050 0000F153 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.yz = r0.xy * 0.1 + UniformVector_1.xy;
    ...
    r7.w = ps;
    ps = rsqrt(abs(r0.w));
    r6.xzw = r15.wzx + r15.wzy;
    r12.x = ps;
    r6.z = dot(r14.yy, r13.yy) + r6.z;
    r6.x = dot(r14.zz, r13.zz) + r6.x;
    r6.w = saturate(r7.y * r9.x + r6.w);
    ps = log2(r6.w);
    r2.xy = r7.ww * ModShadowGroupColor.xy;
    r6.w = ps;
    ps = 15.0 * r6.w;
    r4 = r12.yzxx * float4(0.875, 0.875, -0.5, 0.5);
    r7.w = ps;
    ...
    r4 = r4.zxyw + float4(0.5, 0.125, 0.125, 0.5);
    ps = r4.y * r4.z;
    r4.xw = abs(r4.xw) * abs(r4.xw);
    r6.x = ps;
    r6.xyz = r6.xxx * r9.yzw + ModShadowColor.xyz;
    r4.xyz = r0.xzy * r4.xxx;
    r5.xyz = r0.xzy * r4.www;
    r7.xyz = r5.xzy * UpperSkyColor.xyz + r7.xyz;
    r7.xyz = r4.xyz * LowerSkyColor.xzy + r7.xzy;
    r7.xyz = r2.xzy * r8.xyz + r7.xzy;
