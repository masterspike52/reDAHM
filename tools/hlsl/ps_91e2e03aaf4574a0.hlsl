// ps_91e2e03aaf4574a0.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 324 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000510 10041500 0000080A 00000000 00007108 003F00FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 + ps;
    r18.xyz = r6.xyz * float3(-0.025, 0.5, 0.5);
    r6.x = ps;
    ...
    ps = 5.0 * r6.x;
    r19 = r4.xxyw + float4(-3.0, -2.0, -1.0, -1.0);
    r13.w = saturate(ps);
    r6.x = (r19.y == 0.0) ? r11.z : r2.w;
    r13.x = (r19.x == 0.0) ? r11.w : r6.x;
    ps = 1.0 / r5.w;
    r6.xw = -r13.wx + 1.0;
    r15.z = ps;
    ...
    r17.xyz = tex2D(Texture2D_7, r0.zw).xyz;
    r5.xyw = tex2D(Texture2D_0, r10.xy).xyz;
    r14.yzw = tex2D(Texture2D_4, r1.xy).xyz;
    ...
    r6.y = saturate(ps);
    r10.w = r14.z * UniformVector_4.z - r1.z;
    ps = rsqrt(abs(r6.x));
    ...
    ps = 2.5 * r6.w;
    r3.xyz = r17.xyz * r7.zzz;
    r3.w = ps;
    r2.xy = r16.xx * r15.xy + r14.yw;
    ps = abs(r7.w) * abs(r7.w);
    r6.x = r7.x * r7.y;
    r14.y = ps;
    r6.xzw = r6.xxx * r10.xyz + ModShadowColor.xyz;
    r2.xy = r2.xy * UniformVector_4.xy - r1.xy;
    r10.xyz = r3.xyz * r7.www - r11.xyz;
    ps = LightColorAndFalloffExponent.w * r6.y;
    r7.xyz = r14.zxy * r14.zxy;
    r6.y = ps;
    r2.xy = r13.xx * r2.zw + r2.xy;
    r0.w = saturate(r3.w * r7.w - 0.5);
    r2.xy = r2.xy * r0.ww + r1.xy;
    ps = pow(2.0, r6.y);
    r1.xyz = r7.yyy * r12.xyz;
    r7.w = ps;
    r3.xyz = r10.xyz * r0.www + r11.xyz;
    r6.y = r10.w * r0.w - 2.0;
    r2.z = r5.w * 2.0 + r6.y;
    ps = r7.z * r7.z;
    r2.xyw = r2.xyz * r4.yyy;
    r6.y = ps;
    ps = r6.y;
    r2.z = r2.w + 1.0;
    r2.xyz = (r4.yyy > 0.0) ? r2.xyz : float3(0.0, 0.0, 1.0);
    r2.yzw = (r4.yyy >= 0.0) ? r2.xyz : float3(0.0, 0.0, 1.0);
    ps = r8.x * ps;
    r1.w = dot(r2.wyz, r2.wyz);
    r2.x = ps;
    ps = rsqrt(abs(r1.w));
