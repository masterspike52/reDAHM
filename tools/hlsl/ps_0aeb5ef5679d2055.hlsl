// ps_0aeb5ef5679d2055.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 135 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000021C 10040A00 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7 = tex2D(Texture2D_1, r1.xy).xwzy;
    r5.xyw = tex2D(Texture2D_0, r1.xy).xyz;
    r1.xyz = -ModShadowColor.xyz + 1.0;
    r0.w = dot(r4.zxy, r4.zxy);
    r0.xyz = -UniformVector_0.xyz + 1.0;
    r10.xyz = r5.xyw * 2.0 - 1.0;
    r5.xyw = r7.xwz * UniformVector_1.xyz;
    ps = rsqrt(abs(r6.z));
    r0.xyz = r5.xyw * r0.xyz;
    r6.z = ps;
    ps = 0.1 - -r2.z;
    ...
    r6.w = -r6.y + 1.0;
    r6.y = ps;
    r5.xy = -r6.ww * ModShadowGroupColor.xy + 1.0;
    ps = rsqrt(abs(r6.z));
    ...
    r5.xy = r6.yz * r5.xy + 0.125;
    ps = pow(2.0, r6.x);
    r6.y = saturate(dot(r4.zxy, r2.zxy));
    r6.x = ps;
    ps = r6.x;
    ...
    r7.xyz = r0.xyz + r0.zzw;
    ps = pow(2.0, r6.w);
    r0.xyz = r7.www * r3.xyz;
    r6.w = ps;
