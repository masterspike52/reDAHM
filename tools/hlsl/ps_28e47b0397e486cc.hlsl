// ps_28e47b0397e486cc.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 210 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000348 10040C00 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.xyw = tex2D(Texture2D_0, r0.xy).xyz;
    ...
    r11.xyz = r11.yxz + float3(-2.0, -2.0, -1.0);
    r5.w = ps;
    ps = r11.x;
    r5.x = dot(r12.zxy, float3(1.0, 1.0, 1.0));
    ps = -r2.z + ps;
    r5.xyz = -r5.ywx + 1.0;
    r9.w = ps;
    ...
    r0.x = r9.w * UniformScalar_0.x + r2.z;
    ps = r6.x + ps;
    r0.w = r0.w * r0.x;
    r10.w = ps;
    r12.xy = r10.xw * r5.zz + float2(1.0, 0.0);
    r11.yzw = r10.xyz * r5.zxy + float3(1.0, 0.125, 0.125);
    ps = r0.z;
    ...
    ps = r10.w * ps;
    r0.xyz = r12.yxz * UniformVector_2.xzy;
    r5.w = ps;
    ps = r5.w;
    r2.yz = r11.xz * r11.yw;
