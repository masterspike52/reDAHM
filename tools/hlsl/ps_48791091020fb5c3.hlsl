...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.yw = r6.xx * ScreenPositionScaleBias.xy;
    r6.z = ps;
    ...
    r0.yz = tex2D(ModShadowAccumTexture, r6.xz).xy;
    ...
    r2.xyz = r5.yzw * r6.xxx;
    ps = 1.0 + ps;
    r6.x = dot(r2.zxy, r4.zxy);
    r5.y = ps;
    ps = -UniformVector_0.z;
    r8.xyz = r2.xzy * r6.xxx;
