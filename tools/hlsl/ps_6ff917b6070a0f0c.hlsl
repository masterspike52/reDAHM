// ps_6ff917b6070a0f0c.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 126 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001F8 10040A00 0000070A 00000000 000070E7 001F007F 00000001 0000F050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.z = ps;
    ps = 5.0 * r5.x;
    r3.xyz = r0.xyz * r10.xyz;
    r5.x = saturate(ps);
    ps = 1.0 - r5.x;
    r5.w = saturate(dot(r9.xyw, r1.yzx));
    r5.x = ps;
    ps = log2(r5.w);
    r9.xy = r5.xx * ModShadowGroupColor.xy;
    r6.x = ps;
    ps = rsqrt(abs(r5.y));
    r6.xzw = r6.xyz * float3(15.0, 0.875, 0.875);
    r6.y = ps;
    ps = pow(2.0, r6.x);
    r5.xyw = -r9.xyz + 1.0;
    r6.x = ps;
    ...
    r1.zw = r6.zw * r5.xy;
    ps = r6.x * ps;
    r5.xyz = r6.yyx * float3(-0.5, 0.5, 0.21952);
    r6.z = ps;
