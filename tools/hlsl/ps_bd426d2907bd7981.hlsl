...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.w = ps;
    r1.yzw = r10.xyz * r6.www;
    r1.x = saturate(dot(r1.wyz, r3.zxy));
    r6.w = dot(r1.wyz, r9.zxy);
    r1.yzw = r1.ywz * r6.www;
    r1.yzw = r1.yzw * 2.0 - r9.xzy;
    ps = -SpotAngles.x - -r5.y;
    r6.w = saturate(dot(r3.zxy, r1.zyw));
    r5.y = ps;
    ps = log2(r6.w);
    r2.z = saturate(r5.y * SpotAngles.y);
    r7.x = ps;
    ps = LightColorAndFalloffExponent.w * r5.x;
    r1.yzw = r7.xyz * float3(15.0, 0.875, 0.875);
    r5.y = ps;
    r2.xy = r1.zw * r5.zw + 0.125;
    ps = pow(2.0, r1.y);
    r5.xw = r2.xz * r2.yz;
    r0.w = ps;
    ps = pow(2.0, r5.y);
