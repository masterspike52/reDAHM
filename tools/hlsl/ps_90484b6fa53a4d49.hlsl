// ps_90484b6fa53a4d49.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 33 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000084 10000600 00000004 00000000 00005CE7 007F007F 00000001 00003050 00003151 0000F252 0000F353 0000F455 00007556 0000F657
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.xw = r0.xy * UniformVector_1.xy;
    r1.yz = r0.xy * UniformVector_2.xy;
    r0.w = SCENE_COLOR_BIAS_FACTOR.x * r6.w;
    r0.xy = r1.xy + r1.wz;
    r0.xyz = tex2D(Texture2D_0, r0.xy).xyz;
    r1.x = OpacityOverride.x * 5e+01;
    oC0.w = r1.x * r0.x;
    r0.xyz = r0.xyz * float3(5e+01, 5.0, 1e+02) + UniformVector_0.xyz;
