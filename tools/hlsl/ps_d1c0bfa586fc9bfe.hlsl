...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.x = ps;
    ps = rsqrt(abs(r5.w));
    r4.xz = saturate(r2.xy * float2(5.0, 0.00022222222));
    r5.w = ps;
    ps = 1.0 / r4.w;
    ...
    r3.xz = min(r5.xz, float2(1.0, 0.3));
    r5.x = ps;
    ...
    r2.xy = -r2.xy + 1.0;
    r7.x = ps;
    r5.z = (UniformScalar_12.x > 0.0) ? r2.y : 1.0;
    r5.z = (UniformScalar_12.x >= 0.0) ? r5.z : r2.y;
    ...
    r10.xyz = r15.xyz * UniformScalar_9.xxx + UniformScalar_10.xxx;
    ...
    r0.x = ps;
    r21.xyz = (-abs(r0.www) >= 0.0) ? r16.yxz : r22.yxz;
    r16.xyz = (abs(r0.www) > 0.0) ? r22.xzy : r16.xzy;
    ps = r4.x;
