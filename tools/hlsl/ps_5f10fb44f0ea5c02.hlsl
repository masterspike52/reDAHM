...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.x = saturate(ps);
    ps = rsqrt(abs(r5.w));
    r0.xyz = -r9.xyz + r12.xyz;
    r5.w = ps;
    r9.xyz = r0.xyz * UniformScalar_0.xxx + r9.xyz;
    ps = 1.0 - r5.x;
    r0.yzw = r11.zzz * UniformVector_3.xyz;
    r0.x = ps;
    r2.xyz = r11.yyy * UniformVector_2.xyz + r0.yzw;
    ps = log2(r6.z);
    r5.z = dot(r8.zxy, r8.zxy);
    r5.x = ps;
    ps = rsqrt(abs(r5.z));
    r0.yzw = r5.www * r3.xyz;
    r6.z = ps;
    ps = LightColorAndFalloffExponent.w * r5.x;
    r3.xyz = r5.yyy * r1.xyz;
    r5.w = ps;
    r5.xyz = r11.xxx * UniformVector_1.xyz + r2.xyz;
    r1.xy = -r0.xx * ModShadowGroupColor.xy + 1.0;
    r2.xy = r10.xy * r1.xy + 0.125;
    r5.xyz = (-abs(r7.www) >= 0.0) ? 1.0 : r5.xyz;
    ps = pow(2.0, r5.w);
    r8.xyz = r8.xyz * r6.zzz;
    r5.w = ps;
    r7.xyz = r7.xzy * r5.www;
    r5.w = saturate(dot(r8.zxy, r3.zxy));
    ps = (UniformScalar_1.x >= 0.0) ? 1.0 : 0.0;
    ...
    ps = r5.y;
    r2.w = saturate(dot(r3.zxy, r0.zyw));
    ps = r6.y * ps;
    r2.z = r2.w * r2.w;
    r0.y = ps;
    ps = r5.z;
    r6.xy = r2.xz * r2.yw;
    r5.xyz = r6.xxx * r4.xyz + ModShadowColor.xyz;
    ps = r6.w * ps;
