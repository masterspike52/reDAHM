// ps_9ca473ec60e14baf.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 78 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000138 10040700 0000070A 00000000 000070E7 001F007F 00000001 0000F050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.xy = r0.yx - 0.5;
    r5.z = ps;
    r6.y = dot(r5.xy, UniformVector_2.yx) + 0.5;
    r6.x = dot(r5.xy, UniformVector_1.yx) + 0.5;
    ...
    ps = rsqrt(abs(r5.x));
    r6.yzw = r6.xyz + UniformVector_0.xyz;
    r5.x = ps;
    r5.x = r5.x * r1.z + 0.1;
    ps = 5.0 * r5.x;
