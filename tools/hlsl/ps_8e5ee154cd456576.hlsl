...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r17.xyw = tex2D(Texture2D_7, r10.zw).xyz;
    r4.yzw = tex2D(Texture2D_4, r0.xy).xyz;
    r8 = tex2D(Texture2D_1, r10.xy);
    ...
    r0.w = ps;
    ps = r5.w;
    r17.yzw = r2.xyz * r15.xxx;
    r6.x = ps;
    r4.yzw = r17.yzw * UniformScalar_5.xxx + UniformScalar_6.xxx;
    ps = 2.5 * r6.x;
