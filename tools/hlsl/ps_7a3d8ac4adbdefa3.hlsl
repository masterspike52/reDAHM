// ps_7a3d8ac4adbdefa3.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 150 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000258 10040B00 0000090A 00000000 00008129 003F01FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A1 0000F8A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r10.xyw = tex2D(Texture2D_5, r1.xy).xzy;
    r6.yzw = tex2D(Texture2D_6, r1.xy).xyz;
    ...
    r7.w = ps;
    r2.xy = -r8.ww * ModShadowGroupColor.xy + 1.0;
    r11.yz = r3.zw * r2.xy + 0.125;
    ps = 1.0 - r6.x;
    r4.xyz = r1.xyz * r7.www;
    r6.x = saturate(ps);
    ps = log2(abs(r10.y));
    ...
    r6.x = ps;
    ps = pow(2.0, r1.z);
    r7.w = saturate(dot(r4.zxy, r5.zxy));
    r2.x = ps;
    ps = pow(2.0, r1.w);
