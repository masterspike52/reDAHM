...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.xy = r0.xy + UniformVector_2.xy;
    r5.z = 1.0 / r4.w;
    ps = ScreenPositionScaleBias.x * r5.z;
    r5.yw = r0.xy + UniformVector_1.xy;
    r6.x = ps;
    ...
    r9.xyz = tex2D(Texture2D_2, r5.yw).xyz;
    r0.yzw = tex2D(Texture2D_3, r8.xy).xyz;
    r10.xyz = tex2D(Texture2D_0, r5.yw).xyz;
