// ps_3a34a43c0a6cc718.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 198 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000318 10040C00 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.x = ps;
    r8.xw = r6.xy * r5.xx + ScreenPositionScaleBias.wz;
    ps = r10.w;
    ...
    r0.xyz = tex2D(LightAttenuationTexture, r8.xw).xyz;
    r5.yzw = tex2D(Texture2D_1, r5.yz).wxy;
    ...
    r11.x = saturate(ps);
    ps = r1.z;
    r4.yzw = UniformVector_1.xyz * UniformVector_1.www;
    ps = 0.1 + ps;
    ...
    r6.z = ps;
    ps = rsqrt(abs(r4.x));
    r10.xyz = r4.yzw * r10.xyz;
    r5.w = ps;
    ps = rsqrt(abs(r7.w));
    r0.w = saturate(-r0.w + 1.0);
    r5.z = ps;
    ps = 5.0 * r5.x;
    r11.yzw = r6.wxy + float3(-2.0, 0.0, 0.0);
    r5.y = saturate(ps);
    r2.xyz = (-abs(r3.www) >= 0.0) ? r12.xyz : 1.0;
    r2.xyz = (-abs(r1.www) >= 0.0) ? 1.0 : r2.xyz;
    ps = 1.0 - r5.y;
    r4.xyz = r5.zzz * r1.xyz;
    r5.z = ps;
    ps = log2(r0.w);
    r6.xyw = r11.zwy + r6.xyw;
    r5.x = ps;
    ...
    r2.yzw = -r11.xyz + 1.0;
    r5.y = ps;
    r3.zw = r6.wz * r2.yy + 1.0;
    ps = (-1.0) + r6.y;
    r2.x = r2.y * UniformScalar_1.x;
    r5.z = ps;
    r5.yz = r2.xx * r8.xw + r5.yz;
    r3.xy = r5.yz * r2.yy;
    r6 = (r2.xyyy > 0.0) ? r3.wxyz : float4(1.0, 0.0, 0.0, 1.0);
    r3 = (r2.xyyy >= 0.0) ? r6 : float4(1.0, 0.0, 0.0, 1.0);
    ps = LightColorAndFalloffExponent.w * r5.x;
    r6.w = dot(r3.wyz, r3.wyz);
    r5.x = ps;
    ps = pow(2.0, r5.x);
    r5.yzw = r10.xyz * r3.xxx;
    r5.x = ps;
    r6.xyz = r5.yzw * UniformScalar_5.xxx + UniformScalar_6.xxx;
    ps = rsqrt(abs(r6.w));
    r0.xyz = r0.xyz * r5.xxx;
    r5.x = ps;
    r3.xyz = r3.yzw * r5.xxx;
    r5.x = dot(r3.zxy, r1.zxy);
    r10.xyz = r3.xyz * r5.xxx;
    r1.xyz = r10.xyz * 2.0 - r1.xyz;
    r5.x = saturate(dot(r4.zxy, r1.zxy));
    ps = log2(r5.x);
