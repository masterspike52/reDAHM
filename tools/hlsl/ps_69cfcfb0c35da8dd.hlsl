...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.x = r4.x * 2.0 - r4.x;
    ps = 1.0 + ps;
    r0.w = saturate(dot(r6.xyz, r4.yzx));
    r4.w = ps;
    ps = log2(r0.w);
    r4.x = saturate(r3.w * r0.z);
    r5.x = ps;
    ps = log2(r2.w);
    r0.xyz = r5.yxz * float3(0.875, 15.0, 0.875);
    r0.w = ps;
    r4.yz = r0.xz * r2.xy + 0.125;
    ps = pow(2.0, r0.y);
    r0.x = r0.w * LightColorAndFalloffExponent.w;
    r0.y = ps;
    ps = pow(2.0, r0.x);
    r0.w = r0.y * 0.21952;
    r2.y = ps;
