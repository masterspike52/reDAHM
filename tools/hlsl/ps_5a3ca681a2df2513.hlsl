...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.x = saturate(ps);
    ps = rsqrt(abs(r1.x));
    r5.xyz = r1.yyy * r2.zxy;
    r1.x = ps;
    ps = 1.0 - r0.x;
    r4.xyz = r1.xxx * r4.zxy;
    r0.x = ps;
    r1.xz = -r0.xx * ModShadowGroupColor.xy + 1.0;
    r4.yz = -r4.yz;
    r4.x = r4.x * 2.0 - r4.x;
    r0.x = saturate(dot(r5.yzx, r4.yzx));
    ps = log2(r0.x);
    r3.x = r0.y * LightColor.x;
    r0.x = ps;
    ps = 15.0 * r0.x;
    r0.x = ps;
    ps = pow(2.0, r0.x);
    r4.w = saturate(r1.y * r2.z);
    r3.w = ps;
    ps = -UniformVector_0.x;
    r4.xyz = r3.yzw * float3(0.875, 0.875, 0.21952);
    ps = 1.0 + ps;
    r0.xy = r4.zz * r0.zw;
    r1.w = ps;
