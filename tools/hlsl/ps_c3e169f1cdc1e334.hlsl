// ps_c3e169f1cdc1e334.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 93 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000174 10040700 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.xyw = tex2D(LightAttenuationTexture, r6.xy).xyz;
    r6.xyz = -UniformVector_0.xyz + 1.0;
    r5.x = r1.z + 0.1;
    r0.z = rsqrt(abs(r1.w));
    r2.xyz = r0.xyw * LightColor.xyz;
    r5.x = saturate(5.0 * r5.x);
    r7.xyz = r0.zzz * r1.zxy;
    r6.w = rsqrt(abs(r6.w));
    r3.xyz = r6.www * r3.zxy;
    r5.x = 1.0 - r5.x;
