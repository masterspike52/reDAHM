...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.z = ps;
    r10.xy = r9.zw * r7.zz + ScreenPositionScaleBias.wz;
    ...
    r1.xyz = tex2D(Texture2D_4, r7.xy).xyz;
    r9.xyz = tex2D(Texture2D_5, r6.zw).xyz;
    ...
    r6.x = ps;
    r6.yw = r2.xy * r7.ww + r12.xy;
    r7.w = r2.z * r7.w - 2.0;
    ps = ModShadowGroupColor.x * r6.z;
    r1.xyz = r10.yzw * r1.xyz;
    r10.y = ps;
    ...
    r2.yzw = -r10.xyz + 1.0;
    r4.x = ps;
    r7.zw = r4.yx * r2.yy + 1.0;
    ps = -UniformVector_0.x;
    r2.x = r2.y * UniformScalar_3.x;
    r6.yz = r2.xx * r8.xw + r6.yw;
    ps = 1.0 + ps;
    r7.xy = r6.yz * r2.yy;
    r6.y = ps;
    r7 = (r2.xyyy > 0.0) ? r7.wxyz : float4(1.0, 0.0, 0.0, 1.0);
    r4 = (r2.xyyy >= 0.0) ? r7 : float4(1.0, 0.0, 0.0, 1.0);
    ...
    r6.x = ps;
    r7.xyz = r1.xyz * UniformScalar_5.xxx + UniformScalar_6.xxx;
    ps = rsqrt(abs(r6.z));
    ...
    ps = 1.0 + ps;
    r6.x = saturate(dot(r3.zxy, r9.zxy));
    r6.w = ps;
    ps = log2(r6.x);
