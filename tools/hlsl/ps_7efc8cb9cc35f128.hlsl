...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.xyw = r6.xzy * float3(15.0, 0.875, 0.875);
    r5.x = ps;
    r5.zw = r6.wy * r5.zw + 0.125;
    ps = pow(2.0, r6.x);
    r6.w = saturate(dot(r2.zxy, r1.zxy));
    r5.y = ps;
    ps = SpotAngles.y * r5.x;
    r6.xyz = r5.yyy * UniformVector_1.xyz;
    r5.y = saturate(ps);
