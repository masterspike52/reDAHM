// ps_fdd1bec1bc18ea31.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 147 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000024C 10040B00 0000080A 00000000 00007908 003F00FF 00000001 0000F050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.y = ps;
    r6.yz = r6.xy * r5.xy + ScreenPositionScaleBias.wz;
    ps = 1.0 / ModShadowAccumResolution.x;
    r6.x = r2.z + 0.1;
    r7.x = ps;
    r5.xy = r7.xy * abs(r8.xy);
    r7 = tex2D(Texture2D_2, r0.xy);
    r8.x = tex2D(Texture2D_1, r1.xy).w;
    r8.yz = tex2D(ModShadowAccumTexture, r5.xy).xy;
    r9.xyz = tex2D(LightAttenuationTexture, r6.yz).xyz;
    ...
    r6.y = ps;
    ps = 1.0 - r6.z;
    r11.xyz = r6.yyy * -SpotDirection.xyz;
    r6.w = saturate(ps);
    ps = 5.0 * r6.x;
    ...
    r6.y = -r6.x + 1.0;
    r6.x = ps;
    r4.xy = -r6.yy * ModShadowGroupColor.xy + 1.0;
    ps = rsqrt(abs(r6.z));
    r6.y = dot(r11.zxy, r3.zxy);
    r6.z = ps;
    ps = -ModShadowColor.z;
    r3.xyz = r10.xyz * r6.zzz;
    ps = 1.0 + ps;
    ...
    r6.y = ps;
    ps = log2(r6.x);
    r6.w = saturate(r6.y * SpotAngles.y);
    r8.w = ps;
    ps = pow(2.0, r0.x);
    r6.xyz = r8.yzw * float3(0.875, 0.875, 15.0);
    r0.x = ps;
    ps = pow(2.0, r6.z);
    r0.xyz = r0.ywz * r0.xxx;
    r8.y = ps;
    r6.yz = r6.xy * r4.xy + 0.125;
    ps = r6.y * r6.z;
