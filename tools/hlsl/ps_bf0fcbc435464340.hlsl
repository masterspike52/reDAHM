// ps_bf0fcbc435464340.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 87 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000015C 10040700 00000606 00000000 000050C6 003F003F 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.zw = tex2D(ModShadowAccumTexture, r3.xy).xy;
    ps = rsqrt(abs(r0.x));
    r4.xy = r0.zw * 0.875;
    r0.z = ps;
    ps = r2.z;
