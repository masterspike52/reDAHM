...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.x = ps;
    ps = 5.0 * r5.x;
    r5.z = saturate(dot(r5.yzw, r8.yzx));
    r5.x = saturate(ps);
    ps = 1.0 - r5.x;
    ...
    r3.xyz = r0.zwy * r3.xxx;
    ps = 9e+01 + ps;
    r4.xyz = r0.zwy * r3.www;
    r6.w = ps;
    r6.xyz = r4.zxy * UpperSkyColor.xyz + r6.xyz;
    r6.xyz = r3.zyx * LowerSkyColor.xzy + r6.xzy;
    r6.xyz = r1.zyx * 0.21952 + r6.xyz;
