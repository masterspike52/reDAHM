...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.w = ps;
    ps = 1.0 - r5.x;
    r4 = r4.xyxz * float4(5.0, 5.0, 5e+01, 5.0);
    r5.z = ps;
    ps = rsqrt(abs(r6.y));
    ...
    r5.zw = r6.zw * r5.zw + 0.125;
    ps = max(r6.x, r6.y);
    r2.xyz = r3.xyz * TwoSidedSign.xxx;
    r6.y = ps;
    ps = LightColorAndFalloffExponent.w * r5.x;
    r6.x = dot(r2.zxy, r1.zxy);
    r6.z = ps;
    ...
    r6.z = ps;
    ps = log2(r5.x);
    r1.xyz = r8.xzy * r6.zzz;
    r6.z = ps;
    r6.xy = r6.xy * r6.xz;
    ps = pow(2.0, r6.y);
    r5.x = saturate(dot(r2.zxy, r7.zxy));
    r6.z = ps;
    r6.yzw = r4.xyw * r6.zzz;
    r0.xy = r0.xy * r5.xx + r6.yz;
    r0.z = r0.z * r5.x + r6.w;
