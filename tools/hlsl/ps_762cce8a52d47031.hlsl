...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.z = dot(r3.zxy, r0.zxy);
    r3.xyz = r3.xzy * r6.zzz;
    r0.xyz = r3.xyz * 2.0 - r0.xzy;
    ps = -SpotAngles.x - -r6.y;
    r6.z = saturate(dot(r2.zxy, r0.yxz));
    r6.y = ps;
    ps = log2(r6.z);
    r0.x = saturate(r6.y * SpotAngles.y);
    r10.x = ps;
    r6.yzw = r10.xyz * float3(15.0, 0.875, 0.875);
    r0.yz = r6.zw * r7.xy + 0.125;
    ps = pow(2.0, r6.y);
    r7.xyz = r0.wxy * r0.wxz;
    r9.w = ps;
    ps = LightColorAndFalloffExponent.w * r6.x;
    r0 = r9 * r8;
    r6.w = ps;
    r6.xyz = r7.zzz * r1.xyz + ModShadowColor.xyz;
