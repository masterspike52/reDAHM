...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.w = ps;
    r5.yz = r5.zy * r1.yx + ScreenPositionScaleBias.zw;
    r2.xy = r5.ww * r2.xy;
    r5.xw = r2.xy * r5.xx + r0.xy;
    r5.x = tex2D(Texture2D_1, r5.xw).w;
    r5.y = tex2D(SceneDepthTexture, r5.zy).x;
    ps = SCENE_COLOR_BIAS_FACTOR.x * r3.w;
    r5.z = ps;
    r5.y = r5.y * MinZ_MaxZRatio.z - MinZ_MaxZRatio.w;
    r0.xyz = r5.xxx * r4.xyz + UniformVector_0.xyz;
    oC0.xyz = r5.zzz * r0.xyz;
    ps = 1.0 / r5.y;
    r4.z = r5.x * r4.w;
    r4.y = ps;
    r4.x = r4.y - r1.w;
