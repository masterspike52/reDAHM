// ps_11e77715a708febf.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 129 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000204 10040A00 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.x = ps;
    ps = rsqrt(abs(r6.z));
    r9.xyz = r7.zzz * r2.zxy;
    r6.z = ps;
    ps = rsqrt(abs(r6.w));
    r4.xyz = r6.zzz * r4.xyz;
    r6.z = ps;
    ps = log2(r6.y);
    r10.xyz = r6.zzz * -SpotDirection.xyz;
    r6.y = ps;
    r6.zw = -r6.xx * ModShadowGroupColor.xy + 1.0;
    r7.x = dot(r10.zxy, r3.zxy);
    r3.yz = -r4.xy;
    r3.x = r4.z * 2.0 - r4.z;
    ...
    r6.x = ps;
    ps = 15.0 * r6.x;
    r7.z = saturate(r7.z * r2.z);
    r6.x = ps;
    ps = pow(2.0, r6.x);
    r7.x = saturate(r7.x * SpotAngles.y);
    r8.z = ps;
    r2.xyz = r8.xyz * float3(0.875, 0.875, 0.21952);
    r0.xyz = r0.xyz * r7.zzz + r2.zzz;
    r7.zw = r2.xy * r6.zw + 0.125;
