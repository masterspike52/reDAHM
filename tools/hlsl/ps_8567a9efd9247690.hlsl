...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.z = ps;
    ps = 5.0 * r5.x;
    r11.xyz = r8.xyz * r5.zzz;
    r1.x = saturate(ps);
    r5.xz = -r1.yx + 1.0;
    ps = ModShadowGroupColor.x * r5.z;
    r6.y = dot(r11.zxy, r4.xyz);
    r8.x = ps;
    ps = log2(abs(r5.x));
    r1.xyz = r11.xzy * r6.yyy;
    r6.y = ps;
    r1.xyz = r1.xyz * 2.0 - r4.yxz;
    ps = ModShadowGroupColor.y * r5.z;
    r6.y = r6.y * UniformScalar_4.x;
    r8.y = ps;
    ps = pow(2.0, r6.y);
    r5.x = saturate(dot(r10.zxy, r1.yxz));
    r8.z = ps;
    ps = log2(r5.x);
    r1.yzw = -r8.xyz + 1.0;
    r6.y = ps;
    r6 = r6.zwxy * float4(0.875, 0.875, -0.05, 15.0);
    r9.xy = r6.zz * r3.xy + r7.xy;
    ps = UniformVector_2.y * r5.w;
    r13.zw = r6.xy * r1.yz;
    r13.x = ps;
    r6.xy = r6.zz * r3.xy + 0.5;
    ps = r6.x;
    r4 = r13.zwyx + float4(0.125, 0.125, -0.5, -0.5);
    ps = r0.x + ps;
    r7.yz = float2((r13.xy >= 0.5));
    r5.x = ps;
    ps = r6.y;
    r5.zw = r4.zw - r13.yx;
    r5.zw = r5.zw * r7.zy + r13.yx;
    ps = r0.y + ps;
    r3.xy = r5.zw + r5.zw;
    r5.z = ps;
    ps = r4.x * r4.y;
    ...
    r5.w = ps;
    r7.x = tex2D(Texture2D_3, r3.zw).x;
    r4 = tex2D(Texture2D_2, r3.xy);
    r13.xyz = tex2D(LightAttenuationTexture, r9.zw).xyz;
    r5.z = tex2D(Texture2D_1, r5.xz).w;
    ...
    r5.y = ps;
    r5.x = r14.x * r3.w + r5.z;
    r3.xyz = r14.yzw * r3.www + r0.xyz;
    ps = pow(2.0, r5.y);
    r0.xyz = r13.xyz * r2.www;
    r5.y = ps;
    r0.xyz = r0.xzy * r5.yyy;
    r2.xyz = r3.xyz * r12.xyz;
    r5.z = saturate(dot(r11.zxy, r10.zxy));
    r3.xyz = r3.xyz * UniformScalar_0.xxx + UniformScalar_1.xxx;
    r7.y = dot(r7.zyy, float3(1.0, 1.0, 1.0));
    r6.xyz = r5.www * r9.xyz + ModShadowColor.xyz;
    r5.y = (r7.y == 0.0) ? r4.x : r4.y;
    r7.xyz = r7.xyy + float3(1.0, -3.0, -2.0);
    ps = pow(2.0, r6.w);
    r3.w = r7.x - r8.z;
    r1.x = ps;
    r5.y = (r7.z == 0.0) ? r4.z : r5.y;
    r5.y = (r7.y == 0.0) ? r4.w : r5.y;
    r1 = r3 * r1.xxxw;
    ps = 1.0 - r5.y;
    r0.w = r1.w * r5.x;
    r5.w = ps;
    ...
    r5.x = ps;
    ps = (-0.5) - -r5.x;
    r5.yzw = r5.ywz * r6.xzy;
    r5.x = ps;
    if (any(float4(0.0, 0.0, 0.0, 0.0) > r5.xxxx)) clip(-1.0);
    oC0.xyz = r5.ywz * SCENE_COLOR_BIAS_FACTOR.xxx;
    oC0.w = 0.0;
