// vs_4765feec756892bb.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 1107 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000080 0000114C 0071000D 00000000 00000000 00007908 00000001 00000007 00000008 00000290 0010002C 0000602D 0000702E 0000302F 00005030 00015031 00201032 0000F050 00017154 0002F255 00037356 0004F457 0005F5A0 0006F6A1 0007F7A2 0000116D 00001169 0000116E 0000116A 0000116F 0000116B 00001168 0000116C
...
//   vertex element: instruction 50 -> BLENDWEIGHT0
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r7.xzw = r10.xyz * 0.007843138 - 1.0;
    ps = 0.003921569 * r1.y;
    r6.xyz = r12.xxz * r7.xzz;
    r7.z = ps;
    r4 = r11.yyyy * LocalToWorld[1].xzyw + r4.xzwy;
    r4 = r11.xxxx * LocalToWorld[0] + r4.xzyw;
    r6.xyz = r12.zyy * r7.wwx - r6.xyz;
    ps = 0.003921569 * r1.x;
    ...
    r13 = r0.xxxx * LocalToWorld[2].xzyw + r6;
    r12.xyz = r5.yxz * 0.007843138 - 1.0;
    r7.xzw = r10.xyz * 0.007843138 - 1.0;
    ps = 0.003921569 * r1.y;
    r6.xyz = r12.xxz * r7.xzz;
    r7.z = ps;
    r13 = r4.wwww * LocalToWorld[1].xzyw + r13;
    r4 = r4.zzzz * LocalToWorld[0] + r13.xzyw;
    r6.xyz = r12.zyy * r7.wwx - r6.xyz;
    ps = 0.003921569 * r1.x;
    ...
    r12 = r4.wwww * ViewProjectionMatrix[3].xwzy;
    r6.xyz = r10.xyz * 0.007843138 - 1.0;
    r5.xzw = r5.xyz * 0.007843138 - 1.0;
    r1.xyz = r1.xyw * 0.007843138 - 1.0;
    r10 = r4.zzzz * ViewProjectionMatrix[2].xwzy + r12;
    r12.xyz = WorldToLocal[1].xzy * LightDirection.yyy + r0.xyz;
    r0.xyw = -r4.yxz * CameraPosition.www + CameraPosition.yxz;
    r13.xyz = WorldToLocal[0].xyz * LightDirection.xxx + r12.xzy;
    r10 = r4.yyyy * ViewProjectionMatrix[1].xzyw + r10.xzwy;
    r4 = r4.xxxx * ViewProjectionMatrix[0] + r10.xzyw;
    ...
    r10.z = dot(r6.zyx, r13.zxy);
    r12.z = ps;
    r12.xyz = r0.xxx * WorldToLocal[1].xzy + r12.xyz;
    r0.xyz = r0.yyy * WorldToLocal[0].xyz + r12.xzy;
    ...
    r13.x = ps;
    r12.xy = r0.zx * BBox_Size.yx - r6.xy;
    r6.x = dot(r12.yx, r12.yx) + 0.0;
    ps = -r6.y * -r6.y;
    r13.zw = r6.zw * r6.zw;
    r13.y = ps;
    ps = 1.0 / r0.y;
    ...
    r6.x = -r10.w * r12.y + r0.y;
    ps = (-abs(r0.x) > 0.0) ? 1.0 : 0.0;
    r0.xz = -r0.yw + r6.yy;
    r12.y = ps;
    p0 = (r8.x != 0.0);
    ps = p0 ? 0.0 : 1.0;
    r13.xy = float2((r0.wy >= r6.xy));
    r0.xz = r7.xx * r12.zz + r0.xz;
    r0.xz = r0.xz * SP_DemolitionSpread.xx + r0.yw;
    r0.x = (r13.y == 0.0) ? r0.y : r0.x;
    r0.x = (r1.w == 0.0) ? r0.x : r0.z;
    r0.y = (r13.x == 0.0) ? r6.x : r0.x;
    if (p0)
    {
        if (p0)
        {
