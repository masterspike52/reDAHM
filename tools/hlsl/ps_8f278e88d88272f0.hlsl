// ps_8f278e88d88272f0.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 303 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004BC 10041000 00000606 00000000 000048C6 003F003F 00000021 00003050 00003151 00007254 0000F355 00007456 0000F557
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 + ps;
    r11.xyw = r9.zyw * float3(0.5, -0.025, 0.5);
    r0.z = ps;
    ...
    r1.z = ps;
    r0.z = (r1.x == 0.0) ? r12.x : r12.y;
    r1 = r1.yzxx + float4(-1.0, -1.0, -3.0, -2.0);
    r1.xy = r1.xy + r11.xw;
    r0.z = (r1.w == 0.0) ? r12.z : r0.z;
    r9.y = (r1.z == 0.0) ? r12.w : r0.z;
    r0.z = max(r9.y, 0.0);
    r11.x = min(r0.z, 0.3);
    ps = 1.0 / r5.w;
    r11.xyz = r11.yxz * float3(0.875, 3.3333333, 0.875);
    r0.z = ps;
    r1.xy = r11.yy * r1.xy - r6.xy;
    r14.xy = r8.xy * UniformVector_4.xy + r1.xy;
    r0.zw = r14.zw * r0.zz + ScreenPositionScaleBias.wz;
    ...
    r0.y = ps;
    r8.xyz = r16.xyz * UniformScalar_1.xxx + UniformScalar_2.xxx;
    r9.x = r7.w * r9.x - 1.0;
    ps = rsqrt(abs(r0.x));
    r9.z = saturate(r0.y * 5.0);
    r0.y = ps;
    ps = 1.0 - r0.x;
    ...
    r3.x = saturate(ps);
    ps = 2.5 * r0.x;
    r3.yz = r0.ww * ModShadowGroupColor.xy;
    r15.w = ps;
    ps = rsqrt(abs(r1.w));
    r9.yzw = -r3.zyx + 1.0;
    r0.x = ps;
    r11.xyz = r11.yxz * r9.xzy + float3(1.0, 0.125, 0.125);
    ps = abs(r11.x) * abs(r11.x);
    r5.xyz = r0.xxx * r2.xyz;
    r11.w = ps;
    r13.xyz = r15.xyz * r11.xxx - r12.xyz;
    r0.w = saturate(r15.w * r11.x - 0.5);
    r6.xy = r14.xy * r0.ww + r6.xy;
    r1.w = r13.w * r0.w - 2.0;
    r3.xyz = r13.xyz * r0.www + r12.xyz;
