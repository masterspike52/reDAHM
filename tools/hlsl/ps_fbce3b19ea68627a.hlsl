// ps_fbce3b19ea68627a.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 93 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000174 10040700 00000606 00000000 000050C6 003F003F 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.y = ps;
    r0.zw = r0.yz * r5.xy + ScreenPositionScaleBias.wz;
    ...
    ps = log2(r0.x);
    r0.w = r5.y * LightColor.y;
    r0.x = ps;
    ps = 15.0 * r0.x;
    r0.x = ps;
    ps = pow(2.0, r0.x);
    r1.z = saturate(r0.y * r2.z);
    r6.z = ps;
    ps = -UniformVector_0.y;
    r0.xyz = r6.xyz * float3(0.875, 0.875, 0.21952);
