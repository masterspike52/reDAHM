// ps_5b0734a2398b3701.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 303 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004BC 10041100 00000606 00000000 000048C6 003F003F 00000021 00003050 00003151 00007254 0000F355 00007456 0000F557
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = r5.w;
    r10.yz = r0.xy * UniformScalar_0.xx;
    ps = (-4e+02) + ps;
    ...
    ps = 1.0 + ps;
    r14.xyz = r8.yzw * float3(-0.025, 0.5, 0.5);
    r0.z = ps;
    ...
    r9 = r8.zwxy + r4;
    r0.zw = r9.zw + r9.zw;
    r8 = tex2D(Texture2D_1, r0.zw).zwyx;
    r1.xyz = tex2D(Texture2D_2, r1.xy).wxy;
    r4.xyw = tex2D(Texture2D_3, r10.yz).xyw;
    r16.xy = r4.xy * 2.0 - 1.0;
    ps = r1.y + r1.y;
    r17.yz = r5.xy * ScreenPositionScaleBias.xy;
    r10.y = ps;
    ps = r1.z + r1.z;
    r10.x = dot(r10.xww, float3(1.0, 1.0, 1.0));
    r10.w = ps;
    r0.w = (r10.x == 0.0) ? r8.w : r8.z;
    ps = 0.1 - -r2.z;
    r13.xyz = UniformVector_5.xyz * UniformVector_5.www;
    r0.z = ps;
    ps = 5.0 * r0.z;
    r15 = r10.xxyw + float4(-3.0, -2.0, -1.0, -1.0);
    r8.w = saturate(ps);
    r0.z = (r15.y == 0.0) ? r8.x : r0.w;
    r8.x = (r15.x == 0.0) ? r8.y : r0.z;
    ps = 1.0 / r5.w;
    r0.zw = -r8.wx + 1.0;
    r16.z = ps;
    ps = 1.0 / ModShadowAccumResolution.x;
    r10.xy = r0.zz * ModShadowGroupColor.xy;
    r5.x = ps;
    ps = 0.0001 * r5.w;
    r2.w = max(r8.x, 0.0);
    r10.z = saturate(ps);
    ...
    r17.x = ps;
    r5.zw = r17.yz * r16.zz + ScreenPositionScaleBias.wz;
    ...
    r0.y = ps;
    r8 = r13.yzwx * r1.wzyx + float4(0.125, 0.125, 1.0, 1.0);
    r3.xy = r17.xx * r16.xy + r3.xy;
    ...
    r0.y = ps;
    r0.yzw = r0.yyy * r6.xyz + ModShadowColor.xyz;
    r8.xyz = r12.xyz * UniformScalar_3.xxx + UniformScalar_4.xxx;
    ps = r2.x * r2.x;
    r2.zw = r15.zw + r14.yz;
    r6.x = ps;
    r2.xy = r3.xy * UniformVector_4.xy - r11.xy;
    r6.yz = r13.xx * r2.zw + r2.xy;
    r6.w = saturate(r12.w * r8.w - 0.5);
    r3.xyz = r12.xyz * r8.www - r10.xyz;
    r2.z = r3.w * r6.w - 2.0;
