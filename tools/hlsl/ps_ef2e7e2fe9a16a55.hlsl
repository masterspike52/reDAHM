// ps_ef2e7e2fe9a16a55.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 426 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000006A8 10000400 00000008 00000000 00004084 0003000F 00000021 0000F050 0000F156 0000F2A0 0000F3A2
...
// NOTE: unhandled fetch opcode 18 at 26
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.xz = r0.yx - 0.5;
    r3.y = dot(r3.xz, UniformVector_2.yx) + 0.5;
    r3.x = dot(r3.xz, UniformVector_1.yx) + 0.5;
    r3.x = tex2D(Texture2D_0, r3.xy).w;
    r2.x = r3.x * r2.w - 0.5;
