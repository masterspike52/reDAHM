// ps_f77edafb1b23964d.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 75 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000012C 10000600 00000004 00000000 00005CE7 007F007F 00000001 00003050 00003151 0000F252 0000F353 0000F455 00007556 0000F657
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.xy = r0.zw * r4.xy + ScreenPositionScaleBias.wz;
    r1.xyz = tex2D(SceneColorTexture, r5.xy).xyz;
    r2.xyz = tex2D(Texture2D_0, r0.xy).xyz;
    r0.xyz = tex2D(Texture2D_1, r0.xy).yxz;
    r0.w = tex2D(SceneDepthTexture, r5.xy).x;
    r1.w = r0.w * MinZ_MaxZRatio.z - MinZ_MaxZRatio.w;
    ps = OpacityOverride.x * r0.y;
    r5.xyz = r0.zyx * float3(1.000001, 1.0, 1.0);
    r0.x = ps;
    oC0.w = r0.x * r3.w;
    r0 = r5.yyzx * r3.wxyz;
    ps = 1.0 / r1.w;
