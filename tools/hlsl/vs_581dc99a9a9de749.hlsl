// vs_581dc99a9a9de749.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 147 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000040 0000024C 00510009 00000000 00000000 00005CC6 00000001 00000006 00000006 00000290 00100006 00006007 00007008 00003009 0000500A 0021500B 0000F050 0001F156 00027257 0003F3A0 0004F4A1 0005F5A2 0000102F 0000102B 0000102A 0000102E 0000102D 0000102C
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r6.xyz = r5.zzw * r7.xyy;
    r8.y = -r8.w;
    r6.xyz = r5.wyy * r7.zzx - r6.xyz;
    ...
    r1.y = ps;
    r1.w = r1.w * 0.5 + 0.5;
    r6.xyw = -r0.wyx * CameraPosition.www + CameraPosition.zyx;
    ps = 0.003921569 * r1.z;
    ...
    o2.xyz = r5.xyz;
    o1 = r0.xxxx * ViewProjectionMatrix[0] + r3.xzyw;
