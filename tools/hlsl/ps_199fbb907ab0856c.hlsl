...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = r1.z;
    r0.y = float((UniformScalar_0.x >= UniformScalar_1.x));
    ps = 0.1 + ps;
    ...
    r11.w = ps;
    ps = 0.875 * r6.z;
    r5.xyz = r11.zwy + r5.xzy;
    r11.y = ps;
    r6.xzw = (-abs(r6.www) >= 0.0) ? r12.xyz : r13.xyz;
    r0.yzw = (-abs(r0.yyy) >= 0.0) ? r12.xyz : r6.xzw;
    ps = 5.0 * r6.y;
    r6.xzw = r5.xyz + float3(-1.0, -1.0, 0.0);
    r5.x = saturate(ps);
    ps = 1.0 - r5.x;
    r5.y = dot(r3.zxy, r2.zxy);
    r5.x = ps;
    r5.xz = -r5.xx * ModShadowGroupColor.xy + 1.0;
    r3.xy = r11.xy * r5.xz + 0.125;
    ps = -SpotAngles.x - -r5.y;
    r6.xyz = r6.wxz * UniformScalar_0.xxx;
    r5.x = ps;
    ps = 1.0 + r6.x;
    r5.yzw = r0.yzw - r10.xyz;
    r6.w = ps;
    r0.yzw = r5.yzw * UniformScalar_0.xxx + r10.xyz;
    ...
    r9.x = ps;
    ps = 0.0001;
    r6.w = dot(r6.zxy, r1.zxy);
    r9.y = ps;
    ps = max(r9.x, r9.y);
    r3.xyz = r6.xzy * r6.www;
    r7.w = ps;
    ...
    r0.x = ps;
    ps = log2(r6.w);
    r1.xyz = r0.yzw * r8.xyz;
    r0.y = ps;
    r0 = r7.xzyw * r0.xxxy;
    ps = pow(2.0, r0.w);
    r6.w = saturate(dot(r6.zxy, r4.zxy));
    r6.x = ps;
