// ps_8e967f5b6b61bc17.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 147 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000024C 10040B00 0000080A 00000000 00008108 003F00FF 00000001 0000F050 0000F153 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9.yz = tex2D(ModShadowAccumTexture, r6.xz).xy;
    ...
    ps = rsqrt(abs(r6.y));
    r8.xyz = r10.xyz * AmbientColorAndSkyFactor.xyz;
    r6.y = ps;
    r8.xyz = r8.xyz * r7.yzw + UniformVector_0.xyz;
    ps = rsqrt(abs(r6.x));
    ...
    r6.w = ps;
    r5.xyw = r6.www * r11.zxy;
    r2.xyz = r5.xxx * r1.xyz;
    r9.x = dot(r6.zxy, r5.xyw);
    ps = 0.1 - -r7.y;
    r6.y = dot(r5.xyw, r4.zxy);
    r6.x = ps;
    ...
    r9.xy = r4.zw * r6.xy + 0.125;
    ps = log2(r6.z);
    r7.xyz = r0.xzy * r7.xxx;
    r10.w = ps;
    r4 = r10 * float4(4.0, 4.0, 4.0, 15.0);
    r7.xyz = r7.xyz * UpperSkyColor.xzy + r8.xzy;
    ps = r9.x * r9.y;
    r8.xyz = -ModShadowColor.xyz + 1.0;
    r6.z = ps;
    r6.xyz = r6.zzz * r8.xyz + ModShadowColor.xyz;
