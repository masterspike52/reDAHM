// ps_9963639519436571.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 186 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000002E8 10041100 0000090A 00000000 00008129 003F01FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A1 0000F8A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9.xy = r10.yz * UniformScalar_11.xx + r0.xz;
    r7.xy = r15.xw * 0.5;
    ps = rsqrt(abs(r6.w));
    r13.z = r7.y * r14.z;
    r6.w = ps;
    r1.xyz = r7.www * float3(0.2, 3.0, 0.5);
    r12.yzw = r1.xyz * r14.xyz;
    ps = 0.1 - -r2.z;
    r17 = r15.xyxz * float4(0.2, 0.2, 3.0, 3.0);
    r6.y = ps;
    ps = rsqrt(abs(r7.z));
    r13.xy = r17.yw * r14.xy;
    r7.z = ps;
    ps = 0.875 * r6.x;
    r11.xyz = -ModShadowColor.xyz + 1.0;
    r9.z = ps;
    ps = 0.875 * r6.z;
    r7.yzw = r7.zzz * r4.xyz;
    r9.w = ps;
    ps = 5.0 * r6.y;
    r1.xyz = r6.www * r2.xyz;
    r6.x = saturate(ps);
    ps = 1.0 - r6.x;
    r6.z = dot(r16.zxy, r16.zxy);
    r6.w = ps;
    ps = rsqrt(abs(r6.z));
    r6.xy = r17.xz * r12.yz;
    r6.z = ps;
    r2.xy = -r6.ww * ModShadowGroupColor.xy + 1.0;
    r12.yz = r9.zw * r2.xy + 0.125;
    ps = r7.x;
    r2.xyz = r16.xyz * r6.zzz;
    ps = r12.w * ps;
    r7.x = saturate(dot(r2.zxy, r1.zxy));
    r6.z = ps;
    r6.xyz = r15.xxx * r14.xyz + r6.xyz;
    r6.w = dot(r2.zxy, r7.wyz);
    ps = r12.x * r12.x;
    r4.xyz = r2.xzy * r6.www;
    r6.w = ps;
    ps = r12.y * r12.z;
    r2.xyw = r6.xyz + r13.xyz;
    r6.x = ps;
    r6.xyz = r6.xxx * r11.xyz + ModShadowColor.xyz;
    ps = r2.y;
    r8.xyz = r6.www * r8.xyz;
    r7.yzw = r4.xyz * 2.0 - r7.ywz;
