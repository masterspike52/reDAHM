...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.w = ps;
    r7.xw = r7.xw * r5.xy + ScreenPositionScaleBias.wz;
    r1.xyz = tex2D(LightAttenuationTexture, r7.xw).xyz;
    r7.x = tex2D(ShadowTexture, r0.xy).x;
    r0.xyz = tex2D(Texture2D_0, r7.yz).xyz;
    r6.xz = tex2D(ModShadowAccumTexture, r6.xw).xy;
    ps = r2.z;
