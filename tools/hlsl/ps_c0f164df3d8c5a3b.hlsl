...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.w = -r7.w + 1.0;
    r6.z = ps;
    r5.xy = -r7.ww * ModShadowGroupColor.xy + 1.0;
    ps = 0.875 * r6.x;
    ...
    r8.y = ps;
    r5.xy = r8.xy * r5.xy + 0.125;
    r6.x = dot(r2.zxy, r3.zxy);
    r6.xyw = r2.xzy * r6.xxx;
    r3.xyz = r6.xyw * 2.0 - r3.xzy;
    r2.xy = r5.xz * r5.yz;
    r6.xyw = r2.xxx * r9.xyz + ModShadowColor.xyz;
    ps = LightColorAndFalloffExponent.w * r6.z;
    r0.w = saturate(dot(r4.zxy, r3.yxz));
    r6.z = ps;
    ps = log2(r0.w);
    r7.xyz = r2.yyy * r7.xyz;
    r0.w = ps;
    ps = pow(2.0, r6.z);
    r2 = r0 * float4(4.0, 4.0, 4.0, 15.0);
    r6.z = ps;
    ps = pow(2.0, r2.w);
