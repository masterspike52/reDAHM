...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.x = ps;
    ps = 5.0 * r6.x;
    r0.w = dot(r4.xyw, r0.zxy);
    r6.x = saturate(ps);
    ps = AmbientColorAndSkyFactor.y * r6.w;
    r6.z = -r6.x + 1.0;
    r2.z = ps;
    ps = ModShadowGroupColor.x * r6.z;
    r5.xyz = r4.ywx * r0.www;
    r4.x = ps;
    ...
    r4.x = ps;
    ps = 0.5 + r0.x;
    r2.x = float((r5.z >= 0.004));
    r4.y = ps;
    r7.yz = r0.zw * r5.xy + 0.125;
    ps = log2(r7.x);
    r4.xw = abs(r4.yx) * abs(r4.yx);
    r8.x = ps;
    ps = AmbientColorAndSkyFactor.z * r6.y;
    r0 = r8 * 15.0;
    r2.w = ps;
    ps = pow(2.0, r0.x);
    r4.xyz = r10.xzy * r4.xxx;
    r7.x = ps;
    ps = 0.21952 * r7.x;
    r5.xyz = r10.xzy * r4.www;
    r6.x = ps;
    ps = r7.w * r7.x;
    ...
    r8.xy = r6.xx * r1.xy;
    r8.w = ps;
    r6.xyz = r8.www * r12.xyz + ModShadowColor.xyz;
    r7.xyz = r11.xyz * r10.xyz + r8.xyz;
    r7.xyz = r5.xzy * LowerSkyColor.xyz + r7.xyz;
    r7.xyz = r4.xzy * UpperSkyColor.xyz + r7.xyz;
    r7.xyz = r2.yzw * r9.xyz + r7.xyz;
