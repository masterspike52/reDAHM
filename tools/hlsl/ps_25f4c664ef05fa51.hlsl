// ps_25f4c664ef05fa51.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 54 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000000D8 10000300 00000008 00000000 00004084 0003000F 00000021 0000F050 0000F156 0000F2A0 0000F3A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.y = IndividualVelocityScale.y * UniformVector_1.w;
    ps = UniformVector_1.w * r2.x;
    r2.w = r2.y * r2.x;
    r2.y = ps;
    ps = IndividualVelocityScale.x * r2.y;
    r2.z = ps;
    r2.zw = r2.zw * r1.xy;
    r2.x = dot(r2.zw, r2.zw) + 0.0;
    r3.x = max(r2.x, 1.0);
    ps = rsqrt(abs(r3.x));
    r2.x = r2.y - 0.003921569;
    r2.y = ps;
    r2.yz = r2.wz * r2.yy;
    ps = abs(r2.z);
