// ps_e9b4e601c0e237bf.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 102 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000198 10040800 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.yz = tex2D(ModShadowAccumTexture, r6.zw).xy;
    ...
    r6.yz = -r4.xy;
    r6.x = r4.z * 2.0 - r4.z;
    r7.x = saturate(dot(r8.yzx, r6.yzx));
    ps = log2(r7.x);
    r6.xyz = -UniformVector_0.xyz + 1.0;
    r5.x = ps;
    r4.xyz = r5.xyz * float3(15.0, 0.875, 0.875);
    ps = pow(2.0, r4.x);
    r7.x = saturate(r6.w * r2.z);
    r2.w = ps;
    r1.yz = r4.yz * r1.yz + 0.125;
    ps = r1.x * r1.x;
    r2.xyz = r6.xyz * r7.yzw;
    r6.w = ps;
    ps = r1.y * r1.z;
    r7 = r2 * r7.xxxw;
    r6.x = ps;
    r6.xyz = r6.xxx * r0.xyz + ModShadowColor.xyz;
    r7.xyz = r7.xyw + r7.wwz;
