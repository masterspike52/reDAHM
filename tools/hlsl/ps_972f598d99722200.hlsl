...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.z = r0.z * 0.14999999 - 0.003;
    r1.x = r6.w * SCENE_COLOR_BIAS_FACTOR.x;
    r0.w = rsqrt(abs(r0.w));
    r1.yz = r0.ww * r5.xy;
    r1.yz = r1.yz * r0.zz + r0.xy;
    r0.xzw = tex2D(Texture2D_1, r1.yz).xyz;
    r0.y = tex2D(Texture2D_2, r1.yz).z;
    r0.xzw = r0.xzw * r3.xyz + UniformVector_0.xyz;
