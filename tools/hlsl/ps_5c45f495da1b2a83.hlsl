// ps_5c45f495da1b2a83.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 435 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000006CC 10000400 00000008 00000000 00004084 0003000F 00000021 0000F050 0000F156 0000F2A0 0000F3A2
...
// NOTE: unhandled fetch opcode 18 at 38
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.y = saturate(r2.x - UniformScalar_5.x);
    r2.z = 0.5;
    r3.x = tex2D(Texture2D_1, r0.xy).x;
    r3.y = tex2D(Texture2D_0, r0.xy).x;
    r2.x = tex2D(Texture2D_3, r2.yz).x;
    r2.x = r2.x * UniformVector_1.x - 0.5;
    r2.w = dot(r3.yx, float2(5.0, 3e+01)) + 0.0;
    r2.x = r2.w * r2.y + r2.x;
