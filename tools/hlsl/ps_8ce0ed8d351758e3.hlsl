// ps_8ce0ed8d351758e3.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 117 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001D4 10040800 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.xy = tex2D(ModShadowAccumTexture, r0.xy).xy;
    ...
    r3.xyz = r5.www * r8.xyz;
    r5.w = dot(r3.zxy, r7.zxy);
    r8.xyz = r3.xzy * r5.www;
    r7.xyz = r8.xyz * 2.0 - r7.xzy;
    ps = LightColorAndFalloffExponent.w * r5.x;
    r6.w = saturate(dot(r1.zxy, r7.yxz));
    r5.w = ps;
    ps = log2(r6.w);
    ...
    r6.xyz = r6.xyz * r5.xxx + r2.zzz;
    r5.xy = r2.xy * r5.yz + 0.125;
    ps = r5.x * r5.y;
