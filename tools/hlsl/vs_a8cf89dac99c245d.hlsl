// vs_a8cf89dac99c245d.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 1122 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000080 00001188 0081000E 00000000 00000000 00008129 00000001 00000007 00000009 00000290 0010002C 0000602D 0000702E 0000302F 00005030 00015031 0020A032 00003050 0001F151 00027254 0003F355 00047456 0005F557 0006F6A0 0007F7A1 0008F8A2 0000116C 00001173 0000116E 0000116F 00001170 00001174 00001171 0000116D 00001172
...
float4 LightPositionAndInvRadius : register(c20); // float4
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r14.xyz = -r0.zyx + LightPositionAndInvRadius.xyz;
    r10.xyz = r14.zzz * WorldToLocal[2].xzy;
    r13.xyz = r5.xxx * WorldToLocal[2].xyz;
    r4 = r0.yyyy * ViewProjectionMatrix[1].xzyw + r4.xzwy;
    r4 = r0.zzzz * ViewProjectionMatrix[0] + r4.xzyw;
    r5.xyz = r5.yyy * WorldToLocal[1].xyz + r13.xyz;
    r0.xyz = r14.yyy * WorldToLocal[1].xzy + r10.xyz;
    r0.xyz = r14.xxx * WorldToLocal[0].xyz + r0.xzy;
    r10.xyz = r5.www * WorldToLocal[0].xzy + r5.xzy;
    r5.y = dot(r1.xzy, r10.yxz);
    r5.z = dot(r6.yxz, r10.yxz);
    r5.w = dot(r7.zyx, r10.yxz);
    r10.x = dot(r1.xzy, r0.zxy);
    r10.y = dot(r6.yxz, r0.zxy);
    r10.z = dot(r7.zyx, r0.zxy);
    p0 = (-SP_DemolitionSpread.x >= 0.0);
    ps = p0 ? 0.0 : 1.0;
    // UNHANDLED control flow: cjmp
    r0 = r11.wwww * LocalToWorld[3].xwzy;
    ...
    o7.w = 0.0;
    o2.xyz = r10.xyz;
    o3.xyz = r14.xyz * LightPositionAndInvRadius.www;
    o3.w = 0.0;
    o4.xyz = r5.yzw;
    o6 = r3;
    o8 = r2.xzyw;
