// ps_be2e18b46800839c.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 129 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000204 10040900 0000080A 00000000 00007908 003F00FF 00000001 0000F050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.x = tex2D(Texture2D_0, r6.zw).w;
    r5.zw = tex2D(ModShadowAccumTexture, r6.xy).xy;
    ps = r2.z;
    ...
    r6.x = ps;
    r6.yz = -r6.zz * ModShadowGroupColor.xy + 1.0;
    r6.w = dot(r9.zxy, r3.zxy);
    ps = r7.w;
    r3.yz = -r4.xy;
    r3.x = r4.z * 2.0 - r4.z;
    ps = r2.z * ps;
    r7.w = saturate(dot(r8.yzx, r3.yzx));
    r1.x = saturate(ps);
    ps = log2(r7.w);
    r6.w = r6.w - SpotAngles.x;
    r5.y = ps;
    ps = LightColorAndFalloffExponent.w * r6.x;
    r2.yzw = r5.yzw * float3(15.0, 0.875, 0.875);
    r7.w = ps;
    ps = pow(2.0, r2.y);
    r2.x = saturate(r6.w * SpotAngles.y);
    r5.y = ps;
    r2.yz = r2.zw * r6.yz + 0.125;
    ps = r2.x * r2.x;
    ...
    r0 = r5.xxyx * r0.xywz;
    r2.x = ps;
    r6.xyz = r2.xxx * r6.xyz + ModShadowColor.xyz;
    ps = pow(2.0, r7.w);
    r1.yzw = r0.xyw * r1.yzw;
    r7.w = ps;
    r0.xy = r1.yz * r1.xx + r0.zz;
    r0.z = r1.w * r1.x + r0.z;
