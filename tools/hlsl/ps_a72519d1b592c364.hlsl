// ps_a72519d1b592c364.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 93 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000174 10040900 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.y = saturate(ps);
    ps = rsqrt(abs(r7.w));
    r6.xzw = r6.zzz * r2.xyz;
    r7.w = ps;
    ps = 1.0 - r6.y;
    r1.xyz = r7.www * r0.yzw;
    r6.y = ps;
    r0.yz = -r6.yy * ModShadowGroupColor.xy + 1.0;
    r0.yz = r5.xy * r0.yz + 0.125;
