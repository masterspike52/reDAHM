// vs_0590614d52dff186.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 612 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000040 00000990 00410010 00000000 00000000 000040A5 00000001 00000008 00000005 00000290 00100018 00006019 0000301A 0020201B 0010101D 0000501E 0006501F 00375020 00003050 00017154 0002F255 00037356 0004F457 000010C6 000010C7 000010C8 000010C9 000010CA
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r7.z = dot(r13.zxy, r8.zxy);
    r7.w = dot(r13.zxy, r11.zxy);
    ...
    r16.x = dot(r5.zxy, r8.zxy);
    r12.y = ps;
    ps = WorldToLocal[2].y * r0.w;
    r16.y = dot(r5.zxy, r11.zxy);
    r12.z = ps;
    a0 = xe_mova(r2.w);
    ps = r2.w;
    r16.z = dot(r5.zxy, r10.zxy);
