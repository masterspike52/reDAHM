// vs_77acff6d498cbbd8.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 240 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000040 000003C0 0061000D 00000000 00000000 00006CE7 00000001 00000006 00000007 00000290 00100008 00006009 0000700A 0000300B 0000500C 0021500D 0000F050 0001F155 00027256 0003F357 0004F4A0 0005F5A1 0006F6A2 0000104C 0000104D 0000104A 0000104E 0000104B 00001049 00001048
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r11.xyz = r0.ywz * 0.007843138 - 1.0;
    r10.xyz = r1.zxw * 0.007843138 - 1.0;
    r0 = r6.wwww * LocalToWorld[3].xzyw;
    r12.xzw = r9.ywz * 0.007843138 - 1.0;
    r0 = r6.zzzz * LocalToWorld[2].xzyw + r0;
    r3.xyz = r11.yyz * r10.xyy;
    r12.y = -r12.w;
    r3.xyz = r11.zxx * r10.zzx - r3.xyz;
    r0 = r6.yyyy * LocalToWorld[1].xzyw + r0;
    r0 = r6.xxxx * LocalToWorld[0].zxyw + r0.yxzw;
    r1.y = dot(r12.xyz, r3.xyz);
    r1.y = r1.y * 0.5 + 0.5;
    r5.xyw = -r0.xzy * CameraPosition.www + CameraPosition.zyx;
    r13.xyz = r0.yzx - CameraPosition.xyz;
    r3 = r0.wwww * ViewProjectionMatrix[3].xwzy;
    r3 = r0.xxxx * ViewProjectionMatrix[2].xwzy + r3;
    r9.x = dot(r13.zxy, r13.zxy);
    r4.xyz = r5.xxx * WorldToLocal[2].xzy;
    r4.w = float((0.001 >= abs(r13.z)));
    r4.w = (r4.w == 0.0) ? r13.z : 0.001;
    r4.xyz = r5.yyy * WorldToLocal[1].xzy + r4.xyz;
    r5.xyz = r9.yzw * 0.003921569;
    r0.x = sqrt(abs(r9.x));
    r3 = r0.zzzz * ViewProjectionMatrix[1].xzyw + r3.xzwy;
    r3 = r0.yyyy * ViewProjectionMatrix[0] + r3.xzyw;
    r0 = r0.xxxx - FogStartDistance.wzyx;
    r9.xyz = r5.www * WorldToLocal[0].xyz + r4.xzy;
    r4.x = dot(r12.zxw, r9.zxy);
    r4.y = dot(r11.yxz, r9.zxy);
    ps = 1.0 / r4.w;
    r4.z = dot(r10.zyx, r9.zxy);
    r4.w = ps;
    r9 = saturate(r8.wzyx * r4.wwww);
    r7 = saturate(r7.wzyx * r4.wwww);
    r8 = max(r0, 0.0);
    ...
    r1.z = ps;
    ps = pow(2.0, r0.y);
    r4.w = abs(r7.w) * FogDistanceScale.x;
    r0.y = ps;
    ps = pow(2.0, r0.x);
    r7 = abs(r7) * r8;
    r0.z = ps;
