...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.z = ps;
    r5.zw = r5.zz * r2.yx;
    r5.xz = r5.zw * r4.ww + r5.xy;
    r5.y = dot(r5.xz, float2(0.0007963267, -0.9999997)) + 0.5;
    r5.x = dot(r5.xz, float2(0.9999997, 0.0007963267)) + 0.5;
    r4.w = tex2D(Texture2D_1, r5.xy).z;
