...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.y = ps;
    ps = rsqrt(abs(r0.w));
    r0.x = dot(r9.wyz, r9.wyz);
    r0.w = ps;
    ps = rsqrt(abs(r0.x));
    r8.xyz = r0.www * r3.xyz;
    r0.x = ps;
    r0.yw = -r0.yy * ModShadowGroupColor.xy + 1.0;
    r1.yz = r10.xy * r0.yw + 0.125;
    ps = 0.0001;
    r3.xyz = r9.yzw * r0.xxx;
    r9.y = ps;
    ps = max(r9.x, r9.y);
    ...
    r0.y = saturate(ps);
    r0.xzw = r9.xyz * 2.0 - r8.xzy;
    ps = log2(r0.y);
    r0.x = saturate(dot(r6.zxy, r0.zxw));
    r0.y = ps;
    ps = log2(r0.x);
    ...
    ps = pow(2.0, r1.x);
    r1.w = saturate(dot(r3.zxy, r6.zxy));
    r1.x = ps;
    ps = pow(2.0, r0.w);
