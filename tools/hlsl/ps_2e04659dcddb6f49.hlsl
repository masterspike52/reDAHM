// ps_2e04659dcddb6f49.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 81 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000144 10000300 00000008 00000000 00004084 0003000F 00000021 0000F050 0000F156 0000F2A0 0000F3A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.x = -r2.x + 1.0;
    r2.y = ps;
    r2.z = (UniformScalar_18.x > 0.0) ? r2.x : 1.0;
    r2.x = (UniformScalar_18.x >= 0.0) ? r2.z : r2.x;
    ps = (-0.5) - -r2.x;
    r3.xy = r0.xy * r2.yy;
    r2.y = ps;
    ps = abs(r3.x);
