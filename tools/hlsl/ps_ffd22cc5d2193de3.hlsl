...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = r1.x;
    r7 = r17.xzwy - 1.0;
    r6.xw = r6.xx * r7.yz + r8.xy;
    ps = r6.y * ps;
    r1.x = dot(r13.xyy, float3(1.0, 1.0, 1.0));
    r12.w = ps;
    ps = r9.y + r9.y;
    r12 = r12 + float4(-1.0, -1.0, -1.0, 1.0);
    r1.z = ps;
    r7.yz = r6.xw * UniformVector_4.xy - r12.xy;
    r6.x = (r1.x == 0.0) ? r16.x : r16.y;
    r1 = r1.xxyz + float4(-3.0, -2.0, -1.0, -1.0);
    r13.xy = r7.xw * 0.5 + r1.zw;
    r6.x = (r1.y == 0.0) ? r16.z : r6.x;
    r7.x = (r1.x == 0.0) ? r16.w : r6.x;
    r6.x = max(r7.x, 0.0);
    r15.x = min(r6.x, 0.3);
    ps = 1.0 / r5.w;
    r1.yzw = r15.xyz * float3(3.3333333, 0.875, 0.875);
    r6.x = ps;
    r13.xy = r1.yy * r13.xy + r7.yz;
    r6.xw = r13.zw * r6.xx + ScreenPositionScaleBias.wz;
    r9.xyz = tex2D(LightAttenuationTexture, r6.xw).xyz;
    r1.x = tex2D(ShadowTexture, r0.xy).x;
    r10.xyz = tex2D(Texture2D_5, r14.xy).xyz;
    r5.xyz = tex2D(Texture2D_7, r0.zw).xyz;
    ...
    r7.z = ps;
    r11.w = r8.z * UniformVector_4.z - r12.z;
    ps = ModShadowGroupColor.y * r6.z;
    r14.xyz = r5.xyz * r12.www;
    r7.w = ps;
    ...
    r14.w = ps;
    r7.xyz = r1.yzw * r7.ywz + float3(1.0, 0.125, 0.125);
    r11.xyz = r14.xyz * r7.xxx - r10.xyz;
    r0.w = saturate(r14.w * r7.x - 0.5);
