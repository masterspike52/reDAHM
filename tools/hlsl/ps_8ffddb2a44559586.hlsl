// ps_8ffddb2a44559586.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 120 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001E0 10040900 0000060A 00000000 000058C6 000F003F 00000001 00007054 0000F155 00007256 0000F357 0000F4A0 0000F5A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.x = ps;
    ps = pow(2.0, r4.z);
    r4.xyw = r7.xyz * float3(0.21952, 0.875, 0.875);
    r4.z = ps;
    r1.xyz = r6.xyz * r5.www + r4.xxx;
    r4.xy = r4.yw * r0.zw + 0.125;
    ps = r4.x * r4.y;
