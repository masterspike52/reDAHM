...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.x = ps;
    ps = rsqrt(abs(r5.y));
    r6.w = saturate(-r5.w + 1.0);
    r5.y = ps;
    ps = 5.0 * r5.x;
    r6.xyz = r6.xyz * float3(32.0, 2e+01, 0.5);
    r5.x = saturate(ps);
    ps = rsqrt(abs(r5.z));
    r2.xyz = r5.yyy * r1.zxy;
    r5.z = ps;
    ps = 1.0 - r5.x;
    ...
    r5.zw = -r3.xy;
    r5.x = r3.z * 2.0 - r3.z;
    r5.x = saturate(dot(r2.yzx, r5.zwx));
    ps = log2(r5.x);
    r5.y = saturate(r5.y * r1.z);
    r8.z = ps;
    ps = log2(r6.w);
    r5.xzw = r8.zyx * float3(15.0, 0.875, 0.875);
    r6.w = ps;
    r0.xy = r5.wz * r0.xy + 0.125;
    ps = pow(2.0, r5.x);
    r5.w = r6.w * LightColorAndFalloffExponent.w;
    r5.x = ps;
    r6.xyz = r6.xyz * r5.yyy + r5.xxx;
    r0.xy = r0.xz * r0.yz;
