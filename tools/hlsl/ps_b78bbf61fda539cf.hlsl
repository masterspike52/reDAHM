// ps_b78bbf61fda539cf.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 342 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000558 10041100 00000606 00000000 000050C6 003F003F 00000021 00003050 00003151 0000F254 0000F356 0000F457 0000F558
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r14 = tex2D(Texture2D_6, r0.xy).wxyz;
    r0.zw = r1.xy * 6.0;
    r1.z = r14.x - 0.5;
    ...
    r6.yzw = r6.xyz * UniformScalar_3.xxx + UniformScalar_4.xxx;
    ...
    r16.yzw = r16.xyz * r14.yzw;
    r14.yzw = r11.zxy + r11.zxy;
