...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.yz = tex2D(ModShadowAccumTexture, r7.xy).xy;
    ...
    r6.x = ps;
    ps = log2(r0.w);
    r7.xyz = r6.xxx * -SpotDirection.xyz;
    r6.x = ps;
    ...
    r7.y = dot(r3.zxy, r0.zxy);
    r3.xyz = r3.xzy * r7.yyy;
    r0.xyz = r3.xyz * 2.0 - r0.xzy;
    r7.y = saturate(dot(r2.zxy, r0.yxz));
    ps = log2(r7.y);
    r7.x = r7.x - SpotAngles.x;
    r10.w = ps;
    r0 = r10 * float4(0.21952, 0.21952, 0.21952, 15.0);
    ps = pow(2.0, r0.w);
    r7.z = saturate(r7.x * SpotAngles.y);
    r5.x = ps;
    r2.xyz = r5.xyz * float3(0.21952, 0.875, 0.875);
    r0.xyz = r0.xyz * r6.www + r2.xxx;
    r7.xy = r2.yz * r6.yz + 0.125;
