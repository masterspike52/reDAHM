...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.yzw = r9.xyz * UniformVector_1.xyz;
    r6.z = rsqrt(abs(r6.z));
    ...
    r10.xyz = r4.xzy * r6.zzz;
    r2.xyz = r10.xyz * 2.0 - r2.xzy;
    r6.z = saturate(dot(r5.zxy, r2.yxz));
    ps = log2(r6.z);
    r1.xyz = r1.xyz * r9.xyz;
    r8.x = ps;
    r2.xyz = r8.xyz * float3(15.0, 0.875, 0.875);
    r6.yz = r2.yz * r6.xy + 0.125;
    ps = pow(2.0, r2.x);
    r6.x = saturate(dot(r4.zxy, r5.zxy));
    r7.x = ps;
