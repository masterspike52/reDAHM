// ps_4fd88be156c6cd6a.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 210 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000348 10040D00 00000506 00000000 000040A5 001F001F 00000001 00003050 00007154 0000F255 00007356 0000F457
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.xyz = tex2D(LightAttenuationTexture, r2.xy).xyz;
    ...
    r7.w = max(UniformScalar_24.x, 0.0001);
    r4.z = ps;
    ps = UniformVector_2.z * UniformVector_2.z;
    r11.z = UniformScalar_22.x - UniformScalar_21.x;
    r4.w = ps;
    ps = r1.z;
    ...
    r7.xyz = r7.xyz * UniformVector_8.xyz;
    r11.y = ps;
    ps = ModShadowGroupColor.y * r0.z;
    r2.xyz = r13.yxz + float3(-2.0, -2.0, -1.0);
    r11.w = ps;
    ps = r2.x;
    r11.x = dot(r12.zxy, float3(1.0, 1.0, 1.0));
    ps = -r5.z + ps;
    r0.xyz = -r11.ywx + 1.0;
    r9.w = ps;
    ...
    r2.xyz = r11.xzy * UniformScalar_0.xxx;
    r3.w = ps;
    ...
    r4.y = r9.w * UniformScalar_0.x + r5.z;
    ps = r2.x + ps;
    r5.w = r3.w * r4.y;
    r10.w = ps;
    r12.xy = r10.xw * r0.zz + float2(1.0, 0.0);
    r11.yzw = r10.xyz * r0.zxy + float3(1.0, 0.125, 0.125);
    ps = r4.w;
    ...
    r11.x = ps;
    ps = r12.w;
    r9.xyz = r7.xyz * r2.www;
    ps = r10.w * ps;
    r5.xyz = r12.yxz * UniformVector_2.xzy;
    r2.w = ps;
    ps = r2.w;
    r4.yz = r11.xz * r11.yw;
    ...
    ps = rsqrt(abs(r1.w));
    r0.w = dot(r5.yxz, r5.yxz);
    r1.x = ps;
    ps = rsqrt(abs(r0.w));
    r1.xyz = r1.xxx * r3.xyz;
    r0.w = ps;
    r5.xyz = r5.xyz * r0.www;
    r0.w = dot(r5.yxz, r1.zxy);
    r3.xyz = r5.xzy * r0.www;
    r1.xyz = r3.xyz * 2.0 - r1.xyz;
    r0.w = saturate(dot(r0.zxy, r1.zxy));
    ps = log2(r0.w);
    r1.xyz = r8.xzy * LightColor.xzy;
    r6.w = ps;
    r3 = r7 * r6;
    ps = pow(2.0, r3.w);
    r0.w = saturate(dot(r5.yxz, r0.zxy));
    r0.x = ps;
