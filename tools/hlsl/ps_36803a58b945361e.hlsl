// ps_36803a58b945361e.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 90 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000168 10000400 00000004 00000000 000040A5 001F001F 00000021 00003050 00003151 0000F252 0000F353 0000F456
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.xy = r1.xy + r0.yx;
    r0.z = 0.5;
    r1.y = dot(r2.xy, UniformVector_4.yx) + 0.5;
    r1.x = dot(r2.xy, UniformVector_3.yx) + 0.5;
    r0.w = tex2D(Texture2D_2, r0.ww).x;
    r0.y = tex2D(Texture2D_1, r0.zy).x;
    r0.z = tex2D(Texture2D_0, r1.zw).x;
    r0.x = tex2D(Texture2D_0, r1.xy).x;
    r0.x = r0.z + r0.x;
    r1.xy = r0.xy * 3.0;
    r0.xy = r1.xy * r0.yx;
    r0.xy = r0.xy * 0.5;
