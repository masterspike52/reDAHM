// ps_b5237a3acde9f882.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 99 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000018C 10040900 00000806 00000000 00006908 00FF00FF 00000021 00003050 00003151 0000F252 0000F353 00007454 0000F555 00007656 0000F757
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.zw = tex2D(ModShadowAccumTexture, r2.xy).xy;
    ps = rsqrt(abs(r0.y));
    r6.xy = r0.zw * 0.875;
    r0.y = ps;
    ps = r4.z;
    ...
    r0.x = ps;
    ps = 5.0 * r0.z;
    r7.xyz = r0.xxx * -SpotDirection.xyz;
    r0.x = saturate(ps);
    ps = log2(r0.w);
    r0.z = -r0.x + 1.0;
    r0.x = ps;
    ...
    r2.x = saturate(r0.y * r4.z);
    r0.x = ps;
    ps = pow(2.0, r0.x);
    r0.y = dot(r7.zxy, r5.zxy);
    r1.w = ps;
    r0.zw = r6.xy * r0.zw + 0.125;
