// ps_24f0e28b0613ec26.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 81 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000144 10040700 0000070A 00000000 000070E7 001F007F 00000021 0000F050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.x = saturate(ps);
    r6.xyz = r6.xyz * r5.xyz + UniformVector_0.xyz;
    ps = rsqrt(abs(r6.w));
    r3.xy = r0.yz * 0.875;
    r5.x = ps;
    r5.x = r5.x * r1.z + 0.1;
