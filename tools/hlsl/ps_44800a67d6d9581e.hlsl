// ps_44800a67d6d9581e.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 426 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000006A8 10000200 00000004 00000000 00001842 00030003 00000021 00003050 0000F156
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.z = tex2D(Texture2D_2, r0.xy).w;
    r0.w = tex2D(Texture2D_3, r0.xy).w;
    r0.w = -r0.z + r0.w;
    r0.w = r0.w * UniformScalar_5.x - 0.1;
    r0.z = r0.w + r0.z;
