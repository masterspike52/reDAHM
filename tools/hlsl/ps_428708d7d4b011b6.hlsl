// ps_428708d7d4b011b6.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 63 ucode dwords, 0 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000000 000000FC 10000900 00000004 00000000 000050A5 001F001F 00000001 0000F050 0000F151 0000F252 0000F353 0000F454
...
float4 SampleWeights[9] : register(c3); // float4[9]
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0 = tex2D(FilterTexture, r4.xy);
    r0 = r0 * SampleWeights[8];
    r0 = r3.xzyw * SampleWeights[6].xzyw + r0.xzyw;
