...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.x = tex2D(SceneDepthTexture, r0.wz).x;
    r0 = tex2D(Texture2D_0, r0.xy);
    r1 = r0.wxyz * float4(3.0, 0.2, 0.2, 0.2);
    r0.x = r2.x * MinZ_MaxZRatio.z - MinZ_MaxZRatio.w;
    ps = 1.0 / r0.x;
    r0.z = saturate(r1.x * r3.x);
    r0.y = ps;
    r1.xyz = r1.yzw * r3.xyz + UniformVector_0.xyz;
