// ps_d7e9961332bce11f.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 336 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000540 10041100 0000080A 00000000 00008108 003F00FF 00000021 0000F050 0000F153 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r17.yzw = tex2D(Texture2D_3, r6.zw).xyw;
    r6.w = dot(r5.zxy, r5.zxy);
    r6.z = dot(r2.zxy, r2.zxy);
    r14.zw = r17.yz * 2.0 - 1.0;
    ...
    r6.x = ps;
    r4.yzw = r17.yzw * UniformScalar_3.xxx + UniformScalar_4.xxx;
    ps = 2.5 * r6.x;
