...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = rsqrt(abs(r0.x));
    r5.w = dot(r4.wyz, float3(0.5, 0.5, 0.5));
    r0.x = ps;
    ps = rsqrt(abs(r6.w));
    ...
    r5.y = ps;
    ps = log2(r5.z);
    r0.xyz = r5.www - r4.yzw;
    r5.x = ps;
    r5.zw = -r5.yy * ModShadowGroupColor.xy + 1.0;
    r0.xyz = r0.xyz * 0.5 + r4.yzw;
    ps = rsqrt(abs(r6.w));
    ...
    r0.w = saturate(dot(r1.zxy, r3.yxz));
    r6.w = ps;
    ps = log2(r0.w);
    r0.xyz = r0.xyz * r9.xyz;
    r7.z = ps;
    ps = -SpotAngles.x - -r5.y;
    r3.xyz = r7.xyz * float3(0.875, 0.875, 15.0);
    r5.x = ps;
    ps = pow(2.0, r3.z);
    r5.x = saturate(r5.x * SpotAngles.y);
    r0.w = ps;
    r5.yz = r3.xy * r5.zw + 0.125;
    ps = r5.x * r5.x;
