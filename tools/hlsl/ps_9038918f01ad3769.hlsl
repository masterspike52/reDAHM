// ps_9038918f01ad3769.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 432 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000006C0 10041800 0000080A 00000000 00007108 003F00FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.xyz = UniformVector_4.xzy * 2e+01;
    r10.x = ps;
    ps = r12.y;
    r11 = r10.wzxy - 0.5;
    ps = abs(r8.y) * ps;
    ...
    r17 = tex2D(Texture2D_7, r1.xy);
    r8 = tex2D(Texture2D_6, r1.xy);
    r0.yzw = tex2D(Texture2D_5, r1.xy).xyz;
    r18 = tex2D(Texture2D_4, r6.xy);
    r6.xyw = tex2D(Texture2D_0, r12.xy).xyz;
    r10.xyz = UniformVector_5.xzy * 2e+01;
    r15.xyz = r6.xyw * 2.0 - 1.0;
    r16.zw = r18.xy * 2.0 - 1.0;
    r1.xyz = r0.yzw * 2.0 - 1.0;
    ps = r8.x * r8.w;
    r6.z = float((UniformScalar_8.x >= UniformScalar_1.x));
    r4.x = ps;
    ps = r8.z * r8.w;
    r0.yzw = r17.xzy * r17.www;
    r4.z = ps;
    r6.xy = r19.yz * 2.0 - 1.0;
    ps = r8.y * r8.w;
    r0.yzw = r10.xyz * r0.yzw;
    r4.w = ps;
    r17.xyz = r1.xyz * UniformVector_3.xyz;
    ps = 0.0001 * r5.w;
    r4.xzw = r5.xyz * r4.xzw;
    r20.z = saturate(ps);
    r1.xyz = (-abs(r6.zzz) >= 0.0) ? r0.zyw : r4.zxw;
    r10.xyz = (abs(r6.zzz) > 0.0) ? r4.xwz : r0.ywz;
    ps = r2.z;
    r0.x = float((UniformScalar_11.x >= 1.0));
    ps = 0.1 + ps;
    r0.z = dot(r10.zxy, float3(0.11, 0.3, 0.59));
    r6.z = ps;
    r0.x = r14.w * r0.x + r7.w;
    ps = 5.0 * r6.z;
    ...
    r6.yz = min(r7.xy, float2(1.0, 0.3));
    r7.x = ps;
    ps = 3.3333333 * r6.z;
    ...
    r4.xw = -r17.zw + 1.0;
    r7.w = ps;
    r0.y = (UniformScalar_12.x > 0.0) ? r4.w : 1.0;
    r0.w = (UniformScalar_12.x >= 0.0) ? r0.y : r4.w;
    r7.xy = r7.zw * r7.xz;
    ps = rsqrt(abs(r6.z));
    r5.xw = r4.xy * r4.zy;
    r6.z = ps;
    ...
    r3.xyz = r9.xyz * UniformScalar_9.xxx + UniformScalar_10.xxx;
    ps = 1.0 - r6.x;
