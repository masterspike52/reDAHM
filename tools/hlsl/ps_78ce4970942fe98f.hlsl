// ps_78ce4970942fe98f.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 252 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000003F0 10041000 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.x = saturate(ps);
    ps = r4.w;
    r8.yz = r0.xy * UniformScalar_7.xx;
    ps = 0.0001 * ps;
    ...
    r2.z = r13.z * 2.0 - 1.0;
    r2.xy = r13.xy * 2.0 - 1.0;
    ps = rsqrt(abs(r0.w));
    r5.x = saturate(-r5.x + 1.0);
    r0.w = ps;
    r7.xyz = (-abs(r3.www) >= 0.0) ? r7.xyz : 1.0;
    r7.xyz = (-abs(r1.www) >= 0.0) ? 1.0 : r7.xyz;
    ps = rsqrt(abs(r6.w));
    ...
    r5.x = ps;
    r3.xyz = r16.xxx * r10.xyz;
    r10.xyz = r15.xyz * r10.xyz - r3.xyz;
    r2.xy = r9.xx * r14.xy + r2.xy;
    ps = LightColorAndFalloffExponent.w * r5.x;
    r2.xyz = r2.xyz * UniformVector_2.xyz;
    r6.w = ps;
    ps = pow(2.0, r6.w);
    r5.x = dot(r2.zxy, r2.zxy);
    r6.w = ps;
    ...
    r5.x = dot(r2.zxy, r13.zxy);
    r14.xyz = r2.xzy * r5.xxx;
    r13.xyz = r14.xyz * 2.0 - r13.xzy;
    r5.x = saturate(dot(r1.zxy, r13.yxz));
    ps = log2(r5.x);
    r6.w = saturate(dot(r2.zxy, r1.zxy));
    r12.w = ps;
    r1.xyw = r12.yzw * float3(0.875, 0.875, 15.0);
    r12.yz = r1.xy * r5.yw;
    r1.xyz = r12.xyz + float3(0.5, 0.125, 0.125);
    ps = r1.y * r1.z;
    r11.w = r8.w * r1.x;
    r5.x = ps;
    ...
    r5.x = saturate(ps);
    r5.yzw = r5.xxx * r10.xyz + r3.xyz;
    r5.x = (r9.x > 0.0) ? r0.w : 1.0;
    r5.x = (r9.x >= 0.0) ? r5.x : 1.0;
    r5.yzw = r8.xyz * r5.yzw;
    r5.yzw = r5.yzw * r7.xyz;
    r5.yzw = r5.yzw * r5.xxx;
    r1.xyz = r5.yzw * r2.xyz;
    ps = pow(2.0, r1.w);
    r2.xyz = -r5.yzw + r4.xyz;
    r5.x = ps;
    r5.yzw = r2.xyz * UniformScalar_11.xxx + r5.yzw;
    r5.yzw = r5.yzw * UniformScalar_12.xxx + UniformScalar_13.xxx;
