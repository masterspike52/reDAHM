// ps_2ab5223803057681.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 240 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000003C0 10040D00 0000080A 00000000 00007908 003F00FF 00000021 00003050 0000F151 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7 = tex2D(Texture2D_2, r1.xy).xwyz;
    ps = r7.y;
    ...
    r0.yzw = tex2D(LightMapTexture, r0.xy).xyz;
    ...
    r5.xyw = r0.ywz * LightMapScale.xzy;
    ...
    r6.x = ps;
    r2.xyz = r6.yzw * r7.xzw + r1.xyz;
    r9.xyz = r9.xyz * r2.xyz + r4.xyz;
    ps = 5.0 * r6.x;
    r7.zw = r12.xw * r6.zw;
    r8.x = saturate(ps);
    ps = r0.w;
    r6.x = dot(r1.zxy, float3(0.11, 0.3, 0.59));
    ps = r7.x * ps;
    r6.x = r6.x - r1.x;
    r7.y = ps;
    ps = r6.x;
    ...
    r1.yzw = r8.yzw + r1.xyz;
    r4.z = ps;
    ps = (-1.0) - -r1.y;
    r4.w = saturate(r3.w * 0.0001);
    r1.x = ps;
    r10 = -r4.wxyz + 1.0;
    r1.yzw = r1.xzw * r10.xxx;
    ps = 1.0 + r1.y;
    r8.xyz = -ModShadowColor.xyz + 1.0;
    r1.x = ps;
    r6.xzw = (r10.xxx > 0.0) ? r1.xzw : float3(1.0, 0.0, 0.0);
    r1.xyz = (r10.xxx >= 0.0) ? r6.xzw : float3(1.0, 0.0, 0.0);
    r6.x = dot(r1.xyz, r1.xyz);
    ps = rsqrt(abs(r6.x));
    r6.w = float((r10.y >= 0.004));
    r6.x = ps;
    ps = 1.0 - r6.y;
    r4.xyw = r1.yzx * r6.xxx;
    r0.w = ps;
    ps = UniformScalar_5.x + r7.y;
    r12.x = dot(r13.zxy, r4.wxy);
    r1.x = ps;
    ps = UniformScalar_5.x + r7.z;
    r6.x = dot(r4.wxy, r11.zxy);
    r1.y = ps;
    ps = UniformScalar_5.x + r7.w;
    r6.xyz = r4.xyw * r6.xxx;
    r1.z = ps;
    ps = r5.x;
    ...
    ps = r5.w;
    r5.xyz = r5.xwy * r7.www;
    ps = r4.w * ps;
    r4.xyz = r5.xzy * r0.www;
    r0.z = ps;
    r6.xyz = r4.xyz * r1.xzy + r6.xzy;
    r6.xyz = r0.xzy * r2.xyz + r6.xzy;
    ps = -r3.w;
