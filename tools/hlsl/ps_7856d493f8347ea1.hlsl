// ps_7856d493f8347ea1.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 288 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000480 10041000 0000080A 00000000 00007908 001F00FF 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A1 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.xy = r0.wz * 6.0;
    r3.x = saturate(ps);
    r3.yzw = tex2D(Texture2D_2, r6.xy).xyw;
    r10.xyz = tex2D(Texture2D_2, r0.wz).xyw;
    r6.xyw = tex2D(Texture2D_0, r11.xy).xyz;
    r8.xyz = r6.xyw * 2.0 - 1.0;
    r13.x = r3.w * r10.z - 1.0;
    ps = r10.x + r10.x;
    r10.zw = r4.xy * ScreenPositionScaleBias.xy;
    r13.z = ps;
    r6.xyz = r15.zxy * 2.0 - 1.0;
    ps = r10.y + r10.y;
    r13.y = dot(r5.zww, float3(1.0, 1.0, 1.0));
    r13.w = ps;
    r5.z = (r13.y == 0.0) ? r14.x : r14.y;
    r16 = r13.yyzw + float4(-3.0, -2.0, -1.0, -1.0);
    ...
    r15.z = ps;
    r13.yz = r14.zw * 0.5 + r16.zw;
    r5.yw = r7.ww * r13.yz + r15.xy;
    ps = 1.0 / r4.w;
    r10.xy = r5.yw - r8.xy;
    r5.y = ps;
    r5.yw = r10.zw * r5.yy + ScreenPositionScaleBias.wz;
    r11.xyz = tex2D(Texture2D_6, r11.xy).xyz;
    r16.xyz = tex2D(LightAttenuationTexture, r5.yw).xyz;
    ...
    r0.w = r7.w * r13.x + 1.0;
    r7.w = saturate(r12.w * r0.w - 0.5);
    r4.xyz = r12.xyz * r0.www - r11.xyz;
    r3.xyz = r4.xyz * r7.www + r11.xyz;
    r6.xy = r10.xy * r7.ww + r8.xy;
    r6.z = r4.w * r7.w - 2.0;
    r6.z = r6.w * 2.0 + r6.z;
