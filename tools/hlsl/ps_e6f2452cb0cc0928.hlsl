// ps_e6f2452cb0cc0928.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 327 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 0000051C 10041200 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r15.yz = tex2D(ModShadowAccumTexture, r11.xy).xy;
    r16 = tex2D(Texture2D_1, r9.zw);
    r7.xyw = tex2D(Texture2D_0, r5.xy).xyz;
    r12.xyz = tex2D(Texture2D_4, r0.xy).xyz;
    r5.xyz = tex2D(Texture2D_3, r9.xy).wxy;
    r17.xyz = tex2D(Texture2D_2, r6.zw).xyw;
    ...
    r5.z = ps;
    r1.w = r18.z * UniformVector_4.z - r12.z;
    ps = log2(r5.y);
    ...
    r0.z = ps;
    r6.yw = r5.ww * r17.zw + r18.xy;
    r6.yw = r6.yw * UniformVector_4.xy - r12.xy;
    ps = r0.w + r0.w;
    r0.x = dot(r15.xww, float3(1.0, 1.0, 1.0));
    r0.w = ps;
    r5.w = (r0.x == 0.0) ? r16.x : r16.y;
    r2 = r0.zwxx + float4(-1.0, -1.0, -3.0, -2.0);
    r2.xy = r17.xy * 0.5 + r2.xy;
    r5.w = (r2.w == 0.0) ? r16.z : r5.w;
    r0.w = (r2.z == 0.0) ? r16.w : r5.w;
    ...
    r5.x = ps;
    ps = r5.x;
    r1.xyz = r15.xyz * float3(3.3333333, 0.875, 0.875);
    ...
    r9.xyz = r13.xyz * UniformScalar_5.xxx + UniformScalar_6.xxx;
