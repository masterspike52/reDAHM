// ps_973aafcfffe40af6.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 99 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000018C 10040700 0000070A 00000000 000060E7 001F007F 00000001 00003050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.y = ps;
    ps = 1.0 - r5.x;
    r6.xyz = r5.yyy * r3.zxy;
    r5.x = ps;
    r5.xy = -r5.xx * ModShadowGroupColor.xy + 1.0;
    r6.yz = -r6.yz;
    r6.x = r6.x * 2.0 - r6.x;
    r6.w = saturate(dot(r7.yzx, r6.yzx));
    ps = log2(r6.w);
    ...
    r6.xyz = r6.xyz * r5.zzz + r1.zzz;
    r5.yz = r1.xy * r5.xy + 0.125;
    r5.xw = r5.yw * r5.zw;
