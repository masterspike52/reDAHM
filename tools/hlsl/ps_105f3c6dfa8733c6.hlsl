// ps_105f3c6dfa8733c6.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 120 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001E0 10040800 00000506 00000000 000040A5 001F001F 00000001 00003050 00007154 0000F255 00007356 0000F457
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.xw = r0.xy + UniformVector_1.xy;
    r6.x = ps;
    ...
    r8.xyz = tex2D(Texture2D_0, r0.xw).xyz;
    ...
    r3.xyz = r0.zzz * r8.xyz;
    ps = 1.0 + ps;
    r0.z = dot(r3.zxy, r1.zxy);
    r7.w = ps;
    ps = 1.0 - r0.x;
    r8.xyz = r3.xzy * r0.zzz;
    r0.z = saturate(ps);
    r1.xyz = r8.xyz * 2.0 - r1.xzy;
    ps = log2(r0.z);
    r0.x = saturate(dot(r2.zxy, r1.yxz));
    r0.z = ps;
    ps = log2(r0.x);
    ...
    r6.x = ps;
    ps = pow(2.0, r0.z);
    r2.xyz = r6.xyz * float3(0.21952, 0.875, 0.875);
    r0.z = ps;
    r1.xyz = r1.yzw * r0.xxx + r2.xxx;
    r0.xy = r2.yz * r0.yw + 0.125;
    ps = r0.x * r0.y;
