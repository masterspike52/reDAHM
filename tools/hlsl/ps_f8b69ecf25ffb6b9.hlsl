// ps_f8b69ecf25ffb6b9.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 156 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000270 10040D00 0000080A 00000000 00007908 003F00FF 00000001 00003050 0000F151 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = rsqrt(abs(r7.y));
    r8.xyz = r9.xyz * r13.xyz;
    r7.y = ps;
    ps = rsqrt(abs(r6.w));
    r4.xyw = r7.yyy * r4.xyz;
    r6.w = ps;
    ...
    r6.w = dot(r2.xyz, r4.wxy);
    r1.z = ps;
    ps = OpacityOverride.x;
    r6.xyz = r1.xyz * r2.xxx;
    r4.z = saturate(ps);
    ps = 0.1 - -r7.y;
    r0.xyz = r6.xzy * r13.xzy;
    r6.x = ps;
    ps = 5.0 * r6.x;
    r5.xyz = r2.yzx * r6.www;
    r6.x = saturate(ps);
    ps = 1.0 - r6.x;
    r2 = r12.xxyz * float4(-0.5, 0.5, 0.875, 0.875);
    r6.z = ps;
    r6.xyw = r5.xyz * 2.0 - r4.xyw;
