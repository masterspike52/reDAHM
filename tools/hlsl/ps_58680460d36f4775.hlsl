...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5 = tex2D(Texture2D_1, r0.xy).xywz;
    ...
    r1.x = ps;
    r0.xyz = r0.xyz * 2.0 - r8.xzy;
    ps = r5.z;
    r0.y = saturate(dot(r7.zxy, r0.yxz));
    r0.x = ps;
    ps = log2(r0.y);
    r2.x = saturate(dot(r3.zxy, r7.zxy));
    r1.w = ps;
