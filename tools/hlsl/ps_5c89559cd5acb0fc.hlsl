// ps_5c89559cd5acb0fc.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 132 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000210 10040A00 0000070A 00000000 000070E7 001F007F 00000001 0000F053 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.x = ps;
    ps = 5.0 * r5.x;
    r5.z = saturate(dot(r5.yzw, r1.yzx));
    r5.x = saturate(ps);
    ps = log2(r5.z);
    r5.y = -r5.x + 1.0;
    r5.x = ps;
    ...
    r5.w = ps;
    ps = pow(2.0, r5.w);
    r5.xy = r5.yy * ModShadowGroupColor.xy;
    r8.x = ps;
    ps = rsqrt(abs(r6.x));
    r9.z = r5.z * r8.x;
    r6.x = ps;
    r1.xyz = UniformVector_1.xyz + UniformVector_0.xyz;
    r3.xyz = AmbientColorAndSkyFactor.xyz * 0.21952;
    ...
    r9.xy = r7.xx * r0.xy;
    r6.w = ps;
    r6 = r6.xzwy + float4(0.5, 0.125, 0.125, 0.5);
    ps = r6.y * r6.z;
    r6.xw = abs(r6.wx) * abs(r6.wx);
    r5.x = ps;
    r5.xyz = r5.xxx * r10.xyz + ModShadowColor.xyz;
    r4.xyz = r7.ywz * r6.xxx;
    r6.xyz = r7.yzw * r0.xyz + r9.xyz;
    r0.xyz = r7.ywz * r6.www;
    r6.xyz = r0.xzy * LowerSkyColor.xyz + r6.xyz;
    r6.xyz = r4.xzy * UpperSkyColor.xyz + r6.xyz;
    r6.xyz = r3.xyz * r8.yzw + r6.xyz;
