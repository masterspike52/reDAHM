...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.y = ps;
    ps = 1.0 - r5.x;
    r6.w = dot(r4.wyz, float3(0.5, 0.5, 0.5));
    r5.x = ps;
    ps = r5.y;
    r0.xyz = r6.www - r4.yzw;
    ps = r1.x * ps;
    ...
    r5.xz = r10.xy * r5.xz + 0.125;
    ps = r5.y;
    r3.xyz = r2.yzw * r6.www;
    ps = r1.y * ps;
    r6.w = dot(r3.zxy, r7.zxy);
    r2.y = ps;
    ps = r5.y;
    r5.x = r5.x * r5.z;
    r5.xyz = r5.xxx * r9.xyz + ModShadowColor.xyz;
    ps = r1.z * ps;
    r9.xyz = r3.xzy * r6.www;
    r2.z = ps;
    r1.xyz = r9.xyz * 2.0 - r7.xzy;
    r6.w = saturate(dot(r2.zxy, r1.yxz));
    ps = log2(r6.w);
    r4.x = saturate(dot(r3.zxy, r2.zxy));
    r0.w = ps;
    r0 = r0 * float4(0.5, 0.5, 0.5, 15.0);
    r1.xyz = r0.xyz + r4.yzw;
    ps = pow(2.0, r0.w);
