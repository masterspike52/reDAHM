// ps_3580126bd5339a3b.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 63 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000000FC 10000500 00000008 00000000 00005CC6 0007003F 00000021 0000F050 0000F156 00007257 0000F3A0 0000F4A1 0000F5A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.w = ps;
    r3.z = r3.w * r3.z;
    r3.xyz = r5.www * float3(1.0, 0.16, -0.8) + r3.zxy;
    ...
    ps = 1.0 - r3.x;
    r3.x = ps;
    r3.y = (UniformScalar_1.x > 0.0) ? r3.x : 1.0;
    r3.x = (UniformScalar_1.x >= 0.0) ? r3.y : r3.x;
    ps = (-0.5) - -r3.x;
    r3.x = ps;
