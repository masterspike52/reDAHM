...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.x = ps;
    r2.xyz = r1.xxx * r9.xyz;
    r1.x = saturate(dot(r2.zxy, r3.zxy));
    r1.y = dot(r2.zxy, r8.zxy);
    r1.yzw = r2.xzy * r1.yyy;
    r1.yzw = r1.yzw * 2.0 - r8.xzy;
    r1.y = saturate(dot(r3.zxy, r1.zyw));
    ps = log2(r1.y);
    r0.w = r0.w - SpotAngles.x;
    r7.x = ps;
