...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = log2(r5.x);
    r8.z = saturate(r5.y * r1.z);
    r4.z = ps;
    r5.xyz = r4.zxy * float3(15.0, 0.875, 0.875);
    r8.xy = r5.yz * r0.xy + 0.125;
    ps = pow(2.0, r5.x);
    r5.yzw = r5.www * r6.xzy;
    r5.x = ps;
    ps = 0.21952 * r5.x;
    r0.xyz = r5.wzy * float3(0.21952, 1.0, 1.0);
    r6.y = ps;
    ps = 1.0 * r5.x;
    r5.yw = r8.xz * r8.yw;
    r6.z = ps;
    r5.xyz = r5.yyy * r2.xyz + ModShadowColor.xyz;
    r6.x = r5.w + r6.y;
    r6.xyz = r0.zyx * r6.xyz;
