...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.x = saturate(r3.x - UniformScalar_5.x);
    r4.y = 0.5;
    r3.xz = tex2D(Texture2D_1, r0.xy).xw;
    r3.w = tex2D(Texture2D_0, r0.xy).x;
    r3.y = tex2D(Texture2D_3, r4.xy).x;
    r3.y = UniformVector_1.x * r3.y;
    r4.z = dot(r3.wx, float2(5.0, 3e+01)) + 0.0;
    r3.y = r4.z * r4.x + r3.y;
    r3.y = UniformScalar_9.x * r3.y;
    r3.x = r3.y * r3.z - 0.333;
