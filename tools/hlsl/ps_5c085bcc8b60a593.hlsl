// ps_5c085bcc8b60a593.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 276 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000450 10040B00 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = max(r5.y, r5.z);
    r6.w = float((-r6.w > r6.w));
    r5.y = ps;
    ps = 1.0 / r1.w;
    r5.z = float((r5.y >= -r5.y));
    r5.y = ps;
    ps = sqrt(abs(r5.w));
    r0.w = -r0.w + 1.0;
    r5.w = ps;
    r2.yz = -r0.ww * ModShadowGroupColor.yx + 1.0;
    ps = UniformScalar_0.x - r5.w;
    r7.yw = r6.xw * r5.yz;
    r7.z = ps;
    ps = UniformVector_1.y * r5.x;
    r2.x = float((r5.w >= UniformScalar_0.x));
    r7.x = ps;
    r6.xw = r7.xy * r7.zy;
    r5.xyz = r6.yzw * float3(0.875, 0.875, 0.0208351);
    r10.xw = r5.yx * r2.yz + 0.125;
    ...
    r5.y = r6.w * r5.x;
    r5.x = ps;
    r11.zw = r5.xy + float2(0.8, 0.999866);
    r11.y = r7.y * r11.w;
    r5.xyz = r11.zyx * float3(0.24999972, -2.0, -3.1415927);
    r5.xy = r5.xy + float2(0.5, 1.5707964);
    r5.y = r5.y * r0.z + r11.y;
    ...
    r6.y = ps;
    r6.xyz = r6.yyy * r3.zxy;
    r0.y = dot(r2.ywz, r2.ywz);
    ps = rsqrt(abs(r0.y));
    r0.x = float((UniformScalar_0.x >= r5.w));
    r5.w = ps;
    r3.xyz = r2.wzy * r5.www;
    r2.y = float((r7.z >= UniformScalar_2.x));
    r0.y = float((UniformScalar_2.x >= r7.z));
    r5.w = dot(r3.zxy, r6.xyz);
    r0.xy = (r2.xy > 0.0) ? r0.xy : 1.0;
    r2.xyz = r3.zyx * r5.www;
    r2.xyz = r2.zyx * 2.0 - r6.yzx;
    p0 = (-r0.w > 0.0);
    ps = p0 ? 0.0 : 1.0;
    r5.w = r0.x * r0.y;
    r6.xyz = r6.www * r9.xyz + ModShadowColor.xyz;
    if (!p0)
    {
        ps = r0.w;
        r6.w = ps;
    ...
    r4.x = r6.w + r1.w;
    r0.xyz = tex2D(Texture2D_1, r4.xy).xyz;
