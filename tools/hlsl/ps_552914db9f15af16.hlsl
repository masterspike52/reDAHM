// ps_552914db9f15af16.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 129 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000204 10040800 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.w = dot(r4.zxy, r6.zxy);
    r1.xyz = r4.xzy * r6.www;
    r6.xyz = r1.xyz * 2.0 - r6.xzy;
    r6.w = saturate(dot(r2.zxy, r6.yxz));
    ps = log2(r6.w);
