...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.y = ps;
    ps = rsqrt(abs(r0.x));
    r6.xyz = r0.yyy * r4.xyz;
    r0.y = ps;
    r4.xyz = r0.yyy * -SpotDirection.xyz;
    ps = 1.0 - r0.x;
    ...
    r0.x = -r0.z + 1.0;
    r0.y = ps;
    r2.zw = -r0.xx * ModShadowGroupColor.xy + 1.0;
    ps = rsqrt(abs(r0.w));
    r0.z = dot(r4.zxy, r5.zxy);
    r0.x = ps;
    r4.xyz = r11.xyz * r0.xxx;
    r1.w = saturate(dot(r4.zxy, r6.zxy));
    r0.x = dot(r4.zxy, r10.zxy);
    ps = -SpotAngles.x - -r0.z;
    r4.xyz = r4.xzy * r0.xxx;
    r0.x = ps;
    r4.xyz = r4.xyz * 2.0 - r10.xzy;
