// ps_b0f40f61b05119cb.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 120 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001E0 10040800 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = log2(r5.z);
    r5.x = saturate(dot(r1.zxy, r3.yxz));
    r5.z = ps;
    ps = log2(r5.x);
    ...
    ps = pow(2.0, r0.x);
    r5.x = saturate(dot(r2.zxy, r1.zxy));
    r7.x = ps;
    ps = pow(2.0, r5.z);
    r1.xyz = r7.xyz * float3(0.21952, 0.875, 0.875);
    r5.z = ps;
    r0.xyz = r0.yzw * r5.xxx + r1.xxx;
    r5.xy = r1.yz * r5.yw + 0.125;
    ps = r5.x * r5.y;
