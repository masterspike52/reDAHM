// ps_c3a414d15c3da378.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 579 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 0000090C 10000400 00000008 00000000 00004084 0003000F 00000021 0000F050 0000F156 0000F2A0 0000F3A2
...
// NOTE: unhandled fetch opcode 18 at 177
...
float4 UniformScalar_6 : register(c6); // float
sampler2D Texture2D_4 : register(s0);
sampler2D Texture2D_8 : register(s1);
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.y = tex2D(Texture2D_8, r0.xy).w;
    ps = UniformScalar_4.x - r3.w;
    r2.xz = r0.wz * 3.0;
    r2.w = ps;
    r2.z = tex2D(Texture2D_4, r2.xz).z;
    r2.x = float((UniformScalar_3.x >= 1.0));
    r2.x = r2.w * r2.x + r3.w;
    r2.x = -r2.x + r3.z;
    r2.x = max(r2.x, UniformScalar_5.x);
    ...
    ps = 1.0 - r2.x;
    r2.x = ps;
    r2.z = (UniformScalar_4.x > 0.0) ? r2.x : 1.0;
    r2.x = (UniformScalar_4.x >= 0.0) ? r2.z : r2.x;
    r2.x = r2.x * r2.y - 0.5;
