// ps_827bb4678e1a8ade.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 75 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000012C 10000200 00000004 00000000 00001842 00030003 00000021 00003050 0000F156
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2 = r0.xyyx * float4(2e+01, 2e+01, 1.0, 1.0) - 0.5;
    r0.xw = r2.yy * float2(-0.0015926529, -0.99999875) + 0.5;
    r0.yz = r2.zz * float2(0.9999997, 0.0007963267) + 0.5;
    r0.yz = r2.xx * float2(0.0007963267, -0.9999997) + r0.yz;
    r0.xw = r2.ww * float2(-0.99999875, 0.0015926529) + r0.xw;
