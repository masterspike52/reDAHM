// vs_10f063ddf590df90.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 570 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000040 000008E8 0041000F 00000000 00000000 000044A5 00000001 00000007 00000005 00000290 00100017 00006018 00007019 0000301A 0000201B 0000101C 0020501D 00003050 0001F156 00027257 0003F3A0 0004F4A1 000010BA 000010B9 000010B8 000010BC 000010BB
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r14.xyz = r4.xyz * 0.007843138 - 1.0;
    ...
    r9.x = dot(r14.zxy, r0.wyz);
    r9.z = dot(r14.zxy, r4.zxy);
    r10.x = dot(r2.zxy, r4.zxy);
    r10.y = dot(r2.zxy, r5.zxy);
    r10.z = dot(r2.zxy, r0.wyz);
    r0.x = dot(r12.zxy, r5.zxy);
    r0.y = dot(r12.zxy, r0.wyz);
    r0.z = dot(r12.zxy, r4.zxy);
    a0 = xe_mova(r2.w);
    ...
    r7.xyz = r8.xxx * BoneMatrices[a0].xyz;
    r10.xyz = r8.xxx * BoneMatrices[a0 + 1].xyz;
    r9.xyz = r8.xxx * BoneMatrices[a0 + 2].xyz;
    r2.w = dot(r4.zxyw, r15);
    r3.w = dot(r13.zxyw, r15);
    p0 = (r3.z != 0.0);
    ps = p0 ? 0.0 : 1.0;
    r0.x = dot(r11.zxyw, r0);
    r0 = r0.xxxx * LocalToWorld[2] + LocalToWorld[3];
    r0 = r3.wwww * LocalToWorld[1].xzyw + r0.xzyw;
    r4 = r2.wwww * LocalToWorld[0].xywz + r0.xzwy;
    ...
    p0 = (r0.z != 0.0);
    ps = p0 ? 0.0 : 1.0;
    r7.xyz = r8.yyy * BoneMatrices[a0].xyz + r7.xyz;
    ...
    p0 = (r0.z != 0.0);
    ps = p0 ? 0.0 : 1.0;
    r7.xyz = r8.zzz * BoneMatrices[a0].xyz + r7.xyz;
    ...
    r7.xyz = r0.yyy * WorldToLocal[0].xyz + r0.xwz;
    r0.xy = r2.xy * r7.yz;
    r0.w = dot(r13.yx, r7.zx) + 0.0;
    r2.xy = r3.zw * r7.xy;
    ps = r2.x + r2.y;
    r9.x = dot(r12.zxy, r7.zxy);
    r0.z = ps;
    r9.yz = r0.xz + r0.wy;
    r0.x = r1.y * 3.0;
    a0 = xe_mova(r0.x);
    ...
    o2.xyz = r9.xyz;
    o1 = r4.xxxx * ViewProjectionMatrix[0] + r0.xzyw;
    o0.xy = r3.xy;
    o4.xyz = r6.xyz;
    o4.w = 0.0;
    o3 = r5;
