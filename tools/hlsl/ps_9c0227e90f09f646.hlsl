...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.y = saturate(ps);
    ps = 0.875 * r5.z;
    r11.xyz = r10.zxy + float3(-2.0, 0.0, 0.0);
    r8.y = ps;
    ps = 0.875 * r5.w;
    r0.yzw = r12.xyz * r2.www;
    r8.z = ps;
    ps = rsqrt(abs(r3.w));
    r12.xyz = r9.yzw * r4.xyz;
    r5.z = ps;
    ps = rsqrt(abs(r1.w));
    ...
    r5.x = saturate(ps);
    r1.xyz = (-abs(r0.xxx) >= 0.0) ? r9.yzw : r12.xyz;
    ps = log2(r5.y);
    r3.xyz = r11.yzx + r10.xyz;
    r5.y = ps;
    r1.xyz = (-abs(r6.www) >= 0.0) ? r9.yzw : r1.xyz;
    ps = 1.0 - r5.x;
    r3.xyz = r3.xyz + float3(-1.0, -1.0, 0.0);
    r5.x = ps;
    r5.xz = -r5.xx * ModShadowGroupColor.xy + 1.0;
    r8.yz = r8.yz * r5.xz + 0.125;
    ps = LightColorAndFalloffExponent.w * r5.y;
    r5.xzw = r3.zxy * UniformScalar_0.xxx;
    r0.x = ps;
    ps = 1.0 + r5.x;
