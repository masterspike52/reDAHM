// ps_d2c7c242b433f6e4.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 135 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000021C 10040900 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.w = ps;
    r6.yz = r0.zw * r5.xy + ScreenPositionScaleBias.wz;
    r1.xyz = tex2D(LightAttenuationTexture, r6.yz).xyz;
    r0.z = tex2D(ShadowTexture, r0.xy).x;
    r0.yw = tex2D(ModShadowAccumTexture, r7.zw).xy;
    r8.xyz = tex2D(Texture2D_2, r9.xy).xyz;
    ...
    r7.x = ps;
    ps = rsqrt(abs(r6.w));
    r3.xyz = r7.xxx * r2.xyz;
    r6.w = ps;
    ps = rsqrt(abs(r6.y));
    r2.yzw = r6.www * r4.xyz;
    r6.w = ps;
    ps = log2(r6.x);
    r6.y = -r6.z + 1.0;
    r6.x = ps;
    ...
    ps = 1.0 + ps;
    r6.w = dot(r4.zxy, r2.wyz);
    r2.x = ps;
    ps = -UniformVector_0.y;
    r9.xyz = r4.xzy * r6.www;
    r2.yzw = r9.xyz * 2.0 - r2.ywz;
    ps = 1.0 + ps;
    r7.x = saturate(dot(r3.zxy, r2.zyw));
    r2.y = ps;
    ps = log2(r7.x);
    r6.w = saturate(dot(r4.zxy, r3.zxy));
    r7.x = ps;
    ps = -UniformVector_0.z;
    r7 = r7.yzwx * float4(1.5, 1.5, 1.5, 15.0);
    ps = 1.0 + ps;
    ...
    r0.x = ps;
    r0.xyw = r0.xyw * float3(0.21952, 0.875, 0.875);
    r7.xyz = r7.xyz * r6.www + r0.xxx;
    r0.xy = r0.yw * r6.yz + 0.125;
