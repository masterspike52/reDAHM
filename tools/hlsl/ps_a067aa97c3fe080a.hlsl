// ps_a067aa97c3fe080a.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 75 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000012C 18000300 00000008 00000000 00004084 0003000F 00000011 0000F050 0000F157 0000F2A0 0000F3A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.xy = r0.yx - 0.5;
    r2.z = dot(r3.xy, UniformVector_2.yx) + 0.5;
    r2.y = dot(r3.xy, UniformVector_1.yx) + 0.5;
    // unhandled fetch opcode 18
    r2.y = tex2D(Texture2D_0, r2.yz).w;
    r2.z = r2.y * r2.w - 0.5;
    r2.y = max(r3.x, r3.y);
    r2.y = r2.y * SlopeScaleDepthBias.x + DepthBias.x;
    r2.y = r1.z * InvMaxSubjectDepth.x + r2.y;
    r3.xy = r0.yx - 0.5;
    r3.w = dot(r3.xy, UniformVector_2.yx) + 0.5;
    r3.z = dot(r3.xy, UniformVector_1.yx) + 0.5;
    // unhandled fetch opcode 18
