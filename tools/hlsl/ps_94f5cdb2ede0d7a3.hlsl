...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.x = ps;
    r5.xy = r6.yz * r5.xy + ScreenPositionScaleBias.wz;
    ...
    r3.xyz = texCUBE(TextureCube_0, xe_cube_dir(r7.xyz)).xyz;
    ...
    r6.yz = tex2D(ModShadowAccumTexture, r8.xy).xy;
    ...
    r2.xyz = r6.xyz * 2.0 - r9.xzy;
    r0.xy = r0.xz * r0.yz;
    r6.xyz = r0.xxx * r8.xyz + ModShadowColor.xyz;
    r7.x = saturate(dot(r5.zxy, r2.yxz));
    ps = log2(r7.x);
    r0.xyz = r0.yyy * r4.xyz;
    r7.x = ps;
    r7 = r7 * float4(15.0, 3e+01, 3e+01, 3e+01);
    ps = pow(2.0, r7.x);
