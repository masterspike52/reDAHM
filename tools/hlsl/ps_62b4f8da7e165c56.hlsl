// ps_62b4f8da7e165c56.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 69 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000114 10000600 00000004 00000000 000044A5 001F001F 00000001 00003050 0000F151 0000F255 00007356 0000F457
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.w = ps;
    r0.xy = r0.xy * 2.0 + UniformVector_3.xy;
    r2.yzw = tex2D(Texture2D_0, r0.xy).xyz;
    r1.xyz = tex2D(Texture2D_0, r1.xy).xyz;
    r0.xyz = tex2D(Texture2D_0, r0.zw).yzx;
