...
float4 UniformScalar_17 : register(c3); // float
float4 UniformScalar_18 : register(c4); // float
float4 UniformScalar_19 : register(c5); // float
float4 UniformScalar_20 : register(c6); // float
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = UniformScalar_18.x - r3.w;
    r2.x = float((UniformScalar_17.x >= 1.0));
    r4.x = ps;
    r2.x = r4.x * r2.x + r3.w;
    ps = max(r2.z, r2.w);
    r2.x = -r2.x + r3.z;
    ...
    r2.x = max(r2.x, UniformScalar_19.x);
    ...
    r2.y = ps;
    r2.x = r2.y * r2.x;
    r2.y = float((r2.x >= 0.05));
    ps = 1.0 - r2.y;
    r2.x = ps;
    r2.y = (UniformScalar_18.x > 0.0) ? r2.x : 1.0;
    r2.x = (UniformScalar_18.x >= 0.0) ? r2.y : r2.x;
    ps = (-0.5) - -r2.x;
    r2.x = ps;
    r2.yw = r0.wz * 3.0;
    r3.x = tex2D(Texture2D_4, r2.yw).z;
    // unhandled fetch opcode 18
    ps = UniformScalar_18.x - r3.w;
    r2.y = float((UniformScalar_17.x >= 1.0));
    r2.w = ps;
    r2.y = r2.w * r2.y + r3.w;
    ps = max(r0.x, r0.y);
    r2.w = -r2.y + r3.z;
    ...
    r2.w = max(r2.w, UniformScalar_19.x);
    ps = 1.0 / UniformScalar_20.x;
    r2.w = min(r2.w, 1.0);
    r3.y = ps;
    ps = r3.x;
    ...
    r2.w = -r2.w + 1.0;
    r3.x = (UniformScalar_18.x > 0.0) ? r2.w : 1.0;
    r2.w = (UniformScalar_18.x >= 0.0) ? r3.x : r2.w;
    r2.w = r2.w - 0.5;
