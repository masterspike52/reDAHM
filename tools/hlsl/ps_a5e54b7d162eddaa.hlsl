...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = -r4.y;
    r2.xyz = r5.xxx * -SpotDirection.xyz;
    r0.y = ps;
    r0.x = r4.w * 2.0 - r4.w;
    ps = -r4.z;
    ...
    r4.z = saturate(dot(r9.xyz, r0.yzx));
    r4.y = ps;
    ps = log2(r4.z);
