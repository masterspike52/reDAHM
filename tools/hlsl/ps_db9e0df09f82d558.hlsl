// ps_db9e0df09f82d558.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 198 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000318 10041000 0000080A 00000000 00007908 003F00FF 00000001 00003050 0000F151 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r16.xyz = tex2D(Texture2D_2, r6.zw).xyz;
    r8.yzw = tex2D(Texture2D_2, r6.xy).yxz;
    r10.xyw = tex2D(Texture2D_3, r1.xy).xyz;
    ...
    r14.xyz = r0.yzw * AmbientColorAndSkyFactor.xyz;
    r10.z = saturate(ps);
    r15.xyz = r1.zxy * 2.0 - 1.0;
    ps = LightMapScale.x * r6.y;
    r13.xyz = r10.xyw + r11.xyz;
    r8.x = ps;
    ps = LightMapScale.y * r6.z;
    r1.xyw = r16.xzy * r8.zwy;
    r8.y = ps;
    ...
    r4.x = ps;
    ps = 2e+02 * r6.z;
    r7.x = dot(r5.xyz, r10.wxy);
    r4.y = ps;
    ps = 1e+03 * r6.x;
    r11.xyz = r5.yzx * r7.xxx;
    r4.z = ps;
    r6.xyz = r4.xyz * r11.www + UniformVector_0.xyz;
    r4.xyz = r14.xyz * r13.xyz + r6.xyz;
    ps = 1.0 - r6.w;
    r5 = r12.xxyz * float4(-0.5, 0.5, 0.875, 0.875);
    r6.z = ps;
    r6.xyw = r11.xyz * 2.0 - r10.xyw;
    ps = ModShadowGroupColor.x * r6.z;
    r7.x = saturate(dot(r0.xyz, r6.wxy));
    r10.x = ps;
    ...
    r6.xyw = -r10.xyz + 1.0;
    r0.x = ps;
    r0.yz = r5.zw * r6.xy + 0.125;
    ps = 0.0001;
    r6.xy = abs(r5.xy) * abs(r5.xy);
    r0.w = ps;
    ps = max(r0.x, r0.w);
    r5.xyz = r1.xzy * r6.xxx;
    r0.x = ps;
    ps = log2(r7.x);
    r10.xyz = r1.xzy * r6.yyy;
    r0.w = ps;
