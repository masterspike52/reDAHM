...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.yzw = texCUBE(TextureCube_0, xe_cube_dir(r5.xzw)).yzx;
    r0 = tex2D(Texture2D_4, r1.xy);
    r1.xyz = tex2D(Texture2D_0, r1.xy).xyz;
    r6.x = dot(r3.zxy, r3.zxy);
    r5.xzw = r1.xyz * 2.0 - 1.0;
    ps = r0.x + r0.x;
    ...
    r6.x = ps;
    ps = 5.0 * r6.y;
    r10.xyz = r6.xxx * -SpotDirection.xyz;
    r6.x = saturate(ps);
    ps = r0.w;
    r6.w = dot(r5.wxz, r5.wxz);
    r6.y = ps;
    ps = log2(r6.z);
    r0.x = -r6.x + 1.0;
    r6.x = ps;
    ...
    r6.w = ps;
    ps = r6.z;
    r3.xyz = r5.xzw * r6.www;
    r6.z = ps;
    ps = 0.0001;
    r0.x = dot(r3.zxy, r8.zxy);
    r6.w = ps;
    ps = max(r6.z, r6.w);
    r10.xyz = r3.xzy * r0.xxx;
    r5.x = ps;
    r8.xyz = r10.xyz * 2.0 - r8.xzy;
    ps = -SpotAngles.x - -r6.y;
    r6.z = saturate(dot(r2.zxy, r8.yxz));
    r6.y = ps;
    ps = log2(r6.z);
