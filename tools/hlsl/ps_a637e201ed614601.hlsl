// ps_a637e201ed614601.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 99 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000018C 10040800 00000806 00000000 00006908 00FF00FF 00000001 00003050 00003151 0000F252 0000F353 00007454 0000F555 00007656 0000F757
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.xy = tex2D(ModShadowAccumTexture, r2.xy).xy;
    ps = r4.z;
    ...
    r0.x = ps;
    ps = rsqrt(abs(r1.w));
    r2.x = saturate(-r2.x + 1.0);
    r1.w = ps;
    ps = 5.0 * r0.x;
    r2.y = dot(r6.zxy, r6.zxy);
    r0.x = saturate(ps);
    ps = rsqrt(abs(r2.y));
    r7.xyz = r1.www * r4.zxy;
    r2.y = ps;
    ps = 1.0 - r0.x;
    r5.xyz = r2.yyy * r6.zxy;
    r0.x = ps;
    r2.yz = -r0.xx * ModShadowGroupColor.xy + 1.0;
    ps = -UniformVector_0.x;
    r5.yz = -r5.yz;
    r5.x = r5.x * 2.0 - r5.x;
    ps = 1.0 + ps;
    r2.w = saturate(dot(r7.yzx, r5.yzx));
    r0.x = ps;
    ps = log2(r2.w);
    r1.w = saturate(r1.w * r4.z);
    r2.w = ps;
    ps = log2(r2.x);
    r2.w = r2.w * 15.0;
    r2.x = ps;
    ...
    r3.z = ps;
    ps = pow(2.0, r2.x);
    r3.yzw = r3.zxy * float3(0.21952, 0.875, 0.875);
    r2.x = ps;
    r3.x = r1.w * r0.x + r3.y;
    r2 = r3.zwxy * r2.yzxx;
    r2.xy = r2.xy + 0.125;
