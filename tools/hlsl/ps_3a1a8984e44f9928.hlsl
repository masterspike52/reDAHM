// ps_3a1a8984e44f9928.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 147 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000024C 10040C00 0000080A 00000000 00007908 003F00FF 00000001 00003050 0000F151 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.z = saturate(ps);
    ps = rsqrt(abs(r7.z));
    r1.xyz = r9.xyz * r11.xyz;
    r7.z = ps;
    r10.xyz = r1.xyz * AmbientColorAndSkyFactor.xyz + UniformVector_0.xyz;
    ps = rsqrt(abs(r7.y));
    ...
    r5.xyz = r6.www * r12.zxy;
    r2.x = ps;
    ps = LightMapScale.y * r6.z;
    r8.x = dot(r0.zxy, r5.xyz);
    r2.y = ps;
    ...
    r5 = r8.xxyw * float4(-0.5, 0.5, 0.875, 0.875);
    r8.x = ps;
    ...
    r6.xyw = -r8.xyz + 1.0;
    r7.x = ps;
    r4.xyz = r1.xzy * r7.yyy;
    r8.xy = r5.zw * r6.xy + 0.125;
    ps = log2(r6.z);
    r7.xyz = r1.xzy * r7.xxx;
    r11.w = ps;
    r1 = r11 * float4(4.0, 4.0, 4.0, 15.0);
    r7.xyz = r7.xzy * UpperSkyColor.xyz + r10.xyz;
    ps = r8.x * r8.y;
    r5.xyz = -ModShadowColor.xyz + 1.0;
    r6.z = ps;
    r6.xyz = r6.zzz * r5.xyz + ModShadowColor.xyz;
