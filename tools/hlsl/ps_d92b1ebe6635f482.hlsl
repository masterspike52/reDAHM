// ps_d92b1ebe6635f482.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 309 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004D4 10040F00 0000080A 00000000 00007908 001F00FF 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A1 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.xy = tex2D(ModShadowAccumTexture, r7.xy).xy;
    r7.xzw = tex2D(Texture2D_2, r6.yz).xyw;
    ...
    r8.z = ps;
    ps = rsqrt(abs(r5.z));
    r14.xz = saturate(r11.xy * float2(5.0, 0.00022222222));
    r5.x = ps;
    ps = r5.x;
    r6.x = dot(r6.xww, float3(1.0, 1.0, 1.0));
    r5.z = (r6.x == 0.0) ? r10.x : r10.w;
    ps = r3.x * ps;
    r6 = r6.xyzx + float4(-3.0, -1.0, -1.0, -2.0);
    r10.x = ps;
    r5.z = (r6.w == 0.0) ? r10.y : r5.z;
    r14.y = (r6.x == 0.0) ? r10.z : r5.z;
    ps = r5.x;
    r5.z = max(r14.y, 0.0);
    ps = r3.y * ps;
    r14.w = min(r5.z, 0.3);
    r10.y = ps;
    ps = r5.x;
    r6.xw = r14.zw * float2(-0.025, 3.3333333);
    ps = r3.z * ps;
    r5.xz = -r14.yx + 1.0;
    r10.z = ps;
    ps = 2.5 * r5.x;
    r11.xy = r5.zz * ModShadowGroupColor.xy;
    r10.w = ps;
    r5.zw = r10.xy * r6.xx + r12.xy;
    ps = 0.875 * r5.y;
    r11.xyz = -r11.xyz + 1.0;
    r8.w = ps;
    ps = r7.z + r7.z;
    ...
    r6.yz = r7.xy + ScreenPositionScaleBias.wz;
    r1.w = tex2D(Texture2D_4, r0.xy).x;
    r3.xyz = tex2D(Texture2D_7, r5.zw).xyz;
    r4.xyz = tex2D(Texture2D_6, r8.xy).xyz;
    r0.xyz = tex2D(Texture2D_3, r0.xy).xyz;
    r5.xyw = tex2D(Texture2D_0, r5.zw).xyz;
    r15.xyz = tex2D(LightAttenuationTexture, r6.yz).xyz;
    ...
    r0.xyz = r0.xyz * UniformVector_4.xyz;
    ps = -r5.z;
    r6.y = r14.x * r14.y;
    r6.xyz = r6.yyy * r13.xyz + ModShadowColor.xyz;
    r2.xy = r6.ww * r12.xy + r0.xy;
    r6.w = saturate(r10.w * r3.w - 0.5);
    ps = r0.z + ps;
    r0.xy = r2.xy - r5.xy;
    r0.z = ps;
    r5.xy = r0.xy * r6.ww + r5.xy;
    r5.z = r0.z * r6.w - 2.0;
    r5.z = r5.w * 2.0 + r5.z;
    r5.xyz = r5.zxy * r11.zzz;
    ps = 1.0 + r5.x;
    r0.xyz = -UniformVector_0.xyz + 1.0;
    r5.w = ps;
    r5.xyz = (r11.zzz > 0.0) ? r5.yzw : float3(0.0, 0.0, 1.0);
    r2.xyz = (r11.zzz >= 0.0) ? r5.xyz : float3(0.0, 0.0, 1.0);
    ps = rsqrt(abs(r0.w));
    ...
    r5.x = saturate(dot(r5.wyz, r2.zxy));
    ps = log2(r5.x);
    r5.w = saturate(dot(r1.zyx, r5.wzy));
    r5.y = ps;
    ...
    r2.w = ps;
    r4 = r2 * r4.xyzx;
    r2.xyz = r4.xyz * r3.www - r3.xyz;
    r1.xyz = r4.xyz * UniformScalar_11.xxx + UniformScalar_12.xxx;
    r1.xyz = r4.www * r1.www + r1.xyz;
