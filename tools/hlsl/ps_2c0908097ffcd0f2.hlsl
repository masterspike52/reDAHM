// ps_2c0908097ffcd0f2.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 129 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000204 10040800 0000070A 00000000 000060E7 001F007F 00000001 00003050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.w = tex2D(ShadowTexture, r0.xy).x;
    ...
    r6.x = saturate(dot(r1.yzx, r0.yzx));
    r5.y = ps;
    ps = log2(r6.x);
    ...
    r0.y = r0.x * r0.x;
    r6.x = ps;
    r4.yz = r1.yz * r5.zw + 0.125;
    ps = r4.y * r4.z;
    r5.yzw = -ModShadowColor.xyz + 1.0;
    r1.x = ps;
    ps = r4.w * r4.w;
    r6 = r6.xxzw * float4(0.3, 0.6, 0.5, 0.1);
    r0.z = ps;
