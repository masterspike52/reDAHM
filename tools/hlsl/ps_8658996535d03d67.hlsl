// ps_8658996535d03d67.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 108 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001B0 10040900 0000070A 00000000 000070E7 001F007F 00000001 0000F053 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = r0.x * r0.y;
    r5.xy = abs(r0.zw) * abs(r0.zw);
    r5.z = ps;
    r6.xyz = r5.zzz * r6.xyz + ModShadowColor.xyz;
    r0.xyz = r8.xyz * r5.xxx;
    r5.xyz = r8.xyz * r5.yyy;
    r5.xyz = r5.xyz * LowerSkyColor.xyz + r7.xyz;
    r5.xyz = r0.zxy * UpperSkyColor.zxy + r5.zxy;
