...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.xy = tex2D(ModShadowAccumTexture, r5.yw).xy;
    ...
    r0.xyz = r9.xyz * UniformVector_1.xyz;
    r5.z = rsqrt(abs(r5.z));
    r4.xyz = r5.zzz * r1.xyz;
    r5.y = 0.1 - -r1.z;
    r6.w = dot(r11.zxy, r11.zxy);
    r5.y = saturate(5.0 * r5.y);
    ps = rsqrt(abs(r5.w));
    r5.z = -r5.y + 1.0;
    r5.y = ps;
    ...
    ps = 1.0 - r5.x;
    r5.z = saturate(dot(r4.zxy, r5.zyw));
    r5.y = saturate(ps);
    ps = log2(r5.z);
