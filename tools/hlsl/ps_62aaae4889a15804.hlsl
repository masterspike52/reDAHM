...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.yzw = tex2D(Texture2D_2, r1.xy).xyz;
    ...
    ps = 0.875 * r6.x;
    r2.xyz = r6.www * r10.xyz;
    r10.x = ps;
    ps = 0.875 * r6.y;
    r7.w = saturate(dot(r2.zxy, r3.zxy));
    r10.y = ps;
    r0.xy = r10.xy * r0.xy + 0.125;
    r6.x = dot(r2.zxy, r8.zxy);
    r6.xyw = r2.xzy * r6.xxx;
    r2.xyz = r6.xyw * 2.0 - r8.xzy;
    r0.xy = r0.xz * r0.yz;
    ...
    r0.x = ps;
    ps = pow(2.0, r0.x);
    r6.z = saturate(dot(r3.zxy, r2.yxz));
    r0.x = ps;
    ps = log2(r6.z);
    r0.xyz = r0.ywz * r0.xxx;
    r4.x = ps;
    r2 = r4.yzxw * float4(3e+01, 3e+01, 15.0, 3e+01);
    ps = pow(2.0, r2.z);
    r7.xyz = r2.xyw * r7.xyz;
    r6.z = ps;
