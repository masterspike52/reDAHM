// ps_6d7b770a081013fc.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 243 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000003CC 10041100 0000080A 00000000 00008108 003F00FF 00000001 0000F050 0000F153 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9.x = ps;
    ps = r9.z;
    r4.xyw = r13.zyx * r6.xxx;
    r11.xyw = r4.xyw * 2.0 - r7.yxw;
    ps = abs(r8.y) * ps;
    r6 = xe_cube(r11.yxw);
    r9.y = ps;
    ps = 1.0 / abs(r6.z);
    ...
    r8.yz = tex2D(ModShadowAccumTexture, r9.xy).xy;
    r15.xyz = tex2D(Texture2D_1, r0.xy).xyz;
    r4.z = tex2D(Texture2D_4, r0.xy).w;
    r16.xyz = tex2D(Texture2D_2, r0.xy).xyz;
    r12.xyz = tex2D(Texture2D_3, r0.xy).xyz;
    r0 = tex2D(Texture2D_5, r0.xy).wxyz;
    r6.z = dot(r5.zxy, r5.zxy);
    r9.xzw = UniformScalar_6.xxx * UniformVector_1.yxz;
    r7.z = float((UniformScalar_0.x >= UniformScalar_1.x));
    ...
    r0.x = ps;
    r6.xyw = (-abs(r6.xxx) >= 0.0) ? r16.xyz : r17.xyz;
    r0.xyz = r0.yzw * UniformScalar_7.xxx + r0.xxx;
    r9.zw = r9.zw * r4.zz + r0.xz;
    r0.w = r9.x * r4.z + r0.y;
    r0.xyz = (-abs(r7.zzz) >= 0.0) ? r16.xyz : r6.xyw;
    ...
    r4.xyz = r0.xyz * UniformScalar_2.xxx + UniformScalar_3.xxx;
    ps = rsqrt(abs(r6.z));
    r2.xyz = r13.xxx * r1.xyz;
    r6.z = ps;
