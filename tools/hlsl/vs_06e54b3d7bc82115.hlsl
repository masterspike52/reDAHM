// vs_06e54b3d7bc82115.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 1044 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000080 00001050 0061000C 00000000 00000000 000068E7 00000001 00000007 00000007 00000290 0010002A 0000602B 0000702C 0000302D 0001A02E 0000502F 00215030 0000F050 00017154 0002F255 00037356 0004F457 0005F5A0 0006F6A2 00001159 00001155 00001154 00001156 0000115A 00001157 00001158
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r2 = r10.xxxx * LocalToWorld[0] + r0.xzyw;
    // UNHANDLED control flow: cjmp
    ps = 1.0 / BBox_Size.x;
    ...
    r5.xyz = r9.xyz * 0.007843138 - 1.0;
    r4.xzw = r6.xyz * 0.007843138 - 1.0;
    r6.xyz = r3.yzw * 0.007843138 - 1.0;
    r3 = r2.zzzz * ViewProjectionMatrix[2].xwzy + r11;
    ...
    r9.x = dot(r6.xzy, r11.zxy);
    r2.x = ps;
    ps = WorldToLocal[2].z * r0.w;
    r9.y = dot(r4.zxw, r11.zxy);
    r2.y = ps;
    ps = WorldToLocal[2].y * r0.w;
    r9.z = dot(r5.zyx, r11.zxy);
    r2.z = ps;
    ...
    r2.y = -r6.y * r11.y + r5.y;
    ps = (-abs(r0.x) > 0.0) ? 1.0 : 0.0;
    r0.xy = -r5.yw + r2.ww;
    r11.y = ps;
    p0 = (r6.z != 0.0);
    ps = p0 ? 0.0 : 1.0;
    r12.xy = float2((r5.wy >= r2.yw));
    r0.xy = r6.xx * r9.ww + r0.xy;
    r0.xy = r0.xy * SP_DemolitionSpread.xx + r5.yw;
    r0.x = (r12.y == 0.0) ? r5.y : r0.x;
    r0.x = (r0.z == 0.0) ? r0.x : r0.y;
    r0.y = (r12.x == 0.0) ? r2.y : r0.x;
    if (p0)
    {
        if (p0)
        {
