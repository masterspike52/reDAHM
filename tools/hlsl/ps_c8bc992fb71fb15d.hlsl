// ps_c8bc992fb71fb15d.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 174 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000002B8 10040C00 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r12.xy = tex2D(ModShadowAccumTexture, r6.xy).xy;
    ...
    r6.y = ps;
    r1.xyz = (-abs(r2.www) >= 0.0) ? r10.xyz : r1.xyz;
    ps = log2(r7.w);
    r9.xyz = r9.xyz - r0.yzw;
    r6.x = ps;
    r1.xyz = (-abs(r6.www) >= 0.0) ? r10.xyz : r1.xyz;
    r6.yz = -r6.yy * ModShadowGroupColor.xy + 1.0;
    r0.yzw = r9.xyz * UniformScalar_0.xxx + r0.yzw;
    r7.w = dot(r0.wyz, r0.wyz);
    r6.yz = r3.xy * r6.yz + 0.125;
    ...
    r7.w = ps;
    r7.xyz = r7.xyz * UniformScalar_2.xxx + UniformScalar_3.xxx;
    r3.xyz = r0.yzw * r7.www;
    ps = UniformScalar_7.x;
    r7.w = dot(r3.zxy, r4.zxy);
    r0.y = ps;
    ps = 0.0001;
    r8.xyz = r3.xzy * r7.www;
    r0.w = ps;
    r4.xyz = r8.xyz * 2.0 - r4.xzy;
    ps = max(r0.y, r0.w);
    r0.z = saturate(dot(r2.zxy, r4.yxz));
    r0.y = ps;
    ps = log2(r0.z);
