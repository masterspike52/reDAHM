// ps_b2bac266353940b4.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 132 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000210 10040900 00000606 00000000 000050C6 003F003F 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.w = ps;
    ps = rsqrt(abs(r2.w));
    r6 = r6.xyxz * float4(5.0, 5.0, 5e+01, 5.0);
    r1.x = ps;
    ps = rsqrt(abs(r0.w));
    ...
    r1.w = ps;
    ps = max(r1.z, r1.w);
    r0.xyw = r4.xzy * r0.xxx;
    r1.z = ps;
    r0.xyw = r0.xyw * 2.0 - r8.xzy;
    ps = log2(r0.z);
    r0.x = saturate(dot(r2.zxy, r0.yxw));
    r0.y = ps;
    ps = log2(r0.x);
    ...
    ps = pow(2.0, r1.x);
    r1.w = saturate(dot(r4.zxy, r2.zxy));
    r1.x = ps;
    ps = pow(2.0, r0.w);
