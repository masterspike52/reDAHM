// ps_5e9954becb421a27.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 141 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000234 10040D00 0000080A 00000000 00007908 003F00FF 00000001 00003050 0000F151 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.z = tex2D(Texture2D_1, r6.xy).w;
    ...
    r9.xyz = r13.xyz * AmbientColorAndSkyFactor.xyz;
    r8.x = ps;
    ps = rsqrt(abs(r0.x));
    r11.xyw = -r7.xyz + r0.zzz;
    r0.x = ps;
    ps = rsqrt(abs(r7.w));
    r0.xyz = r0.xxx * r2.xzy;
    r7.w = ps;
    ps = LightMapScale.y * r6.z;
    r1.xyw = r7.www * r4.xyz;
    r8.y = ps;
    r2.xyz = r11.xyw * r7.zzz + r7.xyz;
    r9.xyz = r9.xyz * r2.xyz + UniformVector_0.xyz;
    ps = LightMapScale.z * r6.x;
    r11.yw = -r1.xy;
    r8.z = ps;
    ps = rsqrt(abs(r6.w));
    r1.xyz = r2.xyz * r13.xyz;
    r12.x = ps;
    r11.x = r1.w * 2.0 - r1.w;
    ps = 0.1 - -r0.y;
    ...
    r6.x = saturate(ps);
    ps = 1.0 - r6.x;
    r6.y = saturate(dot(r0.xzy, r11.ywx));
    r6.x = ps;
    ps = log2(r6.y);
    r11.xy = r6.xx * ModShadowGroupColor.xy;
    r6.y = ps;
    ps = 15.0 * r6.y;
    r6.xzw = -r11.xyz + 1.0;
    r6.y = ps;
    ...
    r0.y = ps;
    ps = (-0.2) + r7.z;
    r5.xyz = r1.xzy * r0.zzz;
    r0.z = ps;
    r7.xyz = r5.xzy * UpperSkyColor.xyz + r9.xyz;
    r7.xyz = r4.xyz * LowerSkyColor.xzy + r7.xzy;
    r7.xyz = r2.xyz * r0.xzy + r7.xyz;
