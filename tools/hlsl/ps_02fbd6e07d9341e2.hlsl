// ps_02fbd6e07d9341e2.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 198 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000318 10041200 0000080A 00000000 00007908 001F00FF 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A1 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r13.xyw = tex2D(Texture2D_3, r7.xy).xyz;
    ...
    r5.zw = tex2D(ModShadowAccumTexture, r8.xy).xy;
    r7.x = dot(r3.zxy, r3.zxy);
    r11.xyz = r7.yzw * 2.0 - 1.0;
    r14.xyz = r6.www * float3(0.2, 3.0, 0.5);
    ps = 1.0 - r5.x;
    ...
    r3.x = ps;
    ps = 0.875 * r5.w;
    r17.xyz = r6.www * -SpotDirection.xyz;
    r3.y = ps;
    ps = 5.0 * r5.y;
    ...
    r5.w = ps;
    ps = rsqrt(abs(r5.z));
    r5.y = dot(r17.zxy, r2.zxy);
    r5.z = ps;
    r2.xy = -r5.ww * ModShadowGroupColor.xy + 1.0;
    r3.yz = r3.xy * r2.xy + 0.125;
    ps = LightColorAndFalloffExponent.w * r5.x;
    r11.xyz = r11.xyz * r5.zzz;
    r6.w = ps;
    r5.xzw = r16.xxx * r13.xyw + r15.xyz;
    ps = r8.w;
    r7.w = dot(r11.zxy, r7.zxy);
    ps = r13.w * ps;
    r13.xyz = r11.xzy * r7.www;
    r14.z = ps;
    ...
    r0.w = r2.y + r10.x;
    r3.x = saturate(ps);
    r7.yzw = r13.xyz * 2.0 - r7.xzy;
    r2.xyz = r12.xyz * UniformScalar_11.xxx + r2.xyw;
    ps = r2.w;
    r7.x = saturate(dot(r11.zxy, r1.zxy));
    ps = r10.y + ps;
    r5.xw = r3.yx * r3.zx;
    r1.w = ps;
