...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.xyz = tex2D(Texture2D_4, r1.xy).yxz;
    r6.z = dot(r3.zxy, r3.zxy);
    r7.w = 5e+01 * r7.y;
    r0.y = dot(r4.zxy, r4.zxy);
    r0.x = saturate(1.0 - r6.z);
    ...
    r0.xy = r0.xz * r0.yz;
    r3.y = ps;
    r6.xzw = r0.xxx * r9.xzw + ModShadowColor.xyz;
    ps = max(r3.x, r3.y);
    r0.z = saturate(dot(r1.zxy, r4.yxz));
    r9.x = ps;
    ps = log2(r0.z);
    r7.w = saturate(dot(r2.zxy, r1.zxy));
    r9.z = ps;
    ps = LightColorAndFalloffExponent.w * r6.y;
    r0.xz = r9.xy * r9.zy;
    r6.y = ps;
    ps = pow(2.0, r6.y);
    r1.xyz = r0.zzz * r8.xyz;
    r6.y = ps;
    ps = pow(2.0, r0.x);
    r1.xyz = r1.xyz * r6.yyy;
    r6.y = ps;
    r7.xyz = r6.yyy * r7.yxz;
    r7.xy = r5.xy * r7.ww + r7.xy;
    r7.z = r5.z * r7.w + r7.z;
