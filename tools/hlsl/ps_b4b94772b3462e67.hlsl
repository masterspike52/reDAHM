// ps_b4b94772b3462e67.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 90 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000168 10040800 00000806 00000000 00006908 00FF00FF 00000001 00003050 00003151 0000F252 0000F353 00007454 0000F555 00007656 0000F757
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.xyz = r2.zzz * r4.zxy;
    r1.x = rsqrt(abs(r1.x));
    r1.xyz = r1.xxx * r6.zxy;
    r0.x = 1.0 - r0.x;
    r2.xy = -r0.xx * ModShadowGroupColor.xy + 1.0;
    r1.yz = -r1.yz;
    r1.x = r1.x * 2.0 - r1.x;
    r0.x = saturate(dot(r7.yzx, r1.yzx));
    ...
    r1.w = ps;
    ps = pow(2.0, r1.w);
    r0.x = saturate(r2.z * r4.z);
    r5.z = ps;
    r4.xyz = r5.xyz * float3(0.875, 0.875, 0.21952);
    r1.xyz = r1.xyz * r0.xxx + r4.zzz;
    r2.xy = r4.xy * r2.xy + 0.125;
    ps = r2.x * r2.y;
