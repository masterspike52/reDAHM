...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.x = saturate(ps);
    ps = rsqrt(abs(r1.x));
    r5.xyz = r1.yyy * r4.zxy;
    r1.x = ps;
    ps = 1.0 - r0.x;
    r3.xyz = r1.xxx * r6.zxy;
    r0.x = ps;
    r1.xz = -r0.xx * ModShadowGroupColor.xy + 1.0;
    r3.yz = -r3.yz;
    r3.x = r3.x * 2.0 - r3.x;
    r0.x = saturate(dot(r5.yzx, r3.yzx));
    ps = log2(r0.x);
    ...
    r0.x = ps;
    ps = pow(2.0, r0.x);
    r4.w = saturate(r1.y * r4.z);
    r2.z = ps;
    ps = -UniformVector_0.x;
    r4.xyz = r2.xyz * float3(0.875, 0.875, 0.21952);
    ps = 1.0 + ps;
    r0.xy = r4.zz * r0.zw;
    r1.w = ps;
