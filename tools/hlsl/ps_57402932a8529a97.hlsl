// ps_57402932a8529a97.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 213 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000354 10040F00 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.w = -r0.z + 1.0;
    r5.z = ps;
    r14.xy = r0.xy * UniformVector_3.xy;
    r2.zw = r0.xy + 0.5;
    ...
    r5.y = dot(r13.zxy, r4.xyz);
    r7.x = ps;
    ps = log2(abs(r5.x));
    r1.xyz = r13.xzy * r5.yyy;
    r5.y = ps;
    ...
    r7.y = ps;
    ps = pow(2.0, r5.y);
    r5.x = saturate(dot(r12.zxy, r1.yxz));
    r7.z = ps;
    ps = log2(r5.x);
    r1.yzw = -r7.xyz + 1.0;
    r6.y = ps;
    r6 = r6.zwxy * float4(0.875, 0.875, -0.05, 15.0);
    r11.zw = r6.zz * r3.xy + r2.zw;
    ps = UniformVector_2.y * r5.w;
    r15.zw = r6.xy * r1.yz;
    r15.x = ps;
    r5.xw = r6.zz * r3.xy + 0.5;
    ps = r5.x;
    r10 = r15.zwyx + float4(0.125, 0.125, -0.5, -0.5);
    ps = r0.x + ps;
    r11.xy = float2((r15.xy >= 0.5));
    r5.x = ps;
    ps = r5.w;
    r5.yz = r10.zw - r15.yx;
    r5.yz = r5.yz * r11.yx + r15.yx;
    ps = r0.y + ps;
    r2.zw = r5.yz + r5.yz;
    r5.y = ps;
    r5.z = tex2D(Texture2D_3, r14.xy).x;
    r4 = tex2D(Texture2D_2, r2.zw);
    r14.xyz = tex2D(LightAttenuationTexture, r2.xy).xyz;
    r2 = tex2D(Texture2D_1, r0.xy);
    r0.xyz = tex2D(Texture2D_1, r11.zw).xyz;
    r5.y = tex2D(Texture2D_1, r5.xy).w;
    r3.yzw = UniformVector_1.xyz * UniformVector_1.www;
    ps = 1.0 - r5.y;
    r0.xyz = r0.xyz * 0.15;
    r3.x = ps;
    r3.yzw = r3.yzw * r2.xyz - r0.xyz;
    r5.x = r3.x * r2.w + r5.y;
    r3.xyz = r3.yzw * r2.www + r0.xyz;
    r2.xyz = r3.xyz * UniformScalar_0.xxx + UniformScalar_1.xxx;
    ps = r3.x;
    r0.xyz = r14.xyz * LightColor.xyz;
    ps = r8.x * ps;
    r1.x = saturate(dot(r13.zxy, r12.zxy));
    r3.x = ps;
    ps = r3.y;
    r5.w = dot(r11.yxx, float3(1.0, 1.0, 1.0));
    ps = r8.y * ps;
    r5.y = r10.x * r10.y;
    r3.y = ps;
    r6.xyz = r5.yyy * r9.xyz + ModShadowColor.xyz;
