// ps_8df0c441df0360b2.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 192 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000300 10040E00 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 / r5.w;
    r9.x = max(UniformScalar_7.x, 0.0001);
    r6.x = ps;
    ...
    r6.y = ps;
    r2.xyz = (-abs(r7.www) >= 0.0) ? r14.xyz : r2.xyz;
    ps = log2(r7.z);
    r13.xyz = r6.yyy * -SpotDirection.xyz;
    r6.y = ps;
    r2.xyz = (-abs(r6.www) >= 0.0) ? r14.xyz : r2.xyz;
    ps = 1.0 - r6.x;
    r6.z = dot(r13.zxy, r3.zxy);
    r6.x = ps;
    r3.xyz = r12.xyz * UniformScalar_0.xxx + r11.xyz;
    r6.xw = -r6.xx * ModShadowGroupColor.xy + 1.0;
    r7.xy = r7.xy * r6.xw + 0.125;
    r6.x = dot(r3.zxy, r3.zxy);
    r2.xyz = r2.xyz - r8.xyz;
    r2.xyz = r2.xyz * UniformScalar_0.xxx + r8.xyz;
    ps = rsqrt(abs(r6.x));
    r0.xyw = r2.xyz * r0.xyz;
    r6.x = ps;
    r2.xyz = r2.xyz * UniformScalar_2.xxx + UniformScalar_3.xxx;
    ps = -SpotAngles.x - -r6.z;
    r3.xyz = r3.xyz * r6.xxx;
    r6.x = ps;
    ps = SpotAngles.y * r6.x;
    r7.z = dot(r3.zxy, r4.zxy);
    r7.w = saturate(ps);
    r7.xy = r7.xw * r7.yw;
    r6.xzw = r7.xxx * r10.xyz + ModShadowColor.xyz;
    r8.xyz = r3.xzy * r7.zzz;
