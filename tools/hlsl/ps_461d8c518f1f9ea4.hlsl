// ps_461d8c518f1f9ea4.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 138 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000228 10040800 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.zw = r1.xy * 0.5 + UniformVector_2.xy;
    ps = 1.0 / r5.w;
    r6.z = dot(r4.zxy, r4.zxy);
    r6.w = ps;
    ps = 1.0 / ModShadowAccumResolution.y;
    r1.xy = r6.ww * ScreenPositionScaleBias.xy;
    r1.w = ps;
    ps = 1.0 / ModShadowAccumResolution.x;
    r7.xyz = -UniformVector_0.xyz + 1.0;
    r1.z = ps;
    r8.xy = r1.zw * abs(r8.xy);
    ...
    r0.yzw = tex2D(Texture2D_0, r6.xy).xyz;
    ps = r2.z;
    r6.w = dot(r2.zxy, r2.zxy);
    ps = 0.1 + ps;
    r6.y = dot(r3.zxy, r3.zxy);
    r6.x = ps;
    r0.yzw = r0.yzw * 4.0 - 4.0;
    ps = rsqrt(abs(r6.w));
    r7.yzw = r7.xyz * UniformVector_3.xyz;
    r6.w = ps;
    ps = 5.0 * r6.x;
    r3.xyz = r6.www * r2.xyz;
    r6.x = saturate(ps);
    r8.xyz = r8.xyz * 4.0 + r0.yzw;
    ps = 1.0 - r6.x;
    r2.xyz = -ModShadowColor.xyz + 1.0;
    r6.x = ps;
    r0.yz = -r6.xx * ModShadowGroupColor.xy + 1.0;
    ps = rsqrt(abs(r6.z));
    ...
    r7.x = ps;
    r4.xyz = r8.xyz * r7.xxx;
    r7.x = dot(r4.zxy, r6.wxz);
    ps = 1.0 - r6.y;
    r8.xyz = r4.xzy * r7.xxx;
    r6.y = saturate(ps);
    r6.xzw = r8.xyz * 2.0 - r6.xwz;
    ps = log2(r6.y);
