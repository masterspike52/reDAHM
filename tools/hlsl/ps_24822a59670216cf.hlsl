// ps_24822a59670216cf.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 78 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000138 10040600 0000060A 00000000 000060C6 000F003F 00000001 0000F054 0000F156 0000F257 0000F358 0000F4A0 0000F5A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.zw = r4.xx * ScreenPositionScaleBias.xy;
    r5.y = ps;
    ps = 1.0 / ModShadowAccumResolution.x;
    r4.x = dot(r0.zxy, r0.zxy);
    r5.x = ps;
    r5 = r5.zwxy * abs(r6.xyxy);
    r4.yz = r5.xy + ScreenPositionScaleBias.wz;
    r4.yzw = tex2D(Texture2D_0, r4.yz).xyz;
    r5.xy = tex2D(ModShadowAccumTexture, r5.zw).xy;
    ps = rsqrt(abs(r4.x));
    r2.xyz = r4.yzw + UniformVector_0.xyz;
    r4.x = ps;
    r4.x = r4.x * r0.z + 0.1;
    ps = 5.0 * r4.x;
    r4.y = saturate(ps);
