...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.xyw = texCUBE(TextureCube_0, xe_cube_dir(r3.xyz)).yzx;
    ...
    r4 = tex2D(Texture2D_4, r0.xy).yzwx;
    ...
    r5.x = ps;
    r1.xy = -r6.yy * ModShadowGroupColor.xy + 1.0;
    r1.yz = r9.xy * r1.xy + 0.125;
    ps = r4.w + r4.w;
    r4.xyz = r8.xyz * r5.xxx;
    r6.y = ps;
    ps = r6.y;
    r5.x = dot(r4.zxy, r6.wxz);
    ps = r3.w * ps;
    r8.xyz = r4.xzy * r5.xxx;
    r6.y = ps;
    r6.xzw = r8.xyz * 2.0 - r6.xwz;
    ps = 1.8 * r5.y;
    r5.x = saturate(dot(r3.zxy, r6.zxw));
    r6.z = ps;
    ps = log2(r5.x);
    r1.x = max(r5.w, 0.0001);
    r1.w = ps;
    ps = 1.5 * r5.z;
    r1.xy = r1.xy * r1.wz;
    r6.w = ps;
