// ps_585fb8a82ea4c037.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 159 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000027C 10040A00 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.xyz = r3.xzy * r6.yyy;
    r4.xyz = r8.xyz * 2.0 - r4.xzy;
    r6.y = saturate(dot(r2.zxy, r4.yxz));
    ps = log2(r6.y);
    ...
    r0.w = ps;
    r0.xyw = r0.xyw * float3(0.875, 0.875, 0.1);
    r7.xyz = r7.xyz * r6.yyy + r0.www;
    r0.xy = r0.xy * r6.xz + 0.125;
    r0.xy = r0.xz * r0.yz;
