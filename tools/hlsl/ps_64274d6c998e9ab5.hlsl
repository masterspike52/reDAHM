// ps_64274d6c998e9ab5.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 90 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000168 10040600 0000060A 00000000 000058C6 000F003F 00000001 00007054 0000F155 00007256 0000F357 0000F4A0 0000F5A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.yzw = tex2D(LightAttenuationTexture, r4.xy).xyz;
    r4.yzw = -UniformVector_0.xyz + 1.0;
    r4.x = r0.z + 0.1;
    r0.w = rsqrt(abs(r0.w));
    r1.xyz = r5.yzw * LightColor.xyz;
    r4.x = saturate(5.0 * r4.x);
    r6.xyz = r0.www * r0.zxy;
    r5.x = rsqrt(abs(r5.x));
    r5.xyz = r5.xxx * r2.zxy;
    r4.x = 1.0 - r4.x;
    r2.xy = -r4.xx * ModShadowGroupColor.xy + 1.0;
    r5.yz = -r5.yz;
    r5.x = r5.x * 2.0 - r5.x;
    r4.x = saturate(dot(r6.yzx, r5.yzx));
    r5.xyz = r4.yzw * UniformVector_1.xyz;
    r4.x = log2(r4.x);
    ps = 15.0 * r4.x;
    r4.yzw = -ModShadowColor.xyz + 1.0;
    r5.w = ps;
    ps = pow(2.0, r5.w);
    r4.x = saturate(r0.w * r0.z);
    r3.z = ps;
    r0.xyz = r3.xyz * float3(0.875, 0.875, 0.21952);
    r5.xyz = r5.xyz * r4.xxx + r0.zzz;
