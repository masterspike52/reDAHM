// ps_24a1d763581b8a12.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 99 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000018C 10040800 00000406 00000000 00003884 000F000F 00000001 00007054 0000F155 00007256 0000F357
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 0.1 + ps;
    r1.y = dot(r1.zxy, r1.zxy);
    r1.x = ps;
    ps = rsqrt(abs(r0.w));
    r1.y = saturate(-r1.y + 1.0);
    r1.z = ps;
    ps = 5.0 * r1.x;
    r1.w = dot(r2.zxy, r2.zxy);
    r0.w = saturate(ps);
    ps = rsqrt(abs(r1.w));
    r8.xyz = r1.zzz * r0.zxy;
    r1.x = ps;
    ps = 1.0 - r0.w;
    r4.xyz = r1.xxx * r2.zxy;
    r0.w = ps;
    r2.xy = -r0.ww * ModShadowGroupColor.xy + 1.0;
    r4.yz = -r4.yz;
    r4.x = r4.x * 2.0 - r4.x;
    r0.w = saturate(dot(r8.yzx, r4.yzx));
    ps = log2(r0.w);
    r1.x = saturate(r1.z * r0.z);
    r7.x = ps;
    ps = log2(r1.y);
    r4 = r7 * float4(15.0, 0.21952, 0.21952, 0.21952);
    r0.x = ps;
    ps = pow(2.0, r4.x);
    r0.z = r0.x * LightColorAndFalloffExponent.w;
    r6.z = ps;
    ps = pow(2.0, r0.z);
    r0.xyw = r6.xyz * float3(0.875, 0.875, 0.21952);
    r0.z = ps;
    r1.xyz = r4.yzw * r1.xxx + r0.www;
