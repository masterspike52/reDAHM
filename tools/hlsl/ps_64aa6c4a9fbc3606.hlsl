// ps_64aa6c4a9fbc3606.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 78 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000138 10040600 00000606 00000000 000058C6 003F003F 00000021 00003050 0000F151 0000F254 0000F356 0000F457 0000F558
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.xyz = r1.xyz * 0.003 + UniformVector_0.xyz;
    ps = rsqrt(abs(r0.z));
    r6.xy = r6.xy * 0.875;
    r0.x = ps;
    r0.x = r0.x * r2.z + 0.1;
