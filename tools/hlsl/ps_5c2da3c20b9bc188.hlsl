// ps_5c2da3c20b9bc188.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 114 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001C8 10040800 00000606 00000000 000048C6 003F003F 00000001 00003050 00003151 00007254 0000F355 00007456 0000F557
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.y = ps;
    r0.zw = r3.xy * r5.xy + ScreenPositionScaleBias.wz;
    r3.xyz = tex2D(LightAttenuationTexture, r0.zw).xyz;
    r0.w = tex2D(ShadowTexture, r0.xy).x;
    r6.xy = tex2D(ModShadowAccumTexture, r1.zw).xy;
    ...
    r0.x = saturate(ps);
    ps = rsqrt(abs(r0.y));
    r8.xyz = r2.www * r2.zxy;
    r0.y = ps;
    ps = 1.0 - r0.x;
    r4.xyz = r0.yyy * r4.zxy;
    r0.x = ps;
    r0.yz = -r0.xx * ModShadowGroupColor.xy + 1.0;
    r4.yz = -r4.yz;
    r4.x = r4.x * 2.0 - r4.x;
    r0.x = saturate(dot(r8.yzx, r4.yzx));
    ps = log2(r0.x);
    ...
    r6.z = ps;
    r2.xyz = r6.xyz * float3(0.875, 0.875, 0.21952);
    r1.xyz = r1.xyz * r0.xxx + r2.zzz;
    r0.yz = r2.xy * r0.yz + 0.125;
    r0.xw = r0.yw * r0.zw;
