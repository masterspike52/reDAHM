...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.xy = r0.xy * 0.08 + UniformVector_2.xy;
    r5.x = tex2D(Texture2D_1, r5.xy).x;
    r1.xy = r0.xy * 3.0 + UniformVector_1.xy;
    ...
    r5.y = ps;
    r5.yz = r5.yy * r2.xy;
    r5.yz = r5.yz * r5.xx + r0.xy;
    r5.x = tex2D(Texture2D_0, r1.xy).x;
    r0.xyz = tex2D(Texture2D_2, r5.yz).xyz;
    r0.x = r0.x * r4.x;
    ps = r0.x;
    r5.yz = r5.xx * r0.yz;
    ps = r5.x * ps;
    r4.xz = r5.yz * r4.yz;
    r4.y = ps;
    r5.xyz = r4.yxz + UniformVector_0.xyz;
