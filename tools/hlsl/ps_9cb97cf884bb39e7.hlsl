// ps_9cb97cf884bb39e7.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 147 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000024C 10040B00 00000506 00000000 000040A5 001F001F 00000001 00003050 00007154 0000F255 00007356 0000F457
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.x = ps;
    ps = rsqrt(abs(r1.w));
    r0.yzw = r0.xxx * -SpotDirection.xyz;
    r1.w = ps;
    ps = log2(r3.w);
    r3.x = -r4.w + 1.0;
    r0.x = ps;
    r8.xy = -r3.xx * ModShadowGroupColor.xy + 1.0;
    r3.xyz = r1.www * r11.xyz;
    r0.y = dot(r0.wyz, r2.zxy);
    r3.xyz = r3.xyz * TwoSidedSign.xxx;
    r0.z = dot(r3.zxy, r10.zxy);
    r2.xyz = r3.xzy * r0.zzz;
    r2.xyz = r2.xyz * 2.0 - r10.xzy;
    ps = -SpotAngles.x - -r0.y;
    r0.z = saturate(dot(r1.zxy, r2.yxz));
    r0.y = ps;
    ps = log2(r0.z);
    r2.z = saturate(r0.y * SpotAngles.y);
    r9.x = ps;
    r0.yzw = r9.xyz * float3(15.0, 0.875, 0.875);
    r2.xy = r0.zw * r8.xy + 0.125;
    ps = pow(2.0, r0.y);
    r0.z = saturate(dot(r3.zxy, r1.zxy));
    r0.y = ps;
    ps = LightColorAndFalloffExponent.w * r0.x;
    r1.xyz = r0.yyy * r7.zxy;
    r0.y = ps;
    r1.yz = r5.xy * r0.zz + r1.yz;
    r1.w = r5.z * r0.z + r1.x;
    ps = pow(2.0, r0.y);
    r0.xw = r2.xz * r2.yz;
    r1.x = ps;
