// ps_fb56c6ddf6439b7d.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 525 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000834 10000400 00000008 00000000 00004084 0003000F 00000021 0000F050 0000F156 0000F2A0 0000F3A2
...
// NOTE: unhandled fetch opcode 18 at 28
...
// NOTE: unhandled fetch opcode 18 at 55
...
// NOTE: unhandled fetch opcode 18 at 103
...
// NOTE: unhandled fetch opcode 18 at 127
// NOTE: unhandled control flow cjmp at cf 38
// NOTE: unhandled fetch opcode 18 at 135
// NOTE: unhandled control flow cjmp at cf 41
// NOTE: unhandled fetch opcode 18 at 143
// NOTE: unhandled control flow cjmp at cf 44
// NOTE: unhandled fetch opcode 18 at 151
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    if (any(float4(0.0, 0.0, 0.0, 0.0) > float4(-0.5, -0.5, -0.5, -0.5))) clip(-1.0);
    ...
    r2.y = ps;
    ps = 1.0 / r0.w;
    r0.xy = r2.xx - TextureDensityParameters.zy;
    r2.z = ps;
