// vs_34e7c3d21948fa11.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 174 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000040 000002B8 0041000A 00000000 00000000 000050A5 00000001 00000005 00000005 00000290 00100006 00006007 00007008 00003009 0030500A 0000F050 0001F156 0002F2A0 0003F3A1 0004F4A2 00001038 00001035 00001037 00001036 00001034
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r5.x = 0.003921569 * r1.x;
    r5.w = r0.w * 0.5 + 0.5;
    r4.xyz = r2.yzw - r3.yzx;
    r5.y = 0.003921569 * r1.y;
    r0.w = dot(r7.zxy, r4.xzy);
    r5.z = 0.003921569 * r1.z;
    p0 = (r0.w >= 0.0);
    ...
    if (p0)
    {
        if (p0)
        {
            ...
            r2 = r2.wwww * ViewProjectionMatrix[0] + r4.xzyw;
            r1.xyz = r3.xxx * PrevViewProjectionMatrix[0].xyw + r1.xyz;
            r0.w = 1.0 / r1.z;
        }
    }
    if (p0)
    ...
    if (!p0)
    {
        ...
        r2 = r3.xxxx * ViewProjectionMatrix[3].xwyz;
        r2 = r3.yyyy * ViewProjectionMatrix[2].xwyz + r2;
    }
    if (!p0)
    {
        if (!p0)
        {
            r2 = r3.zzzz * ViewProjectionMatrix[1].xwyz + r2;
            r2 = r3.wwww * ViewProjectionMatrix[0] + r2.xzwy;
        }
    }
