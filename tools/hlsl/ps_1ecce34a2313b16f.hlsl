// ps_1ecce34a2313b16f.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 579 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 0000090C 10000400 00000008 00000000 000050A5 0003001F 00000021 0000F050 0000F156 0000F2A0 0000F3A1 0000F4A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 - r2.x;
    r2.x = ps;
    r2.y = (UniformScalar_1.x > 0.0) ? r2.x : 1.0;
    r2.y = (UniformScalar_1.x >= 0.0) ? r2.y : r2.x;
    ps = (-0.5) - -r2.y;
    r2.x = ps;
