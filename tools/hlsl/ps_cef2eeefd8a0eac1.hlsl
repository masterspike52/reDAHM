...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.xy = r9.xy * r6.xy + 0.125;
    ps = r6.z * r6.z;
    r4.xyz = r0.xyz * r6.www;
    r0.x = ps;
    ps = r7.x;
    r6.z = dot(r4.zxy, r2.zxy);
    r0.y = ps;
    ps = 0.0001;
    r9.xyz = r4.xzy * r6.zzz;
    r0.z = ps;
    r2.xyz = r9.xyz * 2.0 - r2.xzy;
    ps = max(r0.y, r0.z);
    r6.w = saturate(dot(r3.zxy, r2.yxz));
    r6.z = ps;
    ps = log2(r6.w);
