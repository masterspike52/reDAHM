// ps_4239b291b5830b42.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 150 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000258 10040C00 0000080A 00000000 00007908 003F00FF 00000001 00003050 0000F151 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r10.xyw = r6.www * r5.xyz;
    r10.z = saturate(ps);
    ps = LightMapScale.x * r6.y;
    r6.w = dot(r11.xyz, r11.xyz);
    r5.x = ps;
    ps = rsqrt(abs(r7.x));
    r1.xyz = r8.xyz * r7.yzw;
    r7.x = ps;
    r4.xyz = r1.xyz * AmbientColorAndSkyFactor.xyz + UniformVector_0.xyz;
    ps = rsqrt(abs(r6.w));
    ...
    ps = pow(2.0, r7.w);
    r4.xyz = r1.xzy * r0.xxx;
    r7.w = ps;
    r0.xyz = r5.xzy * r7.www;
