// ps_32d53bea3cecc447.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 147 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000024C 10040D00 0000080A 00000000 00007908 003F00FF 00000001 00003050 0000F151 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.z = ps;
    r10.xyz = r11.xyz * AmbientColorAndSkyFactor.xyz + UniformVector_0.xyz;
    ps = rsqrt(abs(r7.y));
    ...
    r2.xyz = r6.www * r1.zxy;
    r1.x = ps;
    ps = LightMapScale.y * r6.z;
    r12.x = dot(r0.zxy, r2.xyz);
    r1.y = ps;
    ps = LightMapScale.z * r6.x;
    r6.w = dot(r2.xyz, r4.zxy);
    r1.z = ps;
    ps = 0.1 - -r7.x;
    r0.xyz = r1.xyz * r2.xxx;
    r6.x = ps;
    ps = 5.0 * r6.x;
    r0.xyz = r0.xzy * r13.xzy;
    r6.x = saturate(ps);
    ps = 1.0 - r6.x;
    r2.xyz = r2.yzx * r6.www;
    r6.z = ps;
    r2.xyz = r2.xyz * 2.0 - r4.xyz;
    ps = ModShadowGroupColor.x * r6.z;
    r4 = r12.xxyw * float4(-0.5, 0.5, 0.875, 0.875);
    r12.x = ps;
    ps = ModShadowGroupColor.y * r6.z;
    r6.yw = r4.xy + 0.5;
    r12.y = ps;
    ps = abs(r6.y) * abs(r6.y);
    r6.x = saturate(dot(r7.xyz, r2.zxy));
    r6.z = ps;
    ps = abs(r6.w) * abs(r6.w);
    r7.xyz = -r12.xyz + 1.0;
    r6.y = ps;
    r2.xyz = r11.xzy * r6.zzz;
    ps = log2(r6.x);
    r6.w = float((r7.z >= 0.004));
    r6.x = ps;
    r4.xy = r4.zw * r7.xy + 0.125;
    ps = 15.0 * r6.x;
