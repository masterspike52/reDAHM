// ps_db376e6e3eea1289.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 117 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001D4 10040700 0000070A 00000000 000060E7 001F007F 00000001 00003050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.x = ps;
    ps = rsqrt(abs(r5.z));
    r5.w = saturate(-r5.w + 1.0);
    r5.z = ps;
    ps = 5.0 * r5.x;
    r6.xyz = r6.xyz * UniformVector_1.xyz;
    r5.x = saturate(ps);
    ps = rsqrt(abs(r5.y));
    r7.yzw = r5.zzz * r1.zxy;
    r5.y = ps;
    ps = 1.0 - r5.x;
    r2.xyz = r5.yyy * r3.zxy;
    r5.x = ps;
    ...
    r2.x = r2.x * 2.0 - r2.x;
    ps = 1.0 + ps;
    r6.w = saturate(dot(r7.zwy, r2.yzx));
    r7.y = ps;
    ps = log2(r6.w);
