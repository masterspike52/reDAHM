// ps_f5254090a82c8b56.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 348 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000570 10041200 0000080A 00000000 00007908 003F00FF 00000021 00003050 0000F151 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.xyz = tex2D(Texture2D_7, r1.xy).xyz;
    r6.w = dot(r5.zxy, r5.zxy);
    r6.z = dot(r2.zxy, r2.zxy);
    r14.xyz = r1.xyz * UniformScalar_3.xxx + UniformScalar_4.xxx;
