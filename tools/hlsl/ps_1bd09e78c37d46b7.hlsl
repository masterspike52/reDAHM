// ps_1bd09e78c37d46b7.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 78 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000138 10000500 00000008 00000000 00005CC6 000F003F 00000001 0000F050 0000F155 00007256 0000F357 0000F4A0 0000F5A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.x = r5.x * r4.w;
    r4.w = r5.z * MinZ_MaxZRatio.z - MinZ_MaxZRatio.w;
    ps = 1.0 / r4.w;
    r5.yzw = r0.xyz * 3e+01;
    r4.w = ps;
    r4.xyz = r5.yzw * r4.xyz + UniformVector_0.xyz;
    r5.yzw = r4.xyz * r3.www + r3.xyz;
    r4.x = r4.w - r1.w;
    ps = 0.001 * r4.x;
    r4.y = float((r4.w != 1.0));
    r4.x = saturate(ps);
