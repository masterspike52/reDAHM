// ps_87005c0afa09a975.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 123 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001EC 10040A00 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.zw = r10.xz + r10.yz;
    r5.y = ps;
    r5.x = r2.w * TwoSidedSign.x - r9.z;
    r5.x = saturate(r8.z * r5.x + r2.z);
    ps = log2(r5.x);
    ...
    r4.z = ps;
    r5.xyz = r4.xyz * float3(0.875, 0.875, 0.21952);
    r6.xyz = r6.xyz * r5.www + r5.zzz;
