...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.yz = tex2D(ModShadowAccumTexture, r7.zw).xy;
    ...
    r4.xyz = r6.www * r7.xyz;
    ps = 1.0 + ps;
    r6.w = dot(r4.zxy, r8.zxy);
    r1.y = ps;
    ps = -UniformVector_0.z;
    r10.xyz = r4.xzy * r6.www;
    ...
    r5.x = ps;
    r1.xyz = r5.xyz * float3(15.0, 0.875, 0.875);
    r6.zw = r1.yz * r6.xz + 0.125;
    ps = pow(2.0, r1.x);
    r6.x = saturate(dot(r4.zxy, r2.zxy));
    r7.w = ps;
    r7.xyz = r7.www * r7.xyz;
    r7.xy = r0.xy * r6.xx + r7.xy;
    r7.z = r0.z * r6.x + r7.z;
    r6.xw = r6.zy * r6.wy;
