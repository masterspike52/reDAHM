// ps_7c1d49978d9f79f8.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 63 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000000FC 18000300 00000004 00000000 00002863 00070007 00000011 00003050 0000F151 0000F257
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    // unhandled fetch opcode 18
    r1.y = max(r1.y, r1.z);
    r0.y = InvMaxSubjectDepth.x * r2.z;
