// ps_b408be25d2d54100.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 180 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000002D0 10040A00 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.z = ps;
    ps = 5.0 * r5.x;
    r4.xyw = r6.wxy + float3(-2.0, 0.0, 0.0);
    r5.y = saturate(ps);
    r5.xzw = (-abs(r3.www) >= 0.0) ? r9.xyz : 1.0;
    r9.xyz = (-abs(r2.www) >= 0.0) ? 1.0 : r5.xzw;
    ps = 1.0 - r5.y;
    r10.xyz = r7.xyz * r10.xyz;
    r5.z = ps;
    ps = rsqrt(abs(r1.w));
    r6.xyw = r4.ywx + r6.xyw;
    r5.x = ps;
    ...
    r4.yzw = -r4.zxy + 1.0;
    r5.x = ps;
    r5.zw = r6.wz * r4.yy + 1.0;
    ps = (-1.0) + r6.y;
    r4.x = r4.y * UniformScalar_1.x;
    r5.y = ps;
    r5.xy = r4.xx * r8.xw + r5.xy;
    ps = -UniformVector_0.x;
    r5.xy = r5.xy * r4.yy;
    r5 = (r4.xyyy > 0.0) ? r5.wxyz : float4(1.0, 0.0, 0.0, 1.0);
    r10 = (r4.xyyy >= 0.0) ? r5 : float4(1.0, 0.0, 0.0, 1.0);
    ps = 1.0 + ps;
    r5.x = dot(r10.wyz, r10.wyz);
    r5.y = ps;
    ps = rsqrt(abs(r0.w));
    r1.xyz = r1.xyz * r10.xxx;
    r5.z = ps;
    ...
    ps = pow(2.0, r5.z);
    r5.w = saturate(dot(r3.zyx, r7.zyx));
    r5.z = ps;
    r5.xy = r5.xy * r4.zw + 0.125;
    ps = r5.x * r5.y;
