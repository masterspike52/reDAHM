...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.z = ps;
    r6.yw = tex2D(ModShadowAccumTexture, r5.xz).xy;
    ps = rsqrt(abs(r5.y));
    ...
    r5.x = ps;
    ps = 5.0 * r5.x;
    r5.y = saturate(dot(r5.ywz, r1.yzx));
    r5.x = saturate(ps);
    ps = log2(r5.y);
    r5.x = -r5.x + 1.0;
    r5.y = ps;
    ps = 15.0 * r5.y;
    r1.x = -UniformVector_0.y + 1.0;
    r5.y = ps;
    ps = pow(2.0, r5.y);
    r5.xz = r5.xx * ModShadowGroupColor.xy;
    r5.y = ps;
    ps = rsqrt(abs(r6.x));
    r6.z = r6.z * r5.y;
    r6.x = ps;
    r3 = r6.xxyw * float4(-0.5, 0.5, 0.875, 0.875);
    ...
    r0.xy = r0.xy * r1.xx;
    r6.y = r0.x * LowerSkyColor.y + r6.y;
    r6.y = r0.y * UpperSkyColor.y + r6.y;
    r6.y = r1.x * AmbientColorAndSkyFactor.y + r6.y;
