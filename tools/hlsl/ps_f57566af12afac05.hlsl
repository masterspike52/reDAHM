// ps_f57566af12afac05.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 216 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000360 10040D00 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9.xyw = tex2D(Texture2D_4, r1.xy).xyz;
    ...
    r6.z = -r6.z + 1.0;
    r13.y = ps;
    r12.zw = -r6.zz * ModShadowGroupColor.xy + 1.0;
    ps = 1.0 - r6.x;
    r3.xyz = r13.yxw + float3(-2.0, -2.0, -1.0);
    r7.y = ps;
    ps = r9.y + r9.y;
    r6.xzw = r7.yyy * r11.xyz;
    r10.z = ps;
    ps = r9.w + r9.w;
    r11.w = r3.x - r1.y;
    r10.w = ps;
    ...
    r9.xy = r3.yz - r1.wx;
    r7.w = ps;
    r11.xyz = r6.xzw * r10.xzw - r6.xzw;
    r12.y = r11.w * UniformScalar_0.x + r1.y;
    r11.xyz = r11.xyz * UniformScalar_0.xxx + r6.xzw;
    ps = rsqrt(abs(r0.x));
    r6.xzw = r9.xyz * UniformScalar_0.xxx;
    r7.z = ps;
    ps = (-2.0) + r6.z;
    ...
    r2.x = ps;
    ps = r13.y;
    r0 = r7.xzyw * UniformVector_2.xzyy;
    ps = r7.z * ps;
    r10.x = r0.z * r12.y;
    r2.y = ps;
    ps = r10.x;
    r6.xyz = r13.xzw * r12.xzw;
    ps = r0.w * ps;
    r7.x = r6.x * r7.y;
    r6.w = ps;
    r4.w = r7.x * r12.x + r6.w;
    r7 = r4.wxyz + r2.yxxx;
    ps = rsqrt(abs(r7.x));
    ...
    ps = max(r2.x, r2.y);
    r6.w = saturate(dot(r3.zxy, r9.zxy));
    r6.x = ps;
    ps = log2(r6.w);
    r0.xyz = r0.www * r8.xyz;
    r6.w = ps;
    r2.xy = r6.xy * r6.wz;
    r6.xyz = r2.yyy * r5.xyz + ModShadowColor.xyz;
    ps = pow(2.0, r2.x);
