...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.x = saturate(ps);
    ps = rsqrt(abs(r6.w));
    r0 = r4.xxyz * float4(2e+01, 5.0, 5.0, 5.0);
    r5.y = ps;
    ps = 1.0 - r5.x;
    ...
    r1.x = ps;
    ps = 0.0001;
    r6.w = dot(r3.zxy, r5.wxy);
    r1.w = ps;
    ps = max(r1.x, r1.w);
    r8.xyz = r3.xzy * r6.www;
    r1.x = ps;
    r5.xyw = r8.xyz * 2.0 - r5.xwy;
    ps = log2(r5.z);
    r5.x = saturate(dot(r4.zxy, r5.yxw));
    r5.y = ps;
    ps = log2(r5.x);
