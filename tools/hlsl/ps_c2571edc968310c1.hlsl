...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.y = tex2D(Texture2D_0, r0.xy).w;
    ...
    r7.xy = r6.xy * r7.xx + r0.xy;
    r0.xyz = tex2D(Texture2D_0, r7.xy).xyz;
    r2.xyz = r0.zxy * 2.0 - 1.0;
    ...
    r6.w = dot(r11.xyz, r6.zxy);
    r2.xyz = r11.yzx * r6.www;
    r12.xyz = r2.xyz * 2.0 - r6.xyz;
    r6 = xe_cube(r12.xyz);
    ps = 1.0 / abs(r6.z);
    r2.z = r6.w;
    r7.z = ps;
    r2.xy = r6.yx * r7.zz + 1.5;
    r10.yzw = texCUBE(TextureCube_0, xe_cube_dir(r2.xyz)).xyz;
    ...
    r5.z = saturate(ps);
    ps = 5.0 * r7.w;
    r9.xyz = r11.xxx * r1.xyz;
    r6.x = saturate(ps);
    ps = 1.0 - r6.x;
    r4.x = dot(r6.wyz, r11.xyz);
    r6.z = ps;
    ps = ModShadowGroupColor.x * r6.z;
    r11 = r4.xxyz * float4(-0.5, 0.5, 0.875, 0.875);
    r5.x = ps;
    ps = ModShadowGroupColor.y * r6.z;
    r4.xy = r11.xy + 0.5;
    r5.y = ps;
    ps = abs(r4.x) * abs(r4.x);
    r6.z = saturate(dot(r13.zxy, r12.zxy));
    r7.w = ps;
    ps = abs(r4.y) * abs(r4.y);
    r6.xyw = -r5.xyz + 1.0;
    r0.w = ps;
    ps = AmbientColorAndSkyFactor.x * r7.y;
    r4.xyz = r8.xzy * r0.www;
    r2.x = ps;
    ps = log2(r6.z);
    r5.xyz = r8.xzy * r7.www;
    r10.x = ps;
    r11.xy = r11.zw * r6.xy + 0.125;
    ps = r11.x * r11.y;
    r10 = r10 * float4(15.0, 4e+01, 4e+01, 4e+01);
    r6.z = ps;
    r6.xyz = r6.zzz * r2.yzw + ModShadowColor.xyz;
    ps = pow(2.0, r10.x);
    r6.w = float((r6.w >= 0.004));
    r7.w = ps;
    ps = AmbientColorAndSkyFactor.y * r7.z;
    r11.xyz = r7.www * r1.xyz;
    r2.y = ps;
    ps = r11.z;
    r1.xy = r10.yz * r7.yy;
    ps = r10.w * ps;
