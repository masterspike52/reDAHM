// ps_dc835274e9155990.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 78 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000138 10040800 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 0.875 * r5.x;
    r1.yzw = r2.xyz * r6.www;
    r1.x = ps;
    ps = 0.875 * r5.y;
    r6.xyz = r1.yzw * r6.xyz;
    r1.y = ps;
    r5.xy = r1.xy * r5.zw + 0.125;
    ps = r5.x * r5.y;
