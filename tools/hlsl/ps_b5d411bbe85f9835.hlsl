...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r11.yz = tex2D(ModShadowAccumTexture, r6.xz).xy;
    ...
    r12.xyz = r12.zxy * 2.0 - 1.0;
    ps = rsqrt(abs(r6.y));
    r0.xyz = r7.xyz * AmbientColorAndSkyFactor.xyz;
    r6.y = ps;
    ...
    r6.w = ps;
    r2.xyz = r12.xyz * r6.www;
    ps = 0.1 - -r7.x;
    r11.x = dot(r6.zxy, r2.xyz);
    r6.x = ps;
    ps = 5.0 * r6.x;
    ...
    r6.x = ps;
    ps = 0.5 + r6.x;
    r2.w = saturate(dot(r7.xyz, r5.zxy));
    r4.x = ps;
    ps = 0.5 + r0.x;
    r6.xyw = -r4.yzw + 1.0;
    r4.y = ps;
    ...
    r0.x = ps;
    ps = r6.y * r6.z;
    r0.yzw = r8.xzy * r7.yyy;
    r6.x = ps;
    r6.xyz = r6.xxx * r10.xyz + ModShadowColor.xyz;
    r4.xyz = r0.ywz * UpperSkyColor.xyz + r9.xyz;
    ps = pow(2.0, r0.x);
