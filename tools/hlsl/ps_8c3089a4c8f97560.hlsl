...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.xy = r0.yx * 2.0 - 1.0;
    r3.x = dot(r3.yx, r3.yx) + 0.0;
    r3.y = sqrt(abs(r3.x));
    r4.x = float((r3.y >= UniformScalar_0.x));
    ps = UniformScalar_0.x - r3.y;
    r3.x = float((UniformScalar_0.x >= r3.y));
    r3.y = ps;
    r4.y = float((r3.y >= UniformScalar_2.x));
    r3.z = float((UniformScalar_2.x >= r3.y));
    r3.xy = (r4.xy > 0.0) ? r3.xz : 1.0;
    r3.x = r3.x * r3.y - 0.5;
