// ps_c33a6417aa30a521.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 153 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000264 10040B00 0000090A 00000000 00008129 007F01FF 00000001 00003050 0000F151 0000F252 00007354 0000F455 00007556 0000F657 0000F7A0 0000F8A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9 = tex2D(Texture2D_2, r1.xy);
    r7.z = tex2D(Texture2D_1, r2.xy).w;
    ...
    r7.y = ps;
    r11.xyz = r8.yzw * 2.0 - 1.0;
    ps = rsqrt(abs(r8.x));
    r7.y = saturate(r7.y * 5.0);
    r8.x = ps;
    ps = rsqrt(abs(r7.w));
    r2.xyz = r8.xxx * r5.xyz;
    r7.w = ps;
    ps = rsqrt(abs(r7.x));
    r3.xyz = r7.www * r3.xyz;
    r7.w = ps;
    r5.xyz = r7.www * -SpotDirection.xyz;
    ps = 1.0 - r7.x;
    r7.w = dot(r11.zxy, r11.zxy);
    r7.x = saturate(ps);
    ps = log2(r7.x);
    r7.y = -r7.y + 1.0;
    r7.x = ps;
    r8.xy = -r7.yy * ModShadowGroupColor.xy + 1.0;
    ps = rsqrt(abs(r7.w));
    r7.y = dot(r5.zxy, r4.zxy);
    r7.w = ps;
    r4.xyz = r11.xyz * r7.www;
    r8.w = saturate(dot(r4.zxy, r3.zxy));
    r7.w = dot(r4.zxy, r2.zxy);
    r4.xyz = r4.xzy * r7.www;
    r2.xyz = r4.xyz * 2.0 - r2.xzy;
    ps = -SpotAngles.x - -r7.y;
    r7.w = saturate(dot(r3.zxy, r2.yxz));
    r7.y = ps;
    ps = log2(r7.w);
    r2.x = saturate(r7.y * SpotAngles.y);
    r0.z = ps;
    r0.xyz = r0.xyz * float3(0.875, 0.875, 15.0);
    r2.yz = r0.xy * r8.xy + 0.125;
    ps = pow(2.0, r0.z);
    r8.xyz = r2.wxy * r2.wxz;
    r7.w = ps;
    r0 = r7.zzwz * r9.xywz;
    r7.yzw = r8.zzz * r10.xyz + ModShadowColor.xyz;
