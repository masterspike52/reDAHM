// ps_febfcacde446a389.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 237 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000003B4 10041000 0000080A 00000000 00007908 003F00FF 00000001 00003050 0000F151 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.z = ps;
    ps = r6.x;
    r15.xyz = r9.xyz * r6.zzz;
    ps = abs(r8.x) * ps;
    r6.z = dot(r15.xyz, r7.wxy);
    r4.x = ps;
    ps = r6.y;
    r9.xyw = r15.zyx * r6.zzz;
    r12.xyz = r9.yxw * 2.0 - r7.xyw;
    ps = abs(r8.y) * ps;
    r6 = xe_cube(r12.xyz);
    r4.y = ps;
    ps = 1.0 / abs(r6.z);
    ...
    r14.yz = tex2D(ModShadowAccumTexture, r4.xy).xy;
    ...
    r4.w = ps;
    r9.xyz = r16.xyz * r13.xyz + UniformVector_0.xyz;
    ps = rsqrt(abs(r1.w));
    r5.xyz = r4.www * r5.xyz;
    r1.w = ps;
    ps = max(r10.x, r10.y);
    r13.xyz = r1.www * r2.xyz;
    r10.x = ps;
    r1.xyz = (-abs(r0.www) >= 0.0) ? r4.xyz : r1.xyz;
    r1.xyz = (-abs(r6.xxx) >= 0.0) ? r4.xyz : r1.xyz;
    ...
    r6.x = ps;
    r10.yzw = r1.xyz * UniformScalar_0.xxx + r8.xyz;
    r2.xyz = r10.yzw * UniformScalar_2.xxx + UniformScalar_3.xxx;
    ps = LightMapScale.z * r6.w;
    r8.xy = r6.xx * ModShadowGroupColor.xy;
    r4.z = ps;
    ps = r10.y;
    r1.xyz = r4.xyz * r15.xxx;
    ps = r0.x * ps;
    r14.x = dot(r5.zxy, r15.xyz);
    r0.x = ps;
    r8.z = saturate(r9.w * 2.0 - r7.w);
    ps = r10.z;
    r5 = r14.xyzx * float4(-0.5, 0.875, 0.875, 0.5);
    ps = r0.y * ps;
    r7.w = saturate(dot(r13.zxy, r12.zxy));
    r0.y = ps;
    ps = r10.w;
    r6.xy = r5.xw + 0.5;
    ps = r0.z * ps;
    r5.xw = abs(r6.xy) * abs(r6.xy);
    r0.z = ps;
    ps = log2(r7.w);
    r6 = -r8 + 1.0;
    r10.w = ps;
