...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.zw = tex2D(ModShadowAccumTexture, r4.zw).xy;
    ...
    r0.y = r0.x * r0.x;
    r5.y = ps;
    r2.xyz = r5.yzw * float3(0.21952, 0.875, 0.875);
    r5.xyz = r3.yzw * r5.xxx + r2.xxx;
