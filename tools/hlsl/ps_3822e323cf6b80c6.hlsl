// ps_3822e323cf6b80c6.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 87 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000015C 10040800 00000806 00000000 00006908 00FF00FF 00000021 00003050 00003151 0000F252 0000F353 00007454 0000F555 00007656 0000F757
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.z = saturate(r0.z * r4.z);
    r0.x = ps;
    ps = pow(2.0, r0.x);
    r2.xyz = r2.xyz * r0.zzz;
    r0.z = ps;
    r0.xy = r5.xy * r0.yw + 0.125;
    ps = r0.x * r0.y;
    r2.xyz = r2.xyz * r0.zzz;
    r0.x = ps;
