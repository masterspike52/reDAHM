// ps_7aa32222823aa2f0.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 291 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 0000048C 10040E00 00000606 00000000 000048C6 003F003F 00000021 00003050 00003151 00007254 0000F355 00007456 0000F557
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9 = tex2D(Texture2D_1, r0.zw);
    r6.xyw = tex2D(Texture2D_2, r1.xy).xyw;
    r4.xyw = tex2D(Texture2D_0, r8.xz).xyz;
    ...
    r11.y = ps;
    ps = r6.y + r6.y;
    r11.x = dot(r1.zww, float3(1.0, 1.0, 1.0));
    r11.z = ps;
    r0.w = (r11.x == 0.0) ? r9.x : r9.y;
    ps = r1.x;
    r11 = r11.xxyz + float4(-3.0, -2.0, -1.0, -1.0);
    ps = UniformVector_6.x * ps;
    r9.xy = r11.zw + r10.xw;
    r1.z = ps;
    r0.w = (r11.y == 0.0) ? r9.z : r0.w;
    r8.y = (r11.x == 0.0) ? r9.w : r0.w;
    ps = r1.y;
    r0.w = max(r8.y, 0.0);
    ...
    r0.w = ps;
    r1.xy = r6.yy * r9.xy - r13.xy;
    r14.zw = r0.xy * UniformVector_4.xy + r1.xy;
    r1.xy = r14.xy * r0.ww + ScreenPositionScaleBias.wz;
    r4.xyz = tex2D(LightAttenuationTexture, r1.xy).xyz;
    r11.xyz = tex2D(Texture2D_4, r8.xz).xyz;
    ...
    r8.z = saturate(ps);
    ps = 1.0 - r0.x;
    r3.xyz = r5.yzw * r12.xyz;
    r0.x = saturate(ps);
    r12.w = r0.z * UniformVector_4.z - r13.z;
    ps = log2(r0.x);
    ...
    r6.x = ps;
    r12.xyz = r1.xyz * r6.yyy - r11.xyz;
    r2.w = saturate(r1.w * r6.y - 0.5);
