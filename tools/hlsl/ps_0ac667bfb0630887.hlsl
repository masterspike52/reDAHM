...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r10.xyz = tex2D(Texture2D_0, r6.xw).xyz;
    ...
    r6.x = saturate(dot(r1.zxy, r8.zxy));
    r5.z = dot(r1.zxy, r9.zxy);
    ps = LightColorAndFalloffExponent.w * r5.x;
    r1.xyz = r1.xzy * r5.zzz;
    r5.x = ps;
    r1.xyz = r1.xyz * 2.0 - r9.xzy;
    ps = -SpotAngles.x - -r5.y;
    r5.z = saturate(dot(r8.zxy, r1.yxz));
    r5.y = ps;
    ps = log2(r5.z);
    r5.w = saturate(r5.y * SpotAngles.y);
    r7.w = ps;
    ps = pow(2.0, r5.x);
    r2 = r7 * float4(0.21952, 0.21952, 0.21952, 15.0);
    r5.x = ps;
    ps = pow(2.0, r2.w);
    r1.xyz = r4.xyz * r5.xxx;
    r6.w = ps;
    r5.xyz = r6.yzw * float3(0.875, 0.875, 0.21952);
    r6.xyz = r2.xyz * r6.xxx + r5.zzz;
    r5.yz = r5.xy * r3.xy + 0.125;
    ps = r5.y * r5.z;
