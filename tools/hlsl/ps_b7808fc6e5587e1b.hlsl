// ps_b7808fc6e5587e1b.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 306 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004C8 10041100 0000070A 00000000 000070E7 001F007F 00000021 0000F050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r16.x = ps;
    r13.yzw = r7.xyz * UniformScalar_1.xxx + UniformScalar_2.xxx;
    r7.x = r8.w * r3.z - 1.0;
    r7.yz = r3.xy * 2.0 - 1.0;
    ps = rsqrt(abs(r6.z));
    ...
    r4.yz = r6.zw - r12.yz;
    r4.x = ps;
    r6.yzw = r14.yzw * r5.yyy - r10.xyz;
    r4.w = saturate(r14.x * r5.y - 0.5);
