...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.zw = r0.xy * 1.31 + UniformVector_3.xy;
    r4.xy = r0.xy * 0.39 + UniformVector_2.xy;
    r4.xyz = tex2D(Texture2D_0, r4.xy).xyz;
    r0.xyz = tex2D(Texture2D_0, r5.zw).xyz;
    r5 = tex2D(Texture2D_0, r5.xy);
    r0.xyz = -r5.xyz + r0.xyz;
    r4.xzw = r0.xyz + r4.xyz;
    r4.y = r5.w;
    r4.xzw = r4.xzw * r5.www + r5.xyz;
    r4.xzw = r4.xzw * float3(0.25, 0.5, 1.8) + UniformVector_0.xyz;
