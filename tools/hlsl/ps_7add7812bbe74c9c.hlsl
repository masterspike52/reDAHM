...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 5.0 * r5.x;
    r7.xyz = r5.www * r3.zxy;
    r5.x = saturate(ps);
    ps = 1.0 - r5.x;
    r3.z = saturate(dot(r7.xyz, r8.zxy));
    r5.x = ps;
    r3.xy = r5.xx * ModShadowGroupColor.xy;
    r3.xyz = -r3.xyz + 1.0;
    r6.xyz = tex2D(LightAttenuationTexture, r6.xy).xyz;
    r4.yz = tex2D(ModShadowAccumTexture, r5.yz).xy;
    ...
    r6.w = ps;
    ps = 1.0 - r5.x;
    r8.xyz = r6.www * r1.zxy;
    r5.x = saturate(ps);
    ps = r6.w;
    r7.yz = -r7.yz;
    r7.x = r7.x * 2.0 - r7.x;
    ps = r1.z * ps;
    r0.w = saturate(dot(r8.yzx, r7.yzx));
    r6.w = saturate(ps);
    ps = log2(r0.w);
