...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 + ps;
    r12.xyz = r6.yzx * float3(0.875, 0.875, -0.025);
    r6.x = ps;
    ...
    r4 = r10.zwxy + r4;
    r6.xz = r4.zw + r4.zw;
    r14 = tex2D(Texture2D_1, r6.xz).xzwy;
    r16.xyz = tex2D(Texture2D_3, r0.xy).xyz;
    r11.xyz = tex2D(Texture2D_2, r7.xy).wxy;
    r13.xyw = tex2D(Texture2D_2, r1.xy).xwy;
    r10.xyz = tex2D(Texture2D_0, r4.xy).xyz;
    ps = r5.w;
    r6.z = r2.z + 0.1;
    ps = 0.0001 * ps;
    ...
    r11.x = r11.x * r13.y - 1.0;
    ps = r13.x + r13.x;
    r12.zw = r5.xy * ScreenPositionScaleBias.xy;
    r1.y = ps;
    r13.xyz = r16.xyz * 2.0 - 1.0;
    ps = r13.w + r13.w;
    r6.z = saturate(r6.z * 5.0);
    r1.z = ps;
    ps = 1.0 - r6.z;
    r13.xyw = r13.xyz * UniformVector_4.xyz;
    r6.z = ps;
    ps = 1.0 - r6.x;
    r1.x = dot(r6.yww, float3(1.0, 1.0, 1.0));
    r7.w = ps;
    r6.x = (r1.x == 0.0) ? r14.x : r14.w;
    ps = ModShadowGroupColor.x * r6.z;
    r1 = r1.yzxx + float4(-1.0, -1.0, -2.0, -3.0);
    r14.x = ps;
    r6.x = (r1.z == 0.0) ? r14.y : r6.x;
    r14.z = (r1.w == 0.0) ? r14.z : r6.x;
    ...
    r1.w = ps;
    r11.yz = r14.zw * 0.5 + r1.xy;
    r6.xy = r1.ww * r11.yz + r13.xy;
    ps = 1.0 / r5.w;
    r12.xy = r6.xy - r10.xy;
    r6.x = ps;
    ...
    r5.xyz = tex2D(Texture2D_7, r4.xy).xyz;
    r7.xyz = tex2D(Texture2D_6, r7.xy).yxz;
    r4.xyw = tex2D(Texture2D_8, r0.xy).xyz;
    ...
    r0.z = ps;
    r3.xyz = r4.xyw * UniformScalar_11.xxx + UniformScalar_12.xxx;
    ps = rsqrt(abs(r6.y));
    r0.xyz = r0.xyz * r15.xyz;
    r6.y = ps;
    ps = 1.0 - r6.x;
    r4.xyw = r6.yyy * r2.xyz;
    r6.x = saturate(ps);
    ps = log2(r6.x);
    r0.xyz = r0.xyz * r7.yxz;
    r6.x = ps;
    r11.w = -r10.w + r13.w;
    ps = 2.5 * r6.w;
    r6.y = r14.x * r14.y;
    r0.w = ps;
    r6.yzw = r6.yyy * r13.xyz + ModShadowColor.xyz;
    r2.x = r1.w * r11.x + 1.0;
    r1.w = saturate(r0.w * r2.x - 0.5);
    r11.xyz = r0.xyz * r2.xxx - r5.xyz;
    r5.xyz = r11.xyz * r1.www + r5.xyz;
    r0.xy = r12.xy * r1.ww + r10.xy;
    r0.z = r11.w * r1.w - 2.0;
    r0.z = r10.z * 2.0 + r0.z;
    ...
    r2.yzw = (r7.www >= 0.0) ? r0.xyz : float3(0.0, 0.0, 1.0);
    r7.w = dot(r2.wyz, r2.wyz);
    ps = rsqrt(abs(r7.w));
    r0.xyz = r5.xyz * r9.xyz;
    r7.w = ps;
    r5.xyz = r2.yzw * r7.www;
    r7.w = dot(r5.zxy, r8.zxy);
    r2.yzw = r5.xyz * r7.www;
    r2.yzw = r2.yzw * 2.0 - r8.xyz;
    ps = UniformScalar_8.x * r7.y;
    r0.w = saturate(dot(r4.wxy, r2.wyz));
    r2.y = ps;
    ps = log2(r0.w);
    r7.w = saturate(dot(r5.zyx, r4.wyx));
    r7.x = ps;
    ps = abs(r2.x) * abs(r2.x);
    r7.y = r7.x * UniformScalar_7.x;
    r2.x = ps;
    ps = pow(2.0, r7.y);
    r7.x = r7.x * 15.0;
    r2.z = ps;
