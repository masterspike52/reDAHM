// vs_fc7cc75cdc9b6b18.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 570 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000040 000008E8 00410012 00000000 00000000 00003CA5 00000001 00000009 00000005 00000290 00100015 00006016 00003017 00202018 0000101A 0010501C 0001501D 0006501E 0027501F 00003050 00013151 0002F255 00037356 0004F457 000010B8 000010B9 000010BB 000010BA 000010BC
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r0.x = dot(r2.zxyw, r14);
    ps = FogMaxHeight.w;
    r2.x = dot(r7.zxyw, r10);
    r3.xyz = r3.xyz * 0.007843138 - 1.0;
    ps = -CameraPosition.z + ps;
    r0.y = dot(r3.xzy, r3.xzy);
    r10.x = ps;
    r2 = r2.xxxx * LocalToWorld[2] + LocalToWorld[3];
    r2 = r0.xxxx * LocalToWorld[1].xzyw + r2.xzyw;
    ps = rsqrt(abs(r0.y));
    r0.x = dot(r8.zxyw, r14);
    r0.y = ps;
    ps = FogMaxHeight.z;
    r7.xyz = r3.zyx * r0.yyy;
    r8 = r0.xxxx * LocalToWorld[0].xzyw + r2;
    r2.xyw = -r8.zxy * CameraPosition.www + CameraPosition.yxz;
    ps = -CameraPosition.z + ps;
    r14.xyz = r8.xzy - CameraPosition.xyz;
    r10.y = ps;
    ps = FogMaxHeight.y;
    r0.x = dot(r7.zxy, r16.xzy);
    ps = -CameraPosition.z + ps;
    r3 = r8.wwww * ViewProjectionMatrix[3].xwzy;
    r10.z = ps;
    r3 = r8.yyyy * ViewProjectionMatrix[2].xwzy + r3;
    r4.xyz = -r7.zyx * r0.xxx + r16.xyz;
    ps = FogMaxHeight.x;
    r2.z = dot(r14.zxy, r14.zxy);
    ps = -CameraPosition.z + ps;
    r0.x = float((0.001 >= abs(r14.z)));
    r10.w = ps;
    r0.x = (r0.x == 0.0) ? r14.z : 0.001;
    ps = sqrt(abs(r2.z));
    r0.y = dot(r4.xzy, r4.xzy);
    r2.z = ps;
    r3 = r8.zzzz * ViewProjectionMatrix[1].xzyw + r3.xzwy;
    r8 = r8.xxxx * ViewProjectionMatrix[0] + r3.xzyw;
    ps = rsqrt(abs(r0.y));
    r3 = r2.zzzz - FogStartDistance.wzyx;
    r0.y = ps;
    ps = 1.0 / r0.x;
    r4.xyz = r4.zyx * r0.yyy;
    r0.x = ps;
    r16 = saturate(r10.wzyx * r0.xxxx);
    r10 = saturate(r13.wzyx * r0.xxxx);
    r14 = max(r3, 0.0);
    ...
    r0.y = dot(r7.zxy, r15.zxy);
    r11.z = dot(r13.zxy, r9.zxy);
    r11.w = dot(r13.zxy, r14.zxy);
