// ps_85497a2c4a9e3256.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 165 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000294 10040D00 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 / r4.w;
    r5.xw = r0.xy + UniformVector_2.xy;
    r5.z = ps;
    ...
    r13.xyz = tex2D(Texture2D_0, r8.xy).xyz;
    r8.xyz = tex2D(Texture2D_1, r0.xy).xyz;
    r9.xyz = tex2D(Texture2D_0, r5.xw).xyz;
    ...
    r5.z = ps;
    r9.xyz = r9.xyz * 2.0 - 2.0;
    ps = rsqrt(abs(r5.x));
    r5.z = saturate(r5.z * 5.0);
    r5.w = ps;
    ps = rsqrt(abs(r6.w));
    r12.xyz = r8.xyz * UniformVector_3.xyz;
    r6.w = ps;
    ps = rsqrt(abs(r5.y));
    r8.xyz = r6.www * r1.xyz;
    r5.y = ps;
    r10.xyz = r5.www * -SpotDirection.xyz;
    r9.yzw = r13.xyz * 2.0 + r9.xyz;
    ps = 1.0 - r5.x;
    ...
    ps = r3.x * ps;
    r5.w = dot(r9.wyz, r9.wyz);
    r9.x = ps;
    ps = rsqrt(abs(r5.w));
    r5.z = dot(r10.zxy, r2.zxy);
    r5.w = ps;
    ps = r5.y;
    r2.xyz = r9.yzw * r5.www;
    ps = r3.y * ps;
    ...
    r3.xyz = r2.xzy * r5.yyy;
    r3.xyz = r3.xyz * 2.0 - r9.xzy;
    r5.y = saturate(dot(r8.zxy, r3.yxz));
    ps = log2(r5.y);
    r1.x = saturate(r5.z * SpotAngles.y);
    r5.y = ps;
    ...
    r7.z = ps;
    ps = pow(2.0, r5.x);
    r2.xyz = r7.xyz * float3(0.875, 0.875, 0.1);
    r5.x = ps;
    r5.yzw = r4.xyz * r5.yyy + r2.zzz;
    r1.yz = r2.xy * r1.yz + 0.125;
    ps = r1.x * r1.x;
