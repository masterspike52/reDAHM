// ps_448bde20cac9eb3a.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 435 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000006CC 10000200 00000004 00000000 00001842 00030003 00000021 00003050 0000F156
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.z = tex2D(Texture2D_3, r2.xy).x;
    r0.z = r0.z * UniformVector_1.x - 0.5;
    r0.w = dot(r2.wz, float2(5.0, 3e+01)) + 0.0;
    r0.z = r0.w * r2.x + r0.z;
