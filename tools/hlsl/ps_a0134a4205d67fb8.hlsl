...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 + ps;
    r9.xyz = r9.xzy * float3(-0.025, 0.5, 0.5);
    r5.x = ps;
    ...
    r13.z = ps;
    r5.z = (r13.x == 0.0) ? r15.x : r15.y;
    r13 = r13.xxyz + float4(-3.0, -2.0, -1.0, -1.0);
    ps = r13.z;
    r5.xyw = r5.xyw * UniformVector_4.xyz;
    r5.z = (r13.y == 0.0) ? r15.z : r5.z;
    r15.z = (r13.x == 0.0) ? r15.w : r5.z;
    ps = r9.z + ps;
    r5.z = max(r15.z, 0.0);
    r9.x = ps;
    ps = r13.w;
    ...
    r9.y = ps;
    r9.xy = r10.yy * r9.xy + r5.xy;
    ps = 1.0 / r4.w;
    r12.xy = r9.xy - r11.xy;
    r5.z = ps;
    r6.xy = r12.zw * r5.zz + ScreenPositionScaleBias.wz;
    ...
    r15.y = ps;
    r4.xyz = r16.xyz * UniformScalar_1.xxx + UniformScalar_2.xxx;
    r5.y = r8.w * r7.w - 1.0;
    ps = UniformVector_5.z * UniformVector_5.w;
    r6.w = saturate(-r6.w + 1.0);
    r15.w = ps;
    ps = log2(r6.w);
    r0.z = saturate(r0.y * 5.0);
    r5.x = ps;
    ps = LightColorAndFalloffExponent.w * r5.x;
    r13.xyz = r13.xyz * r2.www;
    r0.y = ps;
    ps = -r11.z;
    r14.xyz = r15.xyw * r14.xyz;
    ps = r5.w + ps;
    r0.xw = -r0.zx + 1.0;
    r10.w = ps;
    ps = rsqrt(abs(r5.z));
