// ps_c2446077f1b9532b.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 78 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000138 10000700 00000004 00000000 00005CE7 007F007F 00000001 00003050 00003151 0000F252 0000F353 0000F455 00007556 0000F657
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.xyz = tex2D(Texture2D_2, r0.zw).xyz;
    r5.xyz = tex2D(Texture2D_3, r0.xy).xyz;
    r7.xyz = tex2D(Texture2D_4, r0.zw).xyz;
    r0.w = tex2D(Texture2D_5, r0.zw).z;
    r0.xyz = tex2D(Texture2D_6, r0.xy).xyz;
    r0.xyz = r0.www * float3(5.0, 1e+01, 4e+01) + r0.xyz;
    r0.xyz = r7.xyz * float3(5.0, 1e+01, 5e+01) + r0.xyz;
    r0.xyz = r5.xyz * float3(1.0, 5.0, 2e+01) + r0.xyz;
    r0.yzw = r4.xyz * float3(1.0, 5.0, 3e+01) + r0.xyz;
    ps = r3.x;
    r0.x = r0.y + r4.x;
    ps = 0.3 * ps;
    r0.xyz = r0.xzw + r2.xyz;
    r0.w = ps;
    r0.x = r0.w * r0.x;
    ps = r6.w;
    r0.yz = r0.yz * r3.yz;
    ...
    r0.w = ps;
    r0.x = dot(r0.zy, float2(0.11, 0.59)) + r0.x;
