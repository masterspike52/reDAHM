// vs_aa7b2da5f7b83577.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 261 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000040 00000414 0051000F 00000000 00000000 00005CC6 00000001 00000006 00000006 00000290 00100008 00006009 0000700A 0000300B 0001A00C 0020500D 0000F050 0001F155 00027256 0003F357 0004F4A0 0005F5A2 00001053 00001054 00001051 00001055 00001052 00001050
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r14.xyz = r1.yzx - CameraPosition.xyz;
    r13.x = ps;
    ...
    r0.x = ps;
    ps = 1.0 / r0.z;
    r15.xyz = r7.xxx * WorldToLocal[2].xyz;
    r0.z = ps;
    ps = 1.0 / r0.w;
    r2.w = float((0.001 >= abs(r14.z)));
    r0.w = ps;
    r2.w = (r2.w == 0.0) ? r14.z : 0.001;
    r7.xyz = r7.yyy * WorldToLocal[1].xyz + r15.xyz;
    ps = sqrt(abs(r0.y));
    r6.x = dot(r14.zxy, r14.zxy);
    r0.y = ps;
    r3 = r1.zzzz * ViewProjectionMatrix[1].xzyw + r3.xzwy;
    r3 = r1.yyyy * ViewProjectionMatrix[0] + r3.xzyw;
    r1.yzw = r13.xzy * r0.wzx;
    ps = sqrt(abs(r6.x));
    ...
    r2.w = ps;
    r12 = saturate(r11.wzyx * r2.wwww);
    r10 = saturate(r10.wzyx * r2.wwww);
