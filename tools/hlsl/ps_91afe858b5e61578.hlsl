...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3 = tex2D(Texture2D_0, r1.xy).xywz;
    ...
    ps = r2.z;
    r7.xy = r3.zz * UniformVector_1.xy;
    ps = 0.1 + ps;
    r3.xyw = r9.xyz * r3.xyw;
    r6.x = ps;
    ps = rsqrt(abs(r7.w));
    r1.yzw = r0.xxx * r2.zxy;
    r7.w = ps;
    ps = 5.0 * r6.x;
    r0.xyz = r7.www * r4.zxy;
    r6.x = saturate(ps);
    ps = 1.0 - r6.x;
    r0.yz = -r0.yz;
    r6.x = ps;
    ...
    r5.yz = r5.yz * r2.xy + 0.125;
    ps = r7.z * r7.z;
    r6.x = saturate(dot(r1.zwy, r0.yzx));
    r7.z = ps;
    ps = log2(r6.x);
