// ps_2954f2af6428e20d.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 36 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000090 10000500 00000004 00000000 00004CC6 003F003F 00000021 00003050 00003151 0000F252 0000F353 0000F456 00007557
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.z = tex2D(Texture2D_0, r1.xy).w;
    r0.z = -r0.x + r0.z;
    r0.y = 5.0 * r3.w;
    r0.x = r0.z * r2.x + r0.x;
    r0.x = r0.y * r0.x;
