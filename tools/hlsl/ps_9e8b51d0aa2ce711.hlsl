// ps_9e8b51d0aa2ce711.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 279 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 0000045C 10040E00 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.xy = r9.zw + r9.zw;
    r5.w = ps;
    r7.yw = tex2D(ModShadowAccumTexture, r5.zw).xy;
    ...
    r7.x = min(r5.z, 0.3);
    ps = r10.z + ps;
    r3.xyz = r7.yxw * float3(0.875, 3.3333333, 0.875);
    r0.y = ps;
