// vs_417de7eb69c5044d.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 309 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000040 000004D4 0051000E 00000000 00000000 00005CC6 00000001 00000007 00000006 00000290 0010000A 0000600B 0000700C 0000300D 0001A00E 0000500F 00215010 0000F050 0001F155 00027256 0003F357 0004F4A0 0005F5A2 00001063 00001064 00001061 00001065 00001062 00001060
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r3.z = ps;
    ps = r0.z;
    r3.y = dot(r9.zyw, r10.zxy);
    ps = r3.z + ps;
    r3.w = r0.z - r3.z;
    r3.z = ps;
    r9.zw = saturate(r9.xx * -r3.zw);
    ps = r9.w * r9.w;
