...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.xy = r10.zw * r5.yz + 0.125;
    ps = max(r10.x, r10.y);
    r2.xzw = r2.xyz * r5.xxx;
    r3.z = ps;
    ps = r6.x;
    r5.w = saturate(dot(r2.wxz, r8.zxy));
    r5.y = ps;
    ...
    r5.x = saturate(dot(r8.zxy, r5.yxz));
    r2.w = ps;
    ps = log2(r5.x);
    r2.x = r2.y * r7.x;
    r3.w = ps;
    r6.xy = r3.zx * r3.wy;
    r5.xyz = r6.yyy * r4.xyz + ModShadowColor.xyz;
    ps = pow(2.0, r6.x);
