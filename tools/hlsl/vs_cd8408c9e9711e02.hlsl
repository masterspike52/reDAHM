// vs_cd8408c9e9711e02.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 156 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000040 00000270 0061000B 00000000 00000000 000064E7 00000001 00000007 00000007 00000290 00100006 00006007 00007008 00003009 0001A00A 0000500B 0020A00C 00003050 0001F151 0002F256 00037357 0004F458 0005F5A0 0006F6A2 0000102D 00001031 00001032 0000102E 0000102F 00001030 0000102C
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r0.w = 0.0;
    r3.xy = In.color0.xy;
    r4.xy = r3.xy * ShadowCoordinateScaleBias.xy + ShadowCoordinateScaleBias.wz;
    ...
    r6.y = dot(r2.zyw, WorldToLocal[2].zxy);
    r6.z = dot(r8.zyx, WorldToLocal[2].zxy);
    r3 = r5.zzzz * LocalToWorld[2].xwzy + r3;
    r3 = r5.yyyy * LocalToWorld[1].xzyw + r3.xzwy;
    r10 = r5.xxxx * LocalToWorld[0].xywz + r3.xzwy;
    r7.xyw = -r10.wyx * CameraPosition.www + CameraPosition.zyx;
    r3 = r10.zzzz * ViewProjectionMatrix[3].xwzy;
    r3 = r10.wwww * ViewProjectionMatrix[2].xwzy + r3;
    r11.xyz = r7.xxx * WorldToLocal[2].xzy;
    r7.xyz = r7.yyy * WorldToLocal[1].xzy + r11.xyz;
    r3 = r10.yyyy * ViewProjectionMatrix[1].xzyw + r3.xzwy;
    r3 = r10.xxxx * ViewProjectionMatrix[0] + r3.xzyw;
