...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.x = ps;
    ps = rsqrt(abs(r7.y));
    r6.yz = r6.xx * ScreenPositionScaleBias.xy;
    r6.x = ps;
    r1.xy = r6.yz * r5.xy + ScreenPositionScaleBias.wz;
    ps = rsqrt(abs(r7.x));
    ...
    ps = 0.1 + ps;
    r3 = r9 * float4(0.70710677, 0.70710677, 0.875, 0.875);
    r6.x = ps;
    ps = 5.0 * r6.x;
    r7.z = r3.x + r3.y;
    r7.x = saturate(ps);
    ...
    r8.y = float((abs(r7.x) > 0.0345));
    r6.x = ps;
    ps = SpotAngles.y * r6.x;
    r8.z = float((abs(r7.x) >= 0.0345));
    r8.w = saturate(ps);
    r6.xyz = r8.ywx * r8.zwx;
    ps = (-0.1) - -r6.x;
    r0.yzw = r4.xyz * r0.xyz;
    r6.x = ps;
    ...
    r2.xy = r3.zw * r2.xy + 0.125;
    ps = r2.x * r2.y;
    r0.xyz = r0.xyz * r6.www;
    r6.w = ps;
    r7.xyz = r6.www * r7.xyz + ModShadowColor.xyz;
