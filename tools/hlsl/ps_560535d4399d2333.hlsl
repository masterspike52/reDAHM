// ps_560535d4399d2333.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 138 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000228 10040B00 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.y = saturate(ps);
    r10.xyz = r4.xyz * 2.0 - 1.0;
    ps = rsqrt(abs(r6.w));
    r4.xyz = r0.xyz * r11.xyz;
    r5.z = ps;
    ps = rsqrt(abs(r5.w));
    ...
    r5.z = ps;
    ps = r6.w;
    r2.yzw = r10.xyz * r5.zzz;
    ps = r1.y * ps;
    r3.xyz = r2.yzw * TwoSidedSign.xxx;
    r2.y = ps;
    ps = r6.w;
    r5.z = dot(r3.zxy, r9.zxy);
    ps = r1.z * ps;
    r10.xyz = r3.xzy * r5.zzz;
    r2.z = ps;
    ...
    r7.x = ps;
    r1.xyz = r7.xyz * float3(15.0, 0.875, 0.875);
    ps = pow(2.0, r1.x);
