// ps_50ea147c4a889e0a.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 441 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000006E4 10000400 00000008 00000000 00004084 0003000F 00000021 0000F050 0000F156 0000F2A0 0000F3A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.xy = r0.yx - 0.5;
    r3.z = dot(r3.xy, UniformVector_3.yx) + 0.5;
    r3.y = dot(r3.xy, UniformVector_2.yx) + 0.5;
    r3.x = tex2D(Texture2D_1, r0.xy).x;
    r3.y = tex2D(Texture2D_1, r3.yz).x;
    r2.x = r3.y * r2.x;
    r2.x = r2.x * r3.x;
    r2.y = min(r2.x, 1.0);
    r2.x = (-0.5) - -r2.y;
