// ps_06d5de9558013973.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 444 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000006F0 10000300 00000004 00000000 00001842 00030003 00000021 00003050 0000F156
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.z = UniformVector_1.x * r0.z;
    r0.w = dot(r2.zx, float2(5.0, 3e+01)) + 0.0;
    r0.z = r0.w * r3.x + r0.z;
    r0.z = UniformScalar_9.x * r0.z;
    r0.z = r0.z * r2.y - 0.333;
