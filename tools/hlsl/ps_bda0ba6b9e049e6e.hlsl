// ps_bda0ba6b9e049e6e.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 123 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001EC 10040A00 0000070A 00000000 000070E7 001F007F 00000001 0000F053 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.x = ps;
    ps = rsqrt(abs(r5.y));
    r5.w = saturate(dot(r1.xyz, r6.yzx));
    r6.z = ps;
    ps = log2(r5.w);
    ...
    r6.x = ps;
    ps = 1.0 - r5.y;
    r8.xyz = r6.yzz * float3(15.0, -0.5, 0.5);
    r6.y = ps;
    ps = 1.0 - r5.z;
    r3.xy = r8.yz * r4.zz;
    r6.z = ps;
    ...
    ps = r6.w;
    r3.xyz = r8.ywz * r3.xxx;
    ps = r1.x * ps;
    r4.xyz = r8.ywz * r6.zzz;
    r6.z = ps;
    r6.xyz = r8.yzw * r0.xyz + r6.xyz;
    r6.xyz = r4.xzy * LowerSkyColor.xyz + r6.xyz;
    r6.xyz = r3.xzy * UpperSkyColor.xyz + r6.xyz;
    r6.xyz = r7.xyz * r1.yzw + r6.xyz;
