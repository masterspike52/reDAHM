// ps_bfccc48e00630397.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 78 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000138 10040500 00000406 00000000 00004084 000F000F 00000001 0000F054 0000F156 0000F257 0000F358
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.zw = r2.xx * ScreenPositionScaleBias.xy;
    r5.y = ps;
    ps = 1.0 / ModShadowAccumResolution.x;
    r2.w = dot(r0.zxy, r0.zxy);
    r5.x = ps;
    r4 = r5.zwxy * abs(r4.xyxy);
    r0.xy = r4.xy + ScreenPositionScaleBias.wz;
    r2.xyz = tex2D(Texture2D_0, r0.xy).xyz;
    r0.xy = tex2D(ModShadowAccumTexture, r4.zw).xy;
    ps = rsqrt(abs(r2.w));
