// ps_67a0c1e8c25ce86b.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 156 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000270 10040900 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.zw = r7.xy * r5.yz;
    r5.y = ps;
    r3.xyz = r5.yzw + float3(-0.015, 0.125, 0.125);
    ...
    r5.x = dot(r8.zxy, r6.zxy);
    r5.xyz = r8.zxy * r5.xxx;
    r9.xyz = r5.xyz * 2.0 - r6.zxy;
    r5 = xe_cube(r9.yzx);
    ps = 1.0 / abs(r5.z);
    r6.z = r5.w;
    r6.x = ps;
