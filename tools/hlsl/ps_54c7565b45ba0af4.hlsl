...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.xzw = tex2D(Texture2D_1, r1.xy).xyz;
    r1.xyz = -ModShadowColor.xyz + 1.0;
    ps = r2.z;
    r6.y = dot(r3.zxy, r3.zxy);
    ps = 0.1 + ps;
    r7.xyw = r7.xyw * r6.xzw;
    r6.x = ps;
    ps = rsqrt(abs(r0.w));
    ...
    r6.z = -r6.x + 1.0;
    r6.x = ps;
    r0.xy = -r6.zz * ModShadowGroupColor.xy + 1.0;
    r3.xyz = r6.xxx * r8.xyz;
    r6.x = dot(r3.zxy, r4.zxy);
    ps = 1.0 - r6.y;
    r6.xzw = r3.xzy * r6.xxx;
    r6.y = saturate(ps);
    r6.xzw = r6.xzw * 2.0 - r4.xzy;
    ps = log2(r6.y);
    ...
    r0.xy = r6.yz * r0.xy + 0.125;
    ps = pow(2.0, r6.x);
    r7.z = saturate(dot(r3.zxy, r2.zxy));
    r6.x = ps;
