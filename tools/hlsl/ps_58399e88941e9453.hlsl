...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.y = float((UniformScalar_8.x >= 1.0));
    r2.z = ps;
    r2.y = r2.z * r2.y + r3.w;
    ps = max(r4.x, r4.y);
    r2.y = -r2.y + r3.z;
    ...
    r2.y = max(r2.y, UniformScalar_10.x);
    ...
    ps = 1.0 - r2.y;
    r2.y = ps;
    r2.w = (UniformScalar_9.x > 0.0) ? r2.y : 1.0;
    r2.y = (UniformScalar_9.x >= 0.0) ? r2.w : r2.y;
    r2.y = r2.y * r2.x - 0.5;
    r3.xy = r0.wz * 3.0;
    ...
    r3.x = -r3.x + 1.0;
    r3.y = (UniformScalar_9.x > 0.0) ? r3.x : 1.0;
    r3.x = (UniformScalar_9.x >= 0.0) ? r3.y : r3.x;
    r2.w = r3.x * r2.w - 0.5;
