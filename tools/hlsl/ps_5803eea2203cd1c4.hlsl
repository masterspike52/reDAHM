...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 + ps;
    r9.xzw = r6.xyz * float3(-0.025, 0.5, 0.5);
    r5.x = ps;
    ...
    r10.w = ps;
    r5.y = (r10.x == 0.0) ? r13.x : r13.y;
    ps = 5.0 * r5.x;
    r14 = r10.xxyw + float4(-3.0, -2.0, -1.0, -1.0);
    r16.x = saturate(ps);
    r5.x = (r14.y == 0.0) ? r13.z : r5.y;
    r16.y = (r14.x == 0.0) ? r13.w : r5.x;
    ps = 1.0 / r4.w;
    r5.xy = -r16.xy + 1.0;
    r12.z = ps;
    ...
    r15.x = ps;
    r7.xy = r15.yz * r12.zz + ScreenPositionScaleBias.wz;
    r10.xyz = tex2D(Texture2D_5, r3.xy).xyz;
    r13.yz = tex2D(ModShadowAccumTexture, r4.xy).xy;
    r4.xyz = tex2D(Texture2D_7, r11.xy).xyz;
    ...
    r5.x = saturate(ps);
    r2.w = r2.w * UniformVector_4.z - r11.z;
    ps = log2(r5.x);
    ...
    r2.xy = r15.xx * r12.xy + r2.xy;
    ps = abs(r5.x) * abs(r5.x);
    r1.xyz = r7.xzy * r0.www;
    r0.w = ps;
    ps = r5.y * r5.z;
    r12.xyz = r4.xyz * r5.www;
    r1.w = ps;
    r0.xyz = r1.www * r0.xyz + ModShadowColor.xyz;
    r4.xyz = r12.xyz * UniformScalar_5.xxx + UniformScalar_6.xxx;
    ps = r0.w * r0.w;
    r7.yz = r14.zw + r9.zw;
    r7.x = ps;
    r2.xy = r2.xy * UniformVector_4.xy - r11.xy;
    r7.yz = r13.xx * r7.yz + r2.xy;
    r7.w = saturate(r12.w * r5.x - 0.5);
    r2.xyz = r12.xyz * r5.xxx - r10.xyz;
    r5.z = r2.w * r7.w - 2.0;
    r10.xyz = r2.xyz * r7.www + r10.xyz;
    ps = -UniformVector_0.z;
    r2.xyw = r7.yzx * r7.wwx;
    ps = 1.0 + ps;
    r5.xy = r11.xy + r2.xy;
    r9.z = ps;
    r5.z = r3.w * 2.0 + r5.z;
