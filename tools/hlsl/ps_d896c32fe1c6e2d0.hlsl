// ps_d896c32fe1c6e2d0.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 153 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000264 10040D00 0000080A 00000000 00007908 003F00FF 00000001 00003050 0000F151 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r12.yw = tex2D(ModShadowAccumTexture, r6.zw).xy;
    ...
    r10.xyz = r1.xyz + UniformVector_0.xyz;
    r12.z = saturate(ps);
    ps = rsqrt(abs(r7.z));
    r11.xyz = r0.xyz * r1.xyz;
    r7.z = ps;
    r10.xyz = r11.xyz * AmbientColorAndSkyFactor.xyz + r10.xyz;
    ps = rsqrt(abs(r7.y));
    r4.xyz = r7.zzz * r4.xyz;
    r7.y = ps;
    ps = rsqrt(abs(r7.x));
    r13.xyz = r7.yyy * r5.xyz;
    r7.x = ps;
    ps = rsqrt(abs(r6.w));
