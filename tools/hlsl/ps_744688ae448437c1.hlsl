...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.y = ps;
    r6.xy = r5.wz * r1.yx + ScreenPositionScaleBias.zw;
    r5.yz = r5.yy * r2.xy;
    r5.xy = r5.yz * r5.xx + r0.xy;
    r2.x = tex2D(Texture2D_3, r5.xy).x;
    r2.yzw = tex2D(Texture2D_2, r5.xy).xyz;
    r5.xyz = tex2D(Texture2D_0, r0.xy).xyz;
    r5.w = tex2D(SceneDepthTexture, r6.yx).x;
    r0.xyz = r4.xyz * 1e+01;
    r5.w = r5.w * MinZ_MaxZRatio.z - MinZ_MaxZRatio.w;
    r5.xyz = r2.yzw + r5.xyz;
