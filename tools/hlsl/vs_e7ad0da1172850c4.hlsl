// vs_e7ad0da1172850c4.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 1077 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000080 000010D4 0051000C 00000000 00000000 00005CC6 00000001 00000006 00000006 00000290 0010002B 0000602C 0000702D 0000302E 0000502F 00215030 0000F050 0001F156 00027257 0003F3A0 0004F4A1 0005F5A2 00001165 00001161 00001160 00001163 00001162 00001164
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r4 = r10.wwww * LocalToWorld[3].xwzy;
    ps = 0.003921569 * r1.w;
    r3.xyz = r11.yxz * 0.003921569;
    r7.x = ps;
    r0.y = -r1.y * 0.007843138 + 1.0;
    r0.xz = r1.wx * 0.007843138 - 1.0;
    r9 = r10.zzzz * LocalToWorld[2].xwzy + r4;
    r7.yzw = r5.yxz * 0.007843138 - 1.0;
    r6.xyz = r11.xzy * 0.007843138 - 1.0;
    ps = 0.003921569 * r1.y;
    r4.xyz = r7.yyw * r6.xzz;
    r7.y = ps;
    r9 = r10.yyyy * LocalToWorld[1].xzyw + r9.xzwy;
    r9 = r10.xxxx * LocalToWorld[0] + r9.xzyw;
    r4.xyz = r7.wzz * r6.yyx - r4.xyz;
    ps = 0.003921569 * r1.x;
    ...
    r6 = r10.wwww * LocalToWorld[3].xzyw;
    ps = 0.003921569 * r1.w;
    r3.xyz = r11.yxz * 0.003921569;
    r7.x = ps;
    r0.z = -r1.y * 0.007843138 + 1.0;
    r0.yw = r1.wx * 0.007843138 - 1.0;
    r9 = r0.xxxx * LocalToWorld[2].xzyw + r6;
    r12.xyz = r5.yxz * 0.007843138 - 1.0;
    r7.yzw = r11.yxz * 0.007843138 - 1.0;
    ps = 0.003921569 * r1.y;
    r6.xyz = r12.xxz * r7.zyy;
    r7.y = ps;
    r9 = r4.wwww * LocalToWorld[1].xzyw + r9;
    r9 = r4.zzzz * LocalToWorld[0] + r9.xzyw;
    r4.xyz = r12.zyy * r7.wwz - r6.xyz;
    ps = 0.003921569 * r1.x;
    r0.x = dot(r0.yzw, r4.xyz);
    r7.z = ps;
    r3.w = r0.x * 0.5 + 0.5;
    r6.xyz = r11.xyz * 0.007843138 - 1.0;
    r4.yzw = r5.xyz * 0.007843138 - 1.0;
    ...
    r5.xy = -r1.wz + Demolition_Center.yx;
    ps = -r5.x * -r5.x;
    ...
    r5.xw = r1.yw + r1.zw;
    // UNHANDLED control flow: cjmp
    r1.w = float((r6.x > r5.x));
    r5.w = saturate(r5.w * r11.y);
    ps = sqrt(abs(r6.x));
    r0.y = float((Collapse_Endcaps.x >= 2.0));
    r5.x = ps;
    p0 = (r0.y != 0.0);
    ...
    r0.x = r5.x * r0.x;
    p0 = (0.0 == 0.0 && r5.w != 0.0);
    r5.x = (0.0 == 0.0 && r5.w != 0.0) ? 0.0 : 0.0 + 1.0;
    if (p0)
    {
    ...
    p0 = (r5.x == 0.0 && r0.y != 0.0);
    r5.x = (r5.x == 0.0 && r0.y != 0.0) ? 0.0 : r5.x + 1.0;
    if (p0)
    {
        r0.xy = r0.xx * float2(-8e+02, -1e+03);
        ps = 1.0 - r0.z;
    ...
    if (p0)
    {
        r5.xw = r0.yy * float2(8e+02, -1e+03);
        r10.x = r5.x + r10.x;
        ps = 3.3333333 * r0.x;
        r0.y = r5.w + r10.z;
        r4.w = ps;
    ...
    r5.x = -r6.y * r11.y + r0.y;
    ps = (-abs(r0.x) > 0.0) ? 1.0 : 0.0;
    r0.xz = -r0.yw + r5.yy;
    r11.y = ps;
    p0 = (r6.z != 0.0);
    ps = p0 ? 0.0 : 1.0;
    r12.xy = float2((r0.wy >= r5.xy));
    r0.xz = r6.xx * r7.ww + r0.xz;
    r0.xz = r0.xz * SP_DemolitionSpread.xx + r0.yw;
    r0.x = (r12.y == 0.0) ? r0.y : r0.x;
    r0.x = (r1.w == 0.0) ? r0.x : r0.z;
    r0.y = (r12.x == 0.0) ? r5.x : r0.x;
    if (p0)
    {
        if (p0)
        {
    ...
    o2.xyz = r4.xyz;
    o1 = r9.xxxx * ViewProjectionMatrix[0] + r0.xzyw;
    o4.xyz = r7.xyz;
    o4.w = 0.0;
    o3 = r3;
    o5 = r2.xzyw;
