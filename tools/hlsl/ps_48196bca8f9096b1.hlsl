...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r11.yzw = tex2D(LightAttenuationTexture, r5.zw).xyz;
    ...
    r11.x = ps;
    ps = rsqrt(abs(r6.w));
    r6.xyz = r10.xyz * UniformScalar_0.xxx;
    r6.w = ps;
    ps = 1.0 - r5.x;
    r0.xyz = r11.yzw * r2.www;
    r2.x = saturate(ps);
    r2.yzw = r7.xyz * 2.0 - 1.0;
    ps = rsqrt(abs(r5.z));
    r5.x = saturate(r0.w * 5.0);
    r0.w = ps;
    ps = 1.0 - r5.x;
    r1.w = dot(r4.xzy, float3(1.0, 1.0, 1.0));
    r5.z = ps;
    ps = log2(r2.x);
    r7.xyz = r2.wyz * float3(0.7, 1.0, 1.0);
    r5.x = ps;
    ...
    r1.z = ps;
    ps = log2(abs(r1.w));
    r5.x = dot(r3.zxy, r2.wyz);
    r2.x = ps;
    ps = pow(2.0, r0.w);
    r2 = r2.xwyz * float4(0.1, 0.7, 1.0, 1.0);
    r5.z = ps;
    ps = rsqrt(abs(r6.w));
    r0.xyz = r0.xzy * r5.zzz;
    r5.z = ps;
    ps = r5.x;
    r7.xyz = r2.zwy * r5.zzz;
    r1.x = ps;
    ps = 0.0;
    r6.w = saturate(dot(r7.zxy, r4.zxy));
    r1.w = ps;
    ps = max(r1.x, r1.w);
    r5.x = dot(r7.zxy, r3.zxy);
    r1.w = ps;
    ps = pow(2.0, r2.x);
    r7.xyz = r7.xzy * r5.xxx;
    r1.x = ps;
    ps = 0.875 * r5.w;
    r1 = -r1.wxyz + float4(0.45, 1.0, 1.0, 1.0);
    r11.y = ps;
    r2.yz = r11.xy * r1.zw + 0.125;
    ps = r1.x;
    r5.yzw = r1.yyy * r10.xyz;
    r5.x = ps;
    r3.xyz = r7.xyz * 2.0 - r3.xzy;
    ps = 4.0 * r5.x;
    r2.w = saturate(dot(r4.zxy, r3.yxz));
    r5.x = saturate(ps);
    ps = r2.w * r2.w;
    r3.xyz = r5.yzw * UniformVector_3.www;
    r2.x = ps;
    r3.xyz = r3.xyz * UniformVector_3.xyz - r5.yzw;
    r5.xyz = r5.xxx * r3.xyz + r5.yzw;
    ps = r2.x * r2.w;
