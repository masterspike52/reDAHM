...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.w = ps;
    ps = rsqrt(abs(r5.y));
    r6.x = saturate(r5.w * 5.0);
    r0.y = ps;
    r5.w = saturate(r0.y * r1.z);
    r4.xyz = -ModShadowColor.xyz + 1.0;
    r8.xyz = r0.xzw * r2.www;
    ps = 1.0 - r5.x;
    r6.yzw = r6.yzw * 3.0;
    r0.x = saturate(ps);
    ps = rsqrt(abs(r5.x));
    r7.xyz = r6.yzw * r10.xyz;
    r5.y = ps;
    ps = rsqrt(abs(r5.z));
    r10.xyz = r0.yyy * r1.zxy;
    r5.z = ps;
    ps = log2(r0.x);
    r6.x = -r6.x + 1.0;
    r5.x = ps;
    ...
    r6.x = saturate(dot(r10.yzx, r0.yzx));
    r5.y = ps;
    ps = log2(r6.x);
    r5.z = saturate(r5.y * SpotAngles.y);
    r9.z = ps;
    ps = pow(2.0, r5.x);
    r0.xyw = r9.xyz * float3(0.875, 0.875, 15.0);
    r6.x = ps;
    r5.xy = r0.xy * r1.xy + 0.125;
    ps = pow(2.0, r0.w);
    r0.xyz = r8.xzy * r6.xxx;
    r6.x = ps;
