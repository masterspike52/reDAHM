// ps_8c2a28c0c6f376dc.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 201 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000324 10040E00 0000080A 00000000 00008108 001F00FF 00000021 0000F050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A1 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.x = ps;
    r4.xy = r4.xy * abs(r8.xy);
    if (any(float4(0.0, 0.0, 0.0, 0.0) > r4.zzzz)) clip(-1.0);
    r8.zw = tex2D(ModShadowAccumTexture, r4.xy).xy;
    r8.xy = r0.xy + UniformVector_3.xy;
    r9 = r8 * float4(-1.0, -1.0, 0.875, 0.875);
    ...
    r6.y = saturate(ps);
    r8.xyz = UniformVector_2.xyz * UniformVector_2.www - r0.xyz;
    ps = r11.x + r11.x;
