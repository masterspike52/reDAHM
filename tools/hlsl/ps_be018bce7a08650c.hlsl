...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r11.xy = tex2D(ModShadowAccumTexture, r6.xz).xy;
    ...
    r0.xyz = r9.xyz * r10.yzw;
    r10.x = ps;
    ps = rsqrt(abs(r6.y));
    r10.yzw = r10.yzw * AmbientColorAndSkyFactor.xyz;
    r6.y = ps;
    r9.xyz = r10.yzw * r9.xyz + UniformVector_0.xyz;
    ps = rsqrt(abs(r7.w));
    ...
    r4.x = r2.z * 2.0 - r2.z;
    ps = 0.1 - -r6.w;
    r2 = r11.wxyw * float4(-0.5, 0.875, 0.875, 0.5);
    r6.x = ps;
    ps = 5.0 * r6.x;
    ...
    r7 = r0.xzyw * r2.yyyz;
    r7.xyz = r7.xzy * UpperSkyColor.xyz + r9.xyz;
    ps = pow(2.0, r7.w);
    r4.xyz = r0.xzy * r2.xxx;
    r7.w = ps;
    r2.xyz = r7.www * r1.xzy;
