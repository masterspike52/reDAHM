// ps_f73736479ace425d.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 252 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000003F0 10041100 0000070A 00000000 000060E7 001F007F 00000001 00003050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A1
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.zw = tex2D(ModShadowAccumTexture, r6.xy).xy;
    ...
    r7.w = ps;
    r0.x = r5.x * UniformScalar_9.x + UniformScalar_10.x;
    ps = r11.x + r11.w;
    r12.zw = r0.zw * 0.875;
    r13.x = ps;
    r0.yzw = r9.xyz * 2.0 - 1.0;
    ps = r5.w + r5.w;
    ...
    r14.y = ps;
    r13.yzw = (-abs(r8.xxx) >= 0.0) ? UniformVector_6.xyz : r15.xyz;
    r16.xyz = (-abs(r8.xxx) >= 0.0) ? UniformVector_4.xyz : r17.xyz;
    ps = rsqrt(abs(r4.w));
    r5.z = saturate(r7.w * 5.0);
    r5.y = ps;
    ps = rsqrt(abs(r3.w));
    ...
    r5.y = ps;
    r16.xyz = (-abs(r1.www) >= 0.0) ? r17.xyz : r16.xyz;
    r1.xyw = (-abs(r1.www) >= 0.0) ? r15.xyz : r13.yzw;
    ps = log2(r6.w);
    r5.z = -r5.z + 1.0;
    r5.x = ps;
    ...
    r12.x = ps;
    ps = r1.y;
    r2.xyz = r14.xyz - r0.yzw;
    r0.yzw = r2.xyz * UniformScalar_2.xxx + r0.yzw;
    ps = r11.w * ps;
    r1.xyz = -r13.xyz + 1.0;
    r12.y = ps;
    ...
    r5.xy = r5.yx * r5.yz;
    r5.z = ps;
    r0.yzw = r5.zzz * UniformScalar_8.xxx + r0.yzw;
    ps = pow(2.0, r5.y);
