...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.w = ps;
    ps = rsqrt(abs(r2.w));
    r5.w = saturate(r4.w * 5.0);
    r6.x = ps;
    ps = 1.0 - r3.z;
    r4.w = saturate(r6.x * r0.z);
    r2.w = saturate(ps);
    ps = rsqrt(abs(r0.w));
    r8.xyz = r6.xxx * r0.zxy;
    r0.x = ps;
    ps = rsqrt(abs(r3.z));
    ...
    r0.z = saturate(dot(r8.yzx, r7.yzx));
    r0.y = ps;
    ps = log2(r0.z);
    ...
    r6.x = ps;
    ps = pow(2.0, r0.z);
    r0.xyw = r6.xyz * float3(0.21952, 0.875, 0.875);
    r0.z = ps;
    r1.xyz = r5.xyz * r4.www + r0.xxx;
