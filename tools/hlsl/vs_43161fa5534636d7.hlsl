// vs_43161fa5534636d7.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 1152 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000080 00001200 00810010 00000000 00000000 00009129 00000001 00000007 00000009 00000290 0010002D 0000602E 0000702F 00003030 00005031 00015032 00255033 0000F050 0001F153 0002F254 0003F356 0004F457 0005F558 0006F6A0 0007F7A1 0008F8A2 0000117A 0000117E 00001175 00001173 00001176 00001177 00001178 00001174 00001179
...
//   vertex element: instruction 51 -> TEXCOORD5
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    if (p0)
    {
        ps = 3.3333333 * r2.z;
        r5.w = ps;
        r4.xw = r2.ww * float2(-1e+03, 8e+02) + r12.zy;
    }
    p0 = (r4.z == 1.0);
    ...
    if (p0)
    {
        ps = 3.3333333 * r2.x;
        r5.w = ps;
        r4.xz = r2.ww * float2(-1e+03, 8e+02) + r12.zx;
    }
    p0 = (r4.w == 1.0);
    ...
    r10 = r12.wwww * LocalToWorld[3].xzyw;
    ps = 0.003921569 * r1.w;
    r3.xyz = r8.yxz * 0.003921569;
    r7.y = ps;
    ...
    r13.xyz = r5.yxz * 0.007843138 - 1.0;
    r7.xzw = r8.xyz * 0.007843138 - 1.0;
    ps = 0.003921569 * r1.y;
    ...
    r16.xy = r0.xx * ViewProjectionMatrix[2].zw + r4.xy;
    r10.xyw = -r0.xyz * CameraPosition.www + CameraPosition.zyx;
    ...
    r14.xyz = r13.xxx * WorldToLocal[2].xyz;
    r15.xyz = r10.xxx * WorldToLocal[2].xyz;
    r8.xy = r0.yy * ViewProjectionMatrix[1].zw + r16.xy;
    r8.zw = r0.zz * ViewProjectionMatrix[0].zw + r8.xy;
    r10.xyz = r10.yyy * WorldToLocal[1].xyz + r15.xyz;
    r0.xyz = r13.yyy * WorldToLocal[1].xyz + r14.xyz;
    r0.xyz = r13.zzz * WorldToLocal[0].xzy + r0.xzy;
    r13.xyz = r10.www * WorldToLocal[0].xzy + r10.xzy;
    r10.x = dot(r1.xzy, r13.yxz);
    r10.y = dot(r5.zyw, r13.yxz);
    r10.z = dot(r6.zyx, r13.yxz);
    ...
    ps = -r6.y * -r6.y;
    r13.yz = -r6.xy + BBox_Size.xy;
    r13.x = ps;
    r14.xy = r0.zx * BBox_Size.yx - r6.yx;
    r5.w = dot(r14.yx, r14.yx) + 0.0;
    ps = -r6.x * -r6.x;
    r13.zw = r13.yz * r13.yz;
    r13.y = ps;
    ps = 1.0 / r0.y;
    ...
    r1.y = ps;
    ps = 1.0;
    r13.x = saturate(floor(r0.w));
    r1.w = ps;
    p0 = (r8.x != 0.0);
    ps = p0 ? 0.0 : 1.0;
    r13.z = saturate(r0.y * r1.x);
    if (p0)
    {
        if (p0)
        {
    ...
    ps = r12.z;
    r0.y = ps;
    r1.w = float((r12.z >= r0.w));
    r6.x = -r7.x * r11.w + r0.y;
    ps = (-abs(r0.x) > 0.0) ? 1.0 : 0.0;
    r0.xz = -r0.yw + r6.yy;
    r13.y = ps;
    p0 = (r8.x != 0.0);
    ...
    if (p0)
    {
        if (p0)
        {
            ...
            r0.x = r0.x * r0.x;
            r13.y = r0.x * SP_DemolitionSpread.x;
        }
    }
