...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.xyz = tex2D(Texture2D_2, r5.xy).xyz;
    ...
    r5.w = ps;
    ps = 1.0 - r5.x;
    r12.xyz = r5.www * -SpotDirection.xyz;
    r5.x = saturate(ps);
    ps = log2(r5.x);
    r5.y = -r5.y + 1.0;
    r5.x = ps;
    ...
    r5.z = ps;
    r2.xyz = r5.zzz * r11.xyz;
    r5.z = saturate(dot(r2.zxy, r3.zxy));
    r5.w = dot(r2.zxy, r10.zxy);
    r2.xyz = r2.xzy * r5.www;
    r2.xyz = r2.xyz * 2.0 - r10.xzy;
    ps = -SpotAngles.x - -r5.y;
    r5.w = saturate(dot(r3.zxy, r2.yxz));
    r5.y = ps;
    ps = log2(r5.w);
