...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.xyz = tex2D(Texture2D_0, r7.xy).xyz;
    r8.xyz = r7.xyz * 2.0 - 2.0;
    r1.xyz = r6.xyz * UniformVector_3.xyz;
    ps = r2.z;
    ...
    r6.y = saturate(dot(r1.zxy, r4.yxz));
    ps = log2(r6.y);
    ...
    r0.x = ps;
    r0.xyw = r0.xyw * float3(0.1, 0.875, 0.875);
    r7.xyz = r7.xyz * r6.yyy + r0.xxx;
    r0.xy = r0.yw * r6.xz + 0.125;
    r6.xw = r0.xz * r0.yz;
