// ps_45eb8caec0a81612.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 36 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000090 10000400 00000008 00000000 00004CA5 0007001F 00000021 0000F050 0000F156 00007257 0000F3A0 0000F4A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.z = saturate(r3.x - UniformScalar_5.x);
    r3.w = 0.5;
    r3.x = tex2D(Texture2D_3, r3.zw).x;
