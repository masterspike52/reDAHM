// ps_6a23d18f44ff1e4e.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 36 ucode dwords, 0 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000000 00000090 18000200 00000004 00000000 00002863 00070007 00000011 00003050 0000F151 0000F257
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.x = saturate(r2.z * InvMaxSubjectDepth.x + r0.x);
    // unhandled fetch opcode 18
    oDepth.x = saturate(r0.x);
    r0.x = max(r0.y, r0.z);
    r0.x = r0.x * SlopeScaleDepthBias.x + DepthBias.x;
    oC0 = saturate(r2.zzzz * InvMaxSubjectDepth.xxxx + r0.xxxx);
