// ps_82062b7d2b889ec3.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 174 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000002B8 10040B00 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.zw = r7.xy * r5.yz;
    r5.y = ps;
    r10.yzw = r5.yzw + float3(-0.015, 0.125, 0.125);
    r0.zw = r6.xy * r10.yy + r0.xy;
    ...
    r6.xyw = texCUBE(TextureCube_0, xe_cube_dir(r6.xyz)).xyz;
    ...
    r6.z = saturate(dot(r1.zxy, r11.xyz));
    r10.x = saturate(ps);
    r5.xw = r10.zx * r10.wx;
    ...
    r6.z = ps;
    r8.zw = r6.wz * float2(4e+01, 15.0);
    ps = pow(2.0, r8.w);
    r2.xyz = r8.xyz * r4.xyx;
    r1.x = ps;
    r6.xyz = r3.xyz * r1.xxy;
