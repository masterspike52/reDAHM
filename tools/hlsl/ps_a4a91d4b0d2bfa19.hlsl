...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.zw = r0.zw * r6.yz;
    r6.y = ps;
    r10.yzw = r6.yzw + float3(-0.015, 0.125, 0.125);
    r0.zw = r7.xy * r10.yy + r1.xy;
    r6.xyz = tex2D(Texture2D_0, r0.zw).xyz;
    r6.yzw = r6.xyz * 2.0 - 1.0;
    r1.xy = r2.ww * ScreenPositionScaleBias.xy;
    ...
    r6.x = dot(r12.zxy, r7.zxy);
    r6.xyz = r12.zxy * r6.xxx;
    r11.xyz = r6.xyz * 2.0 - r7.zxy;
    r6 = xe_cube(r11.yzx);
    ps = 1.0 / abs(r6.z);
    r7.z = r6.w;
    r7.x = ps;
    ...
    r1.xyz = tex2D(Texture2D_1, r0.zw).xzy;
    r5.xyz = texCUBE(TextureCube_0, xe_cube_dir(r7.xyz)).xyz;
    ...
    r6.x = ps;
    r7.xyz = r7.xyz * r1.xxy;
    r1.y = saturate(dot(r12.zxy, r6.wyz));
    r6.w = saturate(dot(r6.wyz, r11.xyz));
    ...
    ps = pow(2.0, r4.w);
    r2.xyz = r4.xyz * r1.xzx;
    r1.x = ps;
    r7.xyz = r7.xyz * r1.xxy;
    r7.xyz = r2.xyz * r1.yyx + r7.xyz;
