// ps_e786128626837b73.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 315 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004EC 10041000 0000080A 00000000 00007908 001F00FF 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A1 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.z = ps;
    ps = r6.z + r6.z;
    r7 = r7 + float4(-1.0, -1.0, -1.0, 1.0);
    r15.z = ps;
    ps = UniformScalar_1.x * r5.y;
    r15.x = dot(r10.xww, float3(1.0, 1.0, 1.0));
    r5.w = ps;
    r5.x = (r15.x == 0.0) ? r14.x : r14.y;
    r10.xw = r5.ww * r16.zw + r7.xy;
    r13.xy = r10.xw * UniformVector_4.xy - r12.xy;
    r15 = r15.xxyz + float4(-3.0, -2.0, -1.0, -1.0);
    r14.xy = r16.xy * 0.5 + r15.zw;
    r5.x = (r15.y == 0.0) ? r14.z : r5.x;
    r6.x = (r15.x == 0.0) ? r14.w : r5.x;
    r5.x = max(r6.x, 0.0);
    r10.x = min(r5.x, 0.3);
    ps = 1.0 / r4.w;
    r10.xyz = r10.xyz * float3(3.3333333, 0.875, 0.875);
    r5.x = ps;
    r13.xy = r10.xx * r14.xy + r13.xy;
    r5.xw = r13.zw * r5.xx + ScreenPositionScaleBias.wz;
    r3.z = tex2D(Texture2D_5, r0.xy).x;
    r3.xyw = tex2D(Texture2D_7, r3.xy).xyz;
    r0.yzw = tex2D(LightAttenuationTexture, r5.xw).xyz;
    ...
    r6.z = ps;
    r11.w = r7.z * UniformVector_4.z - r12.z;
    ps = ModShadowGroupColor.y * r5.z;
    r4.xyz = r4.xyz * r7.www;
    r6.w = ps;
    r2.xyz = r4.xyz * UniformScalar_11.xxx + UniformScalar_12.xxx;
    ps = rsqrt(abs(r5.x));
    r6.xzw = -r6.xwz + 1.0;
    r5.x = ps;
    ps = 2.5 * r6.x;
    r7.xyz = r0.yzw * LightColor.xyz;
    r4.w = ps;
    r10.xyz = r10.xyz * r6.ywz + float3(1.0, 0.125, 0.125);
    ps = abs(r10.x) * abs(r10.x);
    r1.xyz = r5.xxx * r1.xyz;
    r10.w = ps;
    r11.xyz = r4.xyz * r10.xxx - r3.xyw;
    r6.w = saturate(r4.w * r10.x - 0.5);
    r0.yz = r13.xy * r6.ww + r12.xy;
    r4.xyz = r11.xyz * r6.www + r3.xyw;
    r5.x = r11.w * r6.w - 2.0;
    ps = -UniformVector_0.y;
    r3.yw = r10.wy * r10.wz;
    r6.xyz = r3.www * r8.xyz + ModShadowColor.xyz;
    r0.w = r2.w * 2.0 + r5.x;
    ps = 1.0 + ps;
    r8.xyw = r0.yzw * r5.yyy;
    r0.y = ps;
    ps = -UniformVector_0.z;
    r8.z = r8.w + 1.0;
    r8.xyz = (r5.yyy > 0.0) ? r8.xyz : float3(0.0, 0.0, 1.0);
    r5.yzw = (r5.yyy >= 0.0) ? r8.xyz : float3(0.0, 0.0, 1.0);
    ps = 1.0 + ps;
