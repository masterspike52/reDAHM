// ps_67bdd9e861d77e70.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 126 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001F8 10040A00 0000080A 00000000 00007908 003F00FF 00000001 0000F050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.x = tex2D(Texture2D_1, r1.xy).w;
    r7 = tex2D(Texture2D_2, r0.xy).xywz;
    ...
    r1.xzw = r1.xxx * r7.xyw;
    r3.xyz = r1.xzw * r10.xyz;
    r0.w = rsqrt(abs(r2.w));
    ps = 0.1 - -r2.z;
    ...
    r5.z = ps;
    r2.xyz = r5.xyz * float3(0.875, 0.875, 15.0);
    ps = pow(2.0, r2.z);
    r7.xyw = r3.xyz * r6.xxx;
    r6.x = ps;
    r1.xy = r2.xy * r1.xy + 0.125;
    ps = r1.x * r1.y;
    r7.z = r6.x * r7.z;
    r6.x = ps;
