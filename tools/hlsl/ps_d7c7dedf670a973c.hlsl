// ps_d7c7dedf670a973c.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 57 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000000E4 18000400 00000004 00000000 000040A5 001F001F 00000011 00003050 00003151 0000F252 0000F353 0000F457
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    // unhandled fetch opcode 18
    r0.x = max(r0.x, r0.y);
    r1.z = InvMaxSubjectDepth.x * r4.z;
    r1.y = r0.x * SlopeScaleDepthBias.x + DepthBias.x;
    r0.xy = r1.xy + r1.xz;
    r1.x = r0.x * r3.w - 0.1;
