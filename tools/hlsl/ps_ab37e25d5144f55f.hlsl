...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.yzw = tex2D(Texture2D_0, r5.zw).xyz;
    ...
    ps = 1.0 + ps;
    r6.w = saturate(dot(r1.zxy, r9.yxz));
    r7.z = ps;
    ps = log2(r6.w);
    ...
    r3.xyz = r6.xyz * r8.xyz;
    r1.y = ps;
    ps = pow(2.0, r6.w);
    r6.xyz = r3.xyz * r7.xyz;
    r4.z = ps;
    ps = LightColor.z * r5.w;
    r3.xyz = r4.xyz * float3(0.875, 0.875, 0.21952);
    r1.z = ps;
    r6.xyz = r6.xyz * r5.xxx + r3.zzz;
    r5.xy = r3.xy * r2.xy + 0.125;
    ps = r5.x * r5.y;
