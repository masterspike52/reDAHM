...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.y = -r0.y + 1.0;
    r0.x = ps;
    r9.xy = -r0.yy * ModShadowGroupColor.xy + 1.0;
    ps = rsqrt(abs(r0.z));
    r0.y = dot(r3.wyz, r2.zxy);
    r0.z = ps;
    ps = r0.w;
    r2.xyz = r8.xyz * r0.zzz;
    ps = r1.y * ps;
    r8.xyz = r2.xyz * TwoSidedSign.xxx;
    r3.y = ps;
    ps = r0.w;
    r0.z = dot(r8.zxy, r11.zxy);
    ps = r1.z * ps;
    r2.xyz = r8.xzy * r0.zzz;
    r3.z = ps;
    r1.xyz = r2.xyz * 2.0 - r11.xzy;
