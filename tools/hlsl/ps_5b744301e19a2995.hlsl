// ps_5b744301e19a2995.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 117 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001D4 10040700 00000506 00000000 000040A5 001F001F 00000001 00003050 00007154 0000F255 00007356 0000F457
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.z = ps;
    ps = 5.0 * r0.x;
    r6.xyw = r5.yzw * UniformVector_1.xyz;
    r0.x = saturate(ps);
    ps = rsqrt(abs(r0.y));
    r5.yzw = r0.zzz * r1.zxy;
    r0.y = ps;
    ps = 1.0 - r0.x;
    ...
    r2.x = r2.x * 2.0 - r2.x;
    ps = 1.0 + ps;
    r1.w = saturate(dot(r5.zwy, r2.yzx));
    r5.y = ps;
    ps = log2(r1.w);
