...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.xy = r7.xy * r5.xy + 0.125;
    ps = r0.z * ps;
    r0.w = saturate(dot(r6.xyz, r2.yzx));
    r5.z = saturate(ps);
    ps = log2(r0.w);
    r0.xy = r5.xz * r5.yw;
    r3.x = ps;
    r2.xyz = r0.xxx * r4.xyz + ModShadowColor.xyz;
    r3 = r3 * float4(15.0, 0.21952, 1.0, 1.0);
    ps = pow(2.0, r3.x);
