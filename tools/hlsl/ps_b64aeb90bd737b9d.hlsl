...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.yzw = tex2D(Texture2D_3, r1.xy).xyz;
    ...
    ps = 5.0 * r6.x;
    r7.yzw = r7.yzw * UniformVector_3.xyz;
    r6.x = saturate(ps);
    ps = r0.x * r0.x;
    r5.xyz = r5.xyz * UniformVector_2.xyz;
    r0.x = ps;
    ps = rsqrt(abs(r7.x));
    ...
    r9.w = ps;
    r2.xy = r9.xz * r9.yw;
    r6.xyz = r2.xxx * r6.yzw + ModShadowColor.xyz;
    ps = pow(2.0, r2.y);
