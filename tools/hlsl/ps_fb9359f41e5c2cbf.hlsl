...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.xyz = tex2D(Texture2D_1, r4.xy).xyz;
    r4 = tex2D(Texture2D_0, r0.xy);
    r5.w = OpacityOverride.x * 0.5;
    oC0.w = r5.w * r4.w;
    r5.xyz = r5.xyz * float3(0.4376475, 0.23647049, 0.07764749) + r4.xyz;
    r4.xyz = r5.xyz * r4.xyz + UniformVector_0.xyz;
    r4.xyz = r4.www * float3(0.486275, 0.262745, 0.086275) + r4.xyz;
