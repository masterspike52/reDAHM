// ps_f3fbad4362069e6e.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 147 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000024C 18000400 00000008 00000000 000050A5 0003001F 00000011 0000F050 0000F157 0000F2A0 0000F3A1 0000F4A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.y = max(r2.y, UniformScalar_14.x);
    ...
    ps = 1.0 - r2.y;
    r2.y = ps;
    r2.w = (UniformScalar_13.x > 0.0) ? r2.y : 1.0;
    r2.y = (UniformScalar_13.x >= 0.0) ? r2.w : r2.y;
    r2.x = r2.y * r2.x - 0.5;
    r3.xz = r0.wz * 3.0;
    r3.y = r4.w * (-0.8) + r3.z;
    r2.w = tex2D(Texture2D_7, r0.xy).w;
    ...
    r3.x = max(r3.x, UniformScalar_14.x);
    ps = 1.0 / UniformScalar_15.x;
    r3.x = min(r3.x, 1.0);
    r3.z = ps;
    ps = r3.y;
    ...
    r3.x = -r3.x + 1.0;
    r3.y = (UniformScalar_13.x > 0.0) ? r3.x : 1.0;
    r3.x = (UniformScalar_13.x >= 0.0) ? r3.y : r3.x;
    r2.w = r3.x * r2.w - 0.5;
