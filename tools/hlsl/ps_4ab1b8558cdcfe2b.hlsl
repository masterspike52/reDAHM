...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.w = saturate(dot(r2.zxy, r7.yxz));
    r9.y = saturate(ps);
    ...
    r5.x = ps;
    ps = pow(2.0, r7.w);
    r2 = r5.zyxw * float4(3.5, 3.5, 15.0, 3.5);
    r7.w = ps;
    ps = pow(2.0, r2.z);
    r1.xyz = r1.xzy * r7.www;
    r7.w = ps;
    r7.xyw = r2.yxw * r7.www;
