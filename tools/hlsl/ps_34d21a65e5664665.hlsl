// ps_34d21a65e5664665.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 147 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000024C 10040B00 00000506 00000000 000048A5 001F001F 00000001 00003050 0000F154 0000F256 0000F357 0000F458
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = rsqrt(abs(r0.z));
    r10.xyz = r6.xyz * AmbientColorAndSkyFactor.xyz;
    r0.y = ps;
    ...
    ps = 0.1 - -r1.x;
    r11.x = dot(r0.zxy, r4.xyz);
    r0.x = ps;
    ps = 5.0 * r0.x;
    r0.y = dot(r4.xyz, r3.zxy);
    r0.x = saturate(ps);
    ...
    r1.xyz = r3.xzy * r6.www + r1.xzy;
    r1.xyz = r4.xzy * r5.xzy + r1.xzy;
    ps = -r2.w;
