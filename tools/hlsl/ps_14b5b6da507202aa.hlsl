...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.z = ps;
    ps = log2(r0.y);
    r3.yzw = r3.xxx * r8.xyz;
    r0.x = ps;
    ps = 0.875 * r4.y;
    r6.xyz = r3.yzw * r6.xyz;
    r4.w = ps;
    ps = 1.0 - r0.z;
    r0.y = dot(r11.zxy, r2.zxy);
    r0.z = ps;
    r0.zw = -r0.zz * ModShadowGroupColor.xy + 1.0;
    r4.xy = r4.zw * r0.zw + 0.125;
    ps = rsqrt(abs(r1.x));
    r3.yzw = r3.xzw * UniformScalar_7.xxx;
    r0.z = ps;
    ps = LightColorAndFalloffExponent.w * r0.x;
    r2.xyz = r10.xyz * r0.zzz;
    r1.x = ps;
    ps = -SpotAngles.x - -r0.y;
    r0.z = dot(r2.zxy, r1.wyz);
    r0.x = ps;
    ps = SpotAngles.y * r0.x;
    r0.yzw = r2.xzy * r0.zzz;
    r4.z = saturate(ps);
    r1.yzw = r0.yzw * 2.0 - r1.ywz;
    ps = r3.y;
    r0.xw = r4.xz * r4.yz;
    r0.xyz = r0.xxx * r9.xyz + ModShadowColor.xyz;
    ps = r8.x * ps;
    r1.z = saturate(dot(r7.zxy, r1.zyw));
    r3.x = ps;
    ps = log2(r1.z);
    r1.y = saturate(dot(r2.zxy, r7.zxy));
    r1.z = ps;
    ps = pow(2.0, r1.x);
    r2 = r6 * r1.yyyz;
    r1.x = ps;
