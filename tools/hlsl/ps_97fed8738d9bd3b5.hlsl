// ps_97fed8738d9bd3b5.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 432 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000006C0 10000400 00000008 00000000 00004084 0003000F 00000021 0000F050 0000F156 0000F2A0 0000F3A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.z = saturate(r2.x - UniformScalar_5.x);
    r2.w = 0.5;
    r2.x = tex2D(Texture2D_3, r2.zw).x;
    r2.y = tex2D(Texture2D_0, r0.xy).x;
    r2.y = 5e+01 * r2.y;
    r2.x = r2.x * UniformVector_1.x - 0.5;
    r2.x = r2.y * r2.z + r2.x;
