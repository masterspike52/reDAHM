// ps_35092bc1e1ba5249.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 108 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001B0 10040800 0000070A 00000000 000060E7 001F007F 00000001 00003050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.xyz = tex2D(LightAttenuationTexture, r5.zw).xyz;
    ...
    r4.w = ps;
    r5.xyz = r4.yzw * float3(0.875, 0.875, 15.0);
    r4.yz = r5.xy * r3.xy + 0.125;
    ps = pow(2.0, r5.z);
