...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.y = saturate(ps);
    r1.yzw = r0.yzw * 2.0 - 1.0;
    ps = rsqrt(abs(r6.z));
    r6.x = saturate(r7.w * 5.0);
    r0.w = ps;
    ps = r0.w;
    r7.xyw = r11.xyz * r7.xyz;
    ps = r2.x * ps;
    r7.z = dot(r1.wyz, r1.wyz);
    r1.x = ps;
    ps = rsqrt(abs(r6.w));
    r6.z = -r6.x + 1.0;
    r6.x = ps;
    r0.yz = -r6.zz * ModShadowGroupColor.xy + 1.0;
    ps = rsqrt(abs(r7.z));
    r6.xzw = r6.xxx * r4.xyz;
    r7.z = ps;
    ps = r0.w;
    r1.yzw = r1.yzw * r7.zzz;
    ps = r2.y * ps;
    r3.xyz = r1.yzw * TwoSidedSign.xxx;
    r1.y = ps;
    ps = r0.w;
    r7.z = dot(r3.zxy, r6.wxz);
    ps = r2.z * ps;
    r4.xyz = r3.xzy * r7.zzz;
    r1.z = ps;
    r6.xzw = r4.xyz * 2.0 - r6.xwz;
    ps = log2(r6.y);
    r6.x = saturate(dot(r1.zxy, r6.zxw));
    r6.y = ps;
    ps = log2(r6.x);
    r6.w = r6.y * LightColorAndFalloffExponent.w;
    r10.x = ps;
    r6.xyz = r10.xyz * float3(15.0, 0.875, 0.875);
    r0.yz = r6.yz * r0.yz + 0.125;
    ps = pow(2.0, r6.x);
    r7.z = saturate(dot(r3.zxy, r1.zxy));
    r6.x = ps;
