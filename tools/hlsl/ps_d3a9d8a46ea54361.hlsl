// ps_d3a9d8a46ea54361.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 306 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004C8 10040F00 0000080A 00000000 00007108 003F00FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r11.xy = r0.zw - r10.xy;
    r6.z = ps;
    r0.zw = r11.zw * r6.zz + ScreenPositionScaleBias.wz;
    r5.xyz = tex2D(LightAttenuationTexture, r0.zw).xyz;
    r12.x = tex2D(ShadowTexture, r0.xy).x;
    r4.xyz = tex2D(Texture2D_5, r12.yz).xyz;
    ...
    r6.w = ps;
    r8.w = r7.z * UniformVector_4.z - r10.z;
    ps = r6.w;
    ...
    r3.x = ps;
    ps = 2.5 * r7.x;
    r3.yzw = r13.xzy * r7.yzw;
    r13.w = ps;
    ps = rsqrt(abs(r6.z));
    r7 = r3.xwzy + float4(1.0, 0.125, 0.125, 1.0);
    r6.z = ps;
    ps = abs(r7.w) * abs(r7.w);
    r3.xyz = r6.zzz * r2.xyz;
    r12.y = ps;
    ps = r7.y * r7.z;
    r13.xyz = r8.xyz * r7.xxx;
    r6.z = ps;
    r7.xyz = r6.zzz * r0.xyz + ModShadowColor.xyz;
    r0.xyz = r13.xyz * UniformScalar_3.xxx + UniformScalar_4.xxx;
    r8.xyz = r13.xyz * r7.www - r4.xyz;
    r7.w = saturate(r13.w * r7.w - 0.5);
    r6.zw = r12.xy * r12.xy;
    r2.xy = r11.xy * r7.ww + r10.xy;
