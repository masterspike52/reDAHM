// ps_bcbe5eef4eb10bb6.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 180 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000002D0 10000D00 00000008 00000000 000054C6 000F003F 00000001 00003050 0000F155 00007256 0000F357 0000F4A0 0000F5A1
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.zw = r0.xy * 1e+01 + UniformVector_1.xy;
    ...
    r11.xyz = tex2D(Texture2D_3, r0.zw).xyz;
    r10.xyz = tex2D(Texture2D_0, r0.xy).xyz;
    r2.w = dot(r2.zxy, r2.zxy);
    r0 = r4 * 2.0 - 1.0;
    r5.xyz = r5.zxy * 2.0 - 1.0;
    r6.xyz = UniformScalar_5.xxx * UniformVector_2.xzy;
    r7.xyz = UniformScalar_6.xxx * UniformVector_3.xyz - r6.xzy;
    ps = 1.0 / r1.w;
    ...
    r4.x = r4.x * r2.z;
    r12.z = ps;
    r4.zw = r12.yz * r1.xy + ScreenPositionScaleBias.wz;
    r4.w = dot(r4.wz, float2(0.5, 0.5)) + UniformScalar_8.x;
    ps = r4.x;
    r1.xyz = r11.xzy * r9.xzy;
    r4.x = ps;
    ps = rsqrt(abs(r5.w));
    r11.xyz = r1.xzy * r8.xyz;
    r4.z = ps;
    ps = rsqrt(abs(r4.y));
    r9.xyz = r0.xyz * r4.zzz;
    r4.y = ps;
    ps = 0.0;
    ...
    r0 = r12.yzwx * float4(0.8, 0.8, 0.8, 4.0);
    r5.y = dot(r10.xyz, r10.xyz);
    ps = rsqrt(abs(r5.y));
    r0.xyz = r11.xzy + r0.xyz;
    r5.y = ps;
    ps = r0.z;
