// ps_6e9a6142882cf126.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 177 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000002C4 10040F00 0000080A 00000000 00007908 001F00FF 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A1 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 / r4.w;
    r2.xyz = -UniformVector_0.xzy + 1.0;
    r5.z = ps;
    ...
    r5.z = ps;
    r8.xy = r9.yz * UniformScalar_11.xx + r0.xz;
    ps = rsqrt(abs(r5.y));
    ...
    ps = r11.x * ps;
    r6.x = saturate(dot(r10.zxy, r1.zxy));
    r3.x = ps;
    ps = r5.z;
    ...
    r3.xyw = r11.xyz + r3.xyz;
    ps = r3.y;
    r10.xyz = r10.xzy * r5.www;
    r6.yzw = r10.xyz * 2.0 - r6.ywz;
    r3.xyz = r9.xyz * UniformScalar_11.xxx + r3.xyw;
    ps = r8.x + ps;
    r5.w = r3.w + r8.y;
    r0.w = ps;
    ps = r5.w;
    r0.xyz = r3.xyz + r0.yxz;
    ps = r4.z + ps;
    ...
    r1.w = ps;
    ps = r5.w;
    r0.xyz = r3.xyz * UniformScalar_15.xxx;
    ps = r2.y * ps;
    r1.xy = r3.xw * r2.xz;
    r1.z = ps;
    r6 = r1.xzyw * r6.xxxy;
