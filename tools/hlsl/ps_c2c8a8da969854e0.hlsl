// ps_c2c8a8da969854e0.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 111 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001BC 10040900 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.y = ps;
    r5.xz = r5.xy * r4.xy + ScreenPositionScaleBias.wz;
    ps = 1.0 / ModShadowAccumResolution.x;
    r5.y = dot(r1.zxy, r1.zxy);
    r6.x = ps;
    r6.xy = r6.xy * abs(r7.xy);
    r8.xy = tex2D(ModShadowAccumTexture, r6.xy).xy;
    r9.xyz = tex2D(LightAttenuationTexture, r5.xz).xyz;
