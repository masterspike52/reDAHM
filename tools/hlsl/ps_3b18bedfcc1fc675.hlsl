// ps_3b18bedfcc1fc675.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 69 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000114 10000400 00000008 00000000 00004CA5 0007001F 00000021 0000F050 0000F156 00007257 0000F3A0 0000F4A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.yw = r0.xy * UniformVector_2.xy;
    r3.y = tex2D(Texture2D_9, r3.yw).w;
    ps = UniformScalar_12.x - r4.w;
    r3.xz = r0.wz * 3.0;
    r3.w = ps;
    ...
    ps = 1.0 - r3.x;
    r3.x = ps;
    r3.z = (UniformScalar_12.x > 0.0) ? r3.x : 1.0;
    r3.x = (UniformScalar_12.x >= 0.0) ? r3.z : r3.x;
    r3.x = r3.x * r3.y - 0.5;
