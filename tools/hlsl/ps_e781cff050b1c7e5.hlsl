...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.xyz = tex2D(Texture2D_2, r6.xy).xyz;
    ...
    r2.yzw = r0.www * r7.xyz;
    ps = 1.0 + ps;
    r7.x = saturate(dot(r2.wyz, r4.zxy));
    r2.x = ps;
    ps = -UniformVector_0.y;
    r7.y = dot(r2.wyz, r10.zxy);
    ps = 1.0 + ps;
    r3.xyz = r2.ywz * r7.yyy;
    r2.y = ps;
    r3.xyz = r3.xyz * 2.0 - r10.xzy;
    ps = -SpotAngles.x - -r6.y;
    r7.y = saturate(dot(r4.zxy, r3.yxz));
    r6.y = ps;
    ps = log2(r7.y);
    r7.z = saturate(r6.y * SpotAngles.y);
    r0.w = ps;
    ps = -UniformVector_0.z;
    r0 = r0 * float4(1.5, 1.5, 1.5, 15.0);
    ps = 1.0 + ps;
    r3.xyz = r0.xyz * r8.xyz;
    r2.z = ps;
    ps = pow(2.0, r0.w);
