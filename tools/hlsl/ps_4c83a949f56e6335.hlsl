// ps_4c83a949f56e6335.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 120 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001E0 10040800 0000070A 00000000 000068E7 001F007F 00000001 00003050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.yz = tex2D(ModShadowAccumTexture, r5.xz).xy;
    r6.xyz = tex2D(LightMapTexture, r0.xy).xyz;
    r0.x = -UniformVector_0.x + 1.0;
    ...
    r3.x = r1.z * 2.0 - r1.z;
    ps = 0.1 - -r5.w;
    r1 = r8.xxyz * float4(-0.5, 0.5, 0.875, 0.875);
    r5.x = ps;
    ps = 5.0 * r5.x;
    r1.xy = r1.xy * r4.zz;
    r5.x = saturate(ps);
    ...
    r5.x = ps;
    ps = log2(r5.y);
    r0.yz = r5.xx * ModShadowGroupColor.xy;
    r5.y = ps;
    r5.xzw = -r0.ywz + 1.0;
    ps = 15.0 * r5.y;
    r1.zw = r1.zw * r5.xw;
    ...
    ps = r1.z * r1.w;
    r6.yzw = r6.yzw * 0.21952;
    r5.x = ps;
    ps = r6.x;
    r0.zw = abs(r1.xy) * abs(r1.xy);
    r5.xyz = r5.xxx * r7.xyz + ModShadowColor.xyz;
    ps = r6.w + ps;
    r0.zw = r0.zw * r0.xx;
    r6.x = ps;
    r6.x = r0.z * LowerSkyColor.x + r6.x;
    r6.x = r0.w * UpperSkyColor.x + r6.x;
    r6.x = r0.x * AmbientColorAndSkyFactor.x + r6.x;
