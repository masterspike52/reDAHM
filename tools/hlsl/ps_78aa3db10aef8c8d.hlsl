// ps_78aa3db10aef8c8d.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 96 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000180 10040700 00000406 00000000 00003884 000F000F 00000001 00007054 0000F155 00007256 0000F357
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.w = r0.z + 0.1;
    r2.w = 1.0 / r3.w;
    r5.xz = r2.ww * ScreenPositionScaleBias.xy;
    r5.y = 1.0 / ModShadowAccumResolution.y;
    r3.xy = r5.xz * r3.xy + ScreenPositionScaleBias.wz;
    ...
    r2.xyz = r6.yxz * float3(0.21952, 1.0, 1.0);
    r5.z = log2(r0.w);
    r5.xyz = r5.xyz * float3(0.875, 0.875, 15.0);
    r4.yz = r5.xy * r4.xy + 0.125;
    r4.x = saturate(r2.w * r0.z);
    r0.z = pow(2.0, r5.z);
    r2.xyz = r2.yzx * r1.www;
    r1.y = 0.21952 * r0.z;
    ps = 1.0 * r0.z;
    r0.xw = r4.yx * r4.zw;
    r1.z = ps;
