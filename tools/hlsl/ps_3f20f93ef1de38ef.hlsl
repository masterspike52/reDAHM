// ps_3f20f93ef1de38ef.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 234 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000003A8 10041000 0000080A 00000000 00007108 003F00FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = rsqrt(abs(r6.w));
    r5.xy = r13.xy * UniformScalar_4.xx;
    r6.w = ps;
    ps = rsqrt(abs(r7.w));
    r15.xyz = r10.xyz * r10.www;
    r0.w = ps;
    ps = rsqrt(abs(r6.x));
    r10.xyz = r6.www * r4.xyz;
    r6.w = ps;
    r14.xyz = r6.www * -SpotDirection.xyz;
    ps = 1.0 - r6.x;
    r4.xyw = r16.yzx * r15.yzx;
    r6.x = saturate(ps);
    ...
    r6.y = -r6.y + 1.0;
    r6.x = ps;
    r6.zw = -r6.yy * ModShadowGroupColor.xy + 1.0;
    r5.yz = r5.xy * r0.xz;
    r13.xyz = r0.yxz * r13.wxy + r4.wxy;
    ps = UniformScalar_4.x * r0.y;
    r6.y = dot(r14.zxy, r3.zxy);
    r0.x = ps;
    ps = r0.x;
    r7.w = dot(r4.ywx, float3(0.11, 0.3, 0.59));
    ps = r13.w * ps;
    r7.w = r7.w - r4.w;
    r5.x = ps;
    ps = r7.w;
    r3.xyz = r13.xyz * r11.xyz;
    ps = r4.w + ps;
    ...
    r11.w = ps;
    r7.xyz = r7.yzx + r11.xyz;
    ps = r0.w;
    r7.w = r7.z - 1.0;
    ps = r2.x * ps;
    r7.xyw = r7.xyw * r0.yyy;
    r5.x = ps;
    ps = r0.w;
    r7.z = r7.w + 1.0;
    r7.xyz = (r0.yyy > 0.0) ? r7.xyz : float3(0.0, 0.0, 1.0);
    r0.xyz = (r0.yyy >= 0.0) ? r7.xyz : float3(0.0, 0.0, 1.0);
    ps = r2.y * ps;
    r7.x = dot(r0.zxy, r0.zxy);
    r5.y = ps;
    ps = rsqrt(abs(r7.x));
    r7.yzw = r11.www * r8.xyz;
    r7.x = ps;
    ps = r0.w;
    r8.xyz = r0.xyz * r7.xxx;
    ps = r2.z * ps;
    r7.x = dot(r8.zxy, r10.zxy);
    r5.z = ps;
    ps = LightColorAndFalloffExponent.w * r6.x;
    r0.xyz = r8.xyz * r7.xxx;
    r7.x = ps;
    r0.xyz = r0.xyz * 2.0 - r10.xyz;
    ps = pow(2.0, r7.x);
    r6.x = saturate(dot(r5.zxy, r0.zxy));
    r7.x = ps;
    ps = log2(r6.x);
    r0.xyz = r7.ywz * r7.xxx;
    r9.x = ps;
    ps = -SpotAngles.x - -r6.y;
    r7.xyw = r9.xzy * float3(15.0, 0.875, 0.875);
    r6.x = ps;
    r6.zw = r7.wy * r6.zw + 0.125;
    ps = pow(2.0, r7.x);
    r7.w = saturate(dot(r8.zyx, r5.zyx));
    r6.y = ps;
