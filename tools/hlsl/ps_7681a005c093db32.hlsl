...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 + ps;
    r11.xyw = r5.yzx * float3(0.5, 0.5, -0.025);
    r5.x = ps;
    ...
    r9 = r9.zwxy + r5;
    r5.xy = r9.zw + r9.zw;
    r12 = tex2D(Texture2D_1, r5.xy).zxwy;
    r5.yzw = tex2D(Texture2D_2, r0.wz).xwy;
    r3.xyw = tex2D(Texture2D_3, r10.yz).xyw;
    r17.xy = r3.xy * 2.0 - 1.0;
    ps = r5.y + r5.y;
    ...
    r12.y = saturate(ps);
    r5.x = (r15.y == 0.0) ? r12.x : r6.w;
    r12.x = (r15.x == 0.0) ? r12.z : r5.x;
    ps = 1.0 / r4.w;
    r5.xy = -r12.yx + 1.0;
    r17.z = ps;
    ...
    r18.x = ps;
    r4.zw = r18.yz * r17.zz + ScreenPositionScaleBias.wz;
    ...
    r1.w = saturate(ps);
    r5.xzw = r0.zxy * 2.0 - 1.0;
    r0.xyz = r7.xyw * 2.0 - 1.0;
    r11.w = r5.x * UniformVector_4.z - r0.z;
    ps = log2(r1.w);
    r14.w = r3.w - 1.0;
    r5.x = ps;
    r1.w = max(r12.x, 0.0);
    ...
    r5.y = ps;
    r12 = r14 * r6.xwzy + float4(1.0, 0.125, 0.125, 1.0);
    r4.yz = r18.xx * r17.xy + r5.zw;
    ...
    r5.y = ps;
    r5.yzw = r5.yyy * r16.xyz + ModShadowColor.xyz;
    r7.xyz = r13.xyz * UniformScalar_3.xxx + UniformScalar_4.xxx;
    ps = r0.w * r0.w;
    r1.zw = r15.zw + r11.xy;
    r4.x = ps;
    r1.xy = r4.yz * UniformVector_4.xy - r0.xy;
    r4.yz = r14.xx * r1.zw + r1.xy;
    r4.w = saturate(r13.w * r12.x - 0.5);
    r11.xyz = r13.xyz * r12.xxx - r10.xyz;
    r0.z = r11.w * r4.w - 2.0;
