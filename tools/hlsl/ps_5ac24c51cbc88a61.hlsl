// ps_5ac24c51cbc88a61.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 306 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004C8 10041000 0000080A 00000000 00007108 003F00FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.xyz = tex2D(Texture2D_2, r6.xy).xyw;
    ps = r1.w;
    ...
    r15 = tex2D(Texture2D_1, r6.xw).zwyx;
    ...
    r14.x = min(r6.z, 0.3);
    ps = r11.y + ps;
    r15.xyz = r14.xyz * float3(3.3333333, 0.875, 0.875);
    r8.y = ps;
    r8 = r15.xxww * r8;
    r0.zw = r7.yw + r8.zw;
    ...
    r4.xyz = tex2D(Texture2D_5, r13.xy).xyz;
    ...
    r14.x = ps;
    ps = 2.5 * r7.x;
    r14.yzw = r15.xzy * r7.yzw;
    r13.w = ps;
    ps = rsqrt(abs(r6.z));
    r7 = r14.xwzy + float4(1.0, 0.125, 0.125, 1.0);
    r6.z = ps;
