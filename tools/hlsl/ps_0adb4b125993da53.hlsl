// ps_0adb4b125993da53.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 138 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000228 10040900 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9.y = ps;
    r4.xy = r6.yz * r4.xy + ScreenPositionScaleBias.wz;
    ps = rsqrt(abs(r6.x));
    r5.x = -r5.x + 1.0;
    r6.x = ps;
    ...
    ps = abs(r7.x) * ps;
    r5.z = saturate(dot(r8.zxy, r5.wyz));
    r3.x = ps;
    ps = r9.y;
    ...
    r9.xyz = tex2D(Texture2D_2, r5.xx).xyz;
    ...
    r0.w = ps;
    ps = -r8.x;
    r9.xyz = r5.yyy * -SpotDirection.xyz;
    r1.y = ps;
    r1.x = r8.z * 2.0 - r8.z;
    ps = -r8.y;
    r5.y = dot(r9.zxy, r2.zxy);
    r1.z = ps;
    ps = -SpotAngles.x - -r5.y;
    r1.x = saturate(dot(r7.yzx, r1.yzx));
    r5.y = ps;
    ps = log2(r1.x);
    r5.x = saturate(r5.y * SpotAngles.y);
    r5.y = ps;
    ps = pow(2.0, r0.w);
    r5.y = r5.y * 15.0;
    r0.w = ps;
    ...
    r3.z = ps;
    r2.xyz = r3.xyz * float3(0.875, 0.875, 0.21952);
    r6.xyz = r6.yzw * r6.xxx + r2.zzz;
    r5.zw = r2.xy * r5.zw + 0.125;
    ps = r5.x * r5.x;
