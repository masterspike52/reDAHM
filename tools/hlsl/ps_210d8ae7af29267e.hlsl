// ps_210d8ae7af29267e.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 282 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000468 10040E00 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.y = ps;
    ps = r2.y + r2.y;
    r0.x = dot(r11.xww, float3(1.0, 1.0, 1.0));
    r0.z = ps;
    r5.z = (r0.x == 0.0) ? r14.x : r14.y;
    r0 = r0.xzxy + float4(-3.0, -1.0, -2.0, -1.0);
    ps = r0.w;
    r6.xyw = r6.xyz * UniformVector_4.xyz;
    r5.z = (r0.z == 0.0) ? r14.z : r5.z;
    r10.x = (r0.x == 0.0) ? r14.w : r5.z;
    ps = r3.y + ps;
    r5.z = max(r10.x, 0.0);
    r0.x = ps;
    ps = r0.y;
