...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.y = max(UniformScalar_0.x, 0.0001);
    r5.x = ps;
    r5.xy = r5.xy * abs(r7.xy);
    r6.xz = r6.xz * r4.xy + ScreenPositionScaleBias.wz;
    r7.xyz = tex2D(LightAttenuationTexture, r6.xz).xyz;
    r9 = tex2D(Texture2D_0, r0.xy);
    r5.xy = tex2D(ModShadowAccumTexture, r5.xy).xy;
    r5.w = dot(r1.zxy, r1.zxy);
    ps = rsqrt(abs(r5.w));
    r1.w = saturate(-r5.z + 1.0);
    r6.z = ps;
    ps = rsqrt(abs(r5.z));
    r5.w = saturate(r6.z * r1.z);
    r0.w = ps;
    ps = r1.z;
    ...
    r10.x = ps;
    ps = 0.875 * r5.y;
    r4.xyz = r9.www * UniformVector_1.xyz;
    r10.y = ps;
    ps = 5.0 * r5.z;
    ...
    r6.w = saturate(dot(r9.yzx, r6.zwx));
    r6.z = ps;
