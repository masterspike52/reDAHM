// ps_79934ae7d4bee72c.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 123 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001EC 10040800 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.zw = r7.yy * ScreenPositionScaleBias.xy;
    ...
    ps = 1.0 - r6.x;
    r6.w = saturate(dot(r8.zxy, r6.wyz));
    r6.x = ps;
    ...
    r5.xyz = tex2D(Texture2D_2, r6.xx).xyz;
    ...
    r7.x = ps;
    r5.xyz = r7.xxx * r2.zxy;
    r0.yz = -r8.xy;
    r0.x = r8.z * 2.0 - r8.z;
    r0.x = saturate(dot(r5.yzx, r0.yzx));
    ps = log2(r0.x);
