// vs_7f3c83a9f84589c3.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 156 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000040 00000270 0051000A 00000000 00000000 000058C6 00000001 00000005 00000006 00000290 00100006 00006007 00007008 00003009 0031A00A 00007054 0001F155 00027256 0003F357 0004F4A0 0005F5A2 0000102E 0000102F 00001030 00001032 00001031 0000102D
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r8.xyz = r2.zyx * 0.007843138 - 1.0;
    r2 = r3.wwww * LocalToWorld[3];
    r2 = r3.zzzz * LocalToWorld[2] + r2;
    r2 = r3.yyyy * LocalToWorld[1] + r2;
    r9 = r3.xxxx * LocalToWorld[0] + r2;
    r4.xyw = -r9.zyx * CameraPosition.www + CameraPosition.zyx;
    ...
    r9.xyz = r4.www * WorldToLocal[0].xzy + r4.xzy;
    r4.x = dot(r8.xzy, r9.yxz);
    r4.y = dot(r1.zyw, r9.yxz);
    r4.z = dot(r7.zyx, r9.yxz);
    r1.x = dot(r8.xzy, r6.zxy);
    r1.y = dot(r1.zyw, r6.zxy);
    ...
    o5.yzw = 0.0;
    o0.xyz = r1.xyz;
    o1.xyz = r2.xyz * LightPositionAndInvRadius.www;
    o1.w = 0.0;
    o2.xyz = r4.xyz;
    o4 = r0;
    o3 = r5;
