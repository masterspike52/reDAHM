// ps_1088bcbbfbb662e6.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 315 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004EC 10041000 0000080A 00000000 00008108 001F00FF 00000001 0000F050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A1 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 / r2.w;
    r7.z = UniformScalar_12.x * 1.09;
    r7.x = ps;
    ps = 1.0 / ModShadowAccumResolution.y;
    r4.zw = r7.xx * ScreenPositionScaleBias.xy;
    r4.y = ps;
    ps = 1.0 / ModShadowAccumResolution.x;
    r16.xyz = UniformVector_4.xyz * UniformVector_4.xyz;
    r4.x = ps;
    r9 = r4 * abs(r8.xyxy);
    r7.xy = r9.zw + ScreenPositionScaleBias.wz;
    r9.zw = r7.xy * 0.5;
    r7.xy = r9.wz + 0.5;
    r8.xy = r7.zz * r7.yx + UniformVector_6.xy;
    r4 = r7.yxyx * float4(1.09, 1.09, 1.0, 1.0);
    r8.zw = r4.xy * UniformScalar_12.xx + UniformVector_6.xy;
    r7.zw = r4.zw * UniformScalar_12.xx + UniformVector_7.xy;
    r4.xyz = tex2D(Texture2D_3, r0.xy).xyz;
    r10.zw = tex2D(ModShadowAccumTexture, r9.xy).xy;
    r7.w = tex2D(Texture2D_2, r7.zw).x;
    r9.x = tex2D(Texture2D_1, r8.zw).x;
    r9.y = tex2D(Texture2D_1, r8.xy).x;
    r11.yzw = tex2D(Texture2D_0, r0.xy).xyz;
    r12 = r5.yxzw * 2.0 - 1.0;
    r6.xyz = r6.xyz * 2.0 - 1.0;
    r5.x = dot(r1.zxy, r1.zxy);
    ps = rsqrt(abs(r5.x));
    r11.x = UniformScalar_19.x * 0.5;
    r5.x = ps;
    r1.w = r5.x * r1.z;
    r8.xyz = UniformVector_2.xyz * UniformScalar_1.xxx;
    r0.xyz = UniformVector_1.xzy * UniformScalar_0.xxx;
    r6.w = dot(r3.zxy, r3.zxy);
    r5.xyz = r11.yzw + r11.yzw;
    r5.w = dot(r6.zxy, r6.zxy);
    r7.z = dot(r12.zyx, r12.zyx);
    ps = rsqrt(abs(r7.z));
    r11.zw = r7.ww + r9.xy;
    r7.z = ps;
    ps = rsqrt(abs(r5.w));
    ...
    r1.xyz = r6.xzy * r12.www;
    r6.x = dot(r1.yxz, r1.yxz);
    ps = rsqrt(abs(r6.x));
    r5.w = r7.y * 20.000013;
    r6.x = ps;
    r15.xyz = r1.xzy * r6.xxx;
    ...
    r12.xyz = r5.xyz + r3.xyz;
    ps = 0.5 + ps;
    r6 = r12 * float4(0.8944272, -0.4472136, -0.5, 6.2831855);
    r9.x = ps;
    ps = r6.x + r6.y;
    r7.zw = r6.zw + float2(0.5, -3.1415927);
    r11.y = saturate(ps);
    ps = sin(r7.w);
    r5.xyz = r11.xxy * r11.zwy;
    r9.y = ps;
    ...
    r6.xy = saturate(r3.xy * r5.ww);
    r9.z = saturate(ps);
    r6.xy = r6.xy * r3.zz + UniformScalar_25.xx;
    r6.xy = r6.zw * UniformScalar_6.xx + r6.xy;
    ps = r5.z;
    r1.xz = r6.xy * 1.0000007;
    ps = r11.y * ps;
    r5.xyz = r1.wxz + float3(0.1, 0.5, 0.5);
    r7.w = ps;
    ps = 5.0 * r5.x;
    r6.xy = frac(r5.yz);
    r1.x = saturate(ps);
    ...
    r5.y = ps;
    ps = 0.5 + r5.y;
    r7.xyz = r1.xzy * r7.zzz;
    r1.x = ps;
    ps = 0.5 + r6.y;
    r5.w = float((r5.w >= 0.004));
    r1.y = ps;
    r5.xy = r6.zw * r5.xz + 0.125;
    r6.xw = r1.xy * UniformScalar_27.xx + UniformScalar_26.xx;
    ps = r5.x * r5.y;
    r1.xyz = UniformVector_5.xyz * UniformVector_5.www;
    r5.x = ps;
    r1.xyz = r1.xyz * r6.xxx + r7.www;
    r5.xyz = r5.xxx * r3.xyz + ModShadowColor.xyz;
    r1.xyz = r8.xyz * r1.xyz + r0.xzy;
    r1.xyz = r1.xyz * r4.xyz - r0.xzy;
    r6.xyz = r1.xyz * 0.8 + r0.xzy;
