// ps_d7d75007cf310fd4.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 135 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000021C 10040B00 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.yzw = tex2D(Texture2D_4, r1.xy).xyz;
    r1.xyz = tex2D(Texture2D_0, r1.xy).xyz;
    r0.xw = tex2D(ModShadowAccumTexture, r7.xy).xy;
    ...
    r6.x = ps;
    r0.xz = -r7.ww * ModShadowGroupColor.xy + 1.0;
    r0.zw = r9.xy * r0.xz + 0.125;
    ...
    r0.x = ps;
    ps = log2(r6.x);
    r7.w = saturate(dot(r4.zxy, r2.zxy));
    r0.z = ps;
    r0.xw = r0.yx * r0.yz;
    ps = pow(2.0, r0.w);
