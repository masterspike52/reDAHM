...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.w = -r7.w + 1.0;
    r6.z = ps;
    r0.xy = -r7.ww * ModShadowGroupColor.xy + 1.0;
    ps = 0.875 * r6.x;
    r2.xyz = r6.www * r8.xyz;
    r8.x = ps;
    ps = 0.875 * r6.y;
    r7.w = saturate(dot(r2.zxy, r3.zxy));
    r8.y = ps;
    r0.xy = r8.xy * r0.xy + 0.125;
    r6.x = dot(r2.zxy, r4.zxy);
    r6.xyw = r2.xzy * r6.xxx;
    r2.xyz = r6.xyw * 2.0 - r4.xzy;
    r0.xy = r0.xz * r0.yz;
    r6.xyw = r0.xxx * r9.xyz + ModShadowColor.xyz;
    ps = LightColorAndFalloffExponent.w * r6.z;
    r0.x = saturate(dot(r3.zxy, r2.yxz));
    r6.z = ps;
    ps = log2(r0.x);
    r7.xyz = r0.yyy * r7.xyz;
    r5.w = ps;
    ps = pow(2.0, r6.z);
    r2 = r5 * float4(3.5, 3.5, 3.5, 15.0);
    r6.z = ps;
    ps = pow(2.0, r2.w);
    r0.xyz = r7.xzy * r6.zzz;
    r6.z = ps;
