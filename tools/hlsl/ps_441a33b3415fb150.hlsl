...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.xy = r7.xy * 0.875;
    r0.w = rsqrt(abs(r6.x));
    r9.xyz = r6.yzw * r9.xyz - r6.yzw;
    r0.xyz = r11.xyz * r2.www;
    r1.w = saturate(1.0 - r5.x);
    ps = rsqrt(abs(r5.z));
    ...
    r5.z = ps;
    ps = log2(r1.w);
    r5.w = saturate(r6.x * r1.z);
    r5.x = ps;
    r2.xyz = r9.xyz * UniformScalar_0.xxx + r6.yzw;
    ...
    r1 = r10.xzwy * r2.xzzy;
    r3.z = ps;
    r2.xy = r10.ww * r2.xy + r1.xw;
    r7.xy = r7.xy * r5.xz + 0.125;
    ps = pow(2.0, r5.y);
    r5.x = saturate(dot(r9.yzx, r3.yzx));
    r5.y = ps;
    ps = log2(r5.x);
