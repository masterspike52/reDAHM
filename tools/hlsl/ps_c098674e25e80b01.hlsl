...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.xyz = tex2D(Texture2D_0, r0.xy).yxz;
    r5.xyz = r4.yxz * UniformVector_1.xyz;
    r0.xyz = -r5.xyz + r4.yxz;
    r4.y = 3e+01 * r4.y;
    r4.xzw = r0.xyz * UniformScalar_4.xxx + r5.xyz;
