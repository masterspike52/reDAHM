// ps_aa19317de3cc66b1.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 135 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000021C 10040900 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = rsqrt(abs(r5.w));
    r0.w = dot(r1.zxy, r2.zxy);
    r5.w = ps;
    r1.xyz = r5.www * r9.xyz;
    r6.w = saturate(dot(r1.zxy, r3.zxy));
    r5.w = dot(r1.zxy, r8.zxy);
    r1.xyz = r1.xzy * r5.www;
    r1.xyz = r1.xyz * 2.0 - r8.xzy;
    r5.w = saturate(dot(r3.zxy, r1.yxz));
    ps = log2(r5.w);
    r1.x = r0.w - SpotAngles.x;
    r5.w = ps;
    ps = LightColorAndFalloffExponent.w * r5.x;
    r0.w = r5.w * 15.0;
    r5.w = ps;
    ps = pow(2.0, r0.w);
    r5.x = saturate(r1.x * SpotAngles.y);
    r7.z = ps;
    ps = pow(2.0, r5.w);
    r2.xyz = r7.xyz * float3(0.875, 0.875, 0.21952);
    r5.w = ps;
    r1.xyz = r4.xyz * r6.www + r2.zzz;
    r5.yz = r2.xy * r5.yz + 0.125;
    ps = r5.x * r5.x;
