...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.yz = tex2D(ModShadowAccumTexture, r3.xy).xy;
    r5.xyz = tex2D(Texture2D_2, r0.zw).xyz;
    r7.xyz = tex2D(Texture2D_3, r7.xy).xyz;
    r9.xyz = tex2D(Texture2D_0, r0.zw).xyz;
    ...
    r7.w = ps;
    ps = rsqrt(abs(r6.z));
    r8.xyz = r7.www * r2.xyz;
    r6.z = ps;
    ps = 5.0 * r6.x;
    r2.yzw = r6.zzz * r4.xyz;
    r6.x = saturate(ps);
    ps = rsqrt(abs(r6.y));
    r6.x = -r6.x + 1.0;
    r6.z = ps;
    ...
    ps = 1.0 + ps;
    r6.z = dot(r4.zxy, r2.wyz);
    r2.x = ps;
    ps = -UniformVector_0.y;
    r9.xyz = r4.xzy * r6.zzz;
    r2.yzw = r9.xyz * 2.0 - r2.ywz;
    ps = 1.0 + ps;
    r7.w = saturate(dot(r8.zxy, r2.zyw));
    r2.y = ps;
    ps = log2(r7.w);
    r6.z = saturate(dot(r4.zxy, r8.zxy));
    r7.w = ps;
    ps = -UniformVector_0.z;
    r7 = r7 * float4(1.5, 1.5, 1.5, 15.0);
    ps = 1.0 + ps;
