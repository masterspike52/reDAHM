// ps_b75ddae05d21ab7d.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 165 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000294 10040C00 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.yzw = tex2D(Texture2D_1, r1.xy).xyz;
    ...
    r7.y = ps;
    ps = 0.875 * r6.x;
    r12.xyz = r8.zxy + float3(-2.0, 0.0, 0.0);
    r1.x = ps;
    ps = rsqrt(abs(r1.y));
    ...
    r1.y = ps;
    ps = 5.0 * r6.y;
    r8.xyz = r12.yzx + r8.xyz;
    r6.x = saturate(ps);
    r6.yzw = (-abs(r6.www) >= 0.0) ? r10.xyz : r11.xyz;
    r2.xyz = (-abs(r7.zzz) >= 0.0) ? r10.xyz : r6.yzw;
    ps = 1.0 - r6.x;
    r6.yzw = r8.xyz + float3(-1.0, -1.0, 0.0);
    r6.x = ps;
    r7.zw = -r6.xx * ModShadowGroupColor.xy + 1.0;
    r1.xy = r1.xy * r7.zw + 0.125;
    ps = -ModShadowColor.z;
    r6.xyz = r6.wyz * UniformScalar_0.xxx;
    ps = 1.0 + ps;
    r2.xyz = r2.xyz - r0.yzw;
    r7.z = ps;
    r0.yzw = r2.xyz * UniformScalar_0.xxx + r0.yzw;
    ps = 1.0 + r6.x;
    r7.w = r1.x * r1.y;
    r6.w = ps;
    r7.xyz = r7.www * r7.xyz + ModShadowColor.xyz;
    r2.xyz = r0.yzw * UniformScalar_2.xxx + UniformScalar_3.xxx;
    r7.w = dot(r6.wyz, r6.wyz);
    ps = rsqrt(abs(r7.w));
    r1.xyz = r0.yzw * r9.xyz;
    r7.w = ps;
    ...
    ps = max(r0.y, r0.z);
    r6.x = saturate(dot(r5.zxy, r4.yxz));
    r0.y = ps;
    ps = log2(r6.x);
    r6.w = saturate(dot(r6.wyz, r5.zxy));
    r0.z = ps;
    r6.xy = r0.xy * r0.xz;
    ps = pow(2.0, r6.y);
