// ps_3e796b8195472de4.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 132 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000210 10040900 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.xy = tex2D(ModShadowAccumTexture, r6.yz).xy;
    r6.yzw = tex2D(Texture2D_2, r1.xy).xyz;
    ps = rsqrt(abs(r6.x));
    r7.z = saturate(-r7.w + 1.0);
    r2.w = ps;
    r0.z = saturate(r2.w * r2.z);
    ps = r2.z;
    ...
    r6.x = saturate(ps);
    ps = 1.0 - r6.x;
    r0.xyw = r0.xyw * r6.yzw;
    r7.x = ps;
    ps = rsqrt(abs(r1.w));
    r9.xyz = r2.www * r2.zxy;
    r6.x = ps;
    ps = rsqrt(abs(r7.w));
    r2.xyz = r6.xxx * r4.zxy;
    r6.x = ps;
    ps = log2(r7.z);
    r4.xyz = r6.xxx * -SpotDirection.xyz;
    r6.x = ps;
    r7.zw = -r7.xx * ModShadowGroupColor.xy + 1.0;
    ...
    r8.z = ps;
    r2.xyz = r8.xyz * float3(0.875, 0.875, 15.0);
    r7.zw = r2.xy * r7.zw + 0.125;
    ps = pow(2.0, r2.z);
    r7.x = saturate(r7.x * SpotAngles.y);
    r1.w = ps;
    r6.yzw = r1.www * r6.yzw;
