...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.z = ps;
    r1.yzw = r0.zzz * -SpotDirection.xyz;
    ps = 1.0 - r0.x;
    ...
    ps = rsqrt(abs(r1.x));
    r0.y = dot(r1.wyz, r2.zxy);
    r1.x = ps;
    r2.xyz = r10.xyz * r1.xxx;
    r1.w = saturate(dot(r2.zxy, r3.zxy));
    r1.x = dot(r2.zxy, r9.zxy);
