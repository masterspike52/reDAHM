...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.xyz = texCUBE(TextureCube_0, xe_cube_dir(r3.xyz)).xyz;
    r10.yzw = tex2D(Texture2D_2, r0.xy).xyz;
    ...
    ps = rsqrt(abs(r6.y));
    r3.xyz = r3.xyz * AmbientColorAndSkyFactor.xyz;
    r6.y = ps;
    ...
    r5.z = saturate(dot(r6.wyz, r8.zxy));
    r0.w = ps;
    ...
    r4 = r10.yzwx * float4(3e+01, 3e+01, 3e+01, 15.0);
    r1.x = ps;
    r3.xyz = r1.yzw * UpperSkyColor.xzy + r3.xzy;
