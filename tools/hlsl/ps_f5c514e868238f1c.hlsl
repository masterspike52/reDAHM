// ps_f5c514e868238f1c.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 21 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000054 10000400 00000008 00000000 00004CA5 0007001F 00000001 0000F055 00007156 0000F257 0000F3A0 0000F4A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.z = UniformVector_0.y + 1.0;
    r3.xy = r2.ww * UniformVector_0.xz;
    r3.z = r3.z * r2.w;
    ps = OpacityOverride.x;
    r3.xyz = r3.xzy + r2.xyz;
    ps = 0.5 * ps;
