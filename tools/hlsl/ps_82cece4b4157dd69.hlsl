// ps_82cece4b4157dd69.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 72 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000120 10040600 0000060A 00000000 000058C6 000F003F 00000001 00007054 0000F155 00007256 0000F357 0000F4A0 0000F5A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.xy = r4.xx * ScreenPositionScaleBias.xy;
    r4.y = ps;
    ...
    r3.xyz = tex2D(LightAttenuationTexture, r2.xy).xyz;
    r4.xz = tex2D(ModShadowAccumTexture, r4.xy).xy;
    r2.xyz = -ModShadowColor.xyz + 1.0;
    ps = r0.z;
    r5.yzw = r5.xyz * 0.21952;
    ps = 0.1 + ps;
    r1.xyz = r3.xyz * r1.www;
    r4.y = ps;
    ps = rsqrt(abs(r4.w));
    r4.y = saturate(r4.y * 5.0);
    r4.w = ps;
    ps = 1.0 - r4.y;
    r5.x = saturate(r4.w * r0.z);
    r4.y = ps;
