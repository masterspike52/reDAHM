// ps_4d0f1300c2a8ebec.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 342 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000558 10041000 00000606 00000000 000050C6 003F003F 00000021 00003050 00003151 0000F254 0000F356 0000F457 0000F558
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r12.xyz = tex2D(Texture2D_5, r9.xy).xyz;
    r8.xyw = tex2D(Texture2D_7, r1.zw).xyz;
    ...
    r15.yzw = tex2D(Texture2D_3, r7.xy).xyw;
    ...
    r0.x = ps;
    r6.yzw = r16.yzw * UniformScalar_5.xxx + UniformScalar_6.xxx;
    ps = 2.5 * r0.x;
