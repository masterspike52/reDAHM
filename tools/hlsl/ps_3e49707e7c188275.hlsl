// ps_3e49707e7c188275.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 102 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000198 10040700 00000606 00000000 000050C6 003F003F 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.xy = tex2D(ModShadowAccumTexture, r0.xy).xy;
    ...
    r1.w = ps;
    ps = 5.0 * r0.x;
    r5.xyz = r7.xyz * UniformVector_1.xyz;
    r0.x = saturate(ps);
    ps = rsqrt(abs(r4.w));
    r7.xyz = r1.www * r2.zxy;
    r3.x = ps;
    ps = 1.0 - r0.x;
    ...
    r4.yz = -r4.yz;
    r4.x = r4.x * 2.0 - r4.x;
    r0.x = saturate(dot(r7.yzx, r4.yzx));
    ps = log2(r0.x);
    ...
    r6.z = ps;
    ps = pow(2.0, r0.x);
    r4.xyz = r6.xyz * float3(0.875, 0.875, 0.21952);
    r0.x = ps;
    r2.xyz = r5.xyz * r1.www + r4.zzz;
