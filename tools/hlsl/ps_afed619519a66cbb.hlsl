// ps_afed619519a66cbb.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 18 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000048 10000500 00000008 00000000 00004CC6 000F003F 00000021 00003050 00003151 0000F256 00007357 0000F4A0 0000F5A1
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.y = tex2D(Texture2D_6, r0.xy).w;
    r4.x = (-0.5) + r4.y;
