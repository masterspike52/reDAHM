// ps_6bdbd30bc347a319.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 126 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001F8 10040900 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6 = tex2D(Texture2D_1, r1.xy).xwzy;
    ...
    ps = rsqrt(abs(r7.x));
    r0.x = saturate(r7.y * 5.0);
    r7.x = ps;
    ps = -UniformVector_0.x;
    r7.xyz = r7.xxx * r2.xyz;
    ps = 1.0 + ps;
    r7.w = dot(r1.wyz, r1.wyz);
    r1.x = ps;
    ps = rsqrt(abs(r0.y));
    r0.x = -r0.x + 1.0;
    r0.w = ps;
    ...
    r8.xyz = r2.xzy * r7.www;
    r4.xyz = r8.xyz * 2.0 - r4.xzy;
    ps = 1.0 + ps;
    r7.w = saturate(dot(r7.zxy, r4.yxz));
    r1.z = ps;
    ps = log2(r7.w);
    r1.xyz = r1.xyz * r6.xwz;
    r5.x = ps;
    r6.xzw = r5.xyz * float3(15.0, 0.875, 0.875);
    r0.xy = r6.zw * r0.xy + 0.125;
    ps = pow(2.0, r6.x);
    r7.x = saturate(dot(r2.zxy, r7.zxy));
    r7.z = ps;
    ps = r7.z;
    r7.xyw = r1.xyz * r7.xxx;
    ps = r6.y * ps;
    r6.xw = r0.xz * r0.yz;
    r7.z = ps;
