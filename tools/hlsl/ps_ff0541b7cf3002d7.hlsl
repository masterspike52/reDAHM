// ps_ff0541b7cf3002d7.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 141 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000234 10040B00 0000070A 00000000 000070E7 001F007F 00000001 0000F050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r10.yw = tex2D(ModShadowAccumTexture, r5.xw).xy;
    ...
    r1.z = ps;
    r5.xyz = r4.xzy * r7.xyz + r3.xzy;
    r5.xyz = r1.xzy * r0.xzy + r5.xzy;
    ps = -r2.w;
