...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.xy = r0.yx - 0.5;
    r0.y = dot(r1.xy, float2(0.0007963267, 0.9999997)) + 0.5;
    r0.x = dot(r1.xy, float2(-0.9999997, 0.0007963267)) + 0.5;
    r1.xyz = tex2D(Texture2D_0, r0.zw).zxy;
    ...
    r1.w = ps;
    ps = r1.x;
    r0.xyz = r1.yzw + UniformVector_0.xyz;
    ps = r3.w * ps;
