// ps_0c2e1e3edf9100df.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 294 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000498 10041200 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.w = ps;
    r9.xy = r8.xy * r3.ww + ScreenPositionScaleBias.wz;
    r12.zw = r5.xy * 2.0 - 1.0;
    ps = rsqrt(abs(r5.w));
    r12.y = saturate(r1.w * 0.00022222222);
    r5.w = ps;
    ps = -r0.z;
    r8.xyz = r5.www * r3.xyz;
    ps = 1.0 + ps;
    r16.xyz = r12.yzw * float3(-0.025, 0.5, 0.5);
    r5.x = ps;
    ...
    r9.zw = tex2D(ModShadowAccumTexture, r9.zw).xy;
    r15 = tex2D(Texture2D_1, r10.xy);
    r3.xyw = tex2D(Texture2D_0, r3.xy).xyz;
    r10.xyz = tex2D(Texture2D_3, r0.xy).xyz;
    r14.xyz = tex2D(LightAttenuationTexture, r9.xy).xyz;
    ...
    r5.x = ps;
    r7.xyz = r6.xyz * UniformScalar_1.xxx + UniformScalar_2.xxx;
    ...
    r1.y = ps;
    ps = r17.y + r17.y;
    r1.x = dot(r18.xyy, float3(1.0, 1.0, 1.0));
    r1.z = ps;
    r5.x = (r1.x == 0.0) ? r15.x : r15.y;
    r2 = r1.yzxx + float4(-1.0, -1.0, -3.0, -2.0);
    ps = 5.0 * r5.y;
    r2.xy = r2.xy + r16.yz;
    r1.y = saturate(ps);
    r5.x = (r2.w == 0.0) ? r15.z : r5.x;
    r1.x = (r2.z == 0.0) ? r15.w : r5.x;
