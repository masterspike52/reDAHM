// ps_ba7e8a724961c15f.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 132 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000210 10040B00 0000080A 00000000 00007908 003F00FF 00000001 00003050 0000F151 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r11.xyz = tex2D(LightMapTexture, r0.xy).xyz;
    ...
    r2.z = ps;
    ps = 1.0 - r6.x;
    r1.xyz = r11.xyz * LightMapScale.xyz;
    r7.w = ps;
    ps = rsqrt(abs(r0.w));
    r6.y = saturate(dot(r10.xyw, r2.yzx));
    r6.x = ps;
    ps = log2(r6.y);
    r10.xy = r7.ww * ModShadowGroupColor.xy;
    r6.y = ps;
    ps = 15.0 * r6.y;
