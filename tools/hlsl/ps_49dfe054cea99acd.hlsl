// ps_49dfe054cea99acd.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 108 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001B0 10040A00 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r10.x = r5.x * r3.z;
    r5.xy = r10.xy + r10.xz;
    r5.z = r5.x * TwoSidedSign.x - r9.z;
    r5.x = saturate(r7.z * r5.z + r5.y);
    ps = log2(r5.x);
