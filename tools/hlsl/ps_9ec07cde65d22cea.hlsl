...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.x = ps;
    ps = rsqrt(abs(r5.y));
    r8.x = max(r0.x, 0.0001);
    r5.y = ps;
    ps = rsqrt(abs(r6.w));
    r7.xyz = r7.xyz * r8.yzw;
    r6.w = ps;
    ps = rsqrt(abs(r5.z));
    r8.yzw = r5.yyy * r3.xyz;
    r5.y = ps;
    ps = r6.w;
    r3.yzw = r5.yyy * -SpotDirection.xyz;
    ps = r1.x * ps;
    ...
    r5.y = -r5.x + 1.0;
    r5.x = ps;
    r0.xy = -r5.yy * ModShadowGroupColor.xy + 1.0;
    ps = rsqrt(abs(r5.z));
