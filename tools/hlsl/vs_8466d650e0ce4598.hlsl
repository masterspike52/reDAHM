// vs_8466d650e0ce4598.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 1050 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000080 00001068 0061000D 00000000 00000000 000068E7 00000001 00000007 00000007 00000290 0010002A 0000602B 0000702C 0000302D 0001A02E 0000502F 00215030 0000F050 00017154 0002F255 00037356 0004F457 0005F5A0 0006F6A2 0000115B 00001156 00001157 00001158 0000115C 00001159 0000115A
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r0 = r9.xxxx * LocalToWorld[0].zyxw + r0.yzxw;
    // UNHANDLED control flow: cjmp
    ps = 1.0 / BBox_Size.x;
    ...
    r8.x = dot(r6.xzy, r0.zxy);
    r8.y = dot(r5.yxz, r0.zxy);
    r8.z = dot(r2.zyx, r0.zxy);
    p0 = (-SP_DemolitionSpread.x >= 0.0);
    ps = p0 ? 0.0 : 1.0;
    // UNHANDLED control flow: cjmp
    r0 = r9.wwww * LocalToWorld[3].xwzy;
    ...
    r2.x = ps;
    ps = 1.0;
    r10.x = saturate(floor(r2.y));
    r2.y = ps;
    p0 = (r6.z != 0.0);
    ps = p0 ? 0.0 : 1.0;
    r10.z = saturate(r0.y * r0.w);
    if (p0)
    {
        if (p0)
        {
    ...
    ps = r9.z;
    r5.y = ps;
    r0.z = float((r9.z >= r5.w));
    r2.y = -r6.y * r10.y + r5.y;
    ps = (-abs(r0.x) > 0.0) ? 1.0 : 0.0;
    r0.xy = -r5.yw + r2.ww;
    r10.y = ps;
    p0 = (r6.z != 0.0);
    ps = p0 ? 0.0 : 1.0;
    r13.xy = float2((r5.wy >= r2.yw));
    r0.xy = r6.xx * r8.ww + r0.xy;
    r0.xy = r0.xy * SP_DemolitionSpread.xx + r5.yw;
    r0.x = (r13.y == 0.0) ? r5.y : r0.x;
    ...
    oPos = r0;
    o1.xyz = r8.xyz;
    o2.xyz = r11.xyz * LightPositionAndInvRadius.www;
    o2.w = 0.0;
    o3.xyz = r4.yzw;
    o5 = r12;
    o6 = r1.xzyw;
