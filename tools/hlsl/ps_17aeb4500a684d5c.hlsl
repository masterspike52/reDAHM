// ps_17aeb4500a684d5c.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 174 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000002B8 10040B00 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.x = tex2D(Texture2D_0, r1.xy).w;
    ps = r2.z;
    ...
    r6.yz = r7.yz * r6.yz;
    r6.w = ps;
    r4.xzw = r6.wyz + float3(-0.015, 0.125, 0.125);
    r11.xy = r8.xy * r4.xx + r1.xy;
    r6.xyz = tex2D(Texture2D_0, r11.xy).xyz;
    ...
    r6.x = ps;
    r7.xzw = r6.yzw * r6.xxx;
    r6.x = dot(r7.wxz, r8.zxy);
    r6.xyz = r7.wxz * r6.xxx;
    r9.xyz = r6.xyz * 2.0 - r8.zxy;
    r6 = xe_cube(r9.yzx);
    ps = 1.0 / abs(r6.z);
    r8.z = r6.w;
    r7.y = ps;
    ...
    r5.xyz = tex2D(Texture2D_1, r11.xy).xyz;
    ...
    r7.w = saturate(dot(r7.wxz, r2.zxy));
    r6.z = ps;
    ps = SpotAngles.y * r6.z;
    r0.xyz = r0.xyz * r5.xxz;
    r7.x = saturate(ps);
    ps = r4.z * r4.w;
    r7.xy = r7.xy * r7.xy;
    r6.y = ps;
    r6.yzw = r6.yyy * r10.xyz + ModShadowColor.xyz;
    ps = LightColorAndFalloffExponent.w * r6.x;
    r1.xyz = r7.yyy * r1.xyz;
    r7.z = ps;
    ps = pow(2.0, r7.z);
    r6.x = saturate(dot(r2.zxy, r9.xyz));
    r7.z = ps;
    ps = log2(r6.x);
    r1.xyz = r1.xyz * r7.zzz;
    r8.x = ps;
    r4.zw = r8.wx * float2(4e+01, 15.0);
    ps = pow(2.0, r4.w);
    r2.xyz = r4.xyz * r5.xyx;
    r7.z = ps;
    r0.xyz = r0.xyz * r7.zzw;
    r0.xyz = r2.xyz * r7.wwz + r0.xyz;
