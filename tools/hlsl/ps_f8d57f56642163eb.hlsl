...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = rsqrt(abs(r6.y));
    r13.xyz = r7.xyz * UniformVector_1.xyz;
    r6.y = ps;
    ps = rsqrt(abs(r6.x));
    ...
    r0.w = ps;
    r5.xyz = r10.xyz * UniformVector_1.xyz + UniformVector_0.xyz;
    r5.xyz = r4.xyz * AmbientColorAndSkyFactor.xyz + r5.xyz;
    ps = rsqrt(abs(r6.w));
    ...
    r6.x = ps;
    ps = 0.5 + r6.x;
    r2.w = saturate(dot(r7.yxz, r10.zxy));
    r8.x = ps;
    ps = 0.5 + r0.x;
    r6.xyw = -r8.yzw + 1.0;
    r8.y = ps;
    ...
    ps = log2(r2.w);
    r7.xy = abs(r8.xy) * abs(r8.xy);
    r6.x = ps;
    ps = 15.0 * r6.x;
    r6.w = float((r6.w >= 0.004));
    r0.x = ps;
    ps = r6.y * r6.z;
    r0.yzw = r4.xzy * r7.yyy;
    r6.x = ps;
    ...
    r7.xyz = r8.xyz * LowerSkyColor.xzy + r5.xzy;
    r7.xyz = r0.xzy * r7.www + r7.xzy;
    r7.xyz = r2.xzy * r4.xzy + r7.xzy;
    ps = -r3.w;
