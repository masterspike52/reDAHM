// ps_0f971c214518c2f2.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 156 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000270 10040C00 0000080A 00000000 00007908 003F00FF 00000001 00003050 0000F151 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = rsqrt(abs(r0.z));
    r12.xyz = r7.xyz * UniformVector_1.xyz;
    r0.x = ps;
    ps = rsqrt(abs(r6.w));
    ...
    r0.w = ps;
    r4.xyz = r10.xyz * UniformVector_1.xyz + UniformVector_0.xyz;
    r4.xyz = r1.xyz * AmbientColorAndSkyFactor.xyz + r4.xyz;
    ps = rsqrt(abs(r6.w));
    r7.xyz = r0.www * r2.xzy;
    r6.w = ps;
    ps = LightMapScale.y * r6.z;
    r2.xyz = r8.yzw * r6.www;
    r8.y = ps;
    ps = 0.1 - -r7.y;
    r11.x = dot(r5.zxy, r2.xyz);
    r6.y = ps;
    ps = 5.0 * r6.y;
    r6.w = dot(r2.xyz, r0.zxy);
    r6.z = saturate(ps);
    ...
    r6.x = ps;
    ps = 0.5 + r6.x;
    r1.w = saturate(dot(r7.yxz, r10.zxy));
    r5.x = ps;
    ps = 0.5 + r0.x;
    r6.xyw = -r5.yzw + 1.0;
    r5.y = ps;
    ...
    r4.xyz = r0.yzw * UpperSkyColor.xzy + r4.xzy;
    ps = pow(2.0, r0.x);
    r5.xyz = r1.xzy * r7.xxx;
    r0.x = ps;
    r0.xyz = r8.xzy * r0.xxx;
    r7.xyz = r5.xzy * LowerSkyColor.xyz + r4.xzy;
    r7.xyz = r0.xyz * r7.www + r7.xzy;
