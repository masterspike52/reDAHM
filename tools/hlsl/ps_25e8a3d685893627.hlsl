// ps_25e8a3d685893627.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 288 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000480 10040F00 0000080A 00000000 00007108 003F00FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = rsqrt(abs(r6.w));
    r10.y = saturate(r7.z * 0.00022222222);
    r6.w = ps;
    ps = -r1.z;
    r9.xyz = r6.www * r4.xyz;
    ps = 1.0 + ps;
    r4.xyz = r10.yzw * float3(-0.025, 0.5, 0.5);
    r6.x = ps;
    ...
    r7.xy = r10.zw + r10.zw;
    r7.w = ps;
    r8.yw = tex2D(ModShadowAccumTexture, r7.zw).xy;
    ...
    r1.xy = r1.wz * UniformVector_6.xy;
    ...
    r14.z = ps;
    r7.z = (r14.x == 0.0) ? r15.x : r15.y;
    r14 = r14.xxyz + float4(-3.0, -2.0, -1.0, -1.0);
    ps = r14.z;
    r7.xyw = r7.xyw * UniformVector_4.xyz;
    r7.z = (r14.y == 0.0) ? r15.z : r7.z;
    r8.z = (r14.x == 0.0) ? r15.w : r7.z;
    ps = r4.y + ps;
    r7.z = max(r8.z, 0.0);
    r0.z = ps;
    ps = r14.w;
    r8.x = min(r7.z, 0.3);
    ps = r4.z + ps;
    r3.xyz = r8.yxw * float3(0.875, 3.3333333, 0.875);
    r0.w = ps;
    r0.zw = r3.yy * r0.zw + r7.xy;
    ps = 1.0 / r5.w;
    r13.xy = r0.zw - r12.xy;
    r7.z = ps;
    r0.zw = r13.zw * r7.zz + ScreenPositionScaleBias.wz;
    r4.xyz = tex2D(LightAttenuationTexture, r0.zw).xyz;
    r0.y = tex2D(ShadowTexture, r0.xy).x;
    r0.xzw = tex2D(Texture2D_4, r10.xy).xyz;
    ...
    r6.x = ps;
    ps = 5.0 * r6.x;
    r14.xyz = r5.xyz * r10.xyz;
    r8.w = saturate(ps);
    r5.xyz = r14.xyz * UniformScalar_3.xxx + UniformScalar_4.xxx;
    ps = -r12.z;
    ...
    r8.yzw = -r8.wzy + 1.0;
    r6.z = ps;
    r10.xyz = r3.yxz * r8.xzy + float3(1.0, 0.125, 0.125);
    ps = abs(r10.x) * abs(r10.x);
    r3.xyz = r6.zzz * r2.xyz;
    r10.w = ps;
    r11.xyz = r14.xyz * r10.xxx - r0.xzw;
    r7.w = saturate(r14.w * r10.x - 0.5);
    r6.xy = r13.xy * r7.ww + r12.xy;
    r6.z = r11.w * r7.w - 2.0;
    r2.xyz = r11.xyz * r7.www + r0.xzw;
    r0.xz = r10.wy * r10.wz;
