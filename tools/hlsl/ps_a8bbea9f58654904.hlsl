// ps_a8bbea9f58654904.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 93 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000174 10040500 00000406 00000000 00003884 000F000F 00000001 00007054 0000F155 00007256 0000F357
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.xy = tex2D(ModShadowAccumTexture, r3.xy).xy;
    ...
    r1.x = saturate(ps);
    ps = rsqrt(abs(r1.z));
    r5.xyz = r1.yyy * r0.zxy;
    r0.x = ps;
    ps = 1.0 - r1.x;
    r2.xyz = r0.xxx * r2.zxy;
    r0.x = ps;
    r1.xz = -r0.xx * ModShadowGroupColor.xy + 1.0;
    r2.yz = -r2.yz;
    r2.x = r2.x * 2.0 - r2.x;
    r0.x = saturate(dot(r5.yzx, r2.yzx));
    ps = log2(r0.x);
    r3.x = r3.x * LightColor.x;
    r0.x = ps;
    ps = 15.0 * r0.x;
    r0.w = ps;
    ps = pow(2.0, r0.w);
    r4.w = saturate(r1.y * r0.z);
    r4.z = ps;
    ps = -UniformVector_0.x;
    r4.xyz = r4.xyz * float3(0.875, 0.875, 0.21952);
    ps = 1.0 + ps;
    r0.xy = r4.zz * r3.yz;
    r1.w = ps;
    ...
    r1.y = ps;
    r3.w = r4.w * r1.w + r4.z;
    r3.yz = r4.xy * r1.xz + 0.125;
    ps = LightColor.z * r0.y;
    r1.xw = r3.xy * r3.wz;
    r1.z = ps;
