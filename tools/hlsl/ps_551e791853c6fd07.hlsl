...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9.xy = r0.xy + UniformVector_2.xy;
    r6.x = ps;
    ps = 1.0 / r4.w;
    ...
    r8.xyz = tex2D(Texture2D_0, r5.zw).xyz;
    r2.xyz = tex2D(LightAttenuationTexture, r5.xy).xyz;
    r6.xyz = tex2D(Texture2D_2, r0.xy).xyz;
    r5.xyz = tex2D(Texture2D_1, r0.xy).xyz;
    r0.xyz = tex2D(Texture2D_0, r9.xy).xyz;
    r7.xyz = r0.xyz * 2.0 - 2.0;
    r0.xyw = r5.xyz * UniformVector_3.xyz;
    ...
    r6.w = ps;
    ps = pow(2.0, r6.w);
    r5.y = saturate(dot(r3.zxy, r1.zxy));
    r4.x = ps;
    r1.xyz = r4.xyz * float3(0.1, 0.875, 0.875);
    r6.xyz = r6.xyz * r5.yyy + r1.xxx;
