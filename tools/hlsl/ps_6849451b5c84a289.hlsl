// ps_6849451b5c84a289.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 111 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001BC 10040900 0000080A 00000000 00007108 003F00FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.xyz = r9.xyz * 0.25;
    ps = r2.z * ps;
    r5.xyz = r6.zzz * -SpotDirection.xyz;
    r6.z = saturate(ps);
    ps = log2(r6.y);
    ...
    r6.x = dot(r5.zxy, r3.zxy);
    r6.y = ps;
    r6.zw = -r6.zz * ModShadowGroupColor.xy + 1.0;
    r7.zw = r7.yz * r6.zw + 0.125;
    ps = pow(2.0, r6.y);
    ...
    r6.xyz = r7.xxx * r4.xyz + ModShadowColor.xyz;
