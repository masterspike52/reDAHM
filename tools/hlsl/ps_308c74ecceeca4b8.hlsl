...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = rsqrt(abs(r6.w));
    r6.xyz = r10.xyz * UniformVector_1.xyz;
    r6.w = ps;
    ps = 0.1 - -r1.z;
    ...
    ps = rsqrt(abs(r6.w));
    r0.yzw = r5.xxx * r3.xyz;
    r5.x = ps;
    r8.xyz = r8.xyz * r5.xxx;
    r5.x = dot(r8.zxy, r0.wyz);
    ps = LightColor.x * r5.y;
    r1.xyz = r8.xzy * r5.xxx;
    r0.x = ps;
    r0.yzw = r1.xyz * 2.0 - r0.ywz;
    ps = LightColor.y * r5.z;
    r5.x = saturate(dot(r7.zxy, r0.zyw));
    r0.y = ps;
    ps = log2(r5.x);
