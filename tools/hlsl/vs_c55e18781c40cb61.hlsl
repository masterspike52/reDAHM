// vs_c55e18781c40cb61.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 576 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000040 00000900 0051000F 00000000 00000000 00004CC6 00000001 00000008 00000006 00000290 00100017 00006018 00007019 0000301A 0000201B 0000101C 0000501D 0021501E 00003050 00013151 0002F256 00037357 0004F4A0 0005F5A1 000010BB 000010BC 000010BA 000010B9 000010BE 000010BD
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r0.x = dot(r12.zxy, r6.zxy);
    r0.y = dot(r12.zxy, r2.zxy);
    r0.z = dot(r12.zxy, r3.zxy);
    a0 = xe_mova(r0.w);
    ps = r0.w;
    r9.w = dot(r14.zxy, r6.zxy);
