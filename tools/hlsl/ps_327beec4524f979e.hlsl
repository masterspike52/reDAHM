...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.xyz = r3.wyz * float3(1.0000007, 1e+01, 1e+01) + float3(0.5, 1e+01, 1e+01);
    ...
    r0.xyz = tex2D(Texture2D_0, r2.yz).xyz;
    r0.xyz = r0.xyz * r1.xyz + UniformVector_0.xyz;
    r1.x = saturate(r2.x * 7e+01 - 2e+01);
    oC0.w = r3.x * r1.x;
