// ps_f4de7d83362a523c.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 117 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001D4 10040900 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.x = saturate(ps);
    ps = rsqrt(abs(r6.y));
    r8.xyz = r7.xxx * r2.zxy;
    r6.y = ps;
    ps = 1.0 - r6.x;
    r3.xyz = r6.yyy * r4.zxy;
    r6.x = ps;
    r6.xy = -r6.xx * ModShadowGroupColor.xy + 1.0;
    r3.yz = -r3.yz;
    r3.x = r3.x * 2.0 - r3.x;
    r6.w = saturate(dot(r8.yzx, r3.yzx));
    ps = log2(r6.w);
    r7.z = saturate(r7.x * r2.z);
    r0.z = ps;
    ps = log2(r6.z);
    r0.xyw = r0.xyz * float3(0.875, 0.875, 15.0);
    r6.z = ps;
    ps = pow(2.0, r0.w);
    r6.w = r6.z * LightColorAndFalloffExponent.w;
    r0.w = ps;
    r7.xy = r0.xy * r6.xy + 0.125;
    ps = r7.x * r7.y;
