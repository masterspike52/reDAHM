// ps_93695d6e87a4b4b2.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 306 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004C8 10041100 0000080A 00000000 00007108 003F00FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.z = saturate(ps);
    r1.xyw = r1.xyz * 2.0 - 1.0;
    r5.xyz = r5.xyw * 2.0 - 1.0;
    ps = rsqrt(abs(r6.y));
    r14.xyz = r8.xyz * r14.xyz;
    r6.y = ps;
    r8.xyz = r14.xyz * UniformScalar_1.xxx + UniformScalar_2.xxx;
