// ps_92c3d00690be5e82.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 186 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000002E8 10040D00 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 / r4.w;
    r8.y = max(UniformScalar_7.x, 0.0001);
    r5.x = ps;
    ...
    r8.xzw = tex2D(Texture2D_2, r0.xy).xyz;
    ...
    r5.y = ps;
    r1.xyz = (-abs(r0.zzz) >= 0.0) ? r13.xyz : r1.xyz;
    ps = log2(r6.w);
    r12.xyz = r5.yyy * -SpotDirection.xyz;
    r5.y = ps;
    r1.xyz = (-abs(r5.www) >= 0.0) ? r13.xyz : r1.xyz;
    ps = 1.0 - r5.x;
    r5.z = dot(r12.zxy, r2.zxy);
    r5.x = ps;
    r2.xyz = r11.xyz * UniformScalar_0.xxx + r10.xyz;
    r5.xw = -r5.xx * ModShadowGroupColor.xy + 1.0;
    r0.xy = r0.xy * r5.xw + 0.125;
    r5.x = dot(r2.zxy, r2.zxy);
    r1.xyz = r1.xyz - r8.xzw;
    r1.xyz = r1.xyz * UniformScalar_0.xxx + r8.xzw;
    ps = rsqrt(abs(r5.x));
    r5.w = r0.x * r0.y;
    r5.x = ps;
    ...
    r8.xzw = r2.xzy * r5.xxx;
    r5.x = ps;
    r3.xyz = r8.xzw * 2.0 - r3.xzy;
    ps = SpotAngles.y * r5.x;
    r5.z = saturate(dot(r7.zxy, r3.yxz));
    r8.x = saturate(ps);
    ps = log2(r5.z);
