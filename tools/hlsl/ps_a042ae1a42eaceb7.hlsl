...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r10.yz = tex2D(ModShadowAccumTexture, r5.xz).xy;
    ...
    ps = rsqrt(abs(r5.y));
    r0.xyz = r6.xyz * AmbientColorAndSkyFactor.xyz;
    r5.y = ps;
    ...
    r5.x = ps;
    ps = 0.5 + r5.x;
    r1.w = saturate(dot(r6.xyz, r4.zxy));
    r3.x = ps;
    ps = 0.5 + r0.x;
    r5.xyw = -r3.yzw + 1.0;
    r3.y = ps;
    ...
    r0.x = ps;
    ps = r5.y * r5.z;
    r3.xyz = r7.xzy * r6.xxx;
    r5.x = ps;
    r5.xyz = r5.xxx * r9.xyz + ModShadowColor.xyz;
    ps = pow(2.0, r0.x);
    r0.yzw = r7.xzy * r6.yyy;
    r0.x = ps;
    r0.yzw = r0.ywz * UpperSkyColor.xyz + r8.xyz;
    r6.xyz = r3.xyz * LowerSkyColor.xzy + r0.ywz;
    r0.xyz = r0.xxx * ConstantLighting.xzy;
    r6.xyz = r0.xzy * r6.www + r6.xzy;
    r6.xyz = r1.xzy * r7.xzy + r6.xzy;
    ps = -r2.w;
