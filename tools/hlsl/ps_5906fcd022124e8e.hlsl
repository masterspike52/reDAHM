// ps_5906fcd022124e8e.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 363 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000005AC 10041400 0000080A 00000000 00007908 003F00FF 00000001 00003050 0000F151 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
float4 LightMapScale : register(c27); // float3
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9.xyw = tex2D(Texture2D_2, r1.xy).yzx;
    r18.xyz = tex2D(Texture2D_3, r1.xy).xyz;
    r6.yzw = tex2D(Texture2D_1, r1.xy).yxz;
    r12.xyz = UniformVector_7.xyz - UniformVector_6.xyz;
    ps = UniformVector_2.x * UniformVector_2.x;
    r20.xyz = UniformVector_3.xyz - UniformVector_4.xyz;
    r0.z = ps;
    ...
    r16.xyz = r18.xyz * UniformScalar_17.xxx;
    r14.w = ps;
    ps = r6.w + r6.w;
    r6.x = dot(r9.ywx, float3(1.0, 1.0, 1.0));
    r13.w = ps;
    ps = 4.0 * r6.z;
    r1.xyz = r10.xyz + r10.xyz;
    r19.z = ps;
    ps = 4.0 * r6.y;
    r6.z = dot(r18.yzx, float3(0.59, 0.11, 0.3));
    r19.w = ps;
    ps = rsqrt(abs(r7.x));
    r14.xyz = r11.xyz + r11.xyz;
    r6.w = ps;
    r11.xyz = r14.xyz * 0.7 + 0.3;
    ps = 5.0 * r6.z;
    r7.x = dot(r18.yxz, float3(0.59, 0.3, 0.11));
    r6.y = ps;
    ps = 1.0 * r6.z;
    r13.xyz = r6.www * r2.xyz;
    r6.w = ps;
    ps = UniformScalar_19.x;
    r19.xy = r6.wy * UniformScalar_15.xx;
    r17.xyz = r19.yyy * r7.yzw + UniformVector_5.xyz;
    ps = r7.x + ps;
    r6.yw = r13.zw + float2(0.1, -1.0);
    r6.z = ps;
    ps = frac(r6.z);
    r7.w = float((r19.x >= 0.2));
    r1.w = ps;
    ps = 5.0 * r6.y;
    r1 = r1 + float4(-1.0, -1.0, -1.0, -0.5);
    r6.z = saturate(ps);
    ps = abs(r1.w) + abs(r1.w);
    r7.xyz = r19.xzw + float3(-0.2, -2.0, -2.0);
    r9.z = ps;
    ps = 1.25 * r7.x;
    r2.w = float((r19.x > 0.2));
    r2.x = ps;
    ps = r6.w;
    r15.xy = -r1.xy - 2.0;
    ps = -r1.z + ps;
    r15.zw = r7.yz - r1.xy;
    r16.w = ps;
    r2.xyz = r2.xxx * r20.xyz + UniformVector_4.xyz;
    r12.xyz = r12.xyz * r9.zzz + UniformVector_6.xyz;
    ps = 1.0 - r6.x;
    r15.xy = r15.xy + r19.zw;
    r7.y = ps;
    ps = 1.0 - r6.z;
    r12.xyz = r12.xyz * UniformScalar_20.xxx;
    r7.z = ps;
    r6.xyz = (r2.www > 0.0) ? r2.xyz : UniformVector_4.xyz;
    ps = UniformScalar_23.x * r7.y;
    r2.xyz = r7.yyy * r18.xyz;
    r10.w = ps;
    r14.xyz = r2.xyz * r14.xyz - r2.xyz;
    r6.yzw = (r7.www > 0.0) ? r6.xyz : r17.xyz;
    r1 = r15 * UniformScalar_0.xxxx + r1.xyxy;
    ps = UniformScalar_16.x * r6.y;
    r12.yzw = r12.xzy * r9.yyy;
    r12.x = ps;
    ps = UniformScalar_16.x * r6.z;
    r15.xyz = r12.yzw * r9.yyy;
    r12.y = ps;
    r9.xyz = r16.xyz * r9.xxx + r15.xzy;
    r18.xyz = r14.xyz * UniformScalar_0.xxx + r2.xyz;
    r6.x = r14.w * UniformScalar_0.x + UniformScalar_21.x;
    ps = UniformScalar_16.x * r6.w;
    r2.yzw = r18.xyz * r6.xxx;
    r12.z = ps;
    r9.xyz = r12.xzy * r9.www + r9.xzy;
    r16.xyz = r11.xzy * r9.xyz - r9.xyz;
    r6.x = r16.w * UniformScalar_0.x - 2.0;
    ps = r1.z;
    r2.x = r6.x + r10.z;
    ps = r7.y * ps;
    r2 = r2.xywz + r10.zwww;
    ...
    r10.z = r10.x * r1.z;
    ps = r6.z * r6.z;
    r14.xyw = r6.yww * r1.xyw;
    r1.x = ps;
    ps = 1.0 / ModShadowAccumResolution.x;
    r1.w = r14.w * r14.w;
    r0.z = ps;
    r1.z = r10.z * r7.x + r1.w;
    r1.y = dot(r10.yz, r7.wx) + 0.0;
    ...
    r6.x = ps;
    r1.xyz = r17.ywz * r6.xxx;
    r6.x = dot(r1.zxy, r15.zxy);
    r6.xyz = r1.xzy * r6.xxx;
    r8.xyz = r6.xzy * 2.0 - r15.xyz;
    r6 = xe_cube(r8.xyz);
    ps = 1.0 / abs(r6.z);
    r4.z = r6.w;
    r1.w = ps;
    r4.xy = r6.yx * r1.ww + 1.5;
    ...
    r10.y = ps;
    ps = rsqrt(abs(r0.w));
    r6.w = dot(r4.zxy, float3(0.11, 0.3, 0.59));
    r0.w = ps;
    ps = max(r10.x, r10.y);
    r5.xyz = r0.www * r5.xyz;
    r12.x = ps;
    ps = LightMapScale.x * r6.y;
    r19.xyz = r6.www - r4.xyz;
    r10.x = ps;
    r4.xyz = r19.xyz * 0.8 + r4.xyz;
    ps = LightMapScale.y * r6.z;
    r0.xyz = r18.xyz * r0.xyz;
    r10.y = ps;
    r9.xyz = r16.xyz * UniformScalar_0.xxx + r9.xyz;
    ps = LightMapScale.z * r6.x;
    r16.xy = r14.xy * r10.zz;
    r10.z = ps;
    ps = ModShadowGroupColor.x * r7.z;
    r16.z = r17.x;
    r14.x = ps;
    ps = ModShadowGroupColor.y * r7.z;
    r6.x = dot(r16.xyz, r15.xyz);
    r14.y = ps;
    ps = r10.x;
    r14.z = max(r6.x, 0.0);
    ps = r1.z * ps;
    r12.w = dot(r5.zxy, r1.zxy);
    r1.x = ps;
    ps = r10.z;
    r6 = -r14.xzyw + 1.0;
    ps = r1.z * ps;
    ...
    r7.xyz = r7.xyz * UniformScalar_4.xxx + r9.xyz;
    ps = r1.z * ps;
