// ps_1ca6e26f21efe8b8.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 75 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000012C 10000400 00000004 00000000 00003484 000F000F 00000001 00003050 0000F155 00007256 0000F357
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.xy = r1.zw + r0.yx;
    r0.z = rsqrt(abs(r0.z));
    r1.w = dot(r4.xy, UniformVector_4.yx) + 0.5;
    r1.z = dot(r4.xy, UniformVector_3.yx) + 0.5;
    r0.zw = r0.zz * r2.xy;
    r2.xy = -r0.zw * 0.4 + 0.5;
    r0.z = -r0.z * 0.5 + 0.5;
