// ps_cac2bc064e53eff7.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 285 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000474 10040E00 0000080A 00000000 00007108 003F00FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 + ps;
    r10.xyz = r3.yzw * float3(-0.025, 0.5, 0.5);
    r6.x = ps;
    ...
    r6.xy = r7.zw + r7.zw;
    r6.w = ps;
    r8.zw = tex2D(ModShadowAccumTexture, r6.zw).xy;
    ...
    r11.z = ps;
    r6.w = (r11.x == 0.0) ? r14.x : r14.y;
    r11 = r11.xxyz + float4(-3.0, -2.0, -1.0, -1.0);
    ps = r11.z;
    r6.xyz = r6.xyz * UniformVector_4.xyz;
    r6.w = (r11.y == 0.0) ? r14.z : r6.w;
    r0.z = (r11.x == 0.0) ? r14.w : r6.w;
    ps = r10.y + ps;
    r6.w = max(r0.z, 0.0);
    r8.x = ps;
    ps = r11.w;
    r8.y = min(r6.w, 0.3);
    ps = r10.z + ps;
    r11.xyz = r8.zyw * float3(0.875, 3.3333333, 0.875);
    r8.y = ps;
    r8.xy = r11.yy * r8.xy + r6.xy;
    ps = 1.0 / r5.w;
    r12.xy = r8.xy - r3.xy;
    r6.w = ps;
    r8.xy = r12.zw * r6.ww + ScreenPositionScaleBias.wz;
    r4.xyz = tex2D(LightAttenuationTexture, r8.xy).xyz;
    r0.y = tex2D(ShadowTexture, r0.xy).x;
    r10.xyz = tex2D(Texture2D_4, r7.xy).xyz;
    r14.xyz = tex2D(Texture2D_6, r1.xy).xyz;
    ...
    r5.xyz = r14.xyz * UniformScalar_1.xxx + UniformScalar_2.xxx;
    ps = 0.1 + ps;
    r13.xyz = r8.xyz * r13.xyz;
    r7.w = ps;
    r8.x = r9.w * r4.w - 1.0;
    ps = rsqrt(abs(r6.w));
    r0.w = saturate(r7.w * 5.0);
    r6.w = ps;
    ps = -r3.w;
    r6.xy = -r0.zw + 1.0;
    ps = r6.z + ps;
    ...
    r8.yzw = -r0.wzx + 1.0;
    r13.w = ps;
    r6.xyz = r11.xyz * r8.zxy + float3(0.125, 1.0, 0.125);
    r11.xyz = r13.xyz * r6.yyy - r10.xyz;
    r7.w = saturate(r13.w * r6.y - 0.5);
    ps = abs(r6.y) * abs(r6.y);
    r6.x = r6.x * r6.z;
    r0.x = ps;
    r7.xyz = r6.xxx * r7.xyz + ModShadowColor.xyz;
    r6.xy = r12.xy * r7.ww + r3.xy;
    r6.z = r11.w * r7.w - 2.0;
