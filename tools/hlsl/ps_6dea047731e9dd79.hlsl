...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.y = tex2D(Texture2D_9, r0.xy).w;
    ps = UniformScalar_9.x - r3.w;
    r2.xz = r0.wz * 3.0;
    r2.w = ps;
    r2.z = tex2D(Texture2D_4, r2.xz).z;
    r2.x = float((UniformScalar_8.x >= 1.0));
    r2.x = r2.w * r2.x + r3.w;
    r2.x = -r2.x + r3.z;
    r2.x = max(r2.x, UniformScalar_10.x);
    ...
    ps = 1.0 - r2.x;
    r2.x = ps;
    r2.z = (UniformScalar_9.x > 0.0) ? r2.x : 1.0;
    r2.x = (UniformScalar_9.x >= 0.0) ? r2.z : r2.x;
    r2.x = r2.x * r2.y - 0.5;
