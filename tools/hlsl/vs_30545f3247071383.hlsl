// vs_30545f3247071383.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 705 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000040 00000B04 00610012 00000000 00000000 000060E7 00000001 00000007 00000007 00000290 0010001C 0000601D 0000701E 0000301F 00002020 00001021 00205022 00003050 00017154 0002F255 00037356 0004F457 0005F5A0 0006F6A1 000010E3 000010E5 000010E6 000010E7 000010E9 000010E8 000010E4
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r12.x = dot(r4.zxy, r1.zxy);
    r12.y = dot(r4.zxy, r5.zxy);
    r12.z = dot(r4.zxy, r0.wyz);
    r0.x = dot(r15.zxy, r5.zxy);
    r0.y = dot(r15.zxy, r0.wyz);
    r0.z = dot(r15.zxy, r1.zxy);
    a0 = xe_mova(r3.w);
    ps = r3.w;
    r11.w = dot(r9.zxy, r5.zxy);
    ...
    r17.x = dot(r15.zxy, r5.zxy);
    r17.y = dot(r15.zxy, r12.zxy);
    r16.z = dot(r4.zxy, r5.zxy);
    r16.w = dot(r4.zxy, r8.zxy);
    r16.x = dot(r4.zxy, r12.zxy);
    ps = WorldToLocal[2].x * r0.w;
    r16.y = dot(r15.zxy, r8.zxy);
    r13.x = ps;
    ps = WorldToLocal[2].z * r0.w;
    r18.x = dot(r9.zxy, r5.zxy);
    r13.y = ps;
    ...
    r1.x = dot(r15.zxy, r5.zxy);
    r1.y = dot(r15.zxy, r13.zxy);
    r1.z = dot(r4.zxy, r5.zxy);
    r1.w = dot(r4.zxy, r12.zxy);
    r3.z = dot(r4.zxy, r13.zxy);
    r3.w = dot(r15.zxy, r12.zxy);
    ps = WorldToLocal[2].x * r0.w;
    ...
    r4.z = ps;
    r4.xyz = r0.yyy * WorldToLocal[1].xzy + r4.xyz;
    r5.xyz = r0.xxx * WorldToLocal[0].xyz + r4.xzy;
    r4.xy = r3.zw * r5.yz;
    r4.w = dot(r1.wz, r5.zx) + 0.0;
    r1.yz = r1.xy * r5.xy;
    ps = r1.y + r1.z;
    r1.x = dot(r15.zxy, r5.zxy);
    r4.z = ps;
    ...
    r5 = r10.yyyy * BoneMatrices[a0 + 1] + r5;
    ...
    r5 = r10.zzzz * BoneMatrices[a0 + 1] + r5;
