...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.zw = r1.ww * ScreenPositionScaleBias.xy;
    r6.y = ps;
    ps = rsqrt(abs(r0.z));
    ...
    r0.z = saturate(ps);
    ps = 1.0 - r0.z;
    r3.z = saturate(dot(r9.zxy, r7.zxy));
    r0.z = ps;
    ...
    r10.xyz = tex2D(Texture2D_2, r5.zz).xyz;
