// ps_daa3d91a9a232c2d.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 69 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000114 10040600 0000060A 00000000 000058C6 000F003F 00000001 00007054 0000F155 00007256 0000F357 0000F4A0 0000F5A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.w = ps;
    ps = 1.0 - r4.y;
    r5.w = saturate(r4.w * r0.z);
    r4.y = ps;
    r4.yw = -r4.yy * ModShadowGroupColor.xy + 1.0;
    ps = 0.875 * r4.x;
    r0.yzw = r2.xyz * r5.www;
    r0.x = ps;
    ps = 0.875 * r4.z;
    r5.xyz = r0.yzw * r5.xyz;
    r0.y = ps;
    r4.xy = r0.xy * r4.yw + 0.125;
    ps = r4.x * r4.y;
    r5.xyz = r5.xyz * LightColor.xyz;
    r4.x = ps;
    r4.xyz = r4.xxx * r1.xyz + ModShadowColor.xyz;
