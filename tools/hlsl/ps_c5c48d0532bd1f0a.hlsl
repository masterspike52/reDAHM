// ps_c5c48d0532bd1f0a.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 123 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001EC 10040700 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.y = ps;
    ps = rsqrt(abs(r5.w));
    r0.xy = r5.yy * ScreenPositionScaleBias.xy;
    r5.y = ps;
    r4.xy = r0.xy * r4.xy + ScreenPositionScaleBias.wz;
    ps = rsqrt(abs(r5.x));
    ...
    ps = 0.1 + ps;
    r0 = r7 * float4(0.70710677, 0.70710677, 0.875, 0.875);
    r5.x = ps;
    ps = 5.0 * r5.x;
    r4.w = r0.x + r0.y;
    r4.z = saturate(ps);
    r0.xy = -r4.zw + 1.0;
    r7.y = float((abs(r0.y) > 0.0345));
    ps = -SpotAngles.x - -r5.y;
    r7.z = float((abs(r0.y) >= 0.0345));
    r5.x = ps;
    ...
    r7.x = saturate(ps);
    r0.zw = r7.xy * r7.xz;
    r7.xyz = r0.xyw + float3(0.125, 0.125, -0.1);
    ps = r7.x * r7.y;
    ...
    r5.xyz = r6.www * r5.yzw + ModShadowColor.xyz;
