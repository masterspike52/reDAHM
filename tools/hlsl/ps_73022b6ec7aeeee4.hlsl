// ps_73022b6ec7aeeee4.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 234 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000003A8 10040D00 0000080A 00000000 00007908 001F00FF 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A1 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r11 = tex2D(Texture2D_3, r0.xy).xwyz;
    ...
    r11.y = tex2D(Texture2D_2, r0.xy).x;
    ...
    r4.z = ps;
    r9.yz = r12.xy * 2.0 - 1.0;
    ps = 5.0 * r5.z;
    r7.w = float((UniformScalar_13.x > 1.0));
    r5.z = saturate(ps);
    r6.xyz = r6.zxy * 2.0 - 1.0;
    r0.xyz = (-abs(r7.www) >= 0.0) ? r13.xyz : 1.0;
    r0.yzw = (-abs(r7.zzz) >= 0.0) ? 1.0 : r0.xyz;
    ps = UniformVector_2.z * r6.x;
    r2.xyz = r4.xyz * r11.xzw;
    r12.w = ps;
    ps = rsqrt(abs(r7.y));
    r5.z = -r5.z + 1.0;
    r7.y = ps;
    ps = ModShadowGroupColor.x * r5.z;
    r4.xyz = r7.yyy * r1.xyz;
    r7.y = ps;
    ...
    ps = 1.0 + ps;
    r5.z = dot(r6.wyz, r3.zxy);
    r6.x = ps;
    ps = 1.0 - r5.x;
    r9.yzw = r6.yzw * r5.zzz;
    r5.z = saturate(ps);
    r3.xyz = r9.yzw * 2.0 - r3.xyz;
    ps = log2(r5.z);
    ...
    r6.w = saturate(dot(r6.wyz, r4.zxy));
    r6.y = ps;
    ps = pow(2.0, r6.y);
    r5.xyw = r5.ywz * float3(0.875, 0.875, 15.0);
    r5.z = ps;
    r9.yz = r5.xy * r7.zw + 0.125;
    ...
    r9.w = (r1.w > 0.0) ? 0.0 : r2.w;
    r6.xyz = -r2.xyz + r10.xyz;
    r6.xyz = r6.xyz * UniformScalar_15.xxx + r2.xyz;
    r0.yzw = r6.xyz * UniformScalar_16.xxx + UniformScalar_17.xxx;
    r6.xy = r9.xy * r9.wz;
    r5.xyz = r6.yyy * r1.xyz + ModShadowColor.xyz;
    ps = pow(2.0, r5.w);
