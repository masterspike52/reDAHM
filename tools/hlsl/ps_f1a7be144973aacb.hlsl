...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.yzw = tex2D(Texture2D_2, r0.xy).xyz;
    ...
    r6.z = ps;
    ps = 0.875 * r6.y;
    r4 = r0.yzyw * float4(5.0, 5.0, 2e+01, 5.0);
    r6.w = ps;
    ...
    r5.w = dot(r3.zxy, r0.zxy);
    r7.xyz = r3.xzy * r5.www;
    r0.xyz = r7.xyz * 2.0 - r0.xzy;
    ps = LightColor.x * r5.y;
    r5.w = saturate(dot(r1.zxy, r0.yxz));
    r0.x = ps;
    ps = log2(r5.w);
    r6.x = max(r4.z, 0.0001);
    r6.w = ps;
