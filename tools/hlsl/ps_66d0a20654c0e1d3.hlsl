...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.x = saturate(ps);
    r8.yzw = r1.xyz * 2.0 - 1.0;
    ps = rsqrt(abs(r6.w));
    r7.w = dot(r0.wyz, float3(0.5, 0.5, 0.5));
    r6.w = ps;
    ps = rsqrt(abs(r6.z));
    ...
    r6.x = saturate(ps);
    ps = 1.0 - r6.x;
    r7.x = dot(r8.wyz, r8.wyz);
    r6.y = ps;
    ps = log2(r0.x);
    r6.zw = r7.ww - r0.yz;
    r6.x = ps;
    r1.xy = r6.zw * 0.5 + r0.yz;
    r6.zw = -r6.yy * ModShadowGroupColor.xy + 1.0;
    ps = rsqrt(abs(r7.x));
    r6.y = dot(r11.zxy, r3.zxy);
    r7.x = ps;
    r3.xyz = r8.yzw * r7.xxx;
    ps = r7.w;
    r7.x = dot(r3.zxy, r4.zxy);
    ps = -r0.w + ps;
    r8.yzw = r3.xzy * r7.xxx;
    r7.w = ps;
    r4.xyz = r8.yzw * 2.0 - r4.xzy;
    ps = -SpotAngles.x - -r6.y;
    r7.x = saturate(dot(r2.zxy, r4.yxz));
    r6.y = ps;
    ps = log2(r7.x);
    r8.y = saturate(r6.y * SpotAngles.y);
    r7.x = ps;
    r7 = r7.yzwx * float4(0.875, 0.875, 0.5, 15.0);
    ps = r7.z;
    r0.x = saturate(dot(r3.zxy, r2.zxy));
    r8.zw = r7.xy * r6.zw + 0.125;
    ps = r0.w + ps;
