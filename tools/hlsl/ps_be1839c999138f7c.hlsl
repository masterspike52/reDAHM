// ps_be1839c999138f7c.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 351 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 0000057C 10041300 0000080A 00000000 00007908 003F00FF 00000021 00003050 0000F151 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r15.yzw = tex2D(Texture2D_4, r1.xy).xyz;
    r4.xyz = tex2D(LightMapTexture, r0.xy).xyz;
    r0 = tex2D(Texture2D_1, r0.zw);
    r10.xyz = tex2D(Texture2D_2, r1.wz).xyw;
    ...
    r14.xyz = r1.xyz * UniformScalar_5.xxx + UniformScalar_6.xxx;
    r16.zw = r18.yz * 2.0 - 1.0;
    ...
    r17.x = ps;
    ps = r1.x * r1.x;
    r17.yzw = r1.yzw * r15.xxx;
    r16.x = ps;
    r1.xyz = r17.yzw * r0.www - r8.xyz;
    r6.x = saturate(r17.x * r0.w - 0.5);
    r1.xyz = r1.xyz * r6.xxx + r8.xyz;
    r8.xyz = r2.yzw * r1.xyz + UniformVector_0.xyz;
    r2.yzw = r16.xyy * r16.xzw;
    r12.xw = r15.zw + r2.zw;
    r2.yzw = r2.yyy * r14.xyz;
