// ps_2df9342002904003.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 234 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000003A8 10040F00 0000070A 00000000 000060E7 001F007F 00000001 00003050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A1
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r14.z = ps;
    r1.w = r5.z * UniformScalar_9.x + UniformScalar_10.x;
    ...
    r5.x = saturate(ps);
    r9.xyz = (-abs(r3.www) >= 0.0) ? UniformVector_4.xyz : r14.xyz;
    r12.xyz = (-abs(r3.www) >= 0.0) ? UniformVector_6.xyz : r15.xyz;
    r12.xyz = (-abs(r0.www) >= 0.0) ? r15.xyz : r12.xyz;
    r14.xyz = (-abs(r0.www) >= 0.0) ? r14.xyz : r9.xyz;
    ps = 1.0 - r5.x;
    ...
    r5.x = ps;
    r3.xyz = r3.xyz * r1.www + UniformVector_2.xyz;
    r2.xyz = r2.xyz * r5.xxx;
    ps = r5.y;
