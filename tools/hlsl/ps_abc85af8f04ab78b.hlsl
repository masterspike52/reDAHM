// ps_abc85af8f04ab78b.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 222 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000378 10040900 00000106 00000001 00001021 00010001 00000001 0000F050
    ...
    for (int xe_iter0 = 0, aL = 0; xe_iter0 < 6; xe_iter0++, aL += 0)
    {
        ...
        if (p0)
        {
            if (p0)
            {
                ...
                r1 = float4((r1 > r0.zzzz));
                r1.x = dot(r1.wzxy, float4(0.041666668, 0.041666668, 0.041666668, 0.041666668));
                ps = 1.0 + r0.x;
                r0.y = r1.x + r0.y;
                r0.x = ps;
            }
