// ps_ce0117d40f55cf92.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 39 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000009C 10000500 00000004 00000000 00004CC6 003F003F 00000021 00003050 00003151 0000F252 0000F353 0000F455 00007556
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.xy = tex2D(Texture2D_1, r0.xy).xy;
    r0.xyz = r0.xyx * float3(4.0, 4.0, 1.0);
    r0.xyz = r0.xzy * UniformVector_1.xxy;
    r1.xy = max(r0.xz, (-255.0));
    r1.xy = min(r1.xy, 255.0);
    r0.x = (-0.003921569) - -r0.y;
    if (any(float4(0.0, 0.0, 0.0, 0.0) > r0.xxxx)) clip(-1.0);
    r0.xy = r1.xy * 0.003921569;
