// ps_cb6117628b4557f4.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 99 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000018C 10040600 00000406 00000000 00003884 000F000F 00000001 00007054 0000F155 00007256 0000F357
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.x = saturate(ps);
    ps = rsqrt(abs(r1.y));
    r6.xyz = r3.www * r0.zxy;
    r0.w = ps;
    ps = 1.0 - r1.x;
    r2.xyz = r0.www * r2.zxy;
    r0.w = ps;
    r1.yz = -r0.ww * ModShadowGroupColor.xy + 1.0;
    ...
    r1.w = ps;
    ps = log2(r0.w);
    r0.x = saturate(r3.w * r0.z);
    r0.y = ps;
    ps = log2(r2.w);
    r0.y = r0.y * 15.0;
    r0.z = ps;
    ps = pow(2.0, r0.y);
    r1.x = r0.z * LightColorAndFalloffExponent.w;
    r4.z = ps;
    ps = pow(2.0, r1.x);
    r0.yzw = r4.zxy * float3(0.21952, 0.875, 0.875);
    r1.x = ps;
    r0.x = r0.x * r1.w + r0.y;
    r0 = r0.zwxy * r1.yzxx;
    r0.xy = r0.xy + 0.125;
    r1.xyz = r0.zww * r3.xyz;
    ps = r0.x * r0.y;
