// ps_1648c2b7e79828fd.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 120 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001E0 10040800 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.z = ps;
    ps = 5.0 * r6.x;
    r7.xyz = r1.yzw * r7.xyz;
    r6.x = saturate(ps);
    ps = rsqrt(abs(r6.y));
    r3.xyz = r6.zzz * r2.zxy;
    r6.y = ps;
    ps = 1.0 - r6.x;
    ...
    r1.y = r1.y * 2.0 - r1.y;
    ps = 1.0 + ps;
    r7.w = saturate(dot(r3.yzx, r1.zwy));
    r1.y = ps;
    ps = log2(r7.w);
    ...
    r7.xyz = r7.xyz * r6.zzz + r0.www;
    r0.xy = r0.xy * r6.xy + 0.125;
    ps = 1.0 + ps;
    r0.xy = r0.xz * r0.yz;
    r1.z = ps;
