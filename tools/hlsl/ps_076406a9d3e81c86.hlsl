...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.x = ps;
    ps = 0.5 + r5.x;
    r6.z = saturate(dot(r6.xyz, r4.zxy));
    r6.x = ps;
    ps = 0.5 + r0.x;
    r5.xyw = -r3.xyz + 1.0;
    r6.y = ps;
    ...
    r6.xyz = r0.xzy * UniformVector_1.xyz + r6.xzy;
