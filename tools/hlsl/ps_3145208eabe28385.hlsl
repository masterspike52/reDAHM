// ps_3145208eabe28385.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 306 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004C8 10041200 0000080A 00000000 00007108 003F00FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r18.y = ps;
    ps = r9.z + r9.z;
    r18.x = dot(r6.zww, float3(1.0, 1.0, 1.0));
    r18.z = ps;
    r6.z = (r18.x == 0.0) ? r16.x : r16.y;
    r18 = r18.xxyz + float4(-3.0, -2.0, -1.0, -1.0);
    r0.zw = r11.xy * 0.5 + r18.zw;
    r6.z = (r18.y == 0.0) ? r16.z : r6.z;
    r6.z = (r18.x == 0.0) ? r16.w : r6.z;
    ps = r5.w;
    r6.w = max(r6.z, 0.0);
    ps = 0.0001 * ps;
    r6.xz = -r6.zx + 1.0;
    ...
    r7.xyz = r17.xyz * float3(3.3333333, 0.875, 0.875);
    r16.z = ps;
    r9.yzw = -r16.zyx + 1.0;
    ps = 1.0 / r5.w;
    r6.z = r9.w * UniformScalar_1.x;
    r6.y = ps;
    r6.zw = r6.zz * r11.zw + r8.xy;
    ...
    r8.xyz = tex2D(Texture2D_5, r15.xy).xyz;
    ...
    r6.y = saturate(ps);
    r10.w = r8.w * UniformVector_4.z - r12.z;
    ps = log2(r6.y);
    r7.w = r7.w - 1.0;
    r6.y = ps;
    ps = 2.5 * r6.x;
    ...
    r0.w = ps;
    r7 = r7.yzwx * r9.zywx + float4(0.125, 0.125, 1.0, 1.0);
    ...
    r2.xyz = r0.xyz * UniformScalar_3.xxx + UniformScalar_4.xxx;
    r10.xyz = r0.xyz * r7.www - r8.xyz;
    ps = LightColorAndFalloffExponent.w * r6.y;
    r6.xz = r5.xy * r5.xy;
    r6.y = ps;
    r0.w = saturate(r0.w * r7.w - 0.5);
    r5.xy = r13.xy * r0.ww + r12.xy;
    ps = pow(2.0, r6.y);
    ...
    ps = r6.x;
    r5.z = r5.w + 1.0;
    r6.yzw = (r9.www > 0.0) ? r5.xyz : float3(0.0, 0.0, 1.0);
    r5.xyz = (r9.www >= 0.0) ? r6.yzw : float3(0.0, 0.0, 1.0);
    ps = r2.x * ps;
    ...
    r6.y = ps;
    ps = r6.x;
    r6.yzw = r5.xyz * r6.yyy;
    ps = r2.y * ps;
    r1.w = dot(r6.wyz, r4.zxy);
    r2.y = ps;
    ps = r6.x;
