// ps_bb23fec4fc540952.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 54 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000000D8 10000200 00000004 00000000 00002863 00070007 00000021 00003050 0000F151 0000F256
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.y = IndividualVelocityScale.y * UniformVector_1.w;
    ps = UniformVector_1.w * r0.x;
    r0.w = r0.y * r0.x;
    r0.y = ps;
