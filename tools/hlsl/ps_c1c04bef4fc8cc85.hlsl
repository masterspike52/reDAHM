// ps_c1c04bef4fc8cc85.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 186 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000002E8 10040D00 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.y = ps;
    ps = 5.0 * r6.x;
    r6.yzw = r6.yyy * r4.xyz;
    r6.x = saturate(ps);
    ps = 1.0 - r6.x;
    r3.z = saturate(dot(r6.wyz, r10.zxy));
    r6.x = ps;
    ps = rsqrt(abs(r7.w));
    r3.xy = r6.xx * ModShadowGroupColor.xy;
    r6.x = ps;
    r5.xyz = r10.xyz * r6.xxx;
    ps = 1.0 - r3.x;
    r6.x = dot(r5.zxy, r6.wyz);
    r8.x = ps;
    ps = 1.0 - r3.y;
    r4.xyz = r5.xzy * r6.xxx;
    r8.y = ps;
    r4.xzw = r4.xyz * 2.0 - r6.ywz;
    ps = 1.0 - r3.z;
    r6 = xe_cube(r4.xwz);
    r8.z = ps;
    ps = 1.0 / abs(r6.z);
    ...
    r7.yw = tex2D(ModShadowAccumTexture, r7.yz).xy;
    r7.z = tex2D(Texture2D_9, r1.xy).x;
    r11.yzw = texCUBE(TextureCube_0, xe_cube_dir(r11.xyz)).yxz;
    r13.xyz = tex2D(Texture2D_1, r1.xy).xyz;
    r6.xyw = tex2D(Texture2D_2, r8.zz).yzx;
    r0.xyz = tex2D(Texture2D_8, r1.xy).yxz;
    ps = 1.0 - r7.x;
    ...
    r7.y = ps;
    r6.yz = r6.yz * r8.xy + 0.125;
    ps = 0.0001;
    r6.y = r6.y * r6.z;
    r7.z = ps;
    r6.yzw = r6.yyy * r9.xyz + ModShadowColor.xyz;
    ps = max(r7.y, r7.z);
    r7.x = saturate(dot(r0.zxy, r4.zxw));
    r4.x = ps;
    ps = log2(r7.x);
    r7.w = saturate(dot(r5.zxy, r0.zxy));
    r4.z = ps;
    ps = LightColorAndFalloffExponent.w * r6.x;
    r7.xy = r4.xy * r4.zy;
    r6.x = ps;
    ps = pow(2.0, r6.x);
    r0.xyz = r7.yyy * r3.xyz;
    r6.x = ps;
    ps = pow(2.0, r7.x);
