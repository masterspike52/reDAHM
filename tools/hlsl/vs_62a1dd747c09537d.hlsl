// vs_62a1dd747c09537d.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 222 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000040 00000378 0051000A 00000000 00000000 00005CC6 00000001 00000007 00000006 00000290 00100007 00006008 00007009 0000300A 0001A00B 0000500C 0021500D 0000F050 0001F155 00027256 0003F357 0004F4A0 0005F5A2 00001046 00001047 00001044 00001048 00001045 00001043
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r10.xyz = r2.xzy * 0.007843138 - 1.0;
    ...
    r9.w = dot(r7.wxy, r7.wxy);
    r7.xyz = r8.xxx * WorldToLocal[2].xzy;
    r3.w = float((0.001 >= abs(r7.w)));
    r3.w = (r3.w == 0.0) ? r7.w : 0.001;
    ...
    r3.x = dot(r3.xzy, r8.zxy);
    r3.y = dot(r10.yxz, r8.zxy);
    ps = 1.0 / r3.w;
    r3.z = dot(r9.zyx, r8.zxy);
    r3.w = ps;
    r8 = saturate(r7.wzyx * r3.wwww);
    r6 = saturate(r6.wzyx * r3.wwww);
    r7 = max(r0, 0.0);
    r0.xyz = r7.xyz * FogDistanceScale.wzy;
    r6 = r8.wzyx - r6.wzyx;
    r0.xyw = r0.yzx * abs(r6.yzx);
    ps = pow(2.0, r0.y);
    r3.w = abs(r6.w) * FogDistanceScale.x;
    r0.y = ps;
    ps = pow(2.0, r0.x);
    r6 = abs(r6) * r7;
    r0.z = ps;
