// ps_a7e90ba613985080.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 120 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001E0 10040700 00000606 00000000 000058C6 003F003F 00000001 00003050 0000F151 0000F254 0000F356 0000F457 0000F558
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.w = ps;
    ps = rsqrt(abs(r0.x));
    r0.y = saturate(dot(r7.xyz, r2.yzx));
    r0.x = ps;
    ps = log2(r0.y);
    ...
    r0.x = ps;
    ps = 0.21952 * r0.x;
    r4 = r4.zwxy + float4(0.5, 0.5, 0.125, 0.125);
    r2.z = ps;
    ps = r4.z * r4.w;
    ...
    r4 = r4.xxyy * r2.xyxy;
    ps = r0.x * ps;
    r4.xy = r4.xy * LowerSkyColor.xy;
    r0.z = ps;
    r0.y = dot(r2.yz, ConstantLighting.yy) + r4.y;
    r0.x = dot(r2.xz, ConstantLighting.xx) + r4.x;
    r0.xy = r4.zw * UpperSkyColor.xy + r0.xy;
