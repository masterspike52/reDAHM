// ps_1b160d06afdf1252.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 84 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000150 10000700 00000004 00000000 000044A5 001F001F 00000001 00003050 0000F151 0000F255 00007356 0000F457
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.w = rsqrt(abs(r0.w));
    r7.xy = r5.yx * r2.yx + ScreenPositionScaleBias.zw;
    r3.xy = r0.ww * r3.xy;
    r0.zw = r3.xy * r0.zz + r0.xy;
    r6.xyz = tex2D(Texture2D_2, r0.zw).xyz;
    r5.xyz = tex2D(Texture2D_0, r0.xy).xyz;
    r0.x = tex2D(SceneDepthTexture, r7.yx).x;
    r0.y = tex2D(Texture2D_3, r0.zw).x;
    r0.z = r0.y * r1.w;
    r3.xyz = r1.xyz * 1e+01;
    r0.x = r0.x * MinZ_MaxZRatio.z - MinZ_MaxZRatio.w;
    r1.xyz = r6.xyz + r5.xyz;
    r0.x = 1.0 / r0.x;
    r1.xyz = r3.xyz * r1.xyz + UniformVector_0.xyz;
