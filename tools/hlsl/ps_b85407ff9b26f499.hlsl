...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.x = ps;
    ps = 5.0 * r6.x;
    r11.xyz = -r0.xyw + r2.www;
    r6.x = saturate(ps);
    ps = rsqrt(abs(r6.z));
    r10.xyz = r1.www * r2.zxy;
    r6.z = ps;
    ps = rsqrt(abs(r6.w));
    r2.xyz = r6.zzz * r4.zxy;
    r6.z = ps;
    r0.xyw = r11.xyz * r0.www + r0.xyw;
    ps = log2(r6.y);
    r4.xyz = r6.zzz * -SpotDirection.xyz;
    r6.y = ps;
    ps = 1.0 - r6.x;
    r0.xyw = r0.xyw * r7.yzw;
    r6.x = ps;
    r7.zw = -r6.xx * ModShadowGroupColor.xy + 1.0;
    r6.z = dot(r4.zxy, r3.zxy);
    r2.yz = -r2.yz;
    r2.x = r2.x * 2.0 - r2.x;
    r6.x = saturate(dot(r10.yzx, r2.yzx));
    ps = log2(r6.x);
    r7.y = r6.z - SpotAngles.x;
    r8.z = ps;
    r6.xzw = r8.xyz * float3(0.875, 0.875, 15.0);
    r7.zw = r6.xz * r7.zw + 0.125;
    ps = pow(2.0, r6.w);
    r7.y = saturate(r7.y * SpotAngles.y);
    r6.x = ps;
    r6.xzw = r1.xyz * r6.xxx;
    r0.xy = r0.xy * r0.zz + r6.xz;
    r0.z = r0.w * r0.z + r6.w;
