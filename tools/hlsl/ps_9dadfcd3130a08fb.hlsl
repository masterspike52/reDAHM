...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.xy = r6.ww * ScreenPositionScaleBias.xy;
    r7.w = ps;
    ps = 1.0 / ModShadowAccumResolution.x;
    r6.w = dot(r3.zxy, r3.zxy);
    r7.z = ps;
    r0.zw = r7.zw * abs(r8.xy);
    ...
    r4.xyz = r1.yzw * r7.xxx;
    ps = 1.0 + ps;
    r7.x = dot(r4.zxy, r8.zxy);
    r1.y = ps;
    ps = -UniformVector_0.z;
    r9.xyz = r4.xzy * r7.xxx;
    r8.xyz = r9.xyz * 2.0 - r8.xzy;
    ps = 1.0 + ps;
    r7.x = saturate(dot(r2.zxy, r8.yxz));
    r1.w = ps;
    ps = log2(r7.x);
    r6.w = saturate(-r6.w + 1.0);
    r5.x = ps;
    ps = log2(r6.w);
    r5.xyz = r5.xyz * float3(15.0, 0.875, 0.875);
    r6.w = ps;
    ps = pow(2.0, r5.x);
    r6.w = r6.w * LightColorAndFalloffExponent.w;
    r1.z = ps;
    r0.zw = r5.yz * r0.xz + 0.125;
    ps = r0.y * r0.y;
