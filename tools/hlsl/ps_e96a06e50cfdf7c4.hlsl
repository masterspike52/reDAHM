// ps_e96a06e50cfdf7c4.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 168 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000002A0 10040B00 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9.z = max(UniformScalar_9.x, 0.0001);
    r6.x = ps;
    ...
    r0.z = ps;
    ps = 0.875 * r6.x;
    r0.y = float((UniformScalar_1.x > UniformScalar_0.x));
    r9.x = ps;
    ps = 0.875 * r6.y;
    ...
    r6.y = ps;
    r10.xyz = (-abs(r0.yyy) >= 0.0) ? r11.xyz : r10.xyz;
    ps = log2(r3.w);
    r0.xyw = r0.xxx * r4.xzy;
    r6.x = ps;
    ps = -r0.x;
    r4.xyz = r2.www * r2.zxy;
    r2.y = ps;
    r2.x = r0.y * 2.0 - r0.y;
    r10.xyz = (-abs(r1.www) >= 0.0) ? r11.xyz : r10.xyz;
    ps = LightColorAndFalloffExponent.w * r6.x;
    r8.xyz = r0.zzz * r8.xyz;
    r0.z = ps;
    r6.xy = -r6.yy * ModShadowGroupColor.xy + 1.0;
    r9.xy = r9.xy * r6.xy + 0.125;
    ps = pow(2.0, r0.z);
    r6.xyw = -r7.xyz + r10.xyz;
    r0.z = ps;
    ps = -r0.w;
    r0.xyz = r8.xzy * r0.zzz;
    r2.z = ps;
    ps = 1.0 - r6.z;
    r0.w = saturate(dot(r4.yzx, r2.yzx));
    r5.w = ps;
    r2.xyz = r6.xyw * UniformScalar_1.xxx + r7.xyz;
    r7.xyz = r2.xyz * UniformScalar_2.xxx + UniformScalar_3.xxx;
    ps = log2(r0.w);
    r6 = r5.xzwy * r2.xzzy;
    r9.w = ps;
    r2.xy = r5.ww * r2.xy + r6.xw;
    ps = r6.y + r6.z;
    r6.xw = r9.xz * r9.yw;
    r2.z = ps;
