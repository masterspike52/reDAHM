// ps_06f201f343517231.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 102 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000198 10040800 0000060A 00000000 000058C6 000F003F 00000001 00007054 0000F155 00007256 0000F357 0000F4A0 0000F5A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.y = ps;
    ps = 5.0 * r4.x;
    r1.xyz = r7.xyz * float3(32.0, 2e+01, 0.5);
    r4.x = saturate(ps);
    ps = rsqrt(abs(r4.w));
    r8.xyz = r4.yyy * r0.zxy;
    r4.w = ps;
    ps = 1.0 - r4.x;
    r7.xyz = r4.www * r2.zxy;
    r4.x = ps;
    r2.xy = -r4.xx * ModShadowGroupColor.xy + 1.0;
    r7.yz = -r7.yz;
    r7.x = r7.x * 2.0 - r7.x;
    r4.x = saturate(dot(r8.yzx, r7.yzx));
    ps = log2(r4.x);
    r5.w = saturate(r4.y * r0.z);
    r6.z = ps;
    ps = log2(r4.z);
    r4.xyw = r6.xyz * float3(0.875, 0.875, 15.0);
    r0.x = ps;
    r4.xz = r4.xy * r2.xy + 0.125;
    ps = pow(2.0, r4.w);
    r4.y = r0.x * LightColorAndFalloffExponent.w;
    r4.w = ps;
    r0.xyz = r1.xyz * r5.www + r4.www;
    ps = pow(2.0, r4.y);
    r4.x = r4.x * r4.z;
    r4.w = ps;
