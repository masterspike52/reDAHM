// ps_60b2b1a891351b3d.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 99 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000018C 10040800 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = r2.z;
    r8.xyz = UniformVector_1.xyz * UniformVector_1.www;
    ps = 0.1 + ps;
    ...
    r1.y = ps;
    ps = rsqrt(abs(r6.z));
    r6.y = saturate(r7.w * 5.0);
    r6.x = ps;
    ps = 1.0 - r6.y;
    r3.xyz = r8.xyz * r5.yzw;
    r6.z = ps;
    ps = log2(r6.w);
    r6.y = saturate(r6.x * r2.z);
    r6.x = ps;
    ps = LightColorAndFalloffExponent.w * r6.x;
    r7.xyz = r3.xyz * r7.xyz;
    r6.x = ps;
    r6.zw = -r6.zz * ModShadowGroupColor.xy + 1.0;
    r5.yz = r1.xy * r6.zw + 0.125;
    ps = pow(2.0, r6.x);
