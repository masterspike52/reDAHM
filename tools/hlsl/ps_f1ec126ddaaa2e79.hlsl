// ps_f1ec126ddaaa2e79.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 132 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000210 10040900 0000080A 00000000 00007908 003F00FF 00000001 0000F050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.x = tex2D(Texture2D_1, r1.xy).w;
    ...
    r9.xyz = r3.xzy * r6.zzz;
    r4.xyz = r9.xyz * 2.0 - r4.xzy;
    r7.w = saturate(dot(r2.zxy, r4.yxz));
    ps = log2(r7.w);
    r6.z = saturate(dot(r3.zxy, r2.zxy));
    r8.z = ps;
    r2.xyz = r8.xyz * float3(0.875, 0.875, 15.0);
    ps = pow(2.0, r2.z);
    r0.xyw = r0.xyz * r6.zzz;
    r6.z = ps;
    r6.xy = r2.xy * r6.xy + 0.125;
    ps = r6.x * r6.y;
    r0.z = r6.z * r5.w;
    r6.x = ps;
