// ps_798f5ad08830da4f.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 123 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001EC 10040600 00000506 00000000 000050A5 001F001F 00000001 0000F053 0000F154 0000F256 0000F357 0000F458
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.z = saturate(ps);
    ps = rsqrt(abs(r1.y));
    r1.x = saturate(dot(r5.xyz, r3.yzx));
    r1.y = ps;
    ps = log2(r1.x);
    r1.w = -r1.z + 1.0;
    r1.x = ps;
    ...
    ps = pow(2.0, r1.x);
    r3.xy = r1.ww * ModShadowGroupColor.xy;
    r6.x = ps;
    r3.z = r6.w * r6.x;
    ...
    r3.xyw = -r3.xyw + 1.0;
    r4.zw = r1.yz * r4.zz;
    r1.x = float((r3.w >= 0.004));
    r1.yzw = r6.xyz * float3(0.21952, 0.875, 0.875);
    ...
    r1.zw = r1.zw * r1.yy;
    r0.w = r1.z * LowerSkyColor.x + r0.w;
    r0.w = r1.w * UpperSkyColor.x + r0.w;
    r3.x = r1.y * AmbientColorAndSkyFactor.x + r0.w;
