...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.yw = tex2D(ModShadowAccumTexture, r5.zw).xy;
    ps = rsqrt(abs(r5.y));
    r5.w = saturate(-r5.x + 1.0);
    r0.y = ps;
    ps = rsqrt(abs(r5.x));
    r6.x = saturate(r0.y * r1.z);
    r5.y = ps;
    ps = r1.z;
    ...
    r0.y = saturate(dot(r1.yzx, r0.yzx));
    r5.y = ps;
    ps = log2(r0.y);
    ...
    r0.y = r0.x * r0.x;
    r8.x = ps;
    r1.xyz = r8.xyw * float3(0.21952, 0.875, 0.875);
    r6.xyz = r6.yzw * r6.xxx + r1.xxx;
    r8.xy = r1.yz * r5.zw + 0.125;
    ps = LightColorAndFalloffExponent.w * r5.x;
    r0.zw = r8.xz * r8.yz;
    r5.w = ps;
    r5.xyz = r0.zzz * r7.xyz + ModShadowColor.xyz;
    ps = pow(2.0, r5.w);
