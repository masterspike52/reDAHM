...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r13.z = saturate(OpacityOverride.x);
    r6.x = ps;
    ...
    r2.xyz = r15.xyz * r6.www;
    r10.z = ps;
    ps = -ModShadowColor.z;
    r5.xyz = r10.xzy * r2.zzz;
    ps = 1.0 + ps;
    r14.x = dot(r13.wxy, r2.zxy);
    r12.z = ps;
    ps = 0.1 - -r7.x;
    r6.y = dot(r2.zxy, r4.zxy);
    r6.x = ps;
    ps = 5.0 * r6.x;
    r13.xyw = r2.xzy * r6.yyy;
    r6.x = saturate(ps);
    ps = 1.0 - r6.x;
    r2 = r14.xxyz * float4(0.5, -0.5, 0.875, 0.875);
    r6.z = ps;
    r6.xyw = r13.xyw * 2.0 - r4.xzy;
    ps = ModShadowGroupColor.x * r6.z;
    r6.y = saturate(dot(r7.xyz, r6.yxw));
    r13.x = ps;
    ...
    r6.z = ps;
    r7.xy = r2.zw * r7.xy + 0.125;
    ps = r7.x * r7.y;
    r2.xyz = r9.xzy * r6.xxx;
    r6.x = ps;
    ps = log2(r6.y);
    r4.xyz = r9.xzy * r6.zzz;
    r11.x = ps;
    r6.xyz = r6.xxx * r12.xyz + ModShadowColor.xyz;
    r7 = r11.yzwx * float4(0.5, 3.0, 4.0, 1e+01);
    ps = pow(2.0, r7.w);
    r7.xyz = r7.xyz * r1.xyz;
    r7.w = ps;
    r10.xyz = r10.xzy * r7.www;
    r7.xyz = r10.xzy * r7.xyz + UniformVector_0.xyz;
    r7.xyz = r5.xzy * r9.xyz + r7.xyz;
    r7.xyz = r4.xyz * LowerSkyColor.xzy + r7.xzy;
    r7.xyz = r2.xzy * UpperSkyColor.xyz + r7.xzy;
    r7.xyz = r8.xzy * r0.xzy + r7.xzy;
    r7.xyz = r1.xyz * 2.0 + r7.xzy;
    ps = -r3.w;
