...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.z = -r0.z + 1.0;
    r0.x = ps;
    r7.yz = -r0.zz * ModShadowGroupColor.xy + 1.0;
    ps = LightColorAndFalloffExponent.w * r0.x;
    r3.xyz = r0.yyy * r3.zxy;
    r0.z = ps;
    ps = -r3.y;
    r8.xyz = r1.www * -SpotDirection.xyz;
    r3.y = ps;
    r3.x = r3.x * 2.0 - r3.x;
    ps = -r3.z;
    r0.y = dot(r8.zxy, r2.zxy);
    r3.z = ps;
    ps = -SpotAngles.x - -r0.y;
    r1.xyz = r0.www * r1.zxy;
    r0.x = ps;
    ps = pow(2.0, r0.z);
    r0.y = saturate(dot(r1.yzx, r3.yzx));
    r7.x = ps;
    ps = log2(r0.y);
    r3.z = r6.x * r7.x;
    r0.y = ps;
    ...
    r3.w = ps;
    r1.xw = r3.zx * r3.wy;
    r0.xyz = r1.www * r4.xyz + ModShadowColor.xyz;
