...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.x = ps;
    ps = rsqrt(abs(r1.w));
    r3.z = saturate(-r2.x + 1.0);
    r1.w = ps;
    ps = 5.0 * r0.x;
    r2.x = dot(r6.zxy, r6.zxy);
    r0.x = saturate(ps);
    ps = rsqrt(abs(r2.x));
    r8.xyz = r1.www * r4.zxy;
    r2.x = ps;
    ps = 1.0 - r0.x;
    r5.xyz = r2.xxx * r6.zxy;
    r0.x = ps;
    r3.xy = -r0.xx * ModShadowGroupColor.xy + 1.0;
    r5.yz = -r5.yz;
    r5.x = r5.x * 2.0 - r5.x;
    r0.x = saturate(dot(r8.yzx, r5.yzx));
    ps = log2(r0.x);
    r1.w = saturate(r1.w * r4.z);
    r2.x = ps;
    ps = log2(r3.z);
    r2 = r2 * float4(15.0, 0.21952, 0.21952, 0.21952);
    r0.x = ps;
    ps = pow(2.0, r2.x);
