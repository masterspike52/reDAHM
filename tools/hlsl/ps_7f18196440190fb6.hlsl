// ps_7f18196440190fb6.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 114 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001C8 10040700 00000406 00000000 00003884 000F000F 00000001 00007054 0000F155 00007256 0000F357
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.xy = tex2D(ModShadowAccumTexture, r3.zw).xy;
    ...
    r1.x = r1.x * 2.0 - r1.x;
    ps = 1.0 + ps;
    r0.w = saturate(dot(r7.yzx, r1.yzx));
    r5.w = ps;
    ps = log2(r0.w);
    r1.w = saturate(r3.w * r0.z);
    r6.z = ps;
    ps = log2(r2.w);
    ...
    r0.x = ps;
    r0.zw = r1.xy * r5.xy + 0.125;
    ps = 0.21952 * r0.x;
    r3.w = ps;
    r1.xy = r1.ww * r5.zw + r3.ww;
    ps = pow(2.0, r0.y);
    r0.x = r0.z * r0.w;
    r0.w = ps;
