// ps_4cb3c7971f7717e4.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 81 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000144 10040700 0000070A 00000000 000070E7 001F007F 00000001 0000F050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.y = float((UniformScalar_7.x >= UniformScalar_0.x));
    r5.x = ps;
    r5.xz = r5.xz * abs(r7.xy);
    r6.xyz = tex2D(Texture2D_0, r0.xy).xyz;
    r0.xy = tex2D(ModShadowAccumTexture, r5.xz).xy;
    ...
    r3.xy = r0.xy * 0.875;
    r5.x = ps;
    r0.xyz = (r5.yyy > 0.0) ? UniformVector_1.xyz : UniformVector_2.xyz;
