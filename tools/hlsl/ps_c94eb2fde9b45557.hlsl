// ps_c94eb2fde9b45557.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 135 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000021C 10040A00 0000080A 00000000 00007908 003F00FF 00000001 00003050 0000F151 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r10.x = ps;
    ps = rsqrt(abs(r6.y));
    r1.xyz = r7.yzw * LightMapScale.xyz;
    r6.y = ps;
    ps = rsqrt(abs(r6.x));
    r7.yzw = r6.yyy * r4.zxy;
    r6.x = ps;
    ps = -r7.z;
    r6.yzw = r6.xxx * r2.zxy;
    r7.z = ps;
    r7.y = r7.y * 2.0 - r7.y;
    ps = -r7.w;
    r0 = r10.xxyw * float4(-0.5, 0.5, 0.875, 0.875);
    r7.w = ps;
    ps = 0.1 - -r6.y;
    r5.xy = r0.xy * r5.zz;
    r6.x = ps;
    ps = 5.0 * r6.x;
    r6.w = saturate(dot(r6.zwy, r7.zwy));
    r6.x = saturate(ps);
    ...
    r2 = r9 * float4(15.0, 3.0, 3.0, 3.0);
    ps = 1.0 + ps;
    r5.zw = r0.zw * r6.xy;
    r7.z = ps;
    r0.xyz = r2.yzw * r7.xyz;
    ps = pow(2.0, r2.x);
    r6.w = float((r6.z >= 0.004));
    r6.x = ps;
    r4.xyz = r1.xzy * r6.xxx;
    r7.xyz = r0.xyz * AmbientColorAndSkyFactor.xyz + UniformVector_0.xyz;
    r5 = r5.xzwy + float4(0.5, 0.125, 0.125, 0.5);
    ps = r5.y * r5.z;
    r5.xw = abs(r5.xw) * abs(r5.xw);
    r6.x = ps;
