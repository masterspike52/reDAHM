// ps_7ad0dfdf3766538a.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 231 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000039C 10040D00 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.z = UniformScalar_22.x - UniformScalar_21.x;
    r11.xyz = -ModShadowColor.xyz + 1.0;
    r5.xyw = r1.wzy * 2.0 - 1.0;
    ps = r6.x + r6.x;
    ...
    r1.x = ps;
    ps = 1.0 - r6.x;
    r6.z = dot(r10.wxz, float3(1.0, 1.0, 1.0));
    r6.y = ps;
    ps = log2(r0.y);
    r10.xzw = r1.xxx * -SpotDirection.xyz;
    r6.x = ps;
    r12.zw = -r6.yy * ModShadowGroupColor.xy + 1.0;
    ps = 4.0 * r6.w;
    r6.y = dot(r10.wxz, r3.zxy);
    r0.y = ps;
    ps = 1.0 - r6.z;
    r10.xzw = r0.yxw + float3(-2.0, -2.0, -1.0);
    r0.w = ps;
    ps = UniformVector_2.x * UniformVector_2.x;
    r3.xyz = r0.www * r13.xyz;
    r6.z = ps;
    ...
    r12.y = r8.w * UniformScalar_0.x + r5.y;
    r3.xyz = r8.xyz * UniformScalar_0.xxx + r3.xyz;
    ps = rsqrt(abs(r7.z));
    r0.xyz = r0.xyz * UniformScalar_0.xxx;
    r7.z = ps;
    ps = (-2.0) + r0.y;
    r10.xzw = -UniformVector_0.xyz + 1.0;
    r6.w = ps;
    ...
    r4.z = ps;
    ps = 0.875 * r7.y;
    r1 = r0.xywz * UniformVector_2.xzyy;
    r4.w = ps;
    ps = r1.z;
    r10.x = r10.z * r12.x;
    ps = r12.y * ps;
    r4.xy = r10.xw * r0.wy;
    r10.x = ps;
    r6.z = r10.x * r1.w + r4.y;
    r6.w = r4.x * r12.x + r6.z;
    r7.xy = r4.zw * r12.zw + 0.125;
    ps = rsqrt(abs(r6.w));
    r6.z = r7.x * r7.y;
    r10.z = ps;
    r7.xyz = r6.zzz * r11.xyz + ModShadowColor.xyz;
    ...
    r6.w = dot(r0.yxz, r8.zxy);
    r6.x = ps;
    ps = SpotAngles.y * r6.x;
    r9.xyz = r0.xzy * r6.www;
    r4.x = saturate(ps);
    r6.xyw = r9.xyz * 2.0 - r8.xyz;
    ps = pow(2.0, r6.z);
    ...
    r6.xy = r4.xy * r4.xz;
    ps = pow(2.0, r6.y);
    r7.w = saturate(dot(r0.yxz, r5.zxy));
    r6.z = ps;
    r6.yzw = r3.xyz * r6.zzz;
    r0.xy = r2.xy * r7.ww + r6.yz;
    r0.z = r2.z * r7.w + r6.w;
