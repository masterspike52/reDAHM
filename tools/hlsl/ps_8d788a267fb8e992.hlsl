...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = rsqrt(abs(r6.z));
    r6.y = dot(r11.zxy, r2.zxy);
    r6.x = ps;
    r2.xyz = r10.xyz * r6.xxx;
    ps = UniformVector_1.x * r5.y;
    r6.z = dot(r2.zxy, r1.zxy);
    r6.x = ps;
    ps = UniformVector_1.y * r5.z;
    r10.xyz = r2.xzy * r6.zzz;
    r6.z = ps;
    r1.xyz = r10.xyz * 2.0 - r1.xzy;
    ps = -SpotAngles.x - -r6.y;
    r6.w = saturate(dot(r8.zxy, r1.yxz));
    r6.y = ps;
    ps = log2(r6.w);
    r1.x = saturate(r6.y * SpotAngles.y);
    r9.x = ps;
    ps = UniformVector_1.z * r5.w;
    r1.yzw = r9.yzx * float3(0.875, 0.875, 15.0);
    r6.w = ps;
    r1.yz = r1.yz * r3.xy + 0.125;
    ps = pow(2.0, r1.w);
    r5.z = saturate(dot(r2.zxy, r8.zxy));
    r5.y = ps;
    ps = LightColorAndFalloffExponent.w * r5.x;
    r6.xyz = r6.wxz * r5.yyy;
    r5.y = ps;
    r6.yz = r7.xy * r5.zz + r6.yz;
    r6.w = r7.z * r5.z + r6.x;
    ps = pow(2.0, r5.y);
    r5.xw = r1.yx * r1.zx;
    r6.x = ps;
