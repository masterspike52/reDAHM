// vs_4c2d104839757768.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 1116 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000080 00001170 0081000D 00000000 00000000 00008929 00000001 00000007 00000009 00000290 0010002C 0000602D 0000702E 0000302F 00005030 00015031 00225032 0000F050 0001F151 00027254 0003F355 00047456 0005F557 0006F6A0 0007F7A1 0008F8A2 00001170 00001171 0000116C 0000116A 0000116D 00001172 0000116E 0000116B 0000116F
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    ps = 0.003921569 * r1.w;
    r12.xyz = r6.yxz * 0.003921569;
    r13.x = ps;
    r4.y = -r1.y * 0.007843138 + 1.0;
    r4.xz = r1.wx * 0.007843138 - 1.0;
    r3 = r11.zzzz * LocalToWorld[2].xwzy + r0;
    r8.xyz = r10.yxz * 0.007843138 - 1.0;
    r5.xyz = r6.xzy * 0.007843138 - 1.0;
    ps = 0.003921569 * r1.y;
    r0.xyz = r8.xxz * r5.xzz;
    r13.y = ps;
    r3 = r11.yyyy * LocalToWorld[1].xzyw + r3.xzwy;
    r3 = r11.xxxx * LocalToWorld[0] + r3.xzyw;
    r0.xyz = r8.zyy * r5.yyx - r0.xyz;
    ps = 0.003921569 * r1.x;
    ...
    r3 = r11.wwww * LocalToWorld[3].xzyw;
    ps = 0.003921569 * r1.w;
    r12.xyz = r6.yxz * 0.003921569;
    r13.x = ps;
    ...
    r13.yzw = r10.yxz * 0.007843138 - 1.0;
    r5.xyz = r6.xzy * 0.007843138 - 1.0;
    ps = 0.003921569 * r1.y;
    r4.xyz = r13.yyw * r5.xzz;
    r13.y = ps;
    r3 = r8.yyyy * LocalToWorld[1].xzyw + r3;
    r3 = r8.xxxx * LocalToWorld[0] + r3.xzyw;
    r4.xyz = r13.wzz * r5.yyx - r4.xyz;
    ps = 0.003921569 * r1.x;
    ...
    r5.yzw = r10.xyz * 0.007843138 - 1.0;
    ...
    r3.y = ps;
    ps = 1.0;
    r10.z = saturate(floor(r1.z));
    r3.x = ps;
    p0 = (r6.z != 0.0);
    ps = p0 ? 0.0 : 1.0;
    r10.x = saturate(r0.y * r1.x);
    if (p0)
    {
        if (p0)
        {
    ...
    if (p0)
    {
        r1.yz = r0.yy * float2(8e+02, -1e+03);
        r11.x = r1.y + r11.x;
        ps = 3.3333333 * r0.x;
        r6.x = r1.z + r11.z;
        r1.y = ps;
    ...
    p0 = (r0.z == 0.0 && r1.z != 0.0);
    r0.z = (r0.z == 0.0 && r1.z != 0.0) ? 0.0 : r0.z + 1.0;
    if (p0)
    {
        r1.yz = r0.yy * float2(-8e+02, -1e+03);
        ps = 1.0 - r0.x;
