// vs_5b9d236182f6a3e0.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 570 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000040 000008E8 0041000F 00000000 00000000 000044A5 00000001 00000007 00000005 00000290 00100017 00006018 00007019 0000301A 0000201B 0000101C 0020501D 00003050 0001F155 00027256 0003F3A0 0004F4A1 000010B8 000010BC 000010BA 000010BB 000010B9
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r2.w = r1.y * 3.0;
    a0 = xe_mova(r2.w);
    r5.z = float((MaxBoneInfluences.x > 1.0));
    ...
    r10.y = dot(r2.zxy, r4.zxy);
    r10.z = dot(r2.zxy, r0.wyz);
    r0.x = dot(r12.zxy, r4.zxy);
    r0.y = dot(r12.zxy, r0.wyz);
    r0.z = dot(r12.zxy, r3.zxy);
    a0 = xe_mova(r2.w);
    r9.w = dot(r14.zxy, r4.zxy);
    ...
    r2.w = dot(r3.zxyw, r15);
    r3.x = dot(r13.zxyw, r15);
    r0 = r0.xxxx * LocalToWorld[2] + LocalToWorld[3];
    r0 = r3.xxxx * LocalToWorld[1].xzyw + r0.xzyw;
    r13 = r2.wwww * LocalToWorld[0].xywz + r0.xzwy;
