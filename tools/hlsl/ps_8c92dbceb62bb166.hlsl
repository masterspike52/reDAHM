...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.yz = tex2D(ModShadowAccumTexture, r0.xz).xy;
    r0.z = dot(r4.zxy, r4.zxy);
    r0.x = 0.1 - -r4.z;
    r2.w = saturate(-r0.y + 1.0);
    r0.z = rsqrt(abs(r0.z));
    r8.w = saturate(r0.z * r4.z);
    r1.w = rsqrt(abs(r0.y));
    ...
    r2.x = ps;
    ps = rsqrt(abs(r0.y));
    r4.xyz = r0.zzz * r4.zxy;
    r0.x = ps;
    ps = log2(r2.w);
    r0.yzw = r0.xxx * r6.xyz;
    r0.x = ps;
    r9.xy = -r2.xx * ModShadowGroupColor.xy + 1.0;
    ps = -r0.y;
    r6.xyz = r1.www * -SpotDirection.xyz;
    r3.y = ps;
    r3.x = r0.w * 2.0 - r0.w;
    ps = -r0.z;
    ...
    r0.z = saturate(dot(r4.yzx, r3.yzx));
    r0.y = ps;
    ps = log2(r0.z);
    r2.x = saturate(r0.y * SpotAngles.y);
    r2.w = ps;
    r8.xyz = r2.yzw * float3(0.875, 0.875, 15.0);
    ps = pow(2.0, r8.z);
    r2.y = r2.x * r2.x;
    r0.y = ps;
    r0.zw = r8.xy * r9.xy + 0.125;
    ps = LightColorAndFalloffExponent.w * r0.x;
    r3.z = r0.y * 0.21952;
    r0.y = ps;
    r3.xy = r8.ww * r9.zw + r3.zz;
    ps = pow(2.0, r0.y);
    r0.x = r0.z * r0.w;
    r0.w = ps;
