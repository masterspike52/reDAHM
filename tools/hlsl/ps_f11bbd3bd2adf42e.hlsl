...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.z = dot(r2.zxy, r1.zxy);
    r10.xyz = r2.xzy * r0.zzz;
    r1.xyz = r10.xyz * 2.0 - r1.xzy;
    ps = -SpotAngles.x - -r0.y;
    r0.z = saturate(dot(r8.zxy, r1.yxz));
    r0.y = ps;
    ps = log2(r0.z);
    r0.w = saturate(r0.y * SpotAngles.y);
    r9.x = ps;
    ps = LightColorAndFalloffExponent.w * r0.x;
    r1.yzw = r9.yxz * float3(0.875, 15.0, 0.875);
    r1.x = ps;
    r0.yz = r1.yw * r3.xy + 0.125;
    ps = pow(2.0, r1.z);
    r1.y = saturate(dot(r2.zxy, r8.zxy));
    r0.x = ps;
    ps = r0.x;
