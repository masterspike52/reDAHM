// ps_435ff1e791014ffd.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 306 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004C8 10041100 0000090A 00000000 00008129 003F01FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A1 0000F8A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.y = ps;
    r13.yz = r8.xy * 2.0 - 1.0;
    ps = rsqrt(abs(r6.z));
    r12.y = r6.w * UniformVector_2.y;
    r6.z = ps;
    ps = 0.1 - -r2.z;
    r6.y = r5.w - 4e+02;
    r6.x = ps;
    ...
    r13.x = saturate(ps);
    ps = r1.w;
    r16.xyz = r13.xyz * float3(-0.025, 0.5, 0.5);
    ps = UniformVector_2.x * ps;
    r12.zw = r11.xy * r16.xx;
    r12.x = ps;
    r6.xy = r12.xy - 0.5;
    r0.zw = float2((r12.xy >= 0.5));
    ps = r3.x;
    r6.xy = r6.xy - r12.xy;
    ps = abs(r9.x) * ps;
    r7.zw = r6.xy * r0.zw;
    ...
    r6.z = saturate(ps);
    ps = r1.w;
    r3.yz = r5.xy * ScreenPositionScaleBias.xy;
    r12.x = r8.z * r8.x - 1.0;
    ...
    r8.z = ps;
    ps = r8.w + r8.w;
    r8.y = dot(r0.zww, float3(1.0, 1.0, 1.0));
    r8.w = ps;
    r6.w = (r8.y == 0.0) ? r9.x : r9.y;
    ps = 1.0 - r6.y;
    r17 = r8.yyzw + float4(-3.0, -2.0, -1.0, -1.0);
    r12.y = ps;
    r6.y = (r17.y == 0.0) ? r9.z : r6.w;
    r6.y = (r17.x == 0.0) ? r9.w : r6.y;
    ps = 1.0 - r6.x;
    r6.w = max(r6.y, 0.0);
    r12.z = ps;
    ps = 1.0 - r6.y;
    ...
    r4.w = ps;
    ps = 1.0 - r6.z;
    r13 = r4.wxyz * float4(2.5, 3.3333333, 0.875, 0.875);
    r12.w = ps;
    r4.xyz = r13.yzw * r12.xzy + float3(1.0, 0.125, 0.125);
    ps = 1.0 / r5.w;
    r3.x = abs(r4.x) * abs(r4.x);
    r3.w = ps;
    ps = r1.z;
    r9.xzw = r3.xyz * r3.xww;
    ps = UniformVector_7.y * ps;
    r6.xy = r9.zw + ScreenPositionScaleBias.wz;
    r8.y = ps;
    r7.z = tex2D(Texture2D_4, r1.xy).x;
    r3.xyz = tex2D(Texture2D_7, r7.xy).xyz;
    r5.xyz = tex2D(Texture2D_6, r8.xy).xyz;
    r8.xyz = tex2D(LightAttenuationTexture, r6.xy).xyz;
    r9.y = tex2D(ShadowTexture, r0.xy).x;
    r0.xyz = tex2D(Texture2D_3, r1.xy).xyz;
    r7.xyw = tex2D(Texture2D_0, r7.xy).xzy;
    r6.xyz = -ModShadowColor.xyz + 1.0;
    r6.w = dot(r2.zxy, r2.zxy);
    r1.xyz = UniformVector_6.xyz * UniformVector_6.www;
    r14.xyz = r7.xwy * 2.0 - 1.0;
    r0.xyz = r0.xyz * 2.0 - 1.0;
    ps = rsqrt(abs(r6.w));
    r15.xyz = r0.xyz * UniformVector_4.xyz;
    r6.w = ps;
    ps = -r14.z;
    ...
    r2.xy = r17.zw + r16.yz;
    r13.z = ps;
    r2.xy = r13.yy * r2.xy + r15.xy;
    r7.x = saturate(r13.x * r4.x - 0.5);
    ps = r4.y * r4.z;
    r13.xy = r2.xy - r14.xy;
    r6.w = ps;
    r6.xzw = r6.www * r6.xyz + ModShadowColor.xyz;
    r2.xy = r13.xy * r7.xx + r14.xy;
    r6.y = r13.z * r7.x - 2.0;
    r2.z = r7.y * 2.0 + r6.y;
    r2.xyw = r2.xyz * r12.www;
    ps = r9.x * r9.x;
    r2.z = r2.w + 1.0;
    r7.y = ps;
    r2.xyz = (r12.www > 0.0) ? r2.xyz : float3(0.0, 0.0, 1.0);
    r2.xyz = (r12.www >= 0.0) ? r2.xyz : float3(0.0, 0.0, 1.0);
    ps = r9.y * r9.y;
    ...
    r6.y = dot(r2.zxy, r11.zxy);
    r9.xyz = r2.xyz * r6.yyy;
    r9.xyz = r9.xyz * 2.0 - r11.xyz;
    r6.y = saturate(dot(r0.zxy, r9.zxy));
    ps = log2(r6.y);
    r7.w = saturate(dot(r2.zyx, r0.zyx));
    r6.y = ps;
