...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.zw = r0.yx + UniformVector_1.yx;
    r4 = r0.xyxy * float4(3.0, 3.0, 4.0, 4.0);
    r3.xy = r4.zw + UniformVector_2.xy;
    r3.zw = r3.wz + r0.xy;
    r3.x = tex2D(Texture2D_1, r3.xy).w;
    r3.y = tex2D(Texture2D_2, r4.xy).x;
    r2.x = tex2D(Texture2D_0, r3.zw).w;
    ps = 4.0 - r2.x;
    r2.y = r3.y * r2.w;
    r2.z = ps;
    r2.x = r2.z * r3.x + r2.x;
