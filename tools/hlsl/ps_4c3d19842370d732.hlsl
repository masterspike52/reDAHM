// ps_4c3d19842370d732.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 132 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000210 10040C00 0000080A 00000000 00007108 003F00FF 00000001 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r8.yzw = tex2D(Texture2D_2, r1.xy).xyz;
    ...
    ps = rsqrt(abs(r6.z));
    r7.xy = r8.yz * float2(0.5, 3.0);
    r6.z = ps;
    ps = rsqrt(abs(r6.y));
    r0.xyz = r6.zzz * r4.xyz;
    r6.y = ps;
    ps = 5.0 * r6.x;
    r1.xzw = r6.yyy * r2.xyz;
    r6.y = saturate(ps);
    ps = 1.0 - r6.y;
    ...
    r11.xy = r3.zw * r6.yz + 0.125;
    r2.xyz = r12.xyz * r6.xxx;
    r1.y = saturate(dot(r2.zxy, r1.wxz));
    ps = r11.x * r11.y;
    r6.y = dot(r2.zxy, r0.zxy);
    r6.x = ps;
    ps = r11.z * r11.z;
    ...
    r6.w = saturate(dot(r1.wxz, r0.yxz));
    ps = log2(r6.w);
    r0.xyz = r7.www * r9.xyz;
    r8.x = ps;
    r3.zw = r8.wx * float2(4.0, 1e+01);
    ps = pow(2.0, r3.w);
