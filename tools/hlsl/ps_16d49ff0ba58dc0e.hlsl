// ps_16d49ff0ba58dc0e.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 126 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001F8 10040B00 0000080A 00000000 00008108 003F00FF 00000001 0000F050 0000F153 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.xyw = tex2D(Texture2D_0, r0.xy).yzx;
    ...
    r10.x = ps;
    ps = rsqrt(abs(r7.z));
    r8.xyz = r7.wxy * AmbientColorAndSkyFactor.xyz;
    r7.z = ps;
    ...
    r6.x = ps;
    ps = rsqrt(abs(r6.y));
    r6.w = saturate(dot(r11.xyz, r2.yzx));
    r2.z = ps;
    ps = log2(r6.w);
    r6.xy = r6.xx * ModShadowGroupColor.xy;
    r2.y = ps;
    ps = 1.0 - r6.x;
    r0.xyz = r0.xyz * r7.wxy;
    r2.x = ps;
    ps = 1.0 - r6.y;
    r7.xyz = r2.yzz * float3(15.0, -0.5, 0.5);
    r2.y = ps;
    ps = 1.0 - r6.z;
    r4.xy = r7.yz * r5.zz;
    r2.z = ps;
