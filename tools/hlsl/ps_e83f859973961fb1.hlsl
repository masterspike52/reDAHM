// ps_e83f859973961fb1.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 285 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000474 10040E00 00000606 00000000 000048C6 003F003F 00000021 00003050 00003151 00007254 0000F355 00007456 0000F557
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = 1.0 + ps;
    r4.xzw = r9.xyz * float3(-0.025, 0.5, 0.5);
    r0.z = ps;
    ps = UniformVector_2.y * r0.z;
    r10.zw = r7.xy * r4.xx;
    r10.y = ps;
    r0.zw = r10.xy - 0.5;
    r9.xz = float2((r10.xy >= 0.5));
    ps = r3.x;
    r0.zw = r0.zw - r10.xy;
    ps = abs(r6.x) * ps;
    r8.zw = r0.zw * r9.xz;
    ...
    r0.xyw = tex2D(Texture2D_0, r8.xy).xyz;
    r4.xy = r1.xy * UniformVector_6.xy;
    r12.xyz = r0.xyw * 2.0 - 1.0;
    r1.xyz = r13.xyz * 2.0 - 1.0;
    ps = r3.x + r3.x;
    r13.zw = r5.xy * ScreenPositionScaleBias.xy;
    r9.y = ps;
    ps = r3.y + r3.y;
    r9.x = dot(r9.xzz, float3(1.0, 1.0, 1.0));
    r9.z = ps;
    r0.z = (r9.x == 0.0) ? r10.x : r10.y;
    r9 = r9.xxyz + float4(-3.0, -2.0, -1.0, -1.0);
    ps = r9.z;
    r1.xyw = r1.xyz * UniformVector_4.xyz;
    r0.z = (r9.y == 0.0) ? r10.z : r0.z;
    r6.y = (r9.x == 0.0) ? r10.w : r0.z;
    ps = r4.z + ps;
    r0.z = max(r6.y, 0.0);
    r4.z = ps;
    ps = r9.w;
    ...
    r4.w = ps;
    r4.zw = r10.yy * r4.zw + r1.xy;
    ps = 1.0 / r5.w;
    r13.xy = r4.zw - r12.xy;
    r0.z = ps;
    r4.zw = r13.zw * r0.zz + ScreenPositionScaleBias.wz;
    r9.xyz = tex2D(Texture2D_4, r8.xy).xyz;
    r3.xyz = tex2D(LightAttenuationTexture, r4.zw).xyz;
    r4.xyz = tex2D(Texture2D_6, r4.xy).xyz;
    ...
    r0.x = ps;
    ps = 5.0 * r0.x;
    r14.xyz = r5.yzw * r4.xyz;
    r6.z = saturate(ps);
    r4.xyz = r14.xyz * UniformScalar_3.xxx + UniformScalar_4.xxx;
    ps = -r12.z;
