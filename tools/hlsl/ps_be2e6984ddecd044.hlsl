...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.yzw = tex2D(LightAttenuationTexture, r5.xy).xyz;
    r9.xyz = tex2D(Texture2D_2, r0.xy).xyz;
    r10.xyz = tex2D(Texture2D_0, r0.xy).xyz;
    r5.xyz = tex2D(Texture2D_3, r0.xy).zxy;
    ...
    r9.xyz = r3.xzy * r6.xxx;
    r0.z = ps;
    r1.xyz = r9.xyz * 2.0 - r1.xzy;
    ps = log2(r5.w);
    r6.x = saturate(dot(r4.zxy, r1.yxz));
    r5.w = ps;
    ps = log2(r6.x);
