// ps_53a773b8ee6d4df1.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 138 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000228 10040B00 0000080A 00000000 00007108 003F00FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.y = ps;
    r6.xz = r7.xy * r5.xy + ScreenPositionScaleBias.wz;
    ...
    r6.w = ps;
    ps = r7.w;
    r4.xyz = r5.yzw * r6.www;
    ps = r2.y * ps;
    r4.xyz = r4.xyz * TwoSidedSign.xxx;
    r5.y = ps;
    ps = r7.w;
    r6.w = dot(r4.zxy, r1.zxy);
    ps = r2.z * ps;
    r11.xyz = r4.xzy * r6.www;
    r5.z = ps;
    r1.xyz = r11.xyz * 2.0 - r1.xzy;
    r6.w = saturate(dot(r5.zxy, r1.yxz));
    ps = log2(r6.w);
    r0.xyz = r0.xyz * r10.xyz;
    r8.z = ps;
    r1.xyz = r8.xyz * float3(0.875, 0.875, 15.0);
    r6.yz = r1.xy * r6.yz + 0.125;
    ps = pow(2.0, r1.z);
