// ps_058647ef97235868.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 99 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000018C 10000400 00000004 00000000 00002863 00070007 00000021 00003050 0000F151 0000F256
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.xy = r0.xy * float2(64.0, 4.0) + UniformVector_5.xy;
    r0.zw = r0.xy * float2(2e+01, 0.5) + UniformVector_3.xy;
    r4.xz = r0.xy * float2(32.0, 1.0) + UniformVector_4.xy;
    r4.y = r4.z + r0.y;
    r0.z = tex2D(Texture2D_2, r0.zw).x;
    r0.w = tex2D(Texture2D_3, r4.xy).w;
    r3.x = tex2D(Texture2D_4, r3.xy).w;
    ...
    r0.y = min(r0.x, 1.0);
    r0.x = r0.y * r0.z;
    r0.w = IndividualVelocityScale.y * r0.x;
    r1.yz = r0.wy * r2.yx;
    r0.y = r1.z * r0.z;
    r1.x = IndividualVelocityScale.x * r0.y;
