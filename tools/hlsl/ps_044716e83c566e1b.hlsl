...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.z = -r0.z + 1.0;
    r0.y = ps;
    r8.xy = -r0.zz * ModShadowGroupColor.xy + 1.0;
    ps = rsqrt(abs(r1.w));
    ...
    r7.y = ps;
    ps = r2.x;
    r1.w = dot(r3.zxy, r0.wyz);
    ps = r1.z * ps;
    r2.xyz = r3.xzy * r1.www;
    r7.z = ps;
    r0.yzw = r2.xyz * 2.0 - r0.ywz;
    ps = 1.0 - r0.x;
    r0.z = saturate(dot(r7.zxy, r0.zyw));
    r0.y = saturate(ps);
    ps = log2(r0.z);
    ...
    r0.z = ps;
    r0.xw = r0.xw * r8.xy + 0.125;
    ps = r0.x * r0.w;
    r1.w = saturate(dot(r3.zxy, r7.zxy));
    r0.x = ps;
    ps = pow(2.0, r0.y);
