...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.zw = tex2D(ModShadowAccumTexture, r6.yz).xy;
    ...
    ps = rsqrt(abs(r6.w));
    r1.xyz = r7.www * r4.xyz;
    r6.w = ps;
    r4.xyz = r5.xyz * r6.www;
    r6.w = dot(r4.zxy, r1.zxy);
    ps = 1.0 - r6.x;
    r5.xyz = r4.xzy * r6.www;
    r6.w = saturate(ps);
    r1.xyz = r5.xyz * 2.0 - r1.xzy;
    ps = log2(r6.w);
    r6.x = saturate(dot(r2.zxy, r1.yxz));
    r6.w = ps;
    ps = log2(r6.x);
    ...
    r0.y = ps;
    r0.yzw = r0.yzw * float3(0.21952, 0.875, 0.875);
    r7.xyz = r7.xyz * r6.xxx + r0.yyy;
    r0.yz = r0.zw * r6.yz + 0.125;
    r0.xy = r0.xy * r0.xz;
