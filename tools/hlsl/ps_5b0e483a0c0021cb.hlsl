// ps_5b0e483a0c0021cb.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 21 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000054 10000400 00000008 00000000 00004CA5 0007001F 00000021 0000F050 0000F156 00007257 0000F3A0 0000F4A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.xy = r0.xy * UniformVector_3.xy;
    r3.y = tex2D(Texture2D_8, r3.xy).w;
    r3.x = (-0.5) + r3.y;
