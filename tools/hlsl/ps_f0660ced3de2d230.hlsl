// ps_f0660ced3de2d230.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 72 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000120 10040400 00000406 00000000 00004084 000F000F 00000021 0000F054 0000F156 0000F257 0000F358
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.yw = tex2D(ModShadowAccumTexture, r2.xy).xy;
    ...
    r0.x = ps;
    ps = -ModShadowColor.y;
    r2.xy = r0.yy * ModShadowGroupColor.xy;
    ps = 1.0 + ps;
    r2.xyz = -r2.xyz + 1.0;
    r0.y = ps;
    ps = -ModShadowColor.z;
