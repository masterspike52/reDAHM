// ps_0e09aef5238663f6.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 75 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000012C 10000400 00000008 00000000 00004CA5 0007001F 00000001 0000F050 0000F155 00007256 0000F3A0 0000F4A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.xy = r0.xy * 0.2;
    r3.zw = tex2D(Texture2D_0, r3.xy).xy;
    ...
    r3.x = -r3.y * abs(r3.x) + 1.0;
    r3.y = log2(abs(r3.x));
    r3.x = 5e+01 * r3.y;
    r3.x = pow(2.0, r3.x);
    r3.xy = r3.xx * r3.zw;
    r3.xy = r3.xy * 4.0;
    r3.xy = r3.xy * UniformVector_1.xy;
