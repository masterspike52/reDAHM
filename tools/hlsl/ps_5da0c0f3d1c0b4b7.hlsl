// ps_5da0c0f3d1c0b4b7.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 153 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000264 10040C00 0000080A 00000000 00008108 003F00FF 00000001 0000F050 0000F153 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.xyz = r10.xyz * r7.yzw;
    r6.w = dot(r8.zxy, r8.zxy);
    r11.xyz = r7.yzw * AmbientColorAndSkyFactor.xyz;
    ps = rsqrt(abs(r6.y));
    r7.yzw = r7.yzw + UniformVector_0.xyz;
    r6.y = ps;
    r10.xyz = r11.xyz * r10.xyz + r7.yzw;
    ps = rsqrt(abs(r6.x));
    ...
    r6.w = ps;
    r5.xyz = r6.www * r8.zxy;
    r2.xyz = r5.xxx * r1.xyz;
    r12.x = dot(r6.zxy, r5.xyz);
    ps = 0.1 - -r7.x;
    r6.y = dot(r5.xyz, r4.wxy);
    r6.x = ps;
    ps = OpacityOverride.x;
    r6.x = saturate(r6.x * 5.0);
    r4.z = saturate(ps);
    ps = 1.0 - r6.x;
    r5.xyz = r5.yzx * r6.yyy;
    r6.z = ps;
    r11.xyz = r5.xyz * 2.0 - r4.xyw;
    ...
    r6.x = saturate(dot(r7.xyz, r11.zxy));
    r6.z = ps;
    ps = abs(r6.w) * abs(r6.w);
    r7.xyz = -r4.xyz + 1.0;
    r6.y = ps;
    r4.xyz = r0.xzy * r6.zzz;
    ps = log2(r6.x);
