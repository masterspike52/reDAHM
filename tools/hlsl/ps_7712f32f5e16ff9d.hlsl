...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r17.xyw = tex2D(Texture2D_7, r10.xy).xyz;
    r18.xyz = tex2D(Texture2D_4, r1.xy).xyz;
    ...
    r6.x = ps;
    r2.yzw = r17.yzw * UniformScalar_5.xxx + UniformScalar_6.xxx;
    ps = 2.5 * r6.x;
