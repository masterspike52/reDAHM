...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.xz = r0.xy - 0.5;
    r4.yw = UniformVector_2.xy * UniformScalar_6.xx;
    r5.z = r4.y * r4.x;
    ps = r4.w;
    r4.xy = r4.zx * UniformScalar_6.xx;
    ps = r4.z * ps;
    r5.x = r4.y * UniformVector_2.x;
    r0.y = ps;
    ps = UniformVector_1.y * r4.x;
    r0.z = r4.x * UniformVector_2.y;
    r0.x = ps;
    ps = UniformVector_1.x * r4.y;
    r0.xyz = r0.xyz + UniformVector_3.xyy;
    r5.y = ps;
    r5.xyz = r0.xyz + r5.yzx;
    r4.xzw = tex2D(Texture2D_0, r5.xy).xyz;
    r4.y = tex2D(Texture2D_0, r5.xz).w;
    ps = OpacityOverride.x * r4.y;
    oC0.w = ps;
    r4.xyz = r4.xzw * UniformScalar_7.xxx + UniformVector_0.xyz;
