// ps_737d4b570597df2d.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 75 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 0000012C 10000200 00000004 00000000 00001021 00010001 00000001 0000F050
...
float4 SampleOffsets[2] : register(c3); // float4[2]
float4 ScreenPositionScaleBias : register(c1); // float4
float4 ScreenToShadowMatrix[4] : register(c5); // float4x4 (matrix_columns)
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.x = dot(r0.wzxy, float4(0.25, 0.25, 0.25, 0.25));
    oC0 = r0.xxxx * r0.xxxx;
