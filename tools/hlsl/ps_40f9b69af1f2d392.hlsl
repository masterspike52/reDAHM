// ps_40f9b69af1f2d392.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 198 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000318 10040D00 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.xyz = tex2D(Texture2D_0, r5.xy).wxy;
    r9.zw = r0.wz * UniformVector_3.xy;
    r8.yz = r4.xy * ScreenPositionScaleBias.xy;
    ps = r4.w;
    r5.x = r1.z + 0.1;
    r12.xy = r6.yz * 2.0 - 1.0;
    ps = 0.0001 * ps;
    ...
    r7.xy = r4.xy * abs(r7.xy);
    r8.x = ps;
    r9.xy = r8.yz * r12.ww + ScreenPositionScaleBias.wz;
    r4.xyz = tex2D(Texture2D_3, r0.xy).xyz;
    r10.xy = tex2D(ModShadowAccumTexture, r7.xy).xy;
    r7.xyz = tex2D(Texture2D_2, r9.zw).xyz;
    ...
    r11.z = ps;
    r12.z = r13.z * 2.0 - 1.0;
    r10.zw = r13.xy * 2.0 - 1.0;
    ps = rsqrt(abs(r0.w));
    r5.x = saturate(-r5.x + 1.0);
    r0.w = ps;
    r2.xyz = r11.xzy * UniformVector_5.xzy - r11.xzy;
    r2.yzw = r2.xyz * r7.xxx + r11.xzy;
    ps = rsqrt(abs(r6.w));
    r1.yzw = r0.www * r1.xyz;
    r6.w = ps;
    ps = log2(r5.x);
    r11.xyz = r6.www * r3.xyz;
    r5.x = ps;
    r12.xy = r8.xx * r12.xy + r10.zw;
    ps = LightColorAndFalloffExponent.w * r5.x;
    r3.xyz = r12.xyz * UniformVector_2.xyz;
    r6.w = ps;
    ps = pow(2.0, r6.w);
    ...
    ps = 1.0 + ps;
    r5.x = saturate(dot(r1.wyz, r11.yxz));
    r1.x = ps;
    ps = log2(r5.x);
    r6.w = saturate(dot(r3.zxy, r1.wyz));
    r10.z = ps;
    ps = (-1.0) + r6.x;
    r3.xyz = r10.xyz * float3(0.875, 0.875, 15.0);
    r3.w = ps;
    r5.xyw = r3.xyw * r5.yzw + float3(0.125, 0.125, 1.0);
    r5.w = (r8.x > 0.0) ? r5.w : 1.0;
    ps = -UniformVector_0.y;
    r5.x = r5.x * r5.y;
    r5.xyz = r5.xxx * r9.xyz + ModShadowColor.xyz;
    r2.x = (r8.x >= 0.0) ? r5.w : 1.0;
    ps = 1.0 + ps;
    r6.xyz = r2.xwz * r7.xyz;
    r1.y = ps;
    ps = -UniformVector_0.z;
    r6.xyz = r6.xyz * r2.yxx;
    ps = 1.0 + ps;
    ...
    r5.w = ps;
    r6.xyz = r2.xyz * UniformScalar_5.xxx + r6.xyz;
