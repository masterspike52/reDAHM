// ps_4c9e629728cb7c51.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 111 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001BC 10040900 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.y = 1.0 / ModShadowAccumResolution.y;
    ...
    r2.yz = -r2.yz;
    r2.x = r2.x * 2.0 - r2.x;
    r5.w = saturate(dot(r9.yzx, r2.yzx));
    ps = log2(r5.w);
