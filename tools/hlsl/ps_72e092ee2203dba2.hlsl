// ps_72e092ee2203dba2.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 201 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000324 10040E00 0000080A 00000000 00007908 003F00FF 00000001 0000F050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.x = ps;
    r7.xy = r7.yz * r7.xx + ScreenPositionScaleBias.wz;
    ps = r6.z;
    r7.zw = r0.wz * UniformScalar_4.xx;
    ps = r1.x * ps;
    r0.xy = r3.zw * abs(r8.xy);
    r6.z = ps;
    ps = UniformScalar_1.x * r1.y;
    r1.w = saturate(r5.w * 0.0001);
    r6.w = ps;
    r9.yz = tex2D(ModShadowAccumTexture, r0.xy).xy;
    r0.yzw = tex2D(Texture2D_6, r7.zw).xyz;
    r7.w = tex2D(Texture2D_2, r1.xy).x;
    r10.xyz = tex2D(Texture2D_4, r3.xy).xyz;
    r14.xyz = tex2D(Texture2D_5, r6.zw).xyz;
    r1.xyz = tex2D(Texture2D_0, r3.xy).xzy;
    ...
    r12.xyz = r1.xzy * 2.0 - 1.0;
    ps = rsqrt(abs(r2.w));
    r14.xyz = -r10.xyz + r14.xyz;
    r6.z = ps;
    ps = 5.0 * r6.x;
    ...
    r6.xzw = -r1.xwz + 1.0;
    r1.x = ps;
    r2.zw = r1.yx * r6.zz + 1.0;
    ps = UniformScalar_3.x * r6.z;
    r1.xyz = -UniformVector_0.xyz + 1.0;
    r6.y = ps;
    r2.xy = r6.yy * r8.xy + r2.xy;
    r2.xy = r2.xy * r6.zz;
    r2 = (r6.yzzz > 0.0) ? r2.wxyz : float4(1.0, 0.0, 0.0, 1.0);
    r8 = (r6.yzzz >= 0.0) ? r2 : float4(1.0, 0.0, 0.0, 1.0);
    r7.w = dot(r8.wyz, r8.wyz);
    ps = rsqrt(abs(r0.x));
    r10.xyz = r0.yzw * r8.xxx;
    r0.x = ps;
    r2.xyz = r10.xyz * UniformScalar_5.xxx + UniformScalar_6.xxx;
    ps = rsqrt(abs(r7.w));
    r0.yzw = r0.xxx * r4.xyz;
    r7.w = ps;
    r8.xyz = r8.yzw * r7.www;
    r7.w = dot(r8.zxy, r0.wyz);
    ps = LightColor.x * r7.y;
    r4.xyz = r8.xyz * r7.www;
    r0.x = ps;
    r0.yzw = r4.xyz * 2.0 - r0.yzw;
    ps = LightColor.y * r7.z;
    r7.w = saturate(dot(r5.zxy, r0.wyz));
    r0.y = ps;
    ps = log2(r7.w);
