// ps_91b8d50ecab88395.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 297 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004A4 10040B00 0000080A 00000000 00007108 003F00FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9.xy = r5.xz * r5.wz;
    r1.xyw = r9.zwy * float3(0.875, 0.875, 0.0208351);
    ps = UniformScalar_1.x;
    r6.w = r1.w - 0.085133;
    r6.w = r9.y * r6.w + 0.180141;
    r6.w = r9.y * r6.w - 0.3302995;
    ps = (-1.2) * ps;
    r0.w = r9.y * r6.w;
    r0.z = ps;
    r10.zw = r0.zw + float2(0.8, 0.999866);
    r10.y = r5.z * r10.w;
    r5.xzw = r10.zxy * float3(0.24999972, -3.1415927, -2.0);
    r0.zw = r5.xw + float2(0.5, 1.5707964);
    r6.w = r0.w * r7.w + r10.y;
    ps = frac(r0.z);
    r11.x = float((r6.y >= UniformScalar_0.x));
    r7.w = ps;
    ...
    ps = r2.x * ps;
    r11.y = float((r8.x >= UniformScalar_2.x));
    r0.x = ps;
    ps = r0.w;
    ...
    r0.y = ps;
    ps = r0.w;
    r10.yzw = r1.zyx * r6.yyy;
    r4.xy = (r11.xy > 0.0) ? r4.xy : 1.0;
    r6.yzw = r10.wzy * 2.0 - r6.zwx;
    ps = r2.z * ps;
    r10.yz = r5.zw + 0.125;
    r0.w = ps;
    ps = r4.x * r4.y;
    ...
    r5.x = r1.w + r7.w;
    r5.xzw = tex2D(Texture2D_1, r5.xy).xyz;
    r5.xzw = r6.xxx * r5.xzw;
    p0 = (-r0.z > 0.0);
    ps = p0 ? 0.0 : 1.0;
    r7.xyz = r5.xzw * r7.xyz;
    if (p0)
    {
        r0.z = -abs(r0.z) + 1.0;
    }
    ...
    r7.w = saturate(dot(r1.zxy, r0.wxy));
    ...
    r1.y = ps;
    r0.xyz = r5.xyz * UniformScalar_7.xxx + UniformScalar_8.xxx;
    ps = max(r1.x, r1.y);
