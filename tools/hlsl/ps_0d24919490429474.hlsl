...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.xw = r0.xy + UniformVector_2.xy;
    r0.z = 1.0 / r4.w;
    ps = ScreenPositionScaleBias.x * r0.z;
    r0.yw = r0.xy + UniformVector_1.xy;
    r6.y = ps;
    ...
    r8.xyz = tex2D(Texture2D_2, r0.yw).xyz;
    r9.yzw = tex2D(Texture2D_3, r6.xw).xyz;
    r10.xyz = tex2D(Texture2D_0, r0.yw).xyz;
    ...
    r2.xyz = r0.zzz * r10.xyz;
    r0.z = dot(r2.zxy, r3.zxy);
    r10.xyz = r2.xzy * r0.zzz;
    r3.xyz = r10.xyz * 2.0 - r3.xzy;
    r0.z = saturate(dot(r1.zxy, r3.yxz));
    ps = log2(r0.z);
    r1.x = saturate(dot(r2.zxy, r1.zxy));
    r9.x = ps;
    r2 = r9 * float4(15.0, 1.5, 1.5, 1.5);
    ps = LightColorAndFalloffExponent.w * r0.x;
    r1.yzw = r2.yzw * r8.xyz;
    r0.x = ps;
    ps = pow(2.0, r2.x);
