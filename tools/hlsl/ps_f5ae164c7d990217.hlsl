...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.w = ps;
    r1.xy = r0.ww * r5.xy;
    r1.xz = r1.xy * r0.zz + r1.zw;
    r0.z = r1.y * r0.z + UniformVector_2.y;
    r1.y = r0.z + r0.y;
    r0.z = tex2D(Texture2D_1, r1.xz).x;
    r0.y = tex2D(Texture2D_1, r1.xy).x;
    r0.x = r0.z * r0.y;
    r0.xyw = r0.xxy * r3.xyz;
    ps = r6.w;
    r0.z = r0.w * r0.z;
