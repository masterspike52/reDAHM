...
float4 UniformScalar_14 : register(c9); // float
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.xy = r0.xy * float2(3.0, 1.0) + UniformVector_1.xy;
    r0.zw = r0.xy + UniformVector_2.xy;
    ps = UniformScalar_9.x * r0.z;
    r0.xy = r0.xy + UniformVector_3.xy;
    r1.x = ps;
    ps = UniformScalar_9.x * r0.w;
    r1.zw = r0.xy * UniformScalar_14.xx;
    r1.y = ps;
    r0.xyz = tex2D(Texture2D_0, r2.xy).xyz;
    r2.xyz = tex2D(Texture2D_1, r1.zw).xyz;
    ...
    r0.xyz = r0.xyz * UniformVector_4.xyz + UniformVector_0.xyz;
