// ps_3cb83fea826057c1.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 252 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000003F0 10040B00 0000080A 00000000 00008108 001F00FF 00000001 0000F050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A1 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    ps = rsqrt(abs(r5.w));
    r11.xyz = r4.xyz * r6.www;
    r5.w = ps;
    r4.xyz = r9.xzy * r5.www;
    r6.w = dot(r4.yxz, r10.zxy);
    r5.w = dot(r11.zxy, r11.zxy);
    ps = rsqrt(abs(r5.w));
    r4.xyz = r4.xzy * r6.www;
    r5.w = ps;
    r4.xyz = r4.xyz * 2.0 - r10.xyz;
    ps = r7.x;
    r11.yzw = r11.xzy * r5.www;
    r6.xyz = r11.ywz * r9.yyy + r6.xyz;
    ps = abs(r8.x) * ps;
    r5.xyz = r5.zxy * r4.zzz;
    r11.x = ps;
    r5.xyz = r11.ywz * r4.yyy + r5.xyz;
    r6.xyz = r3.xzy * r9.xxx + r6.xyz;
    r11.yzw = r3.xyz * r4.xxx + r5.xzy;
    ps = LocalToWorldMatrix[0].z * r6.x;
    r5.xyz = r11.zzz * LocalToWorldMatrix[2].xyz;
    r3.w = ps;
    ps = LocalToWorldMatrix[1].z * r6.y;
    r3.xyz = r11.www * LocalToWorldMatrix[1].xyz;
    r5.w = ps;
    r3.xyz = r11.yyy * LocalToWorldMatrix[0].xzy + r3.xzy;
    ps = r7.y;
    r3 = r3.xzyw + r5;
    ps = abs(r8.y) * ps;
    r5 = xe_cube(r3.xyz);
    ...
    r5.xz = tex2D(ModShadowAccumTexture, r11.xy).xy;
    r3.xyz = -ModShadowColor.xyz + 1.0;
    r8.xyz = UniformVector_2.xyz * UniformScalar_1.xxx;
    r5.w = dot(r1.zxy, r1.zxy);
    r5.y = dot(r7.zxy, float3(0.11, 0.3, 0.59));
    ps = rsqrt(abs(r5.w));
    r6.xyw = r6.xyw - 1.0;
    r5.w = ps;
    r0.yzw = r6.xyw * UniformScalar_0.xxx + 1.0;
    r6.xyw = r5.www * r1.xzy;
    r1.xyz = r5.yyy - r7.xyz;
    r7.xyz = r1.xyz * 0.8 + r7.xyz;
    ps = 0.1 - -r6.y;
    ...
    r5.x = ps;
    ps = r5.y;
    r7.w = saturate(dot(r6.yxw, r4.zxy));
    r5.y = r6.z * LocalToWorldMatrix[2].z + r3.w;
    ps = r1.z * ps;
    r5.z = r5.y * 0.5;
    r5.y = ps;
    ...
    ps = log2(r7.w);
    r6.yw = r0.xy * float2(0.8, 5e+01);
    r6.z = ps;
    ps = pow(2.0, r6.y);
    r7.w = max(r6.w, 0.0001);
    r6.y = ps;
    ps = sqrt(abs(r6.x));
    r7 = r7 * r6.yyyz;
    r6.x = ps;
    ...
    r6.w = ps;
    r6.xyz = r7.xyz * r6.xxx + UniformVector_1.xyz;
    r7.xyz = r6.www * ConstantLighting.xyz;
    r7.xyz = r7.xyz * r0.yzw;
    r6.xyz = r6.xyz * r0.yzw + UniformVector_0.xyz;
    r6.xyz = r7.xyz * 2e+01 + r6.xyz;
    ps = -r2.w;
