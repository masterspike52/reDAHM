// ps_5e3b8407ea678a99.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 96 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000180 10000300 00000008 00000000 00004084 0003000F 00000021 0000F050 0000F156 0000F2A0 0000F3A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r3.xy = r0.xy * float2(15.0, 1.875) + UniformVector_4.xy;
    r3.zw = r0.xy + r0.xy;
    r0.xz = r0.yx - 0.5;
    r3.zw = r3.zw * float2(5.0, 0.5) + UniformVector_3.xy;
    ...
    r3.y = tex2D(Texture2D_3, r0.xy).x;
    r2.y = tex2D(Texture2D_1, r3.zw).w;
    ps = 2.0 - r2.y;
    r2.z = r3.y * r2.w;
    r2.x = ps;
    r2.x = r2.x * r3.x + r2.y;
