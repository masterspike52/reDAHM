// ps_7de9a9709af83eaf.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 123 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001EC 10040900 0000070A 00000000 000068E7 001F007F 00000021 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.z = ps;
    ps = rsqrt(abs(r5.x));
    r9.xyz = r4.zzz * r1.xyz;
    r5.w = ps;
    ps = 1.0 - r5.x;
    r0.xyz = r5.www * -SpotDirection.xyz;
    r5.x = saturate(ps);
    ps = log2(r5.x);
    r5.y = -r5.y + 1.0;
    r5.x = ps;
    r4.xy = -r5.yy * ModShadowGroupColor.xy + 1.0;
    ...
    r4.w = ps;
    ps = -r3.y;
    r2.xy = r4.zw * TwoSidedSign.xx;
    r3.y = ps;
    ps = -r3.z;
    r3.x = -r3.x + r2.y;
    r3.z = ps;
    ps = -SpotAngles.x - -r5.y;
    r5.z = saturate(dot(r9.xyz, r3.yzx));
    r5.y = ps;
    ps = log2(r5.z);
    ...
    r5.x = ps;
    ps = pow(2.0, r5.z);
    r5.y = saturate(r2.x * r1.z);
    r8.x = ps;
    ps = pow(2.0, r5.x);
    r2.xyz = r8.xyz * float3(0.21952, 0.875, 0.875);
    r5.x = ps;
    r1.xyz = r7.xyz * r5.yyy + r2.xxx;
    r5.yz = r2.yz * r4.xy + 0.125;
    ps = r5.y * r5.z;
