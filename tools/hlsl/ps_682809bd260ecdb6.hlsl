// ps_682809bd260ecdb6.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 357 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 00000594 10041300 0000070A 00000000 000070E7 001F007F 00000001 0000F050 0000F154 0000F256 0000F357 0000F458 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r9.xyw = tex2D(Texture2D_2, r0.xy).yzx;
    r17.xyz = tex2D(Texture2D_3, r0.xy).xyz;
    r5.yzw = tex2D(Texture2D_1, r0.xy).yxz;
    r13.xyz = UniformVector_7.xyz - UniformVector_6.xyz;
    ...
    r0.xyz = UniformVector_4.xyz - UniformVector_5.xyz;
    r10.y = ps;
    ps = UniformScalar_22.x;
    r6.w = dot(r1.zxy, r1.zxy);
    ps = -UniformScalar_21.x + ps;
    r16.xyz = r17.xyz * UniformScalar_17.xxx;
    r15.w = ps;
    ps = r5.w + r5.w;
    r5.x = dot(r9.ywx, float3(1.0, 1.0, 1.0));
    r12.w = ps;
    ps = 4.0 * r5.z;
    r6.xyz = r8.xyz + r8.xyz;
    r19.z = ps;
    ps = 4.0 * r5.y;
    r5.z = dot(r17.yzx, float3(0.59, 0.11, 0.3));
    r19.w = ps;
    ps = rsqrt(abs(r6.w));
    ...
    ps = 5.0 * r5.z;
    r6.w = dot(r17.yxz, float3(0.59, 0.3, 0.11));
    r5.y = ps;
    ps = 1.0 * r5.z;
    r12.xyz = r5.www * r1.xyz;
    r5.w = ps;
    ps = UniformScalar_19.x;
    r19.xy = r5.wy * UniformScalar_15.xx;
    r14.xyz = r19.yyy * r0.xyz + UniformVector_5.xyz;
    ps = r6.w + ps;
    r5.yw = r12.zw + float2(0.1, -1.0);
    r5.z = ps;
    ps = frac(r5.z);
    r1.w = float((r19.x >= 0.2));
    r6.w = ps;
    ps = 5.0 * r5.y;
    r0 = r6.xzyw + float4(-1.0, -1.0, -1.0, -0.5);
    r5.z = saturate(ps);
    ps = abs(r0.w) + abs(r0.w);
    r6.xyz = r19.xzw + float3(-0.2, -2.0, -2.0);
    r9.z = ps;
    ps = 1.25 * r6.x;
    r8.w = float((r19.x > 0.2));
    r1.x = ps;
    ps = r5.w;
    r10.zw = -r0.xz - 2.0;
    ps = -r0.y + ps;
    r6.zw = r6.yz - r0.xz;
    r18.w = ps;
    r1.xyz = r1.xxx * r18.xyz + UniformVector_4.xyz;
    r13.xyz = r13.xyz * r9.zzz + UniformVector_6.xyz;
    ps = 1.0 - r5.x;
    r6.xy = r10.zw + r19.zw;
    r0.y = ps;
    ps = 1.0 - r5.z;
    r13.xyz = r13.xyz * UniformScalar_20.xxx;
    r0.w = ps;
    r5.xyz = (r8.www > 0.0) ? r1.xyz : UniformVector_4.xyz;
    ps = UniformScalar_23.x * r0.y;
    r1.xyz = r0.yyy * r17.xyz;
    r8.w = ps;
    r15.xyz = r1.xyz * r15.xyz - r1.xyz;
    r5.yzw = (r1.www > 0.0) ? r5.xyz : r14.xyz;
    r6 = r6 * UniformScalar_0.xxxx + r0.xzxz;
    ps = UniformScalar_16.x * r5.y;
    r13.xyz = r13.xzy * r9.yyy;
    r14.x = ps;
    ps = UniformScalar_16.x * r5.z;
    r13.xyz = r13.xyz * r9.yyy;
    r14.y = ps;
    r9.xyz = r16.xyz * r9.xxx + r13.xzy;
    r13.xyz = r15.xyz * UniformScalar_0.xxx + r1.xyz;
    r5.x = r15.w * UniformScalar_0.x + UniformScalar_21.x;
    ps = UniformScalar_16.x * r5.w;
    r1.yzw = r13.xyz * r5.xxx;
    r14.z = ps;
    r9.xyz = r14.xzy * r9.www + r9.xzy;
    r18.xyz = r11.xzy * r9.xyz - r9.xyz;
    ...
    r10.z = r10.x * r6.z;
    ps = r5.z * r5.z;
    r17.xyz = r5.yww * r6.xyw;
    r6.y = ps;
    ps = 1.0 / ModShadowAccumResolution.x;
    r1.y = r17.z * r17.z;
    r6.x = ps;
    r1.x = r10.z * r0.x + r1.y;
    r6.z = dot(r10.yz, r0.zx) + 0.0;
    ...
    r11.x = ps;
    r9.xyz = r18.xyz * UniformScalar_0.xxx + r9.xyz;
    ps = r13.x;
    ...
    r3.x = ps;
    ps = log2(abs(r5.y));
    r4 = r11.yzww * float4(0.875, 0.875, -0.5, 0.5);
    r5.y = ps;
    r11.yz = r4.xy * r5.xz + 0.125;
    ...
    r5.z = saturate(dot(r12.zxy, r7.zxy));
    r5.x = ps;
    ps = log2(r5.z);
    ...
    ps = pow(2.0, r6.z);
    r10.xyz = r3.ywz * r0.yyy;
    r6.z = ps;
    ps = ConstantLighting.y * r6.w;
    r0.xyz = r6.zzz * ConstantLighting.xzy;
    r3.y = ps;
    r9.xyz = r10.xyz * UniformScalar_4.xxx + r9.xyz;
    ps = ConstantLighting.z * r6.w;
    r9.xyz = r9.xzy + UniformVector_0.xyz;
    r3.z = ps;
    r6.xyz = r1.xyz * AmbientColorAndSkyFactor.xyz + r9.xyz;
