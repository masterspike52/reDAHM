// ps_a35b842f633f58e4.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 243 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000003CC 10040E00 0000090A 00000000 00008129 003F01FF 00000021 00003050 0000F151 00007254 0000F355 00007456 0000F557 0000F6A0 0000F7A1 0000F8A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r11.x = ps;
    r8.xy = r11.yz * r14.zz + ScreenPositionScaleBias.wz;
    r3.xyz = tex2D(LightAttenuationTexture, r8.xy).xyz;
    r5.y = tex2D(ShadowTexture, r0.xy).x;
    r9.xyz = tex2D(Texture2D_5, r1.xy).xyz;
    r5.w = tex2D(Texture2D_2, r1.xy).x;
    r8.xz = tex2D(ModShadowAccumTexture, r6.zw).xy;
    r0.xyz = tex2D(Texture2D_4, r6.xy).xyz;
    ...
    r8.y = float((UniformScalar_13.x >= 1.0));
    r1.x = ps;
    ...
    r0.xyz = (-abs(r8.www) >= 0.0) ? r0.xyz : 1.0;
    r1.xyz = (-abs(r8.yyy) >= 0.0) ? 1.0 : r0.xyz;
    ps = UniformVector_2.z * r6.x;
    r12.xyz = r6.www * r2.xyz;
    r13.x = ps;
    r13.zw = r13.xw - 1.0;
    r6.xy = r11.xx * r14.xy + r6.yz;
    r13.xy = r6.xy * UniformVector_2.xy;
    r6.xyz = r13.zxy * r7.yyy;
    ps = 1.0 + r6.x;
    ...
    r7.w = ps;
    ps = rsqrt(abs(r6.x));
    r2.yzw = r7.www * r4.xyz;
    r6.x = ps;
    ps = -ModShadowColor.x;
    r6.xyz = r6.yzw * r6.xxx;
    ps = 1.0 + ps;
    r6.w = dot(r6.zxy, r2.wyz);
    r2.x = ps;
    ps = -ModShadowColor.y;
    r4.xyz = r6.xyz * r6.www;
    r2.yzw = r4.xyz * 2.0 - r2.yzw;
    ps = 1.0 + ps;
    r6.w = saturate(dot(r12.zxy, r2.wyz));
    r2.y = ps;
    ps = log2(r6.w);
    r4.z = r13.w * r7.y;
    r8.y = ps;
    ps = UniformScalar_9.x * r8.y;
    r6.w = saturate(dot(r6.zyx, r12.zyx));
    r6.x = ps;
    ps = pow(2.0, r6.x);
    r8.xyw = r8.xzy * float3(0.875, 0.875, 15.0);
    r6.y = ps;
    ps = -ModShadowColor.z;
    r4.xy = r8.xy * r7.xz;
    ps = 1.0 + ps;
    r7.xyz = r4.xzy + float3(0.125, 1.0, 0.125);
    r2.z = ps;
    r7.y = (r11.x > 0.0) ? r7.y : 1.0;
    ps = UniformScalar_10.x * r6.y;
    r6.x = r7.x * r7.z;
    r7.x = ps;
    r6.xyz = r6.xxx * r2.xyz + ModShadowColor.xyz;
    r5.z = (r11.x >= 0.0) ? r7.y : 1.0;
    r10.w = r7.x * r5.z;
    r7 = r10 * r1.xyzx;
    r7 = r7 * r5.zzzw;
    r0.xyz = r7.xyz * r0.xyz;
    r5.z = (r0.w > 0.0) ? 0.0 : r7.w;
    r1.xyz = -r7.xyz + r9.xyz;
    r7.xyz = r1.xyz * UniformScalar_15.xxx + r7.xyz;
    r1.xyz = r7.xyz * UniformScalar_16.xxx + UniformScalar_17.xxx;
    r7.xy = r5.xy * r5.zy;
    r8.xyz = r7.yyy * r3.xyz;
    ps = pow(2.0, r8.w);
    r7.yzw = r1.xyz + r7.xxx;
    r7.x = ps;
