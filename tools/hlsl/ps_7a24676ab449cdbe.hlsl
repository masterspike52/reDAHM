// ps_7a24676ab449cdbe.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 312 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004E0 10041000 0000080A 00000000 00007908 003F00FF 00000021 00003050 0000F151 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.z = ps;
    r16.x = r14.z * r15.z - 1.0;
    r12.xw = r15.xy * 2.0 - 1.0;
    r16.zw = r14.xy * 2.0 - 1.0;
    ps = rsqrt(abs(r6.z));
    r15.yzw = r1.xyz * r13.xyz;
    r6.z = ps;
    ...
    r2.x = saturate(ps);
    r6.w = (r6.z == 0.0) ? r9.z : r6.w;
    r2.z = (r6.y == 0.0) ? r9.w : r6.w;
