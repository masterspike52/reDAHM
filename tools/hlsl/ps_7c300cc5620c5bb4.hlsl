...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r1.x = r3.z * 2.0 - r3.z;
    ps = -r3.y;
    r6 = r6.xyzx * float4(-0.5, 0.875, 0.875, 0.5);
    r1.z = ps;
    ps = 0.1 - -r5.w;
    r4.zw = r6.xw * r4.zz;
    r5.x = ps;
    ps = 5.0 * r5.x;
    r5.w = saturate(dot(r5.yzw, r1.yzx));
    r5.x = saturate(ps);
    ps = -ModShadowColor.x;
    r5.x = -r5.x + 1.0;
    ps = 1.0 + ps;
    ...
    r9.x = ps;
    ps = -ModShadowColor.y;
    r1 = r9 * float4(15.0, 0.21952, 0.21952, 0.21952);
    ps = 1.0 + ps;
    r4.xy = r6.yz * r5.xy;
    r6.y = ps;
    ps = pow(2.0, r1.x);
    ...
    r6.z = ps;
    ps = r4.x * r4.y;
    r5.xy = abs(r4.zw) * abs(r4.zw);
    r5.z = ps;
    r6.xyz = r5.zzz * r6.xyz + ModShadowColor.xyz;
    ps = UniformVector_0.y;
    r4.xyz = r1.yzw * r5.xxx;
    ps = 7e+01 + ps;
    r5.xyz = r1.yzw * r5.yyy;
    r0.y = ps;
    r5.xyz = r5.xyz * UpperSkyColor.xyz + r8.xyz;
    r5.xyz = r4.xyz * LowerSkyColor.xyz + r5.xyz;
    r5.xyz = r3.xyz * 0.21952 + r5.xyz;
    r5.xyz = r7.zxy * r1.wyz + r5.zxy;
