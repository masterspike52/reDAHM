...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r11.xyz = r5.xyz * 2.0 - 1.0;
    r5.xyz = r0.xyw * r7.yzx;
    r6.y = rsqrt(abs(r6.y));
    ...
    r6.x = ps;
    ps = 1.0 - r6.z;
    r4.xyz = r11.xyz * r6.xxx;
    r6.y = saturate(ps);
    ps = UniformVector_1.x * r7.y;
    r6.x = dot(r4.zxy, r10.zxy);
    r2.x = ps;
    ps = UniformVector_1.y * r7.z;
    r6.xzw = r4.xzy * r6.xxx;
    r2.y = ps;
    r6.xzw = r6.xzw * 2.0 - r10.xzy;
    ps = log2(r6.y);
    r6.x = saturate(dot(r8.zxy, r6.zxw));
    r6.y = ps;
    ps = log2(r6.x);
    ...
    ps = pow(2.0, r6.x);
    r7.z = saturate(dot(r4.zxy, r8.zxy));
    r6.x = ps;
    r6.xyz = r2.xyz * r6.xxx;
    r7.xy = r5.xy * r7.zz + r6.xy;
    r7.z = r5.z * r7.z + r6.z;
    r0.xy = r0.xz * r0.yz;
