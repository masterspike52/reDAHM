// ps_84b16e1349963056.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 117 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001D4 10040B00 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r6.xzw = tex2D(Texture2D_2, r0.xy).xyz;
    ...
    r0.y = LightColor.z * r5.x;
    ps = LightColor.y * r5.z;
    r5.w = dot(r8.zxy, r1.zxy);
    r0.z = ps;
    ps = 3.5 * r6.x;
    r5.xyz = r8.xzy * r5.www;
    r3.x = ps;
    r5.xyz = r5.xyz * 2.0 - r1.xzy;
    ps = 3.5 * r6.z;
