// ps_1bbbe8d2b3fe5ae9.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 318 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000080 000004F8 10041100 0000080A 00000000 00008108 003F00FF 00000021 0000F050 0000F153 0000F254 0000F356 0000F457 0000F558 0000F6A0 0000F7A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r4.xy = r6.zw + r6.zw;
    r4.w = ps;
    r12.yz = tex2D(ModShadowAccumTexture, r4.zw).xy;
    r15.xyz = tex2D(Texture2D_4, r6.xy).xyz;
    r17 = tex2D(Texture2D_1, r4.xy);
    r8.xyz = tex2D(Texture2D_6, r10.xy).xyz;
    ...
    r10.xyz = UniformVector_5.xyz * UniformVector_5.www;
    r7.z = dot(r2.zxy, r2.zxy);
    r16.x = r7.w * r13.z - 1.0;
    r16.yz = r13.xy * 2.0 - 1.0;
    ps = rsqrt(abs(r7.z));
    ...
    r14.yzw = r2.yzw * UniformScalar_3.xxx + UniformScalar_4.xxx;
    ps = 0.0001 * ps;
    ...
    r6.x = ps;
    ps = 2.5 * r6.x;
    r7.y = abs(r6.z) * abs(r6.z);
    r2.x = ps;
    ps = r7.y * r7.y;
    r4.yz = r7.zw - r13.yz;
    r4.x = ps;
    r7.yzw = r2.yzw * r6.zzz - r15.xyz;
    r4.w = saturate(r2.x * r6.z - 0.5);
