...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r5.xy = r5.yy * ScreenPositionScaleBias.xy;
    r9.y = ps;
    ...
    ps = abs(r7.x) * ps;
    r3.z = saturate(dot(r8.zxy, r10.zxy));
    r5.z = ps;
    ps = r9.y;
    ...
    r9.xyz = tex2D(Texture2D_2, r3.zz).xyz;
    r7.xyz = tex2D(Texture2D_0, r0.xy).xyz;
    r0.yzw = tex2D(LightAttenuationTexture, r5.xy).xyz;
    r5.x = dot(r1.zxy, r1.zxy);
    r5.y = dot(r2.zxy, r2.zxy);
    ps = rsqrt(abs(r5.x));
    r0.x = saturate(-r5.y + 1.0);
    r6.w = ps;
    r5.w = saturate(r6.w * r1.z);
    ...
    r1.x = r8.z * 2.0 - r8.z;
    ps = log2(r0.x);
    r6.w = saturate(dot(r2.yzx, r1.yzx));
    r0.x = ps;
    ps = log2(r6.w);
    ...
    r6.xyz = r6.xyz * r5.www + r0.zzz;
    r0.xy = r0.xy * r3.xy + 0.125;
    ps = r0.x * r0.y;
    r6.xyz = r1.xyz * r6.xyz;
    r5.w = ps;
    r5.xyz = r5.www * r5.xyz + ModShadowColor.xyz;
