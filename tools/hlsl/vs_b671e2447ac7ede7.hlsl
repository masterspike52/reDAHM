// vs_b671e2447ac7ede7.bin
// Xenos vertex shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1101, 1062 ucode dwords, 8 literal constant(s).
// Constant table creator: 2.0.6995.0 (vs_3_0)
// Shader header: 00000080 00001098 0061000D 00000000 00000000 000070E7 00000001 00000007 00000007 00000290 0010002A 0000602B 0000702C 0000302D 0001A02E 0000502F 00215030 0000F050 0001F154 0002F256 0003F357 0004F458 0005F5A0 0006F6A2 00001160 0000115B 0000115A 0000115C 0000115D 0000115E 0000115F
...
VS_OUTPUT main(VS_INPUT In)
{
    ...
    r13.xy = r0.xx * ViewProjectionMatrix[2].zw + r2.xy;
    ...
    r8.xyz = r12.xxx * WorldToLocal[2].xyz;
    r6.xyz = r9.xxx * WorldToLocal[2].xyz;
    r13.xy = r0.yy * ViewProjectionMatrix[1].zw + r13.xy;
    r9.xy = r0.zz * ViewProjectionMatrix[0].zw + r13.xy;
    r6.xyz = r9.zzz * WorldToLocal[1].xyz + r6.xyz;
    r0.xyz = r12.yyy * WorldToLocal[1].xyz + r8.xyz;
