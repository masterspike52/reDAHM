...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r7.y = ps;
    r0.zw = r7.xy * r4.xy + ScreenPositionScaleBias.wz;
    ...
    r1.x = saturate(ps);
    ps = log2(r0.w);
    r1.z = r1.w - SpotAngles.x;
    r0.w = ps;
    ps = LightColorAndFalloffExponent.w * r0.x;
    r1.y = r0.w * 15.0;
    r0.w = ps;
    ps = pow(2.0, r1.y);
    r0.x = saturate(r1.z * SpotAngles.y);
    r7.z = ps;
    ps = pow(2.0, r0.w);
    r2.xyz = r7.xyz * float3(0.875, 0.875, 0.21952);
    r0.w = ps;
    r1.xyz = r5.xyz * r1.xxx + r2.zzz;
