// ps_bbfb627219cc3cb8.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 114 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 000001C8 10040800 00000506 00000000 000040A5 001F001F 00000001 00003050 00007154 0000F255 00007356 0000F457
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r2.yzw = tex2D(Texture2D_1, r0.xy).xyz;
    ps = 1.0 / r4.w;
    r0.w = r1.z + 0.1;
    r2.x = ps;
    r7.xyz = r2.yzw * 2.0 - 1.0;
    ps = 5.0 * r0.w;
    r1.w = dot(r3.zxy, r3.zxy);
    r0.z = saturate(ps);
    ps = 1.0 / ModShadowAccumResolution.y;
    r2.xy = r2.xx * ScreenPositionScaleBias.xy;
    r6.y = ps;
    ...
    ps = abs(r5.x) * ps;
    r4.z = saturate(dot(r3.xyz, r7.zxy));
    r2.z = ps;
    ps = r6.y;
    r4.xy = r0.zz * ModShadowGroupColor.xy;
    ps = abs(r5.y) * ps;
    r4.xyz = -r4.xyz + 1.0;
    r2.w = ps;
    r5.xy = tex2D(ModShadowAccumTexture, r2.zw).xy;
    r8.xyz = tex2D(Texture2D_2, r4.zz).xyz;
    r7.xyz = tex2D(Texture2D_0, r0.xy).xyz;
    r0.xyz = tex2D(LightAttenuationTexture, r2.xy).zxy;
    ...
    r1.w = saturate(dot(r8.yzx, r3.yzx));
    r3.x = ps;
    ps = log2(r1.w);
