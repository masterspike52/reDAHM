// ps_74c62a80d968c866.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 96 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000180 18000400 00000004 00000000 000040A5 001F001F 00000011 00003050 00003151 0000F252 0000F353 0000F457
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.zw = r0.yx - 0.5;
    r1.y = dot(r0.zw, UniformVector_3.yx) + 0.5;
    r1.x = dot(r0.zw, UniformVector_2.yx) + 0.5;
    r0.z = tex2D(Texture2D_1, r0.xy).x;
    r0.w = tex2D(Texture2D_1, r1.xy).x;
