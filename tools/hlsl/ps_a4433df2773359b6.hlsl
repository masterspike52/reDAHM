// ps_a4433df2773359b6.bin
// Xenos pixel shader decompiled to HLSL (D3D9 / SM3).
// Container flags 0x102A1100, 129 ucode dwords, 4 literal constant(s).
// Constant table creator: 2.0.6995.0 (ps_3_0)
// Shader header: 00000040 00000204 10040900 0000070A 00000000 000068E7 001F007F 00000001 0000F050 00007154 0000F255 00007356 0000F457 0000F5A0 0000F6A2
...
PS_OUTPUT main(PS_INPUT In)
{
    ...
    r0.yz = r6.yz * abs(r7.xy);
    r6.y = ps;
    r6.xy = r6.xy * r4.xy + ScreenPositionScaleBias.wz;
    r6.xyz = tex2D(LightAttenuationTexture, r6.xy).xyz;
    r4.xy = tex2D(ModShadowAccumTexture, r0.yz).xy;
    r9.xyz = tex2D(Texture2D_0, r5.xy).xyz;
    ...
    r6.w = saturate(dot(r1.zxy, r3.zxy));
    r0.x = dot(r1.zxy, r7.zxy);
    r1.xyz = r1.xzy * r0.xxx;
    r1.xyz = r1.xyz * 2.0 - r7.xzy;
    r0.x = saturate(dot(r3.zxy, r1.yxz));
    ps = log2(r0.x);
